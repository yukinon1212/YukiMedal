var ts=Object.defineProperty;var ss=(c,e,s)=>e in c?ts(c,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):c[e]=s;var r=(c,e,s)=>ss(c,typeof e!="symbol"?e+"":e,s);import{M as k,O as is,B as Fe,F as bt,S as Te,U as Ve,V as oe,W as Ue,H as We,N as as,C as ns,a as V,b as se,A as os,c as De,R as rs,d as ls,e as cs,L as ds,f as hs,g as ps,h as Ut,i as ms,j as us,k as Wt,l as A,m as N,n as fs,P as Se,o as gs,p as ys,q as xs,r as bs,s as vs,t as Vt,u as ws,D as Qe,v as vt,w as Ge,x as je,y as Ze,G as wt,z as Ss,E as ne,I as Ts,J as ge,T as Me,K as Es,Q as Ms,X as Yt,Y as Cs,Z as St,_ as Is,$ as _s,a0 as Pe,a1 as ct,a2 as As,a3 as Xe,a4 as Ke}from"./three-CzJWjZO5.js";import{O as Ne}from"./rapier-DpxwuBBO.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))i(t);new MutationObserver(t=>{for(const a of t)if(a.type==="childList")for(const n of a.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function s(t){const a={};return t.integrity&&(a.integrity=t.integrity),t.referrerPolicy&&(a.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?a.credentials="include":t.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(t){if(t.ep)return;t.ep=!0;const a=s(t);fetch(t.href,a)}})();var M=(c=>(c.INIT="INIT",c.TITLE="TITLE",c.STAGE_START="STAGE_START",c.PLAYING="PLAYING",c.STAGE_CLEAR="STAGE_CLEAR",c.SKIP_PROMPT="SKIP_PROMPT",c.GAME_OVER="GAME_OVER",c.SHOP="SHOP",c.SKILL_SELECT="SKILL_SELECT",c.RESULT="RESULT",c))(M||{});class Rs{constructor(){r(this,"listeners",new Map)}on(e,s){this.listeners.has(e)||this.listeners.set(e,new Set);const i=this.listeners.get(e);return i.add(s),()=>i.delete(s)}once(e,s){const i=this.on(e,t=>{s(t),i()})}emit(e,s){const i=this.listeners.get(e);if(i)for(const t of i)t(s)}off(e,s){var i;(i=this.listeners.get(e))==null||i.delete(s)}clear(){this.listeners.clear()}}const L=new Rs,Ps=[{from:M.INIT,to:M.TITLE},{from:M.TITLE,to:M.STAGE_START},{from:M.STAGE_START,to:M.PLAYING},{from:M.PLAYING,to:M.STAGE_CLEAR},{from:M.PLAYING,to:M.GAME_OVER},{from:M.STAGE_CLEAR,to:M.STAGE_START},{from:M.STAGE_CLEAR,to:M.SKIP_PROMPT},{from:M.STAGE_CLEAR,to:M.SHOP},{from:M.SKIP_PROMPT,to:M.SHOP},{from:M.SKIP_PROMPT,to:M.STAGE_START},{from:M.SHOP,to:M.SKILL_SELECT},{from:M.SKILL_SELECT,to:M.STAGE_START},{from:M.GAME_OVER,to:M.RESULT},{from:M.RESULT,to:M.TITLE}];class ks{constructor(){r(this,"current",M.INIT)}get state(){return this.current}canTransition(e){return Ps.some(s=>(Array.isArray(s.from)?s.from:[s.from]).includes(this.current)&&s.to===e)}transition(e){if(!this.canTransition(e))throw new Error(`Invalid state transition: ${this.current} → ${e}`);const s=this.current;this.current=e,L.emit("state:changed",{from:s,to:e})}is(e){return this.current===e}isAny(...e){return e.includes(this.current)}}class Ls{constructor(){r(this,"updateFns",[]);r(this,"rafId",null);r(this,"lastTime",0);r(this,"maxDelta",1/20)}addUpdateFn(e){this.updateFns.push(e)}removeUpdateFn(e){const s=this.updateFns.indexOf(e);s!==-1&&this.updateFns.splice(s,1)}start(){if(this.rafId!==null)return;this.lastTime=performance.now();const e=s=>{this.rafId=requestAnimationFrame(e);const i=(s-this.lastTime)/1e3;this.lastTime=s;const t=Math.min(i,this.maxDelta);for(const a of this.updateFns)a(t)};this.rafId=requestAnimationFrame(e)}stop(){this.rafId!==null&&(cancelAnimationFrame(this.rafId),this.rafId=null)}get isRunning(){return this.rafId!==null}}const Tt="yukimedal_save",Ds="yukimedal_best",Je={bestPhase:0,bestStage:0,totalRuns:0,lastPlayedAt:0};class Hs{constructor(){r(this,"data");this.data=this.load()}load(){try{const e=localStorage.getItem(Tt);return e?{...Je,...JSON.parse(e)}:{...Je}}catch{return{...Je}}}save(){try{localStorage.setItem(Tt,JSON.stringify(this.data))}catch{}}updateBest(e,s){const i=e*3+s,t=this.data.bestPhase*3+this.data.bestStage;i>t&&(this.data.bestPhase=e,this.data.bestStage=s,localStorage.setItem(Ds,JSON.stringify({phase:e,stage:s}))),this.data.lastPlayedAt=Date.now(),this.save()}incrementRuns(){this.data.totalRuns++,this.save()}get bestPhase(){return this.data.bestPhase}get bestStage(){return this.data.bestStage}get totalRuns(){return this.data.totalRuns}}const qt={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}Ce.BlurDirectionX=new oe(1,0);Ce.BlurDirectionY=new oe(0,1);const Ws={name:"OutputShader",uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		...
		}`};class Vs extends _e{constructor(){super();const e=Ws;this.uniforms=Ve.clone(e.uniforms),this.material=new rs({name:e.name,uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader}),this.fsQuad=new dt(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,s,i){this.uniforms.tDiffuse.value=i.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},ls.getTransfer(this._outputColorSpace)===cs&&(this.material.defines.SRGB_TRANSFER=""),this._toneMapping===ds?this.material.defines.LINEAR_TONE_MAPPING="":this._toneMapping===hs?this.material.defines.REINHARD_TONE_MAPPING="":this._toneMapping===ps?this.material.defines.CINEON_TONE_MAPPING="":this._toneMapping===Ut?this.material.defines.ACES_FILMIC_TONE_MAPPING="":this._toneMapping===ms?this.material.defines.AGX_TONE_MAPPING="":this._toneMapping===us&&(this.material.defines.NEUTRAL_TONE_MAPPING=""),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this.fsQuad.render(e)):(e.setRenderTarget(s),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this.fsQuad.render(e))}dispose(){this.material.dispose(),this.fsQuad.dispose()}}class Ys extends Wt{constructor(){super();const e=new A;e.deleteAttribute("uv");const s=new N({side:fs}),i=new N,t=new Se(16777215,900,28,2);t.position.set(.418,16.199,.3),this.add(t);const a=new k(e,s);a.position.set(-.757,13.219,.717),a.scale.set(31.713,28.305,28.591),this.add(a);const n=new k(e,i);n.position.set(-10.906,2.009,1.846),n.rotation.set(0,-.195,0),n.scale.set(2.328,7.905,4.651),this.add(n);const o=new k(e,i);o.position.set(-5.607,-.754,-.758),o.rotation.set(0,.994,0),o.scale.set(1.97,1.534,3.955),this.add(o);const l=new k(e,i);l.position.set(6.167,.857,7.803),l.rotation.set(0,.561,0),l.scale.set(3.927,6.285,3.687),this.add(l);const d=new k(e,i);d.position.set(-2.017,.018,6.124),d.rotation.set(0,.333,0),d.scale.set(2.002,4.566,2.064),this.add(d);const p=new k(e,i);p.position.set(2.291,-.756,-2.621),p.rotation.set(0,-.286,0),p.scale.set(1.546,1.552,1.496),this.add(p);const u=new k(e,i);u.position.set(-2.193,-.369,-5.547),u.rotation.set(0,.516,0),u.scale.set(3.875,3.487,2.986),this.add(u);const f=new k(e,we(50));f.position.set(-16.116,14.37,8.208),f.scale.set(.1,2.428,2.739),this.add(f);const h=new k(e,we(50));h.position.set(-16.109,18.021,-8.207),h.scale.set(.1,2.425,2.751),this.add(h);const m=new k(e,we(17));m.position.set(14.904,12.198,-1.832),m.scale.set(.15,4.265,6.331),this.add(m);const y=new k(e,we(43));y.position.set(-.462,8.89,14.52),y.scale.set(4.38,5.441,.088),this.add(y);const x=new k(e,we(20));x.position.set(3.235,11.486,-12.541),x.scale.set(2.5,2,.1),this.add(x);const v=new k(e,we(100));v.position.set(0,20,0),v.scale.set(1,.1,1),this.add(v)}dispose(){const e=new Set;this.traverse(s=>{s.isMesh&&(e.add(s.geometry),e.add(s.material))});for(const s of e)s.dispose()}}function we(c){const e=new De;return e.color.setScalar(c),e}class qs{constructor(e){r(this,"scene");r(this,"renderer");r(this,"composer");r(this,"renderPass");r(this,"bloomPass");r(this,"onResize",()=>{this.renderer.setSize(window.innerWidth,window.innerHeight),this.composer.setSize(window.innerWidth,window.innerHeight)});this.scene=new Wt,this.scene.background=new V(1710638),this.scene.fog=new gs(1710638,20,60),this.renderer=new ys({antialias:!0}),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=xs,this.renderer.toneMapping=Ut,this.renderer.toneMappingExposure=1.05,this.renderer.outputColorSpace=bs,e.appendChild(this.renderer.domElement);const s=new vs(this.renderer);s.compileEquirectangularShader();const i=s.fromScene(new Ys,.04).texture;this.scene.environment=i,s.dispose();const t=window.innerWidth,a=window.innerHeight,n=new Vt(60,t/a,.1,200);this.renderPass=new Fs(this.scene,n),this.bloomPass=new Ce(new oe(t,a),.88,.42,.72);const o=new Vs;this.composer=new zs(this.renderer),this.composer.addPass(this.renderPass),this.composer.addPass(this.bloomPass),this.composer.addPass(o),window.addEventListener("resize",this.onResize)}setCamera(e){this.renderPass.camera=e}applySceneTheme(e){this.scene.background.set(e.background),this.scene.fog&&this.scene.fog.color.set(e.fogColor),this.bloomPass.strength=e.bloomStrength,this.bloomPass.threshold=e.bloomThreshold,this.bloomPass.radius=e.bloomRadius}render(e){this.renderPass.camera=e,this.composer.render()}add(...e){this.scene.add(...e)}remove(...e){this.scene.remove(...e)}dispose(){window.removeEventListener("resize",this.onResize),this.renderer.dispose()}}const g={INITIAL_MEDALS:100,INITIAL_SHOP_MONEY:0,MEDAL_BUY_PRICE:5,BASE_QUOTA:40,QUOTA_MULTIPLIER:1.3,STAGES_PER_PHASE:3,FIELD_WIDTH:8,FIELD_DEPTH:12,FIELD_HEIGHT:.1,PUSHER_WIDTH:8,PUSHER_DEPTH:6.5,PUSHER_HEIGHT:1.2,PUSHER_RANGE:3.5,PUSHER_PERIOD_MS:2500,MEDAL_RADIUS:.5,MEDAL_RADIUS_LARGE:.75,MEDAL_RADIUS_TRIPLE:.55,MEDAL_THICKNESS:.05,MEDAL_MASS:1,MAX_MEDALS_ON_FIELD:200,INITIAL_FIELD_MEDALS:10,INITIAL_PUSHER_MEDALS:6,MEDAL_PROB_NORMAL:58,MEDAL_PROB_DOUBLE:78,MEDAL_PROB_TRIPLE:88,ITEMS_PER_STAGE:3,SKILL_CHOICES:3,GRAVITY:-9.81,CAMERA_FOV:45,CAMERA_NEAR:.1,CAMERA_FAR:100,JACKPOT_THRESHOLD:35,JACKPOT_MEDAL_REWARD:25,OPEN_ZONE_START:2,MEDAL_CLEANUP_Y:-8};class Qs{constructor(){r(this,"camera");r(this,"target",new se(0,0,-1.5));r(this,"basePosition",new se(0,6,15));r(this,"shakeOffset",new se);r(this,"shakeIntensity",0);r(this,"shakeDecay",0);r(this,"titleMode",!1);r(this,"titleAngle",0);r(this,"idleTime",0);r(this,"onResize",()=>{this.camera.aspect=window.innerWidth/window.innerHeight,this.camera.updateProjectionMatrix()});this.camera=new Vt(g.CAMERA_FOV,window.innerWidth/window.innerHeight,g.CAMERA_NEAR,g.CAMERA_FAR),this.setFrontView(),window.addEventListener("resize",this.onResize)}setFrontView(){this.basePosition.set(0,6,15),this.camera.position.copy(this.basePosition),this.camera.lookAt(this.target)}setTitleMode(e){this.titleMode=e,e||this.setFrontView()}shake(e,s){this.shakeIntensity=e,this.shakeDecay=s>0?-Math.log(.01)/s:0}update(e){if(this.titleMode){this.titleAngle+=e*.18;const t=Math.sin(this.titleAngle)*3,a=6.5+Math.sin(this.titleAngle*.55)*1,n=14.5+Math.cos(this.titleAngle*.7)*1.5;this.camera.position.set(t,a,n),this.camera.lookAt(t*.2,1.5,-2);return}this.idleTime+=e;const s=Math.sin(this.idleTime*.22)*.055,i=Math.sin(this.idleTime*.31)*.038;this.shakeIntensity>.001?(this.shakeOffset.set((Math.random()*2-1)*this.shakeIntensity+s,(Math.random()*2-1)*this.shakeIntensity+i,0),this.camera.position.copy(this.basePosition).add(this.shakeOffset),this.shakeIntensity*=Math.exp(-this.shakeDecay*e)):(this.shakeIntensity=0,this.camera.position.copy(this.basePosition),this.camera.position.x+=s,this.camera.position.y+=i),this.camera.lookAt(this.target)}lookAt(e){this.target.copy(e),this.camera.lookAt(this.target)}dispose(){window.removeEventListener("resize",this.onResize)}}class js{constructor(e){r(this,"ambient");r(this,"dirLight");r(this,"fillLight");r(this,"warmPoint");r(this,"coolPoint");r(this,"sideLeft");r(this,"sideRight");r(this,"fieldSpot");r(this,"backSpot");r(this,"graze");r(this,"scanLight");r(this,"feverActive",!1);this.ambient=new ws(4210784,.55),this.dirLight=new Qe(16775408,1.4),this.dirLight.position.set(6,14,8),this.dirLight.castShadow=!0,this.dirLight.shadow.mapSize.width=2048,this.dirLight.shadow.mapSize.height=2048,this.dirLight.shadow.camera.near=.1,this.dirLight.shadow.camera.far=55,this.dirLight.shadow.camera.left=-14,this.dirLight.shadow.camera.right=14,this.dirLight.shadow.camera.top=14,this.dirLight.shadow.camera.bottom=-14,this.dirLight.shadow.bias=-4e-4,this.fillLight=new Qe(5267711,.28),this.fillLight.position.set(-6,4,6),this.warmPoint=new Se(16760928,1,18),this.warmPoint.position.set(0,7,5),this.coolPoint=new Se(3364351,.65,22),this.coolPoint.position.set(0,5,-9),this.sideLeft=new Se(16771280,.55,24),this.sideLeft.position.set(-10,5,2),this.sideRight=new Se(16771280,.55,24),this.sideRight.position.set(10,5,2),this.fieldSpot=new vt(16774376,1.6,32,Math.PI/4.5,.35,1.2),this.fieldSpot.position.set(0,11,2),this.fieldSpot.target.position.set(0,0,-.5),this.fieldSpot.castShadow=!1,this.backSpot=new vt(8952319,.8,22,Math.PI/6,.45,1.6),this.backSpot.position.set(0,10,-11),this.backSpot.target.position.set(0,1,0),this.backSpot.castShadow=!1,this.graze=new Qe(16767136,.55),this.graze.position.set(14,2,4),this.scanLight=new Se(16775912,1.3,12),this.scanLight.position.set(0,8,-1),e.add(this.ambient,this.dirLight,this.fillLight,this.warmPoint,this.coolPoint,this.sideLeft,this.sideRight,this.fieldSpot,this.fieldSpot.target,this.backSpot,this.backSpot.target,this.graze,this.scanLight)}update(e){this.scanLight.position.x=Math.sin(e*.57)*4.8,this.scanLight.position.z=Math.cos(e*.38)*1.5-3,this.scanLight.intensity=(this.feverActive?2.2:1.3)+Math.sin(e*1.1)*(this.feverActive?.35:.18)}applyTheme(e){this.ambient.color.set(e.ambientColor),this.ambient.intensity=e.ambientIntensity,this.fillLight.color.set(e.fillColor),this.fillLight.intensity=e.fillIntensity,this.warmPoint.color.set(e.warmPointColor),this.warmPoint.intensity=e.warmPointIntensity,this.coolPoint.color.set(e.coolPointColor),this.coolPoint.intensity=e.coolPointIntensity}setFeverMode(e){this.feverActive=e,this.fieldSpot.intensity=e?2.2:1.6,this.fieldSpot.color.set(e?16772710:16774376),this.scanLight.color.set(e?16763972:16775912)}}class Zs{constructor(e){r(this,"stars");r(this,"starMat");r(this,"brightStars");r(this,"brightStarMat");r(this,"grid");r(this,"scene");r(this,"dustMotes");r(this,"dustPos");r(this,"_t",0);this.scene=e;const s=2800,i=new Float32Array(s*3),t=65;for(let m=0;m<s;m++){const y=Math.random()*Math.PI*2,x=Math.acos(2*Math.random()-1),v=(.3+Math.random()*.7)*t;i[m*3]=v*Math.sin(x)*Math.cos(y),i[m*3+1]=v*Math.sin(x)*Math.sin(y),i[m*3+2]=v*Math.cos(x)}const a=new Fe;a.setAttribute("position",new Ge(i,3)),this.starMat=new je({size:.13,color:8952319,transparent:!0,opacity:.88,sizeAttenuation:!0}),this.stars=new Ze(a,this.starMat),e.add(this.stars);const n=200,o=new Float32Array(n*3),l=new Float32Array(n*3),d=[new V(16765088),new V(10070783),new V(16769152),new V(16756991),new V(8454143)];for(let m=0;m<n;m++){const y=Math.random()*Math.PI*2,x=Math.acos(2*Math.random()-1),v=(.5+Math.random()*.45)*t;o[m*3]=v*Math.sin(x)*Math.cos(y),o[m*3+1]=v*Math.sin(x)*Math.sin(y),o[m*3+2]=v*Math.cos(x);const E=d[Math.floor(Math.random()*d.length)];l[m*3]=E.r,l[m*3+1]=E.g,l[m*3+2]=E.b}const p=new Fe;p.setAttribute("position",new Ge(o,3)),p.setAttribute("color",new Ge(l,3)),this.brightStarMat=new je({size:.4,vertexColors:!0,transparent:!0,opacity:.95,sizeAttenuation:!0}),this.brightStars=new Ze(p,this.brightStarMat),e.add(this.brightStars),this.grid=new wt(80,40,1714782,924218),this.grid.position.y=-.56,e.add(this.grid);const u=160;this.dustPos=new Float32Array(u*3);for(let m=0;m<u;m++)this.dustPos[m*3]=(Math.random()-.5)*12,this.dustPos[m*3+1]=Math.random()*7,this.dustPos[m*3+2]=(Math.random()-.5)*14;const f=new Fe;f.setAttribute("position",new Ge(this.dustPos,3));const h=new je({size:.045,color:16765088,transparent:!0,opacity:.32,sizeAttenuation:!0,depthWrite:!1});this.dustMotes=new Ze(f,h),e.add(this.dustMotes)}applyTheme(e){this.starMat.color.set(e.starColor),this.scene.remove(this.grid),this.grid.geometry.dispose(),this.grid.material.dispose(),this.grid=new wt(80,40,e.gridColorA,e.gridColorB),this.grid.position.y=-.56,this.scene.add(this.grid)}update(e){this._t+=e,this.stars.rotation.y+=.008*e,this.brightStars.rotation.y-=.003*e,this.brightStars.rotation.x+=.001*e,this.starMat.opacity=.8+Math.sin(this._t*.45)*.08,this.brightStarMat.opacity=.88+Math.sin(this._t*.62+1.1)*.07;const s=this.dustPos.length/3;for(let i=0;i<s;i++)this.dustPos[i*3]+=Math.sin(i*2.3+this.dustPos[i*3+1]*.7)*6e-4*e,this.dustPos[i*3+1]+=(.006+i%7*5e-4)*e,this.dustPos[i*3+1]>7.5&&(this.dustPos[i*3]=(Math.random()-.5)*12,this.dustPos[i*3+1]=-.2,this.dustPos[i*3+2]=(Math.random()-.5)*14);this.dustMotes.geometry.attributes.position.needsUpdate=!0}}class Xs{constructor(){r(this,"world");r(this,"_initialized",!1)}async init(){await Ne.init(),this.world=new Ne.World({x:0,y:g.GRAVITY,z:0});const e=this.world.integrationParameters;e.numSolverIterations=16,e.numAdditionalFrictionIterations=8,e.numInternalPgsIterations=2,e.maxCcdSubsteps=8,this._initialized=!0}get rapier(){return Ne}get instance(){if(!this._initialized)throw new Error("PhysicsWorld not initialized");return this.world}get initialized(){return this._initialized}step(){this.world.step()}createRigidBody(e){return this.world.createRigidBody(e)}createCollider(e,s){return this.world.createCollider(e,s)}removeRigidBody(e){this.world.removeRigidBody(e)}getEventQueue(){return new Ne.EventQueue(!0)}stepWithEvents(e){this.world.step(e)}forEachActiveRigidBody(e){this.world.forEachActiveRigidBody(e)}setTimestep(e){this._initialized&&(this.world.integrationParameters.dt=e)}dispose(){this._initialized&&(this.world.free(),this._initialized=!1)}}class Ks{constructor(){r(this,"bodyToMesh",new Map)}register(e,s){this.bodyToMesh.set(e.handle,s)}unregister(e){this.bodyToMesh.delete(e.handle)}sync(e){e.forEachActiveRigidBody(s=>{const i=this.bodyToMesh.get(s.handle);if(!i)return;const t=s.translation(),a=s.rotation(),n=i.userData.physicsYOffset??0;i.position.set(t.x,t.y+n,t.z),i.quaternion.set(a.x,a.y,a.z,a.w)})}clear(){this.bodyToMesh.clear()}get count(){return this.bodyToMesh.size}}class Js{constructor(){r(this,"handles",new Map);r(this,"dropZoneHandles",new Set);r(this,"eventQueue");r(this,"medalCollectedCallback");r(this,"itemCollectedCallback")}init(e){this.eventQueue=e.getEventQueue()}registerHandle(e,s){this.handles.set(e,s),s==="drop_zone"&&this.dropZoneHandles.add(e)}unregisterHandle(e){this.handles.delete(e),this.dropZoneHandles.delete(e)}onMedalCollected(e){this.medalCollectedCallback=e}onItemCollected(e){this.itemCollectedCallback=e}processEvents(e,s=1){for(let i=0;i<s;i++)e.stepWithEvents(this.eventQueue);this.eventQueue.drainCollisionEvents((i,t,a)=>{var d,p;if(!a)return;const n=this.handles.get(i),o=this.handles.get(t);if(n==="drop_zone"&&(o==="medal"||o==="item")||o==="drop_zone"&&(n==="medal"||n==="item")){const u=n==="drop_zone"?t:i,f=n==="drop_zone"?o:n;f==="medal"?(d=this.medalCollectedCallback)==null||d.call(this,u):f==="item"&&((p=this.itemCollectedCallback)==null||p.call(this,u))}})}getTag(e){return this.handles.get(e)}clear(){this.handles.clear(),this.dropZoneHandles.clear(),this.medalCollectedCallback=void 0,this.itemCollectedCallback=void 0}}class ei{constructor(){r(this,"body");r(this,"time",0);r(this,"zBase");r(this,"initialized",!1);r(this,"speedMultiplier",1);this.zBase=-12/2+g.PUSHER_DEPTH/2-g.PUSHER_RANGE}async initPhysics(e){const s=e.rapier,i=s.RigidBodyDesc.kinematicVelocityBased().setTranslation(0,g.PUSHER_HEIGHT/2,this.zBase);this.body=e.createRigidBody(i);const t=s.ColliderDesc.cuboid(g.PUSHER_WIDTH/2,g.PUSHER_HEIGHT/2,g.PUSHER_DEPTH/2);e.createCollider(t,this.body),this.initialized=!0}update(e){this.time+=e*this.speedMultiplier;const s=g.PUSHER_PERIOD_MS/1e3,i=this.time%s/s,t=(1-Math.cos(i*Math.PI*2))/2*g.PUSHER_RANGE;if(this.initialized){const a=Math.PI*g.PUSHER_RANGE/s*Math.sin(i*Math.PI*2);this.body.setLinvel({x:0,y:0,z:a},!0),i<e/s&&this.body.setTranslation({x:0,y:g.PUSHER_HEIGHT/2,z:this.zBase},!0)}return t}get currentZOffset(){const e=g.PUSHER_PERIOD_MS/1e3,s=this.time%e/e;return(1-Math.cos(s*Math.PI*2))/2*g.PUSHER_RANGE}get restZ(){return this.zBase}}function $e(c){return[c>>16&255,c>>8&255,c&255]}function et(c){const e=c.replace("#","");return[parseInt(e.slice(0,2),16),parseInt(e.slice(2,4),16),parseInt(e.slice(4,6),16)]}function X(c,e,s,i){return`rgb(${Math.min(255,c+i)},${Math.min(255,e+i)},${Math.min(255,s+i)})`}function ke(c,e,s,i){return`rgb(${Math.max(0,c-i)},${Math.max(0,e-i)},${Math.max(0,s-i)})`}function Mt(c,e,s){return`rgb(${c},${e},${s})`}function le(c,e,s,i,t){return`rgba(${Math.min(255,c+i)},${Math.min(255,e+i)},${Math.min(255,s+i)},${t})`}const Ee=class Ee{static get(e,s){if(!this.cache.has(e)){const i=s(),t=new Ss(i);this.cache.set(e,t)}return this.cache.get(e)}static getMedalTexture(e){return this.get(`medal_${e.toString(16)}`,()=>{const i=document.createElement("canvas");i.width=i.height=256;const t=i.getContext("2d"),a=256/2,n=256/2,o=256/2-2,[l,d,p]=$e(e),u=Mt(l,d,p),f=X(l,d,p,75),h=X(l,d,p,38),m=ke(l,d,p,60),y=ke(l,d,p,90),x=t.createRadialGradient(a-32,n-32,4,a,n,o);x.addColorStop(0,f),x.addColorStop(.25,X(l,d,p,55)),x.addColorStop(.55,h),x.addColorStop(.8,u),x.addColorStop(1,m),t.fillStyle=x,t.beginPath(),t.arc(a,n,o,0,Math.PI*2),t.fill(),t.save(),t.globalCompositeOperation="source-over";const v=480;for(let I=0;I<v;I++){const _=I/v*Math.PI*2,$=.012+Math.random()*.028,F=Math.random()>.5;t.strokeStyle=F?`rgba(${Math.min(255,l+45)},${Math.min(255,d+40)},${Math.min(255,p+35)},${$})`:`rgba(${Math.max(0,l-20)},${Math.max(0,d-18)},${Math.max(0,p-15)},${$*.7})`,t.lineWidth=.5+Math.random()*.6,t.beginPath(),t.moveTo(a+Math.cos(_)*16,n+Math.sin(_)*16),t.lineTo(a+Math.cos(_)*(o-20),n+Math.sin(_)*(o-20)),t.stroke()}t.restore();for(let I=0;I<4;I++){const _=o-6-I*8;t.strokeStyle=ke(l,d,p,35+I*10),t.lineWidth=2,t.beginPath(),t.arc(a,n,_,0,Math.PI*2),t.stroke(),t.strokeStyle=X(l,d,p,22+I*6),t.lineWidth=.9,t.beginPath(),t.arc(a,n,_+2.5,0,Math.PI*2),t.stroke()}t.strokeStyle=y,t.lineWidth=8,t.beginPath(),t.arc(a,n,o-5,0,Math.PI*2),t.stroke(),t.save(),t.strokeStyle=X(l,d,p,60),t.globalAlpha=.55,t.lineWidth=3,t.beginPath(),t.arc(a,n,o-3,Math.PI*.9,Math.PI*1.8),t.stroke(),t.restore();const E=68,C=t.createRadialGradient(a-10,n-10,0,a,n,E);C.addColorStop(0,X(l,d,p,65)),C.addColorStop(.4,X(l,d,p,30)),C.addColorStop(.75,h),C.addColorStop(.92,u),C.addColorStop(1,m),t.fillStyle=C,t.beginPath(),t.arc(a,n,E,0,Math.PI*2),t.fill(),t.strokeStyle=ke(l,d,p,50),t.lineWidth=2.5,t.beginPath(),t.arc(a,n,E+.5,0,Math.PI*2),t.stroke(),t.strokeStyle=X(l,d,p,48),t.lineWidth=1.2,t.beginPath(),t.arc(a,n,E-2.5,0,Math.PI*2),t.stroke(),t.lineCap="round";for(let I=0;I<24;I++){const _=I*Math.PI/12,$=I%2===0,F=$?16:22,z=$?56:48,W=$?.28:.18;t.strokeStyle=`rgba(${Math.min(255,l+50)},${Math.min(255,d+45)},${Math.min(255,p+38)},${W})`,t.lineWidth=$?2.5:1.5,t.beginPath(),t.moveTo(a+Math.cos(_)*F,n+Math.sin(_)*F),t.lineTo(a+Math.cos(_)*z,n+Math.sin(_)*z),t.stroke()}const w=e===13691135;if(w||e===16719968){const I=w?"×2":"×3",_=22,$=t.createRadialGradient(a-5,n-5,0,a,n,_);$.addColorStop(0,X(l,d,p,100)),$.addColorStop(.6,h),$.addColorStop(1,m),t.fillStyle=$,t.beginPath(),t.arc(a,n,_,0,Math.PI*2),t.fill(),t.strokeStyle=y,t.lineWidth=2,t.beginPath(),t.arc(a,n,_,0,Math.PI*2),t.stroke(),t.font="bold 26px sans-serif",t.textAlign="center",t.textBaseline="middle",t.fillStyle="rgba(255,255,255,0.96)",t.shadowColor="rgba(0,0,0,0.85)",t.shadowBlur=6,t.fillText(I,a,n+1),t.shadowBlur=0,t.textAlign="left"}else{const F=Math.PI/5,z=t.createRadialGradient(a-4,n-4,0,a,n,13);z.addColorStop(0,f),z.addColorStop(.5,h),z.addColorStop(1,m),t.fillStyle=z,t.beginPath();for(let W=0;W<10;W++){const j=W%2===0?13:5.5,ee=W*F-Math.PI/2;W===0?t.moveTo(a+j*Math.cos(ee),n+j*Math.sin(ee)):t.lineTo(a+j*Math.cos(ee),n+j*Math.sin(ee))}t.closePath(),t.fill(),t.strokeStyle=y,t.lineWidth=1.5,t.stroke()}const b=t.createRadialGradient(a-48,n-48,0,a-48,n-48,95);b.addColorStop(0,"rgba(255,255,255,0.72)"),b.addColorStop(.2,"rgba(255,255,255,0.32)"),b.addColorStop(.5,"rgba(255,255,255,0.08)"),b.addColorStop(1,"rgba(255,255,255,0)"),t.fillStyle=b,t.beginPath(),t.arc(a,n,o-2,0,Math.PI*2),t.fill();const D=t.createRadialGradient(a+52,n+50,0,a+52,n+50,60);D.addColorStop(0,"rgba(255,255,255,0.22)"),D.addColorStop(.4,"rgba(255,255,255,0.06)"),D.addColorStop(1,"rgba(255,255,255,0)"),t.fillStyle=D,t.beginPath(),t.arc(a,n,o-2,0,Math.PI*2),t.fill();const H=t.getImageData(0,0,256,256),P=H.data;for(let I=0;I<P.length;I+=4){const _=(Math.random()-.5)*10;P[I]=Math.max(0,Math.min(255,P[I]+_)),P[I+1]=Math.max(0,Math.min(255,P[I+1]+_)),P[I+2]=Math.max(0,Math.min(255,P[I+2]+_))}return t.putImageData(H,0,0),i})}static getFieldTexture(e="#2a2a4e"){return this.get(`field_${e}`,()=>{const i=document.createElement("canvas");i.width=i.height=512;const t=i.getContext("2d"),[a,n,o]=et(e),l=a>o+20;if(t.fillStyle=e,t.fillRect(0,0,512,512),l){const d=t.getImageData(0,0,512,512),p=d.data;for(let h=0;h<p.length;h+=4){const m=(Math.random()-.5)*22;p[h]=Math.max(0,Math.min(255,a+m)),p[h+1]=Math.max(0,Math.min(255,n+m)),p[h+2]=Math.max(0,Math.min(255,o+m)),p[h+3]=255}t.putImageData(d,0,0);for(let h=0;h<512;h+=3){const m=.07+Math.random()*.06,y=Math.random()>.5;t.strokeStyle=y?`rgba(${Math.min(255,a+18)},${Math.min(255,n+14)},${Math.min(255,o+10)},${m})`:`rgba(${Math.max(0,a-14)},${Math.max(0,n-10)},${Math.max(0,o-8)},${m})`,t.lineWidth=1+Math.random()*1.5,t.beginPath(),t.moveTo(0,h+.5),t.lineTo(512,h+.5),t.stroke()}t.save(),t.globalAlpha=.1;const u=36;t.strokeStyle=X(a,n,o,50),t.lineWidth=.8,t.translate(512/2,512/2),t.rotate(Math.PI/4),t.translate(-512/2,-512/2);for(let h=-512;h<=512*2;h+=u)t.beginPath(),t.moveTo(h,-512),t.lineTo(h,512*2),t.stroke();for(let h=-512;h<=512*2;h+=u)t.beginPath(),t.moveTo(-512,h),t.lineTo(512*2,h),t.stroke();t.restore();const f=t.createRadialGradient(512/2,512/2,512*.25,512/2,512/2,512*.75);f.addColorStop(0,"rgba(0,0,0,0)"),f.addColorStop(1,"rgba(0,0,0,0.28)"),t.fillStyle=f,t.fillRect(0,0,512,512)}else{const d=t.getImageData(0,0,512,512),p=d.data;for(let h=0;h<p.length;h+=4){const m=(Math.random()-.5)*18;p[h]=Math.max(0,Math.min(255,a+m)),p[h+1]=Math.max(0,Math.min(255,n+m)),p[h+2]=Math.max(0,Math.min(255,o+m)),p[h+3]=255}t.putImageData(d,0,0),t.save(),t.globalAlpha=.14;const u=40;t.strokeStyle=X(a,n,o,60),t.lineWidth=.8,t.translate(512/2,512/2),t.rotate(Math.PI/4),t.translate(-512/2,-512/2);for(let h=-512;h<=512*2;h+=u)t.beginPath(),t.moveTo(h,-512),t.lineTo(h,512*2),t.stroke();for(let h=-512;h<=512*2;h+=u)t.beginPath(),t.moveTo(-512,h),t.lineTo(512*2,h),t.stroke();t.restore(),t.save(),t.globalAlpha=.25,t.fillStyle=X(a,n,o,80),t.translate(512/2,512/2),t.rotate(Math.PI/4),t.translate(-512/2,-512/2);for(let h=0;h<=512*2;h+=u)for(let m=0;m<=512*2;m+=u)t.beginPath(),t.arc(h-512/2,m-512/2,1.8,0,Math.PI*2),t.fill();t.restore();for(let h=0;h<512;h+=4){const m=.04+Math.random()*.04,y=Math.random()>.5;t.strokeStyle=y?`rgba(${Math.min(255,a+20)},${Math.min(255,n+16)},${Math.min(255,o+14)},${m})`:`rgba(${Math.max(0,a-10)},${Math.max(0,n-8)},${Math.max(0,o-8)},${m})`,t.lineWidth=1+Math.random()*1.2,t.beginPath(),t.moveTo(0,h+.5),t.lineTo(512,h+.5),t.stroke()}const f=t.createRadialGradient(512/2,512/2,512*.2,512/2,512/2,512*.72);f.addColorStop(0,"rgba(0,0,0,0)"),f.addColorStop(1,"rgba(0,0,0,0.30)"),t.fillStyle=f,t.fillRect(0,0,512,512)}return i})}static getPusherTexture(e="#3a3a6e"){return this.get(`pusher_${e}`,()=>{const t=document.createElement("canvas");t.width=256,t.height=128;const a=t.getContext("2d"),[n,o,l]=et(e),d=n>l+20;if(a.fillStyle=e,a.fillRect(0,0,256,128),d){a.strokeStyle=le(n,o,l,90,.38),a.lineWidth=.8;const f=14;for(let h=-128;h<384;h+=f)a.beginPath(),a.moveTo(h,0),a.lineTo(h+128,128),a.stroke();for(let h=0;h<512;h+=f)a.beginPath(),a.moveTo(h,0),a.lineTo(h-128,128),a.stroke();a.fillStyle=X(n,o,l,90);for(let h=0;h<2;h++){const m=10+h*108;for(let y=20;y<256;y+=36)a.fillStyle=X(n,o,l,80),a.beginPath(),a.arc(y,m,4.5,0,Math.PI*2),a.fill(),a.fillStyle=le(n,o,l,150,.7),a.beginPath(),a.arc(y-1,m-1,2,0,Math.PI*2),a.fill(),a.fillStyle="rgba(0,0,0,0.45)",a.beginPath(),a.arc(y+1,m+1,3,.5,Math.PI*2),a.fill()}}else{for(let f=0;f<128;f++){const h=.015+Math.random()*.055;a.strokeStyle=le(n,o,l,100,h),a.lineWidth=1,a.beginPath(),a.moveTo(0,f+.5),a.lineTo(256,f+.5),a.stroke()}a.fillStyle=le(n,o,l,120,.35);for(let f=24;f<256;f+=48)a.beginPath(),a.arc(f,8,3,0,Math.PI*2),a.fill()}const p=a.createLinearGradient(0,0,0,18);p.addColorStop(0,le(n,o,l,150,.6)),p.addColorStop(1,le(n,o,l,150,0)),a.fillStyle=p,a.fillRect(0,0,256,18);const u=a.createLinearGradient(0,114,0,128);return u.addColorStop(0,"rgba(0,0,0,0)"),u.addColorStop(1,"rgba(0,0,0,0.55)"),a.fillStyle=u,a.fillRect(0,114,256,14),t})}static getWallTexture(e="#1a1a3e"){return this.get(`wall_${e}`,()=>{const i=document.createElement("canvas");i.width=i.height=256;const t=i.getContext("2d"),[a,n,o]=et(e),l=a>o+20;if(t.fillStyle=e,t.fillRect(0,0,256,256),l)for(let f=0;f<256;f+=40){const h=t.createLinearGradient(0,f,0,f+40);h.addColorStop(0,X(a,n,o,18)),h.addColorStop(.5,Mt(a,n,o)),h.addColorStop(1,ke(a,n,o,12)),t.fillStyle=h,t.fillRect(0,f,256,40),t.strokeStyle="rgba(0,0,0,0.55)",t.lineWidth=2,t.beginPath(),t.moveTo(0,f+40-1),t.lineTo(256,f+40-1),t.stroke(),t.strokeStyle=le(a,n,o,70,.45),t.lineWidth=1,t.beginPath(),t.moveTo(0,f+1),t.lineTo(256,f+1),t.stroke();for(let m=24;m<256;m+=48){const y=f+40-7;t.fillStyle=X(a,n,o,55),t.beginPath(),t.arc(m,y,4,0,Math.PI*2),t.fill(),t.fillStyle=le(a,n,o,130,.6),t.beginPath(),t.arc(m-1,y-1,1.5,0,Math.PI*2),t.fill(),t.fillStyle="rgba(0,0,0,0.5)",t.beginPath(),t.arc(m+1,y+1,2.5,.4,Math.PI*2),t.fill()}}else{for(let m=0;m<256;m+=64){const y=t.createLinearGradient(m,0,m+64,0);y.addColorStop(0,"rgba(0,0,0,0.22)"),y.addColorStop(.12,"rgba(0,0,0,0)"),y.addColorStop(.88,"rgba(0,0,0,0)"),y.addColorStop(1,"rgba(0,0,0,0.22)"),t.fillStyle=y,t.fillRect(m,0,64,256),t.strokeStyle="rgba(0,0,0,0.55)",t.lineWidth=2,t.beginPath(),t.moveTo(m,0),t.lineTo(m,256),t.stroke(),t.strokeStyle=le(a,n,o,72,.28),t.lineWidth=.9,t.beginPath(),t.moveTo(m+2.5,0),t.lineTo(m+2.5,256),t.stroke()}const f=56;for(let m=0;m<256;m+=f){t.strokeStyle="rgba(0,0,0,0.50)",t.lineWidth=2,t.beginPath(),t.moveTo(0,m),t.lineTo(256,m),t.stroke(),t.strokeStyle=le(a,n,o,62,.22),t.lineWidth=.9,t.beginPath(),t.moveTo(0,m+2.5),t.lineTo(256,m+2.5),t.stroke(),t.save(),t.globalAlpha=.6;for(let y=0;y<256;y+=64)t.fillStyle=X(a,n,o,85),t.beginPath(),t.arc(y,m,2.2,0,Math.PI*2),t.fill(),t.fillStyle="rgba(0,0,0,0.45)",t.beginPath(),t.arc(y+.6,m+.6,1.1,0,Math.PI*2),t.fill();t.restore()}t.save(),t.globalAlpha=.04,t.strokeStyle=X(a,n,o,55),t.lineWidth=.6;for(let m=-256;m<256*2;m+=10)t.beginPath(),t.moveTo(m,0),t.lineTo(m+256*.5,256),t.stroke();t.restore();const h=t.createRadialGradient(256/2,256/2,256*.2,256/2,256/2,256*.72);h.addColorStop(0,"rgba(0,0,0,0)"),h.addColorStop(1,"rgba(0,0,0,0.32)"),t.fillStyle=h,t.fillRect(0,0,256,256)}const d=t.getImageData(0,0,256,256),p=d.data;for(let u=0;u<p.length;u+=4){const f=(Math.random()-.5)*(l?8:10);p[u]=Math.max(0,Math.min(255,p[u]+f)),p[u+1]=Math.max(0,Math.min(255,p[u+1]+f)),p[u+2]=Math.max(0,Math.min(255,p[u+2]+f))}return t.putImageData(d,0,0),i})}static getScreenTexture(e,s){return this.get(`screen_${e.toString(16)}_${s.toString(16)}`,()=>{const a=document.createElement("canvas");a.width=512,a.height=256;const n=a.getContext("2d"),[o,l,d]=$e(s),p=n.createRadialGradient(512/2,256*.7,0,512/2,256*.7,512*.65);p.addColorStop(0,`rgb(${Math.min(o+28,60)},${Math.min(l+20,52)},${Math.min(d+28,68)})`),p.addColorStop(1,`rgb(${Math.max(o-4,0)},${Math.max(l-4,0)},${Math.max(d-4,0)})`),n.fillStyle=p,n.fillRect(0,0,512,256);const[u,f,h]=$e(e),m=`rgb(${u},${f},${h})`,y=`rgba(${u},${f},${h},0.60)`,x=`rgba(${u},${f},${h},0.25)`;n.strokeStyle=y,n.lineWidth=1.5,n.strokeRect(10,10,492,236),n.strokeStyle=x,n.lineWidth=.8,n.strokeRect(16,16,480,224);const v=["♠","♥","♦","♣"],E=[[32,38],[480,38],[32,234],[480,234]];n.textAlign="center",n.textBaseline="middle",n.font="bold 20px serif";for(let H=0;H<4;H++)n.fillStyle=x,n.fillText(v[H],E[H][0],E[H][1]);n.strokeStyle=x,n.lineWidth=1.5;for(const[H,P]of[[22,22],[490,22],[22,234],[490,234]])n.beginPath(),n.moveTo(H-7,P),n.lineTo(H+7,P),n.moveTo(H,P-7),n.lineTo(H,P+7),n.stroke();n.textAlign="center",n.textBaseline="top",n.font="bold 12px monospace",n.fillStyle=x,n.fillText("✦  INSERT COIN  ✦",512/2,22),n.strokeStyle=x,n.lineWidth=1,n.beginPath(),n.moveTo(20,52),n.lineTo(492,52),n.stroke(),n.textAlign="left",n.textBaseline="top",n.font="bold 11px monospace",n.fillStyle=x,n.fillText("JACKPOT",32,64),n.fillText("HIGH SCORE",512/2+20,64),n.font="bold 22px monospace",n.fillStyle=y,n.fillText("000000",32,80),n.fillText("999999",512/2+20,80),n.strokeStyle=y,n.lineWidth=1,n.beginPath(),n.moveTo(20,116),n.lineTo(492,116),n.stroke(),n.textAlign="center",n.textBaseline="alphabetic",n.font="bold 52px monospace",n.shadowColor=m,n.shadowBlur=26,n.fillStyle=m,n.fillText("YUKIMEDAL",512/2,206),n.shadowBlur=0,n.font="14px monospace",n.fillStyle=y,n.fillText("ROGUELIKE  MEDAL  PUSHER",512/2,234);const[C,w,S]=$e(s),b=`rgb(${Math.max(C-4,0)},${Math.max(w-4,0)},${Math.max(S-4,0)})`,D=n;return Promise.resolve().then(()=>{const H=`screen_${e.toString(16)}_${s.toString(16)}`,P=Ee.cache.get(H);P&&(Ee._screen={ctx:D,tex:P,nr:u,ng:f,nb:h,clearRgb:b,W:512,H:256})}),a})}static refreshJackpot(e){const s=this._screen;if(!s)return;const{ctx:i,tex:t,nr:a,ng:n,nb:o,clearRgb:l,W:d}=s,p=`rgba(${a},${n},${o},0.60)`,u=`rgba(${a},${n},${o},0.25)`;i.fillStyle=l,i.fillRect(28,62,220,40),i.textAlign="left",i.textBaseline="top",i.font="bold 11px monospace",i.fillStyle=u,i.fillText("JACKPOT",32,64),i.font="bold 22px monospace",i.fillStyle=p,i.fillText(Math.min(e,999999).toString().padStart(6,"0"),32,80),t.needsUpdate=!0}static disposeAll(){this.cache.forEach(e=>e.dispose()),this.cache.clear()}};r(Ee,"cache",new Map),r(Ee,"_screen",null);let re=Ee;const ti=new ne(g.MEDAL_RADIUS,g.MEDAL_RADIUS,g.MEDAL_THICKNESS,48),si=new ne(g.MEDAL_RADIUS_LARGE,g.MEDAL_RADIUS_LARGE,g.MEDAL_THICKNESS,48),ii=new ne(g.MEDAL_RADIUS_TRIPLE,g.MEDAL_RADIUS_TRIPLE,g.MEDAL_THICKNESS*1.3,48),ai={normal:16766720,double:13691135,large:15245312,triple:16719968},ni={normal:1,double:2,large:1,triple:3};function oi(c){const e=c*100;return e<g.MEDAL_PROB_NORMAL?"normal":e<g.MEDAL_PROB_DOUBLE?"double":e<g.MEDAL_PROB_TRIPLE?"triple":"large"}function ri(c){return c==="large"?si:c==="triple"?ii:ti}function Ct(c){c.traverse(e=>{if(e instanceof k){e.geometry.dispose();const s=e.material;Array.isArray(s)?s.forEach(i=>i.dispose()):s.dispose()}})}function li(c){return[c>>16&255,c>>8&255,c&255]}function tt(c){return Math.max(0,Math.min(255,c))}function ht(c,e){const[s,i,t]=li(c);return tt(s+e)<<16|tt(i+e)<<8|tt(t+e)}function ci(c,e,s){const i=c*.27,t=c*.118,a=5,n=Math.max(e*.55,.012),o=i*.1,l=new Es;for(let f=0;f<a*2;f++){const h=f%2===0?i:t,m=f*Math.PI/a-Math.PI/2;f===0?l.moveTo(h*Math.cos(m),h*Math.sin(m)):l.lineTo(h*Math.cos(m),h*Math.sin(m))}l.closePath();const d=new Ms(l,{depth:n,bevelEnabled:!0,bevelSize:o,bevelThickness:n*.5,bevelSegments:3});d.rotateX(-Math.PI/2);const p=new ge({color:ht(s,48),metalness:.98,roughness:.06,clearcoat:.9,clearcoatRoughness:.02,envMapIntensity:1.8}),u=new k(d,p);return u.position.y=e/2,u.castShadow=!0,u}function It(c,e,s,i){const t=c*(i?.4:.32),a=c*.032,n=new Me(t,a,8,36),o=new ge({color:ht(s,65),emissive:new V(s),emissiveIntensity:i?.55:.25,metalness:.95,roughness:.06,clearcoat:.85,clearcoatRoughness:.03,envMapIntensity:1.8}),l=new k(n,o);return l.rotation.x=Math.PI/2,l.position.y=e/2+a,l.castShadow=!0,l}class di{constructor(){r(this,"medals",new Map);r(this,"pendingRemoval",new Set);r(this,"spawnCounter",0)}spawn(e,s,i,t,a,n,o,l,d){if(this.medals.size>=g.MAX_MEDALS_ON_FIELD)return;const p=t.rapier,u=d??oi(Math.random()),f=u==="large"?g.MEDAL_RADIUS_LARGE:u==="triple"?g.MEDAL_RADIUS_TRIPLE:g.MEDAL_RADIUS,h=ni[u],m=p.RigidBodyDesc.dynamic().setTranslation(e,s,i).setLinearDamping(.8).setAngularDamping(4).setCcdEnabled(!0),y=t.createRigidBody(m);y.setEnabledRotations(!0,!1,!0,!0),l&&y.setLinvel(l,!0);const x=p.ColliderDesc.cylinder(g.MEDAL_THICKNESS/2,f).setRestitution(.05).setFriction(.7).setDensity(g.MEDAL_MASS).setActiveEvents(p.ActiveEvents.COLLISION_EVENTS),v=t.createCollider(x,y);n.registerHandle(v.handle,"medal");const E=ai[u],C=re.getMedalTexture(E);C.wrapS=C.wrapT=Ts;const w=u==="triple",S=u==="double",b=.12+Math.random()*.12,D=(Math.random()-.5)*.14,H=new V(Math.min(1,1+D),Math.min(1,1+D*.85),Math.min(1,1-D*.25)),P=new ge({color:w||S?16777215:H,map:C,metalness:.9,roughness:b,clearcoat:.4,clearcoatRoughness:.05+Math.random()*.06,reflectivity:.95,envMapIntensity:.85,emissive:w||S?new V(E):new V(0),emissiveIntensity:w?.18:S?.07:0}),I=new k(ri(u),P);I.castShadow=!0,I.receiveShadow=!1;const _=g.MEDAL_THICKNESS*.58,$=new Me(f-_*.45,_,10,48),F=new ge({color:ht(E,18),metalness:.95,roughness:.1,clearcoat:.6,clearcoatRoughness:.04,envMapIntensity:.9,emissive:w||S?new V(E):new V(0),emissiveIntensity:w?.18:S?.06:0}),z=new k($,F);z.rotation.x=Math.PI/2,I.add(z);const W=Math.random()*Math.PI*2;if(!w&&!S){const j=ci(f,g.MEDAL_THICKNESS,E);j.rotation.y=W,I.add(j)}else{const j=It(f,g.MEDAL_THICKNESS,E,w);if(I.add(j),w){const ee=It(f,g.MEDAL_THICKNESS,E,!1);ee.scale.setScalar(1.35),ee.position.y=g.MEDAL_THICKNESS/2+.005,I.add(ee)}}I.userData.physicsYOffset=.03,I.position.set(e,s,i),o.add(I),a.register(y,I),this.medals.set(v.handle,{body:y,collider:v,mesh:I,type:u,quotaValue:h}),this.spawnCounter++}getQuotaValue(e){var s;return((s=this.medals.get(e))==null?void 0:s.quotaValue)??1}getMedalPosition(e){const s=this.medals.get(e);if(!s)return{x:0,y:0,z:0};const i=s.body.translation();return{x:i.x,y:i.y,z:i.z}}markForRemoval(e){this.pendingRemoval.add(e)}flushRemovals(e,s,i,t){let a=0;for(const n of this.pendingRemoval){const o=this.medals.get(n);o&&(s.unregister(o.body),i.unregisterHandle(n),t.remove(o.mesh),e.removeRigidBody(o.body),Ct(o.mesh),this.medals.delete(n),a++)}return this.pendingRemoval.clear(),a}cleanupFallen(e,s,i,t,a,n){let o=0;for(const[l,d]of this.medals)d.body.translation().y<e&&!this.pendingRemoval.has(l)&&(this.pendingRemoval.add(l),n==null||n(l),o++);return o}get count(){return this.medals.size}clear(e,s,i,t){for(const[a,n]of this.medals)s.unregister(n.body),i.unregisterHandle(a),t.remove(n.mesh),e.removeRigidBody(n.body),Ct(n.mesh);this.medals.clear(),this.pendingRemoval.clear()}}class hi{constructor(){r(this,"body");r(this,"collider")}async initPhysics(e,s){const i=e.rapier,t=g.OPEN_ZONE_START,a=g.FIELD_DEPTH/2+15,n=(t+a)/2,o=(a-t)/2,l=i.RigidBodyDesc.fixed().setTranslation(0,-2,n);this.body=e.createRigidBody(l);const d=i.ColliderDesc.cuboid(g.FIELD_WIDTH/2+1,1.5,o).setActiveEvents(i.ActiveEvents.COLLISION_EVENTS).setSensor(!0);this.collider=e.createCollider(d,this.body),s.registerHandle(this.collider.handle,"drop_zone")}}class pi{constructor(){r(this,"time",0)}setupStage(e,s,i,t){this.clear(t)}getBonusMultiplierAt(e,s){return 1}update(e){this.time+=e}clear(e){this.time=0}}var O=(c=>(c.Common="Common",c.Rare="Rare",c.Epic="Epic",c.Legendary="Legendary",c))(O||{});const Qt={[O.Common]:11184810,[O.Rare]:3381759,[O.Epic]:13387007,[O.Legendary]:16763904},mi={[O.Common]:3355443,[O.Rare]:1127304,[O.Epic]:6689160,[O.Legendary]:8939008},ui={[O.Common]:.45,[O.Rare]:.75,[O.Epic]:.85,[O.Legendary]:.95};function fi(c){const e=Qt[c],s=mi[c],i=ui[c],t=new Yt,a=c===O.Legendary?.4:c===O.Epic?.3:c===O.Rare?.2:.1,n=new ge({color:e,emissive:s,emissiveIntensity:i,metalness:c===O.Legendary?.1:.25,roughness:.1,clearcoat:1,clearcoatRoughness:.04,transmission:a,ior:1.55,transparent:!0,opacity:.92,envMapIntensity:2});let o;switch(c){case O.Legendary:o=new _s(.24,.07,80,12,2,3);break;case O.Epic:o=new Is(.32,0);break;case O.Rare:{const d=new St(.22,.3,8,1),p=new St(.22,.26,8,1),u=new k(p,n.clone());u.rotation.x=Math.PI,u.position.y=-.03;const f=new k(d,n);return f.castShadow=!0,u.castShadow=!0,t.add(f,u),o=d,_t(t,c),t}default:o=new Cs(.3,0);break}const l=new k(o,n);if(l.castShadow=!0,t.add(l),c!==O.Common){const d=new ge({color:e,emissive:e,emissiveIntensity:c===O.Legendary?2:1.4,metalness:0,roughness:.4,clearcoat:.5,clearcoatRoughness:.1,transparent:!0,opacity:.45}),p=o.clone(),u=new k(p,d);u.scale.setScalar(.65),t.add(u)}return _t(t,c),t}function _t(c,e){const s=Qt[e];if(e===O.Common)return;const i=e===O.Legendary?.4:e===O.Epic?.36:.3,t=new Me(i,.018,8,48),a=new ge({color:s,emissive:s,emissiveIntensity:e===O.Legendary?2.5:1.8,metalness:0,roughness:.05,clearcoat:.8,clearcoatRoughness:.02,transparent:!0,opacity:.9}),n=new k(t,a);if(n.rotation.x=Math.PI/3,c.add(n),e===O.Legendary){const o=new k(new Me(i*.88,.012,6,40),a.clone());o.rotation.x=Math.PI/3,o.rotation.y=Math.PI/2,c.add(o)}}class gi{constructor(e){r(this,"mesh");r(this,"animationOffset");r(this,"baseY",0);this.mesh=fi(e),this.mesh.castShadow=!0,this.animationOffset=Math.random()*Math.PI*2}update(e){this.mesh.position.y=this.baseY+Math.sin(e*1.8+this.animationOffset)*.04,this.mesh.rotation.y+=.025;for(const s of this.mesh.children)s instanceof k&&s.geometry instanceof Me&&(s.rotation.z+=.018)}setPosition(e,s,i){this.baseY=s,this.mesh.position.set(e,s,i)}dispose(){this.mesh.traverse(e=>{if(e instanceof k){e.geometry.dispose();const s=e.material;Array.isArray(s)?s.forEach(i=>i.dispose()):s.dispose()}})}}class pt{constructor(e=Date.now()){r(this,"seed");this.seed=e}next(){this.seed|=0,this.seed=this.seed+1831565813|0;let e=Math.imul(this.seed^this.seed>>>15,1|this.seed);return e=e+Math.imul(e^e>>>7,61|e)^e,((e^e>>>14)>>>0)/4294967296}nextInt(e,s){return Math.floor(this.next()*(s-e+1))+e}nextFloat(e,s){return this.next()*(s-e)+e}shuffle(e){const s=[...e];for(let i=s.length-1;i>0;i--){const t=Math.floor(this.next()*(i+1));[s[i],s[t]]=[s[t],s[i]]}return s}weightedPick(e,s){const i=s.reduce((a,n)=>a+n,0);let t=this.next()*i;for(let a=0;a<e.length;a++)if(t-=s[a],t<=0)return e[a];return e[e.length-1]}}class yi{constructor(){r(this,"items",new Map);r(this,"pendingRemoval",new Set)}spawnItems(e,s,i,t,a,n){const o=new pt(n);for(const l of e){const d=o.nextFloat(-3,g.FIELD_WIDTH/2-1),p=o.nextFloat(-12/8,g.FIELD_DEPTH/4);this.spawnSingle(l,d,4,p,s,i,t,a)}}spawnSingle(e,s,i,t,a,n,o,l){const d=a.rapier,p=d.RigidBodyDesc.dynamic().setTranslation(s,i,t).setLinearDamping(.7).setAngularDamping(.8),u=a.createRigidBody(p),f=d.ColliderDesc.ball(.4).setRestitution(.4).setFriction(.5).setDensity(2).setActiveEvents(d.ActiveEvents.COLLISION_EVENTS),h=a.createCollider(f,u);o.registerHandle(h.handle,"item");const m=new gi(e.rarity);m.setPosition(s,i,t),l.add(m.mesh),n.register(u,m.mesh),this.items.set(h.handle,{body:u,collider:h,mesh:m,definitionId:e.id})}getDefinitionId(e){var s;return(s=this.items.get(e))==null?void 0:s.definitionId}getItemPosition(e){const s=this.items.get(e);if(!s)return{x:0,y:0,z:0};const i=s.body.translation();return{x:i.x,y:i.y,z:i.z}}cleanupFallen(e,s){for(const[i,t]of this.items)t.body.translation().y<e&&!this.pendingRemoval.has(i)&&(this.pendingRemoval.add(i),s==null||s(i))}markForRemoval(e){this.pendingRemoval.add(e)}flushRemovals(e,s,i,t){for(const a of this.pendingRemoval){const n=this.items.get(a);n&&(s.unregister(n.body),i.unregisterHandle(a),t.remove(n.mesh.mesh),e.removeRigidBody(n.body),n.mesh.dispose(),this.items.delete(a))}this.pendingRemoval.clear()}update(e){for(const s of this.items.values())s.mesh.update(e)}clear(e,s,i,t){for(const[a,n]of this.items)s.unregister(n.body),i.unregisterHandle(a),t.remove(n.mesh.mesh),e.removeRigidBody(n.body),n.mesh.dispose();this.items.clear(),this.pendingRemoval.clear()}}const nt=[{id:"rusty_gear",name:"さびたギア",quotaValue:5,sellPrice:3,rarity:O.Common,description:"古びたギア。それなりの価値はある。"},{id:"chipped_crystal",name:"欠けた水晶",quotaValue:8,sellPrice:5,rarity:O.Common,description:"割れた水晶の破片。かすかに輝いている。"},{id:"silver_coin",name:"銀貨",quotaValue:12,sellPrice:8,rarity:O.Common,description:"磨けば光る銀の硬貨。"},{id:"strange_mushroom",name:"怪しいキノコ",quotaValue:10,sellPrice:6,rarity:O.Common,description:"食べたら何かが起きそうな不思議なキノコ。"},{id:"ancient_compass",name:"古羅針盤",quotaValue:20,sellPrice:15,rarity:O.Rare,description:"方角を示す古い羅針盤。コレクターに人気。"},{id:"glowing_orb",name:"発光する球体",quotaValue:25,sellPrice:18,rarity:O.Rare,description:"ぼんやりと光を放つ不思議な球体。"},{id:"clockwork_bird",name:"ぜんまい仕掛けの鳥",quotaValue:30,sellPrice:22,rarity:O.Rare,description:"ネジを巻くと動き出す精巧な機械鳥。"},{id:"philosophers_stone",name:"賢者の石（模造品）",quotaValue:50,sellPrice:40,rarity:O.Epic,description:"本物かどうかは不明。でも高く売れる。"},{id:"dragon_scale",name:"ドラゴンの鱗",quotaValue:60,sellPrice:50,rarity:O.Epic,description:"龍から採れた鱗。強靭で美しい。"},{id:"starfall_fragment",name:"星落の欠片",quotaValue:100,sellPrice:80,rarity:O.Legendary,description:"流れ星が落とした神秘の欠片。伝説級のお宝。"}];function Ie(c){return nt.find(e=>e.id===c)}const At={[O.Common]:60,[O.Rare]:30,[O.Epic]:8,[O.Legendary]:2};class xi{constructor(e){r(this,"rng");this.rng=new pt(e)}pickRandom(e){const s=[];for(let i=0;i<e;i++){const t=this.pickRarity(),a=nt.filter(o=>o.rarity===t);if(a.length===0){s.push(nt[0]);continue}const n=Math.floor(this.rng.next()*a.length);s.push(a[n])}return s}pickRarity(){const e=Object.keys(At),s=e.map(i=>At[i]);return this.rng.weightedPick(e,s)}}function R(c,e,s=!1){const i=new k(c,e);return s&&(i.castShadow=!0,i.receiveShadow=!0),i}function Rt(c,e=1){return new N({color:c,emissive:c,emissiveIntensity:e,roughness:.5,metalness:.3})}class G{constructor(e){r(this,"group");r(this,"pusherMesh",null);r(this,"wallMeshes",[]);r(this,"sideGuardMeshes",[]);r(this,"collectionGlowMat",null);r(this,"gaugeMats",[]);r(this,"ledStripMats",[]);r(this,"collectionFlashRemaining",0);r(this,"pusherZBase",-12/2+g.PUSHER_DEPTH/2-g.PUSHER_RANGE);this.group=new Yt,this.rebuild(e)}rebuild(e){this.group.traverse(s=>{if(s!==this.group&&s instanceof k){s.geometry.dispose();const i=s.material;Array.isArray(i)?i.forEach(t=>t.dispose()):i.dispose()}}),this.group.clear(),this.wallMeshes=[],this.sideGuardMeshes=[],this.collectionGlowMat=null,this.gaugeMats=[],this.ledStripMats=[],this.buildFieldSurface(e),this.buildPusher(e),this.addPusherDetails(e),this.createWalls(e),this.buildCabinet(e),this.buildCabinetDetails(e)}static cabinetMat(e){return new N({color:e.cabinetColor,roughness:.72,metalness:.42})}static brassMat(e){return new N({color:e.brassColor,roughness:e.brassRoughness,metalness:e.brassMetalness})}buildFieldSurface(e){const s=g.FIELD_DEPTH/2+g.OPEN_ZONE_START,i=-12/2+s/2,t=re.getFieldTexture(e.fieldTexBase);t.wrapS=t.wrapT=Pe,t.repeat.set(g.FIELD_WIDTH/2,s/2);const a=new N({map:t,color:16777215,roughness:.92,metalness:0}),n=new A(g.FIELD_WIDTH,g.FIELD_HEIGHT,s),o=new k(n,a);o.receiveShadow=!0,o.position.set(0,-.1/2,i),this.group.add(o);const l=-12/2,d=g.OPEN_ZONE_START,p=g.FIELD_WIDTH,u=[{z:l+(d-l)*.35,color:e.secondaryNeon,intensity:.45},{z:l+(d-l)*.65,color:e.tertiaryNeon,intensity:.4}];for(const{z:f,color:h,intensity:m}of u){const y=new N({color:h,emissive:h,emissiveIntensity:m,roughness:.2,metalness:.05}),x=new k(new A(p-.3,.015,.04),y);x.position.set(0,.01,f),this.group.add(x)}}buildPusher(e){const s=re.getPusherTexture(e.pusherTexBase);s.wrapS=s.wrapT=Pe,s.repeat.set(g.PUSHER_WIDTH/2,g.PUSHER_HEIGHT/1);const i=new N({map:s,color:16777215,roughness:.35,metalness:.65}),t=new A(g.PUSHER_WIDTH,g.PUSHER_HEIGHT,g.PUSHER_DEPTH);this.pusherMesh=new k(t,i),this.pusherMesh.castShadow=!0,this.pusherMesh.position.set(0,g.PUSHER_HEIGHT/2,this.pusherZBase),this.group.add(this.pusherMesh)}addPusherDetails(e){const s=g.PUSHER_WIDTH,i=g.PUSHER_HEIGHT,t=g.PUSHER_DEPTH,a=R(new A(s+.06,.14,.14),G.brassMat(e));a.position.set(0,-i/2+.07,t/2),this.pusherMesh.add(a);const n=R(new A(s+.06,.06,.06),G.brassMat(e));n.position.set(0,i/2,t/2),this.pusherMesh.add(n);for(const d of[-1,1]){const p=R(new A(.1,i,.1),G.brassMat(e));p.position.set(d*(s/2-.05),0,t/2),this.pusherMesh.add(p)}const o=new N({color:e.primaryNeon,emissive:new V(e.primaryNeon),emissiveIntensity:.85,roughness:.2,metalness:.05}),l=R(new A(s-.12,.045,.055),o);l.position.set(0,i*.1,t/2+.03),this.pusherMesh.add(l),this.ledStripMats.push({mat:o,baseIntensity:.85,phase:Math.PI*.5,speed:1.4})}createWalls(e){const t=re.getWallTexture(e.wallTexBase);t.wrapS=t.wrapT=Pe;const a=()=>{const w=t.clone();return w.wrapS=w.wrapT=Pe,w.needsUpdate=!0,new N({map:w,color:16777215,roughness:.8,metalness:.15})},n=g.OPEN_ZONE_START- -12/2,o=-12/2+n/2,l=a();l.map.repeat.set(n/2,3.5/2);const d=new A(.3,3.5,n),p=new k(d,l);p.position.set(-8/2-.3/2,3.5/2,o),this.group.add(p),this.wallMeshes.push(p);const u=a();u.map.repeat.set(n/2,3.5/2);const f=new A(.3,3.5,n),h=new k(f,u);h.position.set(g.FIELD_WIDTH/2+.3/2,3.5/2,o),this.group.add(h),this.wallMeshes.push(h);const m=a(),y=g.FIELD_WIDTH+.3*2;m.map.repeat.set(y/2,3.5/2);const x=new A(y,3.5,.3),v=new k(x,m);v.position.set(0,3.5/2,-12/2-.3/2),this.group.add(v),this.wallMeshes.push(v);const E=-12/2+n/2,C=[{y:.8,color:e.secondaryNeon,baseIntensity:.8,phase:0,speed:2.4},{y:2.1,color:e.tertiaryNeon,baseIntensity:.65,phase:1.57,speed:1.8}];for(const{y:w,color:S,baseIntensity:b,phase:D,speed:H}of C){const P=new N({color:S,emissive:S,emissiveIntensity:b,roughness:.2,metalness:.05});this.ledStripMats.push({mat:P,baseIntensity:b,phase:D,speed:H});for(const _ of[-1,1]){const $=_*(g.FIELD_WIDTH/2+.3+.02),F=new k(new A(.3*.4,.038,n),P);F.position.set($,w,E),this.group.add(F)}const I=new k(new A(y,.038,.3*.4),P);I.position.set(0,w,-12/2-.3+.02),this.group.add(I)}}buildCabinet(e){const s=g.FIELD_WIDTH,i=g.FIELD_DEPTH,t=-i/2,a=i/2,n=R(new A(12,1,17),G.cabinetMat(e),!0);n.position.set(0,-.52,-.5),this.group.add(n);const o=R(new A(12,.1,.1),G.brassMat(e));o.position.set(0,0,a+2.55),this.group.add(o);const l=1.1,d=7.2,p=13.5,u=s/2+.75,f=-.25;for(const Q of[-1,1]){const J=R(new A(l,d,p),G.cabinetMat(e),!0);J.position.set(Q*u,d/2-.5,f),this.group.add(J);const me=R(new A(l+.08,.14,p+.08),G.brassMat(e));me.position.set(Q*u,d-.5+.07,f),this.group.add(me);const de=R(new A(l+.08,.1,p+.08),G.brassMat(e));de.position.set(Q*u,-.02,f),this.group.add(de);const Re=R(new A(.06,d*.75,p*.7),new N({color:e.insetColor,roughness:.9,metalness:.1}));Re.position.set(Q*(u-(l/2+.01)),d/2-.5,f),this.group.add(Re);const Be=R(new A(.06,d*.8,.06),G.brassMat(e));Be.position.set(Q*(u-l/2-.04),d/2-.5,f),this.group.add(Be)}for(const Q of[-1,1]){for(const de of[-.22,.22]){const Re=new N({color:e.secondaryNeon,emissive:e.secondaryNeon,emissiveIntensity:.72,roughness:.2,metalness:.05}),Be=de>0?Math.PI*.6:0;this.ledStripMats.push({mat:Re,baseIntensity:.72,phase:Be,speed:1.6});const xt=R(new A(.032,d*.82,.032),Re);xt.position.set(Q*(u+de),d*.41+.04,f+p/2+.09),this.group.add(xt)}const J=new N({color:e.primaryNeon,emissive:e.primaryNeon,emissiveIntensity:1.5,roughness:.1,metalness:.2});this.ledStripMats.push({mat:J,baseIntensity:1.5,phase:Q>0?.8:2,speed:2.2});const me=R(new ct(.14,8,6),J);me.position.set(Q*u,d-.5+.34,f+p/2+.09),this.group.add(me)}const h=10.5,m=1.3,y=t-1.15,x=re.getWallTexture(e.wallTexBase).clone();x.wrapS=x.wrapT=Pe,x.repeat.set(6,5),x.needsUpdate=!0;const v=new N({map:x,color:16777215,roughness:.75,metalness:.18}),E=R(new A(12,h,m),v,!0);E.position.set(0,h/2-.5,y),this.group.add(E);const C=R(new A(12.1,.15,m+.1),G.brassMat(e));C.position.set(0,h-.5+.07,y),this.group.add(C);const w=2,S=8.5,b=5.2,D=y+m/2+.06,H=re.getScreenTexture(e.primaryNeon,e.screenBase),P=new N({color:328965,emissive:16777215,emissiveMap:H,emissiveIntensity:1.4,roughness:.45,metalness:.4}),I=R(new A(S,w,.08),P);I.position.set(0,b,y+m/2+.04),this.group.add(I);const _=R(new A(S+.24,w+.24,.06),G.brassMat(e));_.position.set(0,b,y+m/2),this.group.add(_);const $=R(new A(12.1,.08,.08),G.brassMat(e));$.position.set(0,h-.5+.18,y+m/2),this.group.add($);const F=R(new A(12.1,.08,.08),G.brassMat(e));F.position.set(0,3.7,y+m/2),this.group.add(F);const z=new N({color:e.primaryNeon,emissive:e.primaryNeon,emissiveIntensity:1.2,roughness:.2,metalness:.1}),W=R(new A(.06,w*.9,.06),z);W.position.set(-S/2-.18,b,D),this.group.add(W);const j=R(new A(.06,w*.9,.06),z.clone());j.position.set(S/2+.18,b,D),this.group.add(j);const ee=R(new A(S+.6,.04,.04),z.clone());ee.position.set(0,b-w/2-.22,D),this.group.add(ee);for(let Q=0;Q<3;Q++){const J=b+w*.28-Q*(w*.3),me=new N({color:e.primaryNeon,emissive:e.primaryNeon,emissiveIntensity:.45-Q*.05,roughness:.3,metalness:0,transparent:!0,opacity:.55}),de=R(new A(S-.5,.025,.01),me);de.position.set(0,J,D),this.group.add(de)}const ye=R(new A(12,1.1,4.5),G.cabinetMat(e),!0);ye.position.set(0,-.56,a+2.25),this.group.add(ye);const He=R(new A(12,.12,.12),G.brassMat(e));He.position.set(0,0,a+4.45),this.group.add(He);const xe=R(new A(12,.1,.08),G.brassMat(e));xe.position.set(0,.06,a+4.5),this.group.add(xe);const qe=new N({color:e.primaryNeon,emissive:e.primaryNeon,emissiveIntensity:.04,roughness:.12,metalness:.85,transparent:!0,opacity:.45}),Oe=R(new A(11.6,.02,4),qe);Oe.position.set(0,.01,a+2.25),this.group.add(Oe);const Ae=new N({color:e.primaryNeon,emissive:e.primaryNeon,emissiveIntensity:.28,roughness:.2,metalness:.1}),pe=R(new A(.04,.03,4.1),Ae);pe.position.set(-5.8,.02,a+2.25),this.group.add(pe);const be=R(new A(.04,.03,4.1),Ae.clone());be.position.set(5.8,.02,a+2.25),this.group.add(be);const T=R(new A(11.6,.03,.04),Ae.clone());T.position.set(0,.02,a+.27),this.group.add(T);const B=R(new A(12,.5,p),G.cabinetMat(e),!0);B.position.set(0,6.7,f),this.group.add(B);const Y=R(new A(12,.1,.1),G.brassMat(e));Y.position.set(0,6.96,a+.1),this.group.add(Y);for(const Q of[-1,1]){const J=R(new A(.09,.09,i+.5),G.brassMat(e));J.position.set(Q*(s/2+.04),.05,f),this.group.add(J)}const te=R(new A(s+.2,3.6,.18),new N({color:e.pusherHousingColor,roughness:.65,metalness:.5}));te.position.set(0,1.8,t-.08),this.group.add(te);const ie=R(new A(s-.2,.08,.08),G.brassMat(e));ie.position.set(0,3.65,t+.01),this.group.add(ie);const K=R(new A(s+.1,.07,.07),G.brassMat(e));K.position.set(0,.06,g.OPEN_ZONE_START),this.group.add(K);const ae=new N({color:e.primaryNeon,emissive:e.primaryNeon,emissiveIntensity:1,roughness:.2,metalness:.1,transparent:!0,opacity:.88});this.collectionGlowMat=ae;const ve=R(new A(s+.2,.03,.22),ae);ve.position.set(0,.015,g.OPEN_ZONE_START),this.group.add(ve);const ut=R(new A(s+.1,.07,.07),G.brassMat(e));ut.position.set(0,.06,t+.04),this.group.add(ut);const ft=i/2+g.OPEN_ZONE_START,Jt=t+ft/2;for(const Q of[-1,1]){const J=R(new A(.07,.07,ft),G.brassMat(e));J.position.set(Q*s/2,.06,Jt),this.group.add(J)}const gt=g.OPEN_ZONE_START-t,es=t+gt/2;for(const Q of[-1,1]){const J=R(new A(.08,.08,gt),G.brassMat(e));J.position.set(Q*(s/2),3.55,es),this.group.add(J)}const yt=new k(new A(100,.2,100),new N({color:e.groundColor,emissive:e.groundColor,emissiveIntensity:.1,roughness:.95,metalness:0}));yt.position.set(0,-.65,0),this.group.add(yt)}buildCabinetDetails(e){const s=g.FIELD_DEPTH/2,i=-12/2,t=1.1,a=7.2,n=13.5,o=g.FIELD_WIDTH/2+.75,l=-.25,d=1.3,p=i-1.15;for(const w of[-1,1]){for(let b=0;b<2;b++){const D=b===0?-.26:.16,H=a*.6,P=w*(o+D),I=l+n/2+.07,_=R(new ne(.05,.05,H,8),G.brassMat(e));_.position.set(P,H/2+.3,I),this.group.add(_);const $=4;for(let F=0;F<=$;F++){const z=.3+F*(H/$),W=R(new ne(.09,.09,.07,10),G.brassMat(e));W.position.set(P,z,I),this.group.add(W)}}const S=R(new A(.48,.1,.1),G.brassMat(e));S.position.set(w*o,a*.6+.3+.05,l+n/2+.07),this.group.add(S)}for(const w of[-1,1]){const S=w*(o-t/2-.025),b=R(new ne(.24,.24,.06,18),G.brassMat(e));b.rotation.z=Math.PI/2,b.position.set(S,a*.52,l+.8),this.group.add(b);const D=Rt(e.secondaryNeon,.55),H=R(new ne(.18,.18,.03,18),D);H.rotation.z=Math.PI/2,H.position.set(S-w*.035,a*.52,l+.8),this.group.add(H),this.gaugeMats.push(D);const P=R(new ne(.16,.16,.05,14),G.brassMat(e));P.rotation.z=Math.PI/2,P.position.set(S,a*.28,l-1.2),this.group.add(P);const I=Rt(e.primaryNeon,.45),_=R(new ne(.11,.11,.025,14),I);_.rotation.z=Math.PI/2,_.position.set(S-w*.03,a*.28,l-1.2),this.group.add(_),this.gaugeMats.push(I)}const u=3.2,f=p+d/2+.05,h=R(new Me(.82,.1,10,28),G.brassMat(e));h.position.set(0,u,f),this.group.add(h);const m=R(new ne(.74,.74,.04,28),new N({color:e.screenBase,emissive:e.screenEmissive,emissiveIntensity:.55,transparent:!0,opacity:.82,roughness:.05,metalness:0}));m.rotation.x=Math.PI/2,m.position.set(0,u,f),this.group.add(m);for(let w=0;w<4;w++){const S=w/4*Math.PI*2+Math.PI/4,b=R(new ne(.045,.045,.06,8),G.brassMat(e));b.rotation.x=Math.PI/2,b.position.set(Math.cos(S)*.88,u+Math.sin(S)*.88,f+.03),this.group.add(b)}const y=R(new A(5.5,.05,.05),new N({color:e.secondaryNeon,emissive:e.secondaryNeon,emissiveIntensity:.9,roughness:.2,metalness:.1}));y.position.set(0,u+1.12,f),this.group.add(y);{const w=t+.12,S=.12,b=n+.12;for(const D of[-1,1])for(const H of[.33,.66]){const P=R(new A(w,S,b),G.brassMat(e));P.position.set(D*o,H*a-.5,l),this.group.add(P)}}const x=s+4.45,v=R(new A(1.3,.16,.05),new N({color:e.insetColor,roughness:.9,metalness:.1}));v.position.set(0,-.08,x),this.group.add(v);const E=R(new A(1.5,.3,.04),G.brassMat(e));E.position.set(0,-.08,x-.01),this.group.add(E);const C=R(new A(.9,.045,.06),new N({color:0,roughness:1,metalness:0}));C.position.set(0,-.06,x+.01),this.group.add(C)}addSideGuardMeshes(e){const t=g.FIELD_DEPTH/2-g.OPEN_ZONE_START,a=g.OPEN_ZONE_START+t/2;for(const n of[-1,1]){const o=n*(g.FIELD_WIDTH/2+.1),l=new A(.2,2,t),d=new N({color:4500223,emissive:4500223,emissiveIntensity:.55,transparent:!0,opacity:.55,roughness:.2,metalness:.1}),p=new k(l,d);p.position.set(o,2/2,a),e.add(p),this.sideGuardMeshes.push(p)}}removeSideGuardMeshes(e){for(const s of this.sideGuardMeshes)e.remove(s),s.geometry.dispose(),s.material.dispose();this.sideGuardMeshes=[]}updatePusher(e){this.pusherMesh.position.z=this.pusherZBase+e}triggerCollectionFlash(){this.collectionFlashRemaining=.3}update(e,s=.016){if(this.collectionGlowMat)if(this.collectionFlashRemaining>0){const i=this.collectionFlashRemaining/.3;this.collectionGlowMat.emissiveIntensity=.55+i*1.45,this.collectionFlashRemaining-=s}else this.collectionGlowMat.emissiveIntensity=.35+Math.sin(e*3.8)*.2;for(let i=0;i<this.gaugeMats.length;i++){const t=i%2===0?.55:.45,a=.3,n=i%2===0?2.1:1.5,o=i*1.1;this.gaugeMats[i].emissiveIntensity=t+Math.sin(e*n+o)*a}for(const{mat:i,baseIntensity:t,phase:a,speed:n}of this.ledStripMats)i.emissiveIntensity=t+Math.sin(e*n+a)*(t*.28)}}class bi{constructor(e,s,i,t){r(this,"physicsWorld");r(this,"physicsSync");r(this,"collisionHandler");r(this,"pusher");r(this,"medalSpawner");r(this,"itemSpawner");r(this,"dropZone");r(this,"gimmickManager");r(this,"fieldMesh");r(this,"time",0);r(this,"getMedalQuotaMultiplier",()=>1);r(this,"sideGuardActive",!1);r(this,"sideGuardBodies",[]);this.sceneManager=e,this.quotaManager=s,this.inventory=i,this.physicsWorld=new Xs,this.physicsSync=new Ks,this.collisionHandler=new Js,this.pusher=new ei,this.medalSpawner=new di,this.itemSpawner=new yi,this.dropZone=new hi,this.gimmickManager=new pi,this.fieldMesh=new G(t)}setMedalQuotaMultiplierFn(e){this.getMedalQuotaMultiplier=e}rebuildFieldMesh(e){re.disposeAll(),this.fieldMesh.rebuild(e)}async init(){await this.physicsWorld.init(),this.collisionHandler.init(this.physicsWorld),await this.buildFieldPhysics(),await this.pusher.initPhysics(this.physicsWorld),await this.dropZone.initPhysics(this.physicsWorld,this.collisionHandler),this.collisionHandler.onMedalCollected(e=>{const s=this.medalSpawner.getQuotaValue(e),i=this.medalSpawner.getMedalPosition(e);this.medalSpawner.markForRemoval(e);const t=this.getMedalQuotaMultiplier();this.quotaManager.addMedals(s,t),L.emit("medal:collected",{count:s,x:i.x,y:i.y,z:i.z})}),this.collisionHandler.onItemCollected(e=>{const s=this.itemSpawner.getDefinitionId(e);if(!s)return;const i=this.itemSpawner.getItemPosition(e);this.itemSpawner.markForRemoval(e);const t=this.inventory.addItem(s),a=Ie(s);a&&(this.quotaManager.addItem(a.quotaValue),L.emit("item:collected",{itemId:s,instanceId:t.instanceId,quotaValue:a.quotaValue,x:i.x,y:i.y,z:i.z}))}),this.sceneManager.add(this.fieldMesh.group)}async buildFieldPhysics(){const e=this.physicsWorld.rapier,s=(g.FIELD_DEPTH/2+g.OPEN_ZONE_START)/2,i=-12/2+s,t=e.RigidBodyDesc.fixed().setTranslation(0,-.05,i),a=this.physicsWorld.createRigidBody(t),n=e.ColliderDesc.cuboid(g.FIELD_WIDTH/2,.05,s).setFriction(.4).setRestitution(.05);this.physicsWorld.createCollider(n,a);const o=3.5,l=.2,d=g.OPEN_ZONE_START- -12/2,p=-12/2+d/2,u=e.RigidBodyDesc.fixed().setTranslation(-8/2-l/2,o/2,p),f=this.physicsWorld.createRigidBody(u);this.physicsWorld.createCollider(e.ColliderDesc.cuboid(l/2,o/2,d/2),f);const h=e.RigidBodyDesc.fixed().setTranslation(g.FIELD_WIDTH/2+l/2,o/2,p),m=this.physicsWorld.createRigidBody(h);this.physicsWorld.createCollider(e.ColliderDesc.cuboid(l/2,o/2,d/2),m);const y=8,x=.5,v=e.RigidBodyDesc.fixed().setTranslation(0,y/2,-12/2-x/2),E=this.physicsWorld.createRigidBody(v);this.physicsWorld.createCollider(e.ColliderDesc.cuboid(g.FIELD_WIDTH/2+x,y/2,x/2),E)}startStage(e,s){this.spawnInitialMedals(),this.gimmickManager.setupStage(e,s,this.physicsWorld,this.sceneManager);const t=new xi(e*1e3+s).pickRandom(g.ITEMS_PER_STAGE);this.itemSpawner.spawnItems(t,this.physicsWorld,this.physicsSync,this.collisionHandler,this.sceneManager,e*1e3+s+7)}spawnInitialMedals(){const e=-6+g.PUSHER_DEPTH-g.PUSHER_RANGE,s=g.OPEN_ZONE_START-g.MEDAL_RADIUS,i=g.FIELD_WIDTH/2-g.MEDAL_RADIUS,t=s-e,a=e;for(let h=0;h<g.INITIAL_FIELD_MEDALS;h++){const m=(Math.random()*2-1)*i,y=a+Math.random()*t,x=g.MEDAL_THICKNESS/2+Math.random()*.5,v=Math.random()<.25?"large":"normal";this.medalSpawner.spawn(m,x,y,this.physicsWorld,this.physicsSync,this.collisionHandler,this.sceneManager,void 0,v)}const n=-12/2+g.MEDAL_RADIUS,l=e-g.MEDAL_RADIUS-n,d=6,p=Math.ceil(g.INITIAL_PUSHER_MEDALS/d),u=i*2/(d-1),f=l/Math.max(p-1,1);for(let h=0;h<g.INITIAL_PUSHER_MEDALS;h++){const m=h%d,y=Math.floor(h/d),x=-i+m*u+(Math.random()-.5)*.15,v=n+y*f+(Math.random()-.5)*.15,E=g.PUSHER_HEIGHT+g.MEDAL_THICKNESS/2+.8+y*.25;this.medalSpawner.spawn(x,E,v,this.physicsWorld,this.physicsSync,this.collisionHandler,this.sceneManager,void 0,"normal")}}throwMedal(e,s){const i=g.FIELD_DEPTH/2-.5,t=2,n=-(12+(-s+1)/2*7);this.medalSpawner.spawn(e,t,i,this.physicsWorld,this.physicsSync,this.collisionHandler,this.sceneManager,{x:0,y:6,z:n})}update(e){this.time+=e,this.fieldMesh.update(this.time,e);const s=4,i=Math.min(e,1/15);this.physicsWorld.setTimestep(i/s),this.collisionHandler.processEvents(this.physicsWorld,s),this.medalSpawner.cleanupFallen(g.MEDAL_CLEANUP_Y,this.physicsWorld,this.physicsSync,this.collisionHandler,this.sceneManager,a=>{const n=this.medalSpawner.getQuotaValue(a),o=this.getMedalQuotaMultiplier();this.quotaManager.addMedals(n,o);const l=this.medalSpawner.getMedalPosition(a);L.emit("medal:collected",{count:n,x:l.x,y:l.y,z:l.z})}),this.itemSpawner.cleanupFallen(g.MEDAL_CLEANUP_Y,a=>{const n=this.itemSpawner.getDefinitionId(a);if(!n)return;const o=this.itemSpawner.getItemPosition(a),l=this.inventory.addItem(n),d=Ie(n);d&&(this.quotaManager.addItem(d.quotaValue),L.emit("item:collected",{itemId:n,instanceId:l.instanceId,quotaValue:d.quotaValue,x:o.x,y:o.y,z:o.z}))}),this.medalSpawner.flushRemovals(this.physicsWorld,this.physicsSync,this.collisionHandler,this.sceneManager),this.itemSpawner.flushRemovals(this.physicsWorld,this.physicsSync,this.collisionHandler,this.sceneManager),this.physicsSync.sync(this.physicsWorld);const t=this.pusher.update(e);this.fieldMesh.updatePusher(t),this.gimmickManager.update(e),this.itemSpawner.update(this.time)}endStage(){this.gimmickManager.clear(this.sceneManager),this.medalSpawner.clear(this.physicsWorld,this.physicsSync,this.collisionHandler,this.sceneManager),this.itemSpawner.clear(this.physicsWorld,this.physicsSync,this.collisionHandler,this.sceneManager)}addSideGuardWalls(){if(this.sideGuardActive||!this.physicsWorld.initialized)return;this.sideGuardActive=!0;const e=this.physicsWorld.rapier,s=2,i=.2,t=g.FIELD_DEPTH/2-g.OPEN_ZONE_START,a=g.OPEN_ZONE_START+t/2;for(const n of[-1,1]){const o=n*(g.FIELD_WIDTH/2+i/2),l=e.RigidBodyDesc.fixed().setTranslation(o,s/2,a),d=this.physicsWorld.createRigidBody(l);this.physicsWorld.createCollider(e.ColliderDesc.cuboid(i/2,s/2,t/2),d),this.sideGuardBodies.push(d)}}removeSideGuardWalls(){for(const e of this.sideGuardBodies)this.physicsWorld.removeRigidBody(e);this.sideGuardBodies=[],this.sideGuardActive=!1}get isSideGuardActive(){return this.sideGuardActive}dispose(){this.sceneManager.remove(this.fieldMesh.group),this.physicsWorld.dispose()}}class vi{constructor(){r(this,"current",0);r(this,"target",0);r(this,"phase",1);r(this,"stage",1);r(this,"reached",!1)}startStage(e,s){this.phase=e,this.stage=s,this.current=0,this.reached=!1,this.target=this.calcTarget(e,s),L.emit("stage:started",{phase:e,stage:s,quotaTarget:this.target}),L.emit("quota:updated",{current:this.current,target:this.target})}calcTarget(e,s){const i=(e-1)*g.STAGES_PER_PHASE+s;return Math.ceil(g.BASE_QUOTA*Math.pow(g.QUOTA_MULTIPLIER,i-1))}addMedals(e,s=1){this.current+=e*s,L.emit("quota:updated",{current:this.current,target:this.target}),!this.reached&&this.current>=this.target&&(this.reached=!0,L.emit("quota:reached",{phase:this.phase,stage:this.stage}))}addItem(e,s=1){this.current+=e*s,L.emit("quota:updated",{current:this.current,target:this.target}),!this.reached&&this.current>=this.target&&(this.reached=!0,L.emit("quota:reached",{phase:this.phase,stage:this.stage}))}get currentValue(){return this.current}get targetValue(){return this.target}get isReached(){return this.current>=this.target}get progress(){return Math.min(this.current/this.target,1)}}class wi{constructor(e){r(this,"phase",1);r(this,"stage",1);this.fsm=e}get currentPhase(){return this.phase}get currentStage(){return this.stage}get isLastStageOfPhase(){return this.stage===g.STAGES_PER_PHASE}startCurrentStage(){this.fsm.transition(M.PLAYING)}clearCurrentStage(){L.emit("stage:cleared",{phase:this.phase,stage:this.stage}),this.fsm.transition(M.STAGE_CLEAR),this.stage===g.STAGES_PER_PHASE&&L.emit("phase:cleared",{phase:this.phase})}advanceStage(){this.stage<g.STAGES_PER_PHASE&&this.stage++,this.fsm.transition(M.STAGE_START)}advancePhase(){this.phase++,this.stage=1}reset(){this.phase=1,this.stage=1}}function Si(){return`${Date.now().toString(36)}-${Math.random().toString(36).slice(2,9)}`}class Ti{constructor(){r(this,"items",[])}addItem(e){const s={instanceId:Si(),definitionId:e,collectedAt:Date.now()};return this.items.push(s),s}removeItem(e){const s=this.items.findIndex(i=>i.instanceId===e);return s===-1?!1:(this.items.splice(s,1),!0)}getAll(){return[...this.items]}getDefinition(e){const s=this.items.find(i=>i.instanceId===e);if(s)return Ie(s.definitionId)}get count(){return this.items.length}clear(){this.items=[]}totalSellPrice(){return this.items.reduce((e,s)=>{const i=Ie(s.definitionId);return e+((i==null?void 0:i.sellPrice)??0)},0)}}class Ei{constructor(){r(this,"data",{phase:1,stage:1,totalMedalsCollected:0,totalItemsCollected:0,shopMoneyEarned:0});L.on("medal:collected",({count:e})=>{this.data.totalMedalsCollected+=e}),L.on("item:collected",()=>{this.data.totalItemsCollected++}),L.on("stage:cleared",({phase:e,stage:s})=>{this.data.phase=e,this.data.stage=s})}addShopMoney(e){this.data.shopMoneyEarned+=e}get snapshot(){return{...this.data}}reset(){this.data={phase:1,stage:1,totalMedalsCollected:0,totalItemsCollected:0,shopMoneyEarned:0}}}class Mi{calculate(e,s){const i=s.bestPhase*3+s.bestStage,a=e.phase*3+e.stage>i;return s.updateBest(e.phase,e.stage),s.incrementRuns(),{phase:e.phase,stage:e.stage,totalMedalsCollected:e.totalMedalsCollected,totalItemsCollected:e.totalItemsCollected,isNewBest:a,bestPhase:s.bestPhase,bestStage:s.bestStage}}}var q=(c=>(c.Gold="Gold",c.Alchemy="Alchemy",c.Throw="Throw",c.Guard="Guard",c))(q||{}),U=(c=>(c.Common="Common",c.Rare="Rare",c.Epic="Epic",c))(U||{});const jt=[{id:"gold_touch",name:"黄金の手",description:"メダル1枚あたりのノルマ加算値が+20%",tag:q.Gold,rarity:U.Common,effects:[{type:"QUOTA_PER_MEDAL",value:1.2}]},{id:"lucky_fall",name:"幸運の落下",description:"メダル1枚あたりのノルマ加算値が+50%",tag:q.Gold,rarity:U.Rare,effects:[{type:"QUOTA_PER_MEDAL",value:1.5}]},{id:"golden_shower",name:"黄金雨",description:"メダル1枚あたりのノルマ加算値が+100%",tag:q.Gold,rarity:U.Epic,effects:[{type:"QUOTA_PER_MEDAL",value:2}]},{id:"coin_magnet",name:"コインマグネット",description:"ステージクリア時にボーナスメダル+5枚",tag:q.Gold,rarity:U.Common,effects:[{type:"ON_CLEAR_BONUS_MEDAL",value:5}]},{id:"fortune_wheel",name:"幸運の輪",description:"ステージクリア時にボーナスメダル+15枚",tag:q.Gold,rarity:U.Rare,effects:[{type:"ON_CLEAR_BONUS_MEDAL",value:15}]},{id:"appraiser",name:"鑑定士",description:"アイテムのノルマ加算値が1.5倍",tag:q.Alchemy,rarity:U.Common,effects:[{type:"ITEM_QUOTA_MULTIPLIER",value:1.5}]},{id:"master_appraiser",name:"大鑑定士",description:"アイテムのノルマ加算値が2.5倍",tag:q.Alchemy,rarity:U.Rare,effects:[{type:"ITEM_QUOTA_MULTIPLIER",value:2.5}]},{id:"transmutation",name:"錬成",description:"アイテムの売却価格が1.5倍",tag:q.Alchemy,rarity:U.Common,effects:[{type:"ITEM_SELL_MULTIPLIER",value:1.5}]},{id:"great_transmutation",name:"大錬成",description:"アイテムの売却価格が2倍",tag:q.Alchemy,rarity:U.Rare,effects:[{type:"ITEM_SELL_MULTIPLIER",value:2}]},{id:"philosopher",name:"賢者",description:"アイテムのノルマ加算値3倍+売却価格2倍",tag:q.Alchemy,rarity:U.Epic,effects:[{type:"ITEM_QUOTA_MULTIPLIER",value:3},{type:"ITEM_SELL_MULTIPLIER",value:2}]},{id:"double_throw",name:"ダブル投擲",description:"一度に投入するメダルが2枚になる",tag:q.Throw,rarity:U.Common,effects:[{type:"MEDAL_THROW_COUNT",value:2}]},{id:"triple_throw",name:"トリプル投擲",description:"一度に投入するメダルが3枚になる",tag:q.Throw,rarity:U.Rare,effects:[{type:"MEDAL_THROW_COUNT",value:3}]},{id:"barrage",name:"弾幕",description:"一度に投入するメダルが5枚になる",tag:q.Throw,rarity:U.Epic,effects:[{type:"MEDAL_THROW_COUNT",value:5}]},{id:"quick_draw",name:"クイックドロー",description:"一度に投入するメダルが2枚+クリアボーナス+3枚",tag:q.Throw,rarity:U.Rare,effects:[{type:"MEDAL_THROW_COUNT",value:2},{type:"ON_CLEAR_BONUS_MEDAL",value:3}]},{id:"focused_aim",name:"集中狙い",description:"メダル1枚あたりのノルマ加算+30%",tag:q.Throw,rarity:U.Common,effects:[{type:"QUOTA_PER_MEDAL",value:1.3}]},{id:"safety_net",name:"セーフティネット",description:"ゲームオーバーを一度だけ無効化する",tag:q.Guard,rarity:U.Rare,effects:[{type:"GAME_OVER_SHIELD",value:1}]},{id:"double_safety",name:"ダブルセーフティ",description:"ゲームオーバーを二度まで無効化する",tag:q.Guard,rarity:U.Epic,effects:[{type:"GAME_OVER_SHIELD",value:2}]},{id:"guardian_angel",name:"守護天使",description:"ゲームオーバー無効+クリアボーナスメダル+8枚",tag:q.Guard,rarity:U.Epic,effects:[{type:"GAME_OVER_SHIELD",value:1},{type:"ON_CLEAR_BONUS_MEDAL",value:8}]},{id:"resilience",name:"回復力",description:"クリアボーナスメダル+10枚",tag:q.Guard,rarity:U.Common,effects:[{type:"ON_CLEAR_BONUS_MEDAL",value:10}]},{id:"fortress",name:"要塞",description:"ゲームオーバー無効+アイテムノルマ加算+50%",tag:q.Guard,rarity:U.Epic,effects:[{type:"GAME_OVER_SHIELD",value:1},{type:"ITEM_QUOTA_MULTIPLIER",value:1.5}]}];function Pt(c){return jt.find(e=>e.id===c)}class Ci{constructor(){r(this,"owned",[])}addSkill(e,s){this.owned.push({definitionId:e,acquiredAt:s}),L.emit("skill:selected",{skillId:e})}getOwnedSkills(){return[...this.owned]}getEffectMultiplier(e){let s=1;for(const i of this.owned){const t=Pt(i.definitionId);if(t)for(const a of t.effects)a.type===e&&(s*=a.value)}return s}getEffectSum(e){let s=0;for(const i of this.owned){const t=Pt(i.definitionId);if(t)for(const a of t.effects)a.type===e&&(s+=a.value)}return s}get medalThrowCount(){const e=this.getEffectSum("MEDAL_THROW_COUNT");return e>0?e:1}get gameOverShields(){return this.getEffectSum("GAME_OVER_SHIELD")}get quotaPerMedalMultiplier(){return this.getEffectMultiplier("QUOTA_PER_MEDAL")}get itemQuotaMultiplier(){return this.getEffectMultiplier("ITEM_QUOTA_MULTIPLIER")}get itemSellMultiplier(){return this.getEffectMultiplier("ITEM_SELL_MULTIPLIER")}get onClearBonusMedals(){return this.getEffectSum("ON_CLEAR_BONUS_MEDAL")}consumeShield(){return!1}reset(){this.owned=[]}}const kt={[U.Common]:60,[U.Rare]:30,[U.Epic]:10};class Ii{pickChoices(e,s,i){const t=new pt(i),a=new Set(s.map(d=>d.definitionId)),n=jt.filter(d=>!a.has(d.id));if(n.length===0)return[];const o=[],l=new Set;for(let d=0;d<e&&o.length<n.length;d++){const p=Object.keys(kt),u=p.map(y=>kt[y]),f=t.weightedPick(p,u),h=n.filter(y=>y.rarity===f&&!l.has(y.id));if(h.length===0){const y=n.filter(v=>!l.has(v.id));if(y.length===0)break;const x=y[Math.floor(t.next()*y.length)];o.push(x),l.add(x.id);continue}const m=h[Math.floor(t.next()*h.length)];o.push(m),l.add(m.id)}return o}}const mt=[{id:"side_guard",name:"サイドガード",description:"30秒間サイドの壁を復活",price:300,durationMs:3e4,color:"#44aaff"},{id:"medal_fever",name:"メダルフィーバー",description:"30秒間メダルのノルマ2倍",price:200,durationMs:3e4,color:"#ffaa00"},{id:"medal_shower",name:"メダルシャワー",description:"即座に20枚のメダルが降ってくる",price:250,durationMs:0,color:"#ff60a0"}];function Lt(c){return mt.find(e=>e.id===c)}class _i{constructor(){r(this,"shopMoney");r(this,"medals");r(this,"sellMultiplier",1);r(this,"ownedActiveItems",new Map);this.shopMoney=g.INITIAL_SHOP_MONEY,this.medals=g.INITIAL_MEDALS}setSellMultiplier(e){this.sellMultiplier=e}get money(){return this.shopMoney}get currentMedals(){return this.medals}setMedals(e){this.medals=e}addMoney(e){this.shopMoney+=e}spendMedal(){return this.medals<=0?!1:(this.medals--,!0)}addMedals(e){this.medals+=e}sellItem(e,s){const i=s.getDefinition(e);if(!i)return 0;const t=Math.floor(i.sellPrice*this.sellMultiplier);return s.removeItem(e),this.shopMoney+=t,t}buyMedals(e){const s=e*g.MEDAL_BUY_PRICE;return this.shopMoney<s?!1:(this.shopMoney-=s,this.medals+=e,!0)}buyActiveItem(e){const s=mt.find(i=>i.id===e);return!s||this.shopMoney<s.price?!1:(this.shopMoney-=s.price,this.ownedActiveItems.set(e,(this.ownedActiveItems.get(e)??0)+1),!0)}useActiveItem(e){const s=this.ownedActiveItems.get(e)??0;return s<=0?!1:(s===1?this.ownedActiveItems.delete(e):this.ownedActiveItems.set(e,s-1),!0)}getOwnedActiveItems(){return Array.from(this.ownedActiveItems.entries()).map(([e,s])=>({id:e,count:s}))}reset(){this.shopMoney=g.INITIAL_SHOP_MONEY,this.medals=g.INITIAL_MEDALS,this.sellMultiplier=1,this.ownedActiveItems.clear()}}let Dt=!1;function Ai(){if(Dt)return;Dt=!0;const c=document.createElement("style");c.textContent=`
    @keyframes titleGlow {
  ...
  `,document.head.appendChild(c)}class Oi{constructor(e){r(this,"el");r(this,"medalCounter");r(this,"quotaBar");r(this,"phaseIndicator");r(this,"throwHint");r(this,"inventoryPanel");r(this,"activeItemPanel");r(this,"countdownEl");r(this,"feverBannerEl");r(this,"comboEl");r(this,"edgeGlowEl");r(this,"onUseActiveCallbacks",[]);r(this,"hideTimer",null);r(this,"jackpotHudEl");r(this,"jackpotBarEl");r(this,"comboHideTimer",null);r(this,"aimIndicatorEl");r(this,"stageCountEl");this.el=document.createElement("div"),this.el.style.cssText=`
    ...
    `,this.throwHint.textContent="Tap / Click to throw medal",this.el.appendChild(this.throwHint),this.inventoryPanel=document.createElement("div"),this.inventoryPanel.style.cssText=`
      ...
      max-width: min(220px, 32vw); max-height: min(260px, 35vh);
    ...
    `,this.el.appendChild(this.inventoryPanel),this.activeItemPanel=document.createElement("div"),this.activeItemPanel.style.cssText=`
      ...
      max-width: min(220px, 35vw); pointer-events: all;
    ...
    `,this.jackpotHudEl.innerHTML=`
      ...
      <div class="jp-label" style="font-size:0.65rem;color:var(--t-text-dim);text-align:right;margin-top:3px;">0 / 35</div>
    ...
    `,t.textContent="▸ ITEMS",this.inventoryPanel.appendChild(t);for(const a of e){const n=Ie(a.definitionId);if(!n)continue;const o=String(n.rarity),l=s[o]??"#9999aa",d=i[o]??"◇",p=document.createElement("div");p.style.cssText=`
  ...
  `,document.head.appendChild(c)}class $i{constructor(e){r(this,"el");r(this,"onRetryCallbacks",[]);r(this,"onTitleCallbacks",[]);r(this,"hideTimer",null);Ni(),this.el=document.createElement("div"),this.el.style.cssText=`
      position: absolute;
      inset: 0;
      display: none;
      flex-direction: column;
...
`;class qi{constructor(e){r(this,"el");r(this,"moneyEl");r(this,"inventoryEl");r(this,"onBuyMedalsCallbacks",[]);r(this,"onSellCallbacks",[]);r(this,"onContinueCallbacks",[]);r(this,"onBuyActiveCallbacks",[]);r(this,"hideTimer",null);this.el=document.createElement("div"),this.el.style.cssText=`
    ...
    `,a.textContent="NEXT PHASE →",a.addEventListener("mouseenter",()=>{a.style.transform="scale(1.04)",a.style.boxShadow="0 0 16px var(--t-success)"}),a.addEventListener("mouseleave",()=>{a.style.transform="",a.style.boxShadow=""}),a.addEventListener("click",()=>this.onContinueCallbacks.forEach(n=>n())),i.appendChild(t),i.appendChild(this.moneyEl),i.appendChild(a),this.inventoryEl=document.createElement("div"),this.inventoryEl.style.cssText="margin-top: 16px;",s.appendChild(i),s.appendChild(this.inventoryEl),e.appendChild(this.el)}show(e,s,i=[]){this.hideTimer!==null&&(clearTimeout(this.hideTimer),this.hideTimer=null),this.moneyEl.textContent=`💰 ${e} G`,this.renderContent(e,s,i),this.el.style.opacity="0",this.el.style.display="block",requestAnimationFrame(()=>{this.el.style.opacity="1"})}renderContent(e,s,i){this.inventoryEl.innerHTML="";const t=document.createElement("div");t.style.cssText="margin-bottom: 28px;";const a=document.createElement("h3");a.style.cssText="color: var(--t-primary); margin-bottom: 12px; border-bottom: 1px solid var(--t-border-faint); padding-bottom: 8px;",a.textContent="🪙 BUY MEDALS",t.appendChild(a);const n=document.createElement("div");n.style.cssText="display: flex; gap: 12px; flex-wrap: wrap;";const o=[{count:10,price:50,coins:"🪙🪙🪙"},{count:30,price:130,coins:"🪙🪙🪙🪙🪙",badge:"POPULAR"},{count:100,price:400,coins:"🪙🪙🪙🪙🪙🪙🪙",badge:"BEST VALUE"}];for(const x of o){const v=e>=x.price,E=document.createElement("div");if(E.style.cssText=`
      ...
      `,x.badge){const b=document.createElement("div");b.style.cssText=`
        ...
        `,b.textContent=x.badge,E.appendChild(b)}const C=document.createElement("div");C.style.cssText="font-size: 1.1rem; margin-bottom: 6px;",C.textContent=x.coins;const w=document.createElement("div");w.style.cssText=`color: ${v?"var(--t-primary)":"#666"}; font-size: 1.1rem; font-weight: bold; margin-bottom: 4px;`,w.textContent=`${x.count} medals`;const S=document.createElement("div");S.style.cssText=`color: ${v?"var(--t-text-dim)":"#555"}; font-size: 0.8rem;`,S.textContent=`${x.price} G`,E.appendChild(C),E.appendChild(w),E.appendChild(S),v&&(E.addEventListener("mouseenter",()=>{E.style.transform="translateY(-3px)",E.style.boxShadow="0 8px 32px rgba(0,0,0,0.5), 0 0 16px rgba(200,131,26,0.3)"}),E.addEventListener("mouseleave",()=>{E.style.transform="translateY(0)",E.style.boxShadow=""}),E.addEventListener("click",()=>{this.onBuyMedalsCallbacks.forEach(b=>b(x.count))})),n.appendChild(E)}t.appendChild(n),this.inventoryEl.appendChild(t);const l=document.createElement("hr");l.style.cssText="border: none; border-top: 1px solid var(--t-border-faint); margin: 8px 0 20px;",this.inventoryEl.appendChild(l);const d=document.createElement("div");d.style.cssText="margin-bottom: 28px;";const p=document.createElement("h3");p.style.cssText="color: var(--t-tertiary); margin-bottom: 12px; border-bottom: 1px solid var(--t-border-faint); padding-bottom: 8px;",p.textContent="✨ ACTIVE ITEMS  —  use during game",d.appendChild(p);const u=document.createElement("div");u.style.cssText="display: flex; gap: 12px; flex-wrap: wrap;";const f=new Map(i.map(x=>[x.id,x.count]));for(const x of mt){const v=e>=x.price,E=f.get(x.id)??0,C=document.createElement("div");C.style.cssText=`
        padding: 14px;
        ${st}
        ...
        min-width: 160px;
        transition: transform 0.15s, box-shadow 0.15s;
      `;const w=document.createElement("div");w.style.cssText=`color: ${x.color}; font-size: 0.95rem; font-weight: bold; margin-bottom: 4px;`,w.textContent=x.name;const S=document.createElement("div");S.style.cssText="color: var(--t-text-dim); font-size: 0.75rem; margin-bottom: 8px;",S.textContent=x.description;const b=document.createElement("div");b.style.cssText="color: #88cc88; font-size: 0.75rem; margin-bottom: 8px;",b.textContent=`Owned: ${E}`;const D=document.createElement("button");D.style.cssText=`
        padding: 6px 14px;
        background: transparent;
      ...
      `,D.textContent=`Buy ${x.price} G`,v&&(D.addEventListener("mouseenter",()=>D.style.background=`${x.color}22`),D.addEventListener("mouseleave",()=>D.style.background="transparent"),C.addEventListener("mouseenter",()=>{C.style.transform="translateY(-2px)",C.style.boxShadow="0 8px 32px rgba(0,0,0,0.5)"}),C.addEventListener("mouseleave",()=>{C.style.transform="translateY(0)",C.style.boxShadow=""}),D.addEventListener("click",()=>{this.onBuyActiveCallbacks.forEach(H=>H(x.id))})),C.appendChild(w),C.appendChild(S),C.appendChild(b),C.appendChild(D),u.appendChild(C)}d.appendChild(u),this.inventoryEl.appendChild(d);const h=document.createElement("hr");h.style.cssText="border: none; border-top: 1px solid var(--t-border-faint); margin: 8px 0 20px;",this.inventoryEl.appendChild(h);const m=document.createElement("div"),y=document.createElement("h3");if(y.style.cssText="color: var(--t-text-dim); margin-bottom: 12px; border-bottom: 1px solid var(--t-border-faint); padding-bottom: 8px;",y.textContent="🎁 YOUR ITEMS  —  click to sell",m.appendChild(y),s.length===0){const x=document.createElement("p");x.style.cssText="color: var(--t-text-dim); opacity: 0.5;",x.textContent="No items collected yet.",m.appendChild(x)}else{const x=document.createElement("div");x.style.cssText="display: flex; flex-wrap: wrap; gap: 12px;";for(const v of s){const E=Ie(v.definitionId);if(!E)continue;const C=document.createElement("div");C.style.cssText=`
          width: 160px;
          padding: 14px;
          ${st}
          background: rgba(0,0,0,0.5);
...
}`,this._currentName=e,this._currentTheme=s,this._callbacks.forEach(t=>t(s))}onChange(e){this._callbacks.push(e)}};r(fe,"_instance",null);let lt=fe;const ce=class ce{constructor(){r(this,"comboCount",0);r(this,"lastCollectMs",0);r(this,"feverEndMs",0);r(this,"_wasInFever",!1)}onMedalCollected(e){const s=Date.now();s-this.lastCollectMs<ce.COMBO_WINDOW_MS?this.comboCount+=e:this.comboCount=e,this.lastCollectMs=s,L.emit("combo:updated",{count:this.comboCount}),this.comboCount>=ce.COMBO_TO_FEVER&&!this.isFever&&this._triggerFever()}update(){const e=this.isFever;this._wasInFever&&!e&&(this._wasInFever=!1,this.comboCount=0,L.emit("fever:ended",void 0)),this._wasInFever=e}get isFever(){return Date.now()<this.feverEndMs}get feverRemainingMs(){return Math.max(0,this.feverEndMs-Date.now())}get comboCountValue(){return this.comboCount}reset(){this.comboCount=0,this.lastCollectMs=0,this.feverEndMs=0,this._wasInFever=!1}_triggerFever(){this.feverEndMs=Date.now()+ce.FEVER_DURATION_MS,this.comboCount=0,this._wasInFever=!0,L.emit("fever:started",void 0)}};r(ce,"COMBO_WINDOW_MS",5e3),r(ce,"COMBO_TO_FEVER",6),r(ce,"FEVER_DURATION_MS",1e4),r(ce,"FEVER_SPEED_MULT",1.6);let Ye=ce;const ze=new ct(.05,4,4),aa=new ne(.06,.06,.02,8),na=new As(.06,0),oa=new ct(.028,4,4);class ra{constructor(e){r(this,"particles",[]);r(this,"flashRings",[]);r(this,"scene");this.scene=e}spawnFlashRing(e,s,i,t){const a=new Xe(.1,.38,20),n=new De({color:t,transparent:!0,opacity:.9,side:Ke}),o=new k(a,n);o.position.set(e,s,i),o.rotation.x=-Math.PI/2,this.scene.add(o),this.flashRings.push({mesh:o,life:0,maxLife:.25});const l=new Xe(.05,.22,16),d=new De({color:t,transparent:!0,opacity:.65,side:Ke}),p=new k(l,d);p.position.set(e,s+.01,i),p.rotation.x=-Math.PI/2,this.scene.add(p),this.flashRings.push({mesh:p,life:-.06,maxLife:.35})}spawnMedalCollect(e,s,i){this.spawnFlashRing(e,s,i,16766720);const t=14;for(let a=0;a<t;a++){const n=a<5,o=n?aa:ze,l=new N({color:n?16763904:16766720,emissive:new V(n?14522624:16766720),emissiveIntensity:n?.6:1,metalness:n?.9:.3,roughness:n?.2:.5,transparent:!0}),d=new k(o,l);d.position.set(e,s,i);const p=a/t*Math.PI*2,u=1.5+Math.random()*3.5,f=new se(Math.cos(p)*u*.55,2.5+Math.random()*3.5,Math.sin(p)*u*.55);this.scene.add(d),this.particles.push({mesh:d,velocity:f,life:0,maxLife:.7+Math.random()*.5})}}spawnItemCollect(e,s,i,t){this.spawnFlashRing(e,s,i,t),this.spawnFlashRing(e,s+.1,i,t);const a=new V(t),n=24;for(let o=0;o<n;o++){const d=o%3===0?na:ze,p=new N({color:t,emissive:a,emissiveIntensity:1,metalness:.1,roughness:.4,transparent:!0}),u=new k(d,p);u.position.set(e,s,i);const f=o/n*Math.PI*2+Math.random()*.4,h=2.5+Math.random()*3,m=new se(Math.cos(f)*h,3.5+Math.random()*2.5,Math.sin(f)*h);this.scene.add(u),this.particles.push({mesh:u,velocity:m,life:0,maxLife:1.2+Math.random()*.5})}}spawnThrow(e,s,i){for(let a=0;a<9;a++){const n=new N({color:16766720,emissive:new V(16766720),emissiveIntensity:1,metalness:.5,roughness:.3,transparent:!0}),o=new k(ze,n);o.position.set(e,s,i);const l=a/9*Math.PI*2,d=1.2+Math.random()*1.6,p=new se(Math.cos(l)*d*.4,2.5+Math.random()*2,Math.sin(l)*d*.2);this.scene.add(o),this.particles.push({mesh:o,velocity:p,life:0,maxLife:.35+Math.random()*.2})}}spawnCoinGlints(e,s,i,t=3){const a=[16774314,16769152,16766720,16777215,16771248];for(let n=0;n<t;n++){const o=a[Math.floor(Math.random()*a.length)],l=new N({color:o,emissive:new V(o),emissiveIntensity:2.5,transparent:!0,opacity:.9}),d=new k(oa,l),p=(Math.random()-.5)*1.2,u=(Math.random()-.5)*1.2;d.position.set(e+p,s+Math.random()*.1,i+u);const f=Math.random()*Math.PI*2,h=.4+Math.random()*.6,m=new se(Math.cos(f)*h*.3,.8+Math.random()*1.2,Math.sin(f)*h*.3);this.scene.add(d),this.particles.push({mesh:d,velocity:m,life:0,maxLife:.35+Math.random()*.25})}}spawnJackpot(e,s,i){this.spawnFlashRing(e,s,i,16766720);const t=new Xe(.3,.8,32),a=new De({color:16777215,transparent:!0,opacity:.85,side:Ke}),n=new k(t,a);n.position.set(e,s,i),n.rotation.x=-Math.PI/2,this.scene.add(n),this.flashRings.push({mesh:n,life:0,maxLife:.4});const o=30;for(let l=0;l<o;l++){const d=l/o*360,p=new V(`hsl(${d}, 100%, 60%)`),u=l%4===0,f=new N({color:p,emissive:p,emissiveIntensity:1,metalness:u?.8:.2,roughness:.3,transparent:!0}),h=new k(ze,f);h.position.set(e,s,i);const m=l/o*Math.PI*2+Math.random()*.3,y=3.5+Math.random()*4.5,x=new se(Math.cos(m)*y,4+Math.random()*5,Math.sin(m)*y);this.scene.add(h),this.particles.push({mesh:h,velocity:x,life:0,maxLife:1.6+Math.random()*.6})}}update(e){const i=[];for(const a of this.particles){a.life+=e;const n=a.life/a.maxLife;a.velocity.y+=-9.8*e,a.mesh.position.addScaledVector(a.velocity,e),a.mesh.rotation.x+=e*5,a.mesh.rotation.y+=e*4,a.mesh.rotation.z+=e*3;const o=Math.max(0,1-n*.65);a.mesh.scale.setScalar(o),a.mesh.material.opacity=Math.pow(1-n,1.6),n>=1&&i.push(a)}for(const a of i)this.scene.remove(a.mesh),a.mesh.material.dispose(),this.particles.splice(this.particles.indexOf(a),1);const t=[];for(const a of this.flashRings){if(a.life+=e,a.life<0)continue;const n=a.life/a.maxLife,l=1+(1-Math.pow(1-n,2.2))*3.2;a.mesh.scale.set(l,l,l);const d=a.mesh.material.opacity>.7?.9:.65;a.mesh.material.opacity=d*Math.pow(1-n,.7),n>=1&&t.push(a)}for(const a of t)this.scene.remove(a.mesh),a.mesh.geometry.dispose(),a.mesh.material.dispose(),this.flashRings.splice(this.flashRings.indexOf(a),1)}clear(){for(const e of this.particles)this.scene.remove(e.mesh),e.mesh.material.dispose();this.particles=[];for(const e of this.flashRings)this.scene.remove(e.mesh),e.mesh.geometry.dispose(),e.mesh.material.dispose();this.flashRings=[]}}class la{constructor(){r(this,"counter",0);r(this,"jackpotCount",0)}onQuotaAdded(e){this.counter+=e,L.emit("jackpot:progress",{current:this.counter,target:g.JACKPOT_THRESHOLD}),this.counter>=g.JACKPOT_THRESHOLD&&(this.counter-=g.JACKPOT_THRESHOLD,this.jackpotCount++,L.emit("jackpot:triggered",{count:this.jackpotCount}))}reset(){this.counter=0,this.jackpotCount=0}get progress(){return Math.min(1,this.counter/g.JACKPOT_THRESHOLD)}get current(){return this.counter}get target(){return g.JACKPOT_THRESHOLD}}const it=1280,at=720;function Kt(){const c=document.getElementById("ui-root");if(!c)return;const e=window.innerWidth/it,s=window.innerHeight/at,i=Math.min(e,s),t=Math.round((window.innerWidth-it*i)/2),a=Math.round((window.innerHeight-at*i)/2);c.style.width=`${it}px`,c.style.height=`${at}px`,c.style.transform=`translate(${t}px, ${a}px) scale(${i})`,c.style.transformOrigin="top left",c.style.inset="unset",c.style.top="0",c.style.left="0"}Kt();window.addEventListener("resize",Kt);async function ca(){const c=rt.getInstance(),e=lt.getInstance();e.applyTheme(c.theme);const s=new ks,i=new Ls,t=new Hs,a=new Ei,n=new Mi;let o=0;const l=document.getElementById("app"),d=document.getElementById("ui-root"),p=new qs(l),u=new Qs,f=new js(p),h=new Zs(p.scene);p.setCamera(u.camera);const m=e.currentTheme;p.applySceneTheme(m.scene),f.applyTheme(m.lights),h.applyTheme(m.scene);const y=new vi,x=new wi(s),v=new Ti,E=new Ci,C=new Ii,w=new _i,S=new bi(p,y,v,m.scene);S.setMedalQuotaMultiplierFn(()=>E.quotaPerMedalMultiplier);const b=new ea(d),D=new ia(p.renderer.domElement);b.titleScreen.applyTheme(c.theme);const H=new Ye,P=new ra(p.scene),I=new la,_=new ot;_.setMasterVolume(c.masterVolume),_.setBgmVolume(c.bgmVolume),_.setSfxVolume(c.sfxVolume),e.onChange(T=>{p.applySceneTheme(T.scene),f.applyTheme(T.lights),h.applyTheme(T.scene),b.titleScreen.applyTheme(T.name),S.physicsWorld.initialized&&S.rebuildFieldMesh(T.scene)}),b.titleScreen.onSettings(()=>{b.settingsScreen.show(c.snapshot)}),b.settingsScreen.onClose(()=>{b.settingsScreen.hide()}),b.settingsScreen.onVolumeChange((T,B)=>{T==="master"?(c.setMasterVolume(B),_.setMasterVolume(B)):T==="bgm"?(c.setBgmVolume(B),_.setBgmVolume(B)):(c.setSfxVolume(B),_.setSfxVolume(B))}),b.settingsScreen.onThemeChange(T=>{c.setTheme(T),e.applyTheme(T)});let $=0,F=!1,z=0,W=0,j=0;b.titleScreen.onStart(()=>{He()}),b.stageResultScreen.onContinue(()=>{b.stageResultScreen.hide(),x.advanceStage(),xe()}),b.stageResultScreen.onSkip(()=>{b.stageResultScreen.hide(),x.advancePhase(),qe()}),b.shopScreen.onBuyMedals(T=>{const B=T*g.MEDAL_BUY_PRICE;w.buyMedals(T)?b.shopScreen.show(w.money,v.getAll(),w.getOwnedActiveItems()):console.log(`Not enough shop money (need ${B} G, have ${w.money} G)`)}),b.shopScreen.onSell(T=>{const B=w.sellItem(T,v);a.addShopMoney(B),b.shopScreen.show(w.money,v.getAll(),w.getOwnedActiveItems())}),b.shopScreen.onBuyActive(T=>{w.buyActiveItem(T)&&b.shopScreen.show(w.money,v.getAll(),w.getOwnedActiveItems())}),b.shopScreen.onContinue(()=>{b.shopScreen.hide(),Oe()}),b.skillSelectScreen.onSelect(T=>{E.addSkill(T,x.currentPhase),w.setSellMultiplier(E.itemSellMultiplier),b.skillSelectScreen.hide(),s.transition(M.STAGE_START),xe()}),b.resultScreen.onRetry(()=>{b.resultScreen.hide(),s.transition(M.TITLE),b.titleScreen.show()}),b.resultScreen.onTitle(()=>{b.resultScreen.hide(),s.transition(M.TITLE),b.titleScreen.show()}),b.gameScreen.onUseActive(T=>{if(!s.is(M.PLAYING)||!w.useActiveItem(T))return;const B=Lt(T);if(!B)return;const Y=Date.now()+B.durationMs;if(T==="side_guard")j=Y,S.addSideGuardWalls(),S.fieldMesh.addSideGuardMeshes(S.fieldMesh.group);else if(T==="medal_fever")W=Y;else if(T==="medal_shower"){for(let te=0;te<20;te++)setTimeout(()=>{if(!s.is(M.PLAYING))return;const ie=(Math.random()*2-1)*(g.FIELD_WIDTH/2-.5),K=(Math.random()-.5)*(g.FIELD_DEPTH/2);S.medalSpawner.spawn(ie,5,K,S.physicsWorld,S.physicsSync,S.collisionHandler,p)},te*150);u.shake(.12,.3)}}),D.onAim(T=>{s.is(M.PLAYING)?b.gameScreen.showAim(T):b.gameScreen.hideAim()}),D.onThrow((T,B)=>{if(!s.is(M.PLAYING))return;const Y=T*(g.FIELD_WIDTH/2+.5),te=E.medalThrowCount;let ie=0;for(let K=0;K<te&&w.spendMedal();K++){const ae=(K-Math.floor(te/2))*.6;S.throwMedal(Y+ae,B),ie++}ie>0&&(L.emit("medal:thrown",{count:ie}),P.spawnThrow(Y,2,g.FIELD_DEPTH/2-.5))}),L.on("quota:reached",()=>{s.is(M.PLAYING)&&(D.disable(),setTimeout(()=>{if(!s.is(M.PLAYING))return;const T=E.onClearBonusMedals;T>0&&w.addMedals(T),x.clearCurrentStage(),b.chanceScreen.show(B=>{B.medals>0&&(w.addMedals(B.medals),b.gameScreen.showFloatingText(`+${B.medals}`,"var(--t-primary)"));const Y=x.isLastStageOfPhase;b.stageResultScreen.show(x.currentPhase,x.currentStage,Y,y.currentValue,y.targetValue)})},500))}),L.on("medal:collected",({count:T,x:B,y:Y,z:te})=>{if(s.is(M.PLAYING)){const ie=(B/g.FIELD_WIDTH*2+1)/2*72+14;b.gameScreen.showFloatingText(`+${T}`,T>=2?"var(--t-secondary)":"var(--t-primary)",ie),w.addMedals(T),H.onMedalCollected(T),I.onQuotaAdded(T),P.spawnMedalCollect(B,Math.max(Y,0),te),o+=T*150+Math.floor(Math.random()*50),re.refreshJackpot(o),S.fieldMesh.triggerCollectionFlash()}}),L.on("item:collected",({x:T,y:B,z:Y})=>{s.is(M.PLAYING)&&P.spawnItemCollect(T,Math.max(B,0),Y,59647)}),L.on("jackpot:progress",({current:T,target:B})=>{s.is(M.PLAYING)&&b.gameScreen.updateJackpot(T,B)}),L.on("jackpot:triggered",()=>{if(!s.is(M.PLAYING))return;w.addMedals(g.JACKPOT_MEDAL_REWARD),b.gameScreen.showFloatingText(`JACKPOT! +${g.JACKPOT_MEDAL_REWARD}`,"var(--t-primary)"),_.playJackpotFanfare(),u.shake(.35,.6),P.spawnJackpot(0,2,-2),b.gameScreen.resetJackpot(g.JACKPOT_THRESHOLD)}),L.on("fever:started",()=>{S.pusher.speedMultiplier=Ye.FEVER_SPEED_MULT,b.gameScreen.showFever(1e4),_.playFeverStart(),f.setFeverMode(!0),_.startBGM(!0),u.shake(.2,.4);for(let T=0;T<12;T++)setTimeout(()=>{if(!s.is(M.PLAYING))return;const B=(Math.random()*2-1)*(g.FIELD_WIDTH/2-.5),Y=(Math.random()*2-1)*(g.FIELD_DEPTH/4);S.medalSpawner.spawn(B,4.5,Y,S.physicsWorld,S.physicsSync,S.collisionHandler,p)},T*250)}),L.on("fever:ended",()=>{S.pusher.speedMultiplier=1,b.gameScreen.hideFever(),b.gameScreen.hideCombo(),_.playFeverEnd(),f.setFeverMode(!1),_.startBGM(!1)}),L.on("combo:updated",({count:T})=>{s.is(M.PLAYING)&&T>=2&&(b.gameScreen.showCombo(T),_.playCombo(T))}),L.on("medal:thrown",()=>{_.playThrow(),b.gameScreen.flashAim()}),L.on("medal:collected",()=>_.playMedalCollected()),L.on("quota:reached",()=>_.playQuotaReached()),L.on("stage:cleared",()=>_.playStageCleared()),L.on("game:over",()=>_.playGameOver()),L.on("skill:selected",()=>_.playSkillSelected()),L.on("medal:collected",()=>u.shake(.04,.08)),L.on("quota:reached",()=>u.shake(.15,.3)),L.on("stage:cleared",()=>u.shake(.28,.5)),L.on("game:over",()=>u.shake(.5,.8)),L.on("state:changed",({to:T})=>{T===M.PLAYING?_.startBGM(!1):_.stopBGM(),u.setTitleMode(T===M.TITLE)});let ee=0,ye=0;i.addUpdateFn(T=>{if(ee+=T,s.is(M.PLAYING)){const B=Date.now();j>0&&B>j&&(j=0,S.removeSideGuardWalls(),S.fieldMesh.removeSideGuardMeshes(S.fieldMesh.group)),W>0&&B>W&&(W=0);const Y=W>Date.now()?2:1;S.setMedalQuotaMultiplierFn(()=>E.quotaPerMedalMultiplier*Y),S.update(T),ye+=T;const te=H.isFever?.25:.55;if(ye>=te&&S.medalSpawner.count>0){ye=0;const K=(Math.random()-.5)*5,ae=-2+(Math.random()-.5)*4,ve=H.isFever?5:2;P.spawnCoinGlints(K,.5,ae,ve)}const ie=w.getOwnedActiveItems().map(K=>{const ae=Lt(K.id),ve=K.id==="side_guard"?Math.max(0,j-Date.now()):K.id==="medal_fever"?Math.max(0,W-Date.now()):0;return{...K,name:ae.name,color:ae.color,remainingMs:ve}});if(b.updateGameHUD(w.currentMedals,y.currentValue,y.targetValue,x.currentPhase,x.currentStage,v.getAll(),ie),!F&&w.currentMedals<=0&&!y.isReached&&(F=!0,z=10,D.disable(),b.gameScreen.quotaBar.setDanger(!0)),F&&z>0){const K=Math.ceil(z);z-=T;const ae=Math.ceil(z);ae!==K&&ae>0&&_.playCountdownTick(),z>0?b.gameScreen.showCountdown(z):(b.gameScreen.hideCountdown(),Ae())}}H.update(),P.update(T),h.update(T),f.update(ee),u.update(T),p.render(u.camera)});function He(){t.incrementRuns(),w.reset(),v.clear(),E.reset(),a.reset(),x.reset(),$=0,F=!1,z=0,W=0,j=0,H.reset(),I.reset(),S.pusher.speedMultiplier=1,o=0,re.refreshJackpot(0),s.transition(M.STAGE_START),xe()}async function xe(){const T=x.currentPhase,B=x.currentStage;F=!1,z=0,b.gameScreen.hideCountdown(),b.gameScreen.quotaBar.setDanger(!1),H.reset(),I.reset(),S.pusher.speedMultiplier=1,b.gameScreen.hideFever(),b.gameScreen.hideCombo(),b.gameScreen.resetJackpot(g.JACKPOT_THRESHOLD),y.startStage(T,B);try{S.physicsWorld.initialized?S.endStage():(be(!0),await S.init(),be(!1))}catch(Y){console.error("Field init failed:",Y),be(!1);return}S.startStage(T,B),x.startCurrentStage(),b.gameScreen.showStageCountdown(T,B,()=>{s.is(M.PLAYING)&&D.enable()})}function qe(){S.endStage(),s.transition(M.SHOP),b.shopScreen.show(w.money,v.getAll(),w.getOwnedActiveItems())}function Oe(){s.transition(M.SKILL_SELECT);const T=C.pickChoices(g.SKILL_CHOICES,E.getOwnedSkills(),Date.now());b.skillSelectScreen.show(T)}function Ae(){if($>0){$--,z=0,b.gameScreen.hideCountdown(),D.enable(),F=!1;return}S.endStage();const T=n.calculate(a.snapshot,t);t.updateBest(T.phase,T.stage),s.transition(M.GAME_OVER),s.transition(M.RESULT),b.resultScreen.show(T)}const pe=document.createElement("div");pe.style.cssText=`
    position: absolute; inset: 0; display: none;
    align-items: center; justify-content: center;
    background: var(--t-bg-overlay-dark); color: var(--t-primary);
    font-size: 1.2rem; letter-spacing: 0.2em;
  `,pe.textContent="LOADING...",d.appendChild(pe);function be(T){pe.style.display=T?"flex":"none"}L.on("skill:selected",()=>{$=Math.max($,E.gameOverShields)}),i.start(),u.setTitleMode(!0),s.transition(M.TITLE),b.titleScreen.show(),console.log("YukiMedal initialized")}ca().catch(console.error);
