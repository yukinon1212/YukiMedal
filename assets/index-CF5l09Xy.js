var ot=Object.defineProperty;var lt=(o,e,t)=>e in o?ot(o,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):o[e]=t;var r=(o,e,t)=>lt(o,typeof e!="symbol"?e+"":e,t);import{M as K,O as ct,B as et,F as He,S as ce,U as Ee,V as X,W as xe,H as Te,N as dt,C as ht,a as fe,b as ee,A as ut,c as pt,R as mt,d as ft,e as gt,L as yt,f as bt,g as xt,h as tt,i as Tt,j as Et,k as St,l as vt,m as wt,P as Ct,n as Mt,o as st,p as _t,D as Be,q as Ge,r as It,s as At,t as Pt,G as Ne,u as Rt,v as Q,w as Lt,I as kt,x as V,y as Dt,z as ye,E as M,T as Ht}from"./three--ETyBs3O.js";import{O as be}from"./rapier-DpxwuBBO.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const n of a.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function t(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(s){if(s.ep)return;s.ep=!0;const a=t(s);fetch(s.href,a)}})();var v=(o=>(o.INIT="INIT",o.TITLE="TITLE",o.STAGE_START="STAGE_START",o.PLAYING="PLAYING",o.STAGE_CLEAR="STAGE_CLEAR",o.SKIP_PROMPT="SKIP_PROMPT",o.GAME_OVER="GAME_OVER",o.SHOP="SHOP",o.SKILL_SELECT="SKILL_SELECT",o.RESULT="RESULT",o))(v||{});class Bt{constructor(){r(this,"listeners",new Map)}on(e,t){this.listeners.has(e)||this.listeners.set(e,new Set);const i=this.listeners.get(e);return i.add(t),()=>i.delete(t)}once(e,t){const i=this.on(e,s=>{t(s),i()})}emit(e,t){const i=this.listeners.get(e);if(i)for(const s of i)s(t)}off(e,t){var i;(i=this.listeners.get(e))==null||i.delete(t)}clear(){this.listeners.clear()}}const A=new Bt,Gt=[{from:v.INIT,to:v.TITLE},{from:v.TITLE,to:v.STAGE_START},{from:v.STAGE_START,to:v.PLAYING},{from:v.PLAYING,to:v.STAGE_CLEAR},{from:v.PLAYING,to:v.GAME_OVER},{from:v.STAGE_CLEAR,to:v.STAGE_START},{from:v.STAGE_CLEAR,to:v.SKIP_PROMPT},{from:v.STAGE_CLEAR,to:v.SHOP},{from:v.SKIP_PROMPT,to:v.SHOP},{from:v.SKIP_PROMPT,to:v.STAGE_START},{from:v.SHOP,to:v.SKILL_SELECT},{from:v.SKILL_SELECT,to:v.STAGE_START},{from:v.GAME_OVER,to:v.RESULT},{from:v.RESULT,to:v.TITLE}];class Nt{constructor(){r(this,"current",v.INIT)}get state(){return this.current}canTransition(e){return Gt.some(t=>(Array.isArray(t.from)?t.from:[t.from]).includes(this.current)&&t.to===e)}transition(e){if(!this.canTransition(e))throw new Error(`Invalid state transition: ${this.current} → ${e}`);const t=this.current;this.current=e,A.emit("state:changed",{from:t,to:e})}is(e){return this.current===e}isAny(...e){return e.includes(this.current)}}class Ot{constructor(){r(this,"updateFns",[]);r(this,"rafId",null);r(this,"lastTime",0);r(this,"maxDelta",1/20)}addUpdateFn(e){this.updateFns.push(e)}removeUpdateFn(e){const t=this.updateFns.indexOf(e);t!==-1&&this.updateFns.splice(t,1)}start(){if(this.rafId!==null)return;this.lastTime=performance.now();const e=t=>{this.rafId=requestAnimationFrame(e);const i=(t-this.lastTime)/1e3;this.lastTime=t;const s=Math.min(i,this.maxDelta);for(const a of this.updateFns)a(s)};this.rafId=requestAnimationFrame(e)}stop(){this.rafId!==null&&(cancelAnimationFrame(this.rafId),this.rafId=null)}get isRunning(){return this.rafId!==null}}const Oe="yukimedal_save",Ut="yukimedal_best",Se={bestPhase:0,bestStage:0,totalRuns:0,lastPlayedAt:0};class Ft{constructor(){r(this,"data");this.data=this.load()}load(){try{const e=localStorage.getItem(Oe);return e?{...Se,...JSON.parse(e)}:{...Se}}catch{return{...Se}}}save(){try{localStorage.setItem(Oe,JSON.stringify(this.data))}catch{}}updateBest(e,t){const i=e*3+t,s=this.data.bestPhase*3+this.data.bestStage;i>s&&(this.data.bestPhase=e,this.data.bestStage=t,localStorage.setItem(Ut,JSON.stringify({phase:e,stage:t}))),this.data.lastPlayedAt=Date.now(),this.save()}incrementRuns(){this.data.totalRuns++,this.save()}get bestPhase(){return this.data.bestPhase}get bestStage(){return this.data.bestStage}get totalRuns(){return this.data.totalRuns}}const it={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
...
`;class $s{constructor(e){r(this,"el");r(this,"moneyEl");r(this,"inventoryEl");r(this,"onBuyMedalsCallbacks",[]);r(this,"onSellCallbacks",[]);r(this,"onContinueCallbacks",[]);r(this,"onBuyActiveCallbacks",[]);r(this,"hideTimer",null);this.el=document.createElement("div"),this.el.style.cssText=`
    ...
    `,s.textContent="START NEXT PHASE →",s.addEventListener("mouseenter",()=>s.style.background="rgba(0,255,136,0.13)"),s.addEventListener("mouseleave",()=>s.style.background="transparent"),s.addEventListener("click",()=>this.onContinueCallbacks.forEach(a=>a())),t.appendChild(i),t.appendChild(this.moneyEl),t.appendChild(s),this.inventoryEl=document.createElement("div"),this.inventoryEl.style.cssText="margin-top: 16px;",this.el.appendChild(t),this.el.appendChild(this.inventoryEl),e.appendChild(this.el)}show(e,t,i=[]){this.hideTimer!==null&&(clearTimeout(this.hideTimer),this.hideTimer=null),this.moneyEl.textContent=`Shop Money: ${e} G`,this.renderContent(e,t,i),this.el.style.opacity="0",this.el.style.display="block",requestAnimationFrame(()=>{this.el.style.opacity="1"})}renderContent(e,t,i){this.inventoryEl.innerHTML="";const s=document.createElement("div");s.style.cssText="margin-bottom: 28px;";const a=document.createElement("h3");a.style.cssText="color: var(--t-primary); margin-bottom: 12px; border-bottom: 1px solid var(--t-border-faint); padding-bottom: 8px;",a.textContent="BUY MEDALS",s.appendChild(a);const n=document.createElement("div");n.style.cssText="display: flex; gap: 12px; flex-wrap: wrap;";const l=[{count:10,price:50,label:"10 medals"},{count:30,price:130,label:"30 medals"},{count:100,price:400,label:"100 medals"}];for(const g of l){const T=e>=g.price,w=document.createElement("button");w.style.cssText=`
      ...
      `;const I=document.createElement("div");I.style.cssText=`color: ${g.color}; font-size: 0.95rem; font-weight: bold; margin-bottom: 4px;`,I.textContent=g.name;const E=document.createElement("div");E.style.cssText="color: var(--t-text-dim); font-size: 0.75rem; margin-bottom: 8px;",E.textContent=g.description;const L=document.createElement("div");L.style.cssText="color: #88cc88; font-size: 0.75rem; margin-bottom: 8px;",L.textContent=`Owned: ${w}`;const _=document.createElement("button");_.style.cssText=`
        ...
        border-radius: 4px;
        transition: background 0.2s;
      `,_.textContent=`Buy ${g.price} G`,T&&(_.addEventListener("mouseenter",()=>_.style.background=`${g.color}22`),_.addEventListener("mouseleave",()=>_.style.background="transparent"),x.addEventListener("mouseenter",()=>{x.style.transform="translateY(-2px)",x.style.boxShadow="0 8px 32px rgba(0,0,0,0.5)"}),x.addEventListener("mouseleave",()=>{x.style.transform="translateY(0)",x.style.boxShadow=""}),_.addEventListener("click",()=>{this.onBuyActiveCallbacks.forEach(H=>H(g.id))})),x.appendChild(I),x.appendChild(E),x.appendChild(L),x.appendChild(_),h.appendChild(x)}d.appendChild(h),this.inventoryEl.appendChild(d);const m=document.createElement("hr");m.style.cssText="border: none; border-top: 1px solid var(--t-border-faint); margin: 8px 0 20px;",this.inventoryEl.appendChild(m);const b=document.createElement("div"),f=document.createElement("h3");if(f.style.cssText="color: var(--t-text-dim); margin-bottom: 12px; border-bottom: 1px solid var(--t-border-faint); padding-bottom: 8px;",f.textContent="YOUR ITEMS (click to sell)",b.appendChild(f),t.length===0){const g=document.createElement("p");g.style.cssText="color: var(--t-text-dim); opacity: 0.5;",g.textContent="No items collected yet.",b.appendChild(g)}else{const g=document.createElement("div");g.style.cssText="display: flex; flex-wrap: wrap; gap: 12px;";for(const T of t){const w=ge(T.definitionId);if(!w)continue;const x=document.createElement("div");x.style.cssText=`
          width: 160px;
          padding: 14px;
          ${Xe}
          background: rgba(0,0,0,0.5);
...
}`,this._currentName=e,this._currentTheme=t,this._callbacks.forEach(s=>s(t))}onChange(e){this._callbacks.push(e)}};r(ne,"_instance",null);let Ie=ne;async function Xs(){const o=_e.getInstance(),e=Ie.getInstance();e.applyTheme(o.theme);const t=new Nt,i=new Ot,s=new Ft,a=new Ms,n=new _s,l=document.getElementById("app"),c=document.getElementById("ui-root"),d=new jt(l),y=new Jt,h=new es(d),p=new ts(d.scene);d.setCamera(y.camera);const m=e.currentTheme;d.applySceneTheme(m.scene),h.applyTheme(m.lights),p.applyTheme(m.scene);const b=new Ss,f=new vs(t),g=new Cs,T=new Is,w=new As,x=new Ps,I=new Es(d,b,g,m.scene);I.setMedalQuotaMultiplierFn(()=>T.quotaPerMedalMultiplier);const E=new Zs(c),L=new Ks(d.renderer.domElement);E.titleScreen.applyTheme(o.theme);const _=new Me;_.setMasterVolume(o.masterVolume),_.setBgmVolume(o.bgmVolume),_.setSfxVolume(o.sfxVolume),e.onChange(S=>{d.applySceneTheme(S.scene),h.applyTheme(S.lights),p.applyTheme(S.scene),E.titleScreen.applyTheme(S.name),I.physicsWorld.initialized&&I.rebuildFieldMesh(S.scene)}),E.titleScreen.onSettings(()=>{E.settingsScreen.show(o.snapshot)}),E.settingsScreen.onClose(()=>{E.settingsScreen.hide()}),E.settingsScreen.onVolumeChange((S,R)=>{S==="master"?(o.setMasterVolume(R),_.setMasterVolume(R)):S==="bgm"?(o.setBgmVolume(R),_.setBgmVolume(R)):(o.setSfxVolume(R),_.setSfxVolume(R))}),E.settingsScreen.onThemeChange(S=>{o.setTheme(S),e.applyTheme(S)});let H=0,F=!1,B=0,U=0,$=0;E.titleScreen.onStart(()=>{te()}),E.stageResultScreen.onContinue(()=>{E.stageResultScreen.hide(),f.advanceStage(),j()}),E.stageResultScreen.onSkip(()=>{E.stageResultScreen.hide(),f.advancePhase(),J()}),E.shopScreen.onBuyMedals(S=>{const R=S*u.MEDAL_BUY_PRICE;x.buyMedals(S)?E.shopScreen.show(x.money,g.getAll(),x.getOwnedActiveItems()):console.log(`Not enough shop money (need ${R} G, have ${x.money} G)`)}),E.shopScreen.onSell(S=>{const R=x.sellItem(S,g);a.addShopMoney(R),E.shopScreen.show(x.money,g.getAll(),x.getOwnedActiveItems())}),E.shopScreen.onBuyActive(S=>{x.buyActiveItem(S)&&E.shopScreen.show(x.money,g.getAll(),x.getOwnedActiveItems())}),E.shopScreen.onContinue(()=>{E.shopScreen.hide(),re()}),E.skillSelectScreen.onSelect(S=>{T.addSkill(S,f.currentPhase),x.setSellMultiplier(T.itemSellMultiplier),E.skillSelectScreen.hide(),t.transition(v.STAGE_START),j()}),E.resultScreen.onRetry(()=>{E.resultScreen.hide(),t.transition(v.TITLE),E.titleScreen.show()}),E.gameScreen.onUseActive(S=>{if(!t.is(v.PLAYING)||!x.useActiveItem(S))return;const R=$e(S);if(!R)return;const k=Date.now()+R.durationMs;S==="side_guard"?($=k,I.addSideGuardWalls(),I.fieldMesh.addSideGuardMeshes(I.fieldMesh.group)):S==="medal_fever"&&(U=k)}),L.onThrow((S,R)=>{if(!t.is(v.PLAYING))return;const k=S*(u.FIELD_WIDTH/2+.5),N=T.medalThrowCount;let W=0;for(let Y=0;Y<N&&x.spendMedal();Y++){const oe=(Y-Math.floor(N/2))*.6;I.throwMedal(k+oe,R),W++}W>0&&A.emit("medal:thrown",{count:W})}),A.on("quota:reached",()=>{t.is(v.PLAYING)&&(L.disable(),setTimeout(()=>{const S=T.onClearBonusMedals;S>0&&x.addMedals(S),f.clearCurrentStage();const R=f.isLastStageOfPhase;E.stageResultScreen.show(f.currentPhase,f.currentStage,R,b.currentValue,b.targetValue)},500))}),A.on("medal:collected",({count:S})=>{t.is(v.PLAYING)&&(E.gameScreen.showFloatingText(`+${S}`),x.addMedals(S))}),A.on("medal:thrown",()=>_.playThrow()),A.on("medal:collected",()=>_.playMedalCollected()),A.on("quota:reached",()=>_.playQuotaReached()),A.on("stage:cleared",()=>_.playStageCleared()),A.on("game:over",()=>_.playGameOver()),A.on("skill:selected",()=>_.playSkillSelected()),A.on("medal:collected",()=>y.shake(.04,.08)),A.on("quota:reached",()=>y.shake(.15,.3)),A.on("stage:cleared",()=>y.shake(.28,.5)),A.on("game:over",()=>y.shake(.5,.8)),A.on("state:changed",({to:S})=>{S===v.PLAYING?_.startBGM():_.stopBGM()}),i.addUpdateFn(S=>{if(t.is(v.PLAYING)){const R=Date.now();$>0&&R>$&&($=0,I.removeSideGuardWalls(),I.fieldMesh.removeSideGuardMeshes(I.fieldMesh.group)),U>0&&R>U&&(U=0);const k=U>Date.now()?2:1;I.setMedalQuotaMultiplierFn(()=>T.quotaPerMedalMultiplier*k),I.update(S);const N=x.getOwnedActiveItems().map(W=>{const Y=$e(W.id),oe=W.id==="side_guard"?Math.max(0,$-Date.now()):W.id==="medal_fever"?Math.max(0,U-Date.now()):0;return{...W,name:Y.name,color:Y.color,remainingMs:oe}});if(E.updateGameHUD(x.currentMedals,b.currentValue,b.targetValue,f.currentPhase,f.currentStage,g.getAll(),N),!F&&x.currentMedals<=0&&!b.isReached&&(F=!0,B=10,L.disable()),F&&B>0){const W=Math.ceil(B);B-=S;const Y=Math.ceil(B);Y!==W&&Y>0&&_.playCountdownTick(),B>0?E.gameScreen.showCountdown(B):(E.gameScreen.hideCountdown(),se())}}p.update(S),y.update(S),d.render(y.camera)});function te(){s.incrementRuns(),x.reset(),g.clear(),T.reset(),a.reset(),f.reset(),H=0,F=!1,B=0,U=0,$=0,t.transition(v.STAGE_START),j()}async function j(){const S=f.currentPhase,R=f.currentStage;F=!1,B=0,E.gameScreen.hideCountdown(),b.startStage(S,R);try{I.physicsWorld.initialized?I.endStage():(ue(!0),await I.init(),ue(!1))}catch(k){console.error("Field init failed:",k),ue(!1);return}I.startStage(S,R),f.startCurrentStage(),L.enable()}function J(){I.endStage(),t.transition(v.SHOP),E.shopScreen.show(x.money,g.getAll(),x.getOwnedActiveItems())}function re(){t.transition(v.SKILL_SELECT);const S=w.pickChoices(u.SKILL_CHOICES,T.getOwnedSkills(),Date.now());E.skillSelectScreen.show(S)}function se(){if(H>0){H--,B=0,E.gameScreen.hideCountdown(),L.enable(),F=!1;return}I.endStage();const S=n.calculate(a.snapshot,s);s.updateBest(S.phase,S.stage),t.transition(v.GAME_OVER),t.transition(v.RESULT),E.resultScreen.show(S)}const ie=document.createElement("div");ie.style.cssText=`
    position: absolute; inset: 0; display: none;
    align-items: center; justify-content: center;
    background: var(--t-bg-overlay-dark); color: var(--t-primary);
    font-size: 1.2rem; letter-spacing: 0.2em;
  `,ie.textContent="LOADING...",c.appendChild(ie);function ue(S){ie.style.display=S?"flex":"none"}A.on("skill:selected",()=>{H=Math.max(H,T.gameOverShields)}),i.start(),t.transition(v.TITLE),E.titleScreen.show(),console.log("YukiMedal initialized")}Xs().catch(console.error);
