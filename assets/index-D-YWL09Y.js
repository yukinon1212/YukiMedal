var os=Object.defineProperty;var rs=(c,e,s)=>e in c?os(c,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):c[e]=s;var l=(c,e,s)=>rs(c,typeof e!="symbol"?e+"":e,s);import{M as k,O as ls,B as Ve,F as Et,S as Me,U as Qe,V as ne,W as Ye,H as qe,N as cs,C as ds,a as Y,b as se,A as hs,c as Oe,R as ps,d as ms,e as us,L as fs,f as gs,g as ys,h as Qt,i as xs,j as bs,k as jt,l as A,m as N,n as vs,P as Ee,o as ws,p as Ts,q as Ss,r as Es,s as Ms,t as Zt,u as Cs,D as Xe,v as Mt,w as ze,x as Ke,y as Je,G as Ct,z as Is,E as ie,I as _s,J as ye,T as Ie,K as As,Q as Rs,X as Xt,Y as Ps,Z as It,_ as ks,$ as Ls,a0 as Le,a1 as gt,a2 as Ds,a3 as et,a4 as tt}from"./three-CzJWjZO5.js";import{O as $e}from"./rapier-DpxwuBBO.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))i(t);new MutationObserver(t=>{for(const a of t)if(a.type==="childList")for(const n of a.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function s(t){const a={};return t.integrity&&(a.integrity=t.integrity),t.referrerPolicy&&(a.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?a.credentials="include":t.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(t){if(t.ep)return;t.ep=!0;const a=s(t);fetch(t.href,a)}})();var M=(c=>(c.INIT="INIT",c.TITLE="TITLE",c.STAGE_START="STAGE_START",c.PLAYING="PLAYING",c.STAGE_CLEAR="STAGE_CLEAR",c.SKIP_PROMPT="SKIP_PROMPT",c.GAME_OVER="GAME_OVER",c.SHOP="SHOP",c.SKILL_SELECT="SKILL_SELECT",c.RESULT="RESULT",c))(M||{});class Hs{constructor(){l(this,"listeners",new Map)}on(e,s){this.listeners.has(e)||this.listeners.set(e,new Set);const i=this.listeners.get(e);return i.add(s),()=>i.delete(s)}once(e,s){const i=this.on(e,t=>{s(t),i()})}emit(e,s){const i=this.listeners.get(e);if(i)for(const t of i)t(s)}off(e,s){var i;(i=this.listeners.get(e))==null||i.delete(s)}clear(){this.listeners.clear()}}const L=new Hs,Os=[{from:M.INIT,to:M.TITLE},{from:M.TITLE,to:M.STAGE_START},{from:M.STAGE_START,to:M.PLAYING},{from:M.PLAYING,to:M.STAGE_CLEAR},{from:M.PLAYING,to:M.GAME_OVER},{from:M.STAGE_CLEAR,to:M.STAGE_START},{from:M.STAGE_CLEAR,to:M.SKIP_PROMPT},{from:M.STAGE_CLEAR,to:M.SHOP},{from:M.SKIP_PROMPT,to:M.SHOP},{from:M.SKIP_PROMPT,to:M.STAGE_START},{from:M.SHOP,to:M.SKILL_SELECT},{from:M.SKILL_SELECT,to:M.STAGE_START},{from:M.GAME_OVER,to:M.RESULT},{from:M.RESULT,to:M.TITLE}];class Bs{constructor(){l(this,"current",M.INIT)}get state(){return this.current}canTransition(e){return Os.some(s=>(Array.isArray(s.from)?s.from:[s.from]).includes(this.current)&&s.to===e)}transition(e){if(!this.canTransition(e))throw new Error(`Invalid state transition: ${this.current} → ${e}`);const s=this.current;this.current=e,L.emit("state:changed",{from:s,to:e})}is(e){return this.current===e}isAny(...e){return e.includes(this.current)}}class Gs{constructor(){l(this,"updateFns",[]);l(this,"rafId",null);l(this,"lastTime",0);l(this,"maxDelta",1/20)}addUpdateFn(e){this.updateFns.push(e)}removeUpdateFn(e){const s=this.updateFns.indexOf(e);s!==-1&&this.updateFns.splice(s,1)}start(){if(this.rafId!==null)return;this.lastTime=performance.now();const e=s=>{this.rafId=requestAnimationFrame(e);const i=(s-this.lastTime)/1e3;this.lastTime=s;const t=Math.min(i,this.maxDelta);for(const a of this.updateFns)a(t)};this.rafId=requestAnimationFrame(e)}stop(){this.rafId!==null&&(cancelAnimationFrame(this.rafId),this.rafId=null)}get isRunning(){return this.rafId!==null}}const _t="yukimedal_save",Ns="yukimedal_best",st={bestPhase:0,bestStage:0,totalRuns:0,lastPlayedAt:0};class zs{constructor(){l(this,"data");this.data=this.load()}load(){try{const e=localStorage.getItem(_t);return e?{...st,...JSON.parse(e)}:{...st}}catch{return{...st}}}save(){try{localStorage.setItem(_t,JSON.stringify(this.data))}catch{}}updateBest(e,s){const i=e*3+s,t=this.data.bestPhase*3+this.data.bestStage;i>t&&(this.data.bestPhase=e,this.data.bestStage=s,localStorage.setItem(Ns,JSON.stringify({phase:e,stage:s}))),this.data.lastPlayedAt=Date.now(),this.save()}incrementRuns(){this.data.totalRuns++,this.save()}get bestPhase(){return this.data.bestPhase}get bestStage(){return this.data.bestStage}get totalRuns(){return this.data.totalRuns}}const Kt={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}_e.BlurDirectionX=new ne(1,0);_e.BlurDirectionY=new ne(0,1);const js={name:"OutputShader",uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		...
		}`};class Zs extends Re{constructor(){super();const e=js;this.uniforms=Qe.clone(e.uniforms),this.material=new ps({name:e.name,uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader}),this.fsQuad=new yt(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,s,i){this.uniforms.tDiffuse.value=i.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},ms.getTransfer(this._outputColorSpace)===us&&(this.material.defines.SRGB_TRANSFER=""),this._toneMapping===fs?this.material.defines.LINEAR_TONE_MAPPING="":this._toneMapping===gs?this.material.defines.REINHARD_TONE_MAPPING="":this._toneMapping===ys?this.material.defines.CINEON_TONE_MAPPING="":this._toneMapping===Qt?this.material.defines.ACES_FILMIC_TONE_MAPPING="":this._toneMapping===xs?this.material.defines.AGX_TONE_MAPPING="":this._toneMapping===bs&&(this.material.defines.NEUTRAL_TONE_MAPPING=""),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this.fsQuad.render(e)):(e.setRenderTarget(s),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this.fsQuad.render(e))}dispose(){this.material.dispose(),this.fsQuad.dispose()}}class Xs extends jt{constructor(){super();const e=new A;e.deleteAttribute("uv");const s=new N({side:vs}),i=new N,t=new Ee(16777215,900,28,2);t.position.set(.418,16.199,.3),this.add(t);const a=new k(e,s);a.position.set(-.757,13.219,.717),a.scale.set(31.713,28.305,28.591),this.add(a);const n=new k(e,i);n.position.set(-10.906,2.009,1.846),n.rotation.set(0,-.195,0),n.scale.set(2.328,7.905,4.651),this.add(n);const o=new k(e,i);o.position.set(-5.607,-.754,-.758),o.rotation.set(0,.994,0),o.scale.set(1.97,1.534,3.955),this.add(o);const r=new k(e,i);r.position.set(6.167,.857,7.803),r.rotation.set(0,.561,0),r.scale.set(3.927,6.285,3.687),this.add(r);const d=new k(e,i);d.position.set(-2.017,.018,6.124),d.rotation.set(0,.333,0),d.scale.set(2.002,4.566,2.064),this.add(d);const p=new k(e,i);p.position.set(2.291,-.756,-2.621),p.rotation.set(0,-.286,0),p.scale.set(1.546,1.552,1.496),this.add(p);const u=new k(e,i);u.position.set(-2.193,-.369,-5.547),u.rotation.set(0,.516,0),u.scale.set(3.875,3.487,2.986),this.add(u);const f=new k(e,Se(50));f.position.set(-16.116,14.37,8.208),f.scale.set(.1,2.428,2.739),this.add(f);const h=new k(e,Se(50));h.position.set(-16.109,18.021,-8.207),h.scale.set(.1,2.425,2.751),this.add(h);const m=new k(e,Se(17));m.position.set(14.904,12.198,-1.832),m.scale.set(.15,4.265,6.331),this.add(m);const y=new k(e,Se(43));y.position.set(-.462,8.89,14.52),y.scale.set(4.38,5.441,.088),this.add(y);const x=new k(e,Se(20));x.position.set(3.235,11.486,-12.541),x.scale.set(2.5,2,.1),this.add(x);const v=new k(e,Se(100));v.position.set(0,20,0),v.scale.set(1,.1,1),this.add(v)}dispose(){const e=new Set;this.traverse(s=>{s.isMesh&&(e.add(s.geometry),e.add(s.material))});for(const s of e)s.dispose()}}function Se(c){const e=new Oe;return e.color.setScalar(c),e}function it(){return window.innerWidth<window.innerHeight?window.innerHeight:window.innerWidth}function at(){return window.innerWidth<window.innerHeight?window.innerWidth:window.innerHeight}class Ks{constructor(e){l(this,"scene");l(this,"renderer");l(this,"composer");l(this,"renderPass");l(this,"bloomPass");l(this,"onResize",()=>{const e=it(),s=at();this.renderer.setSize(e,s),this.composer.setSize(e,s)});this.scene=new jt,this.scene.background=new Y(1710638),this.scene.fog=new ws(1710638,20,60),this.renderer=new Ts({antialias:!0}),this.renderer.setSize(it(),at()),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=Ss,this.renderer.toneMapping=Qt,this.renderer.toneMappingExposure=1.05,this.renderer.outputColorSpace=Es,e.appendChild(this.renderer.domElement);const s=new Ms(this.renderer);s.compileEquirectangularShader();const i=s.fromScene(new Xs,.04).texture;this.scene.environment=i,s.dispose();const t=it(),a=at(),n=new Zt(60,t/a,.1,200);this.renderPass=new qs(this.scene,n),this.bloomPass=new _e(new ne(t,a),.88,.42,.72);const o=new Zs;this.composer=new Ys(this.renderer),this.composer.addPass(this.renderPass),this.composer.addPass(this.bloomPass),this.composer.addPass(o),window.addEventListener("resize",this.onResize)}setCamera(e){this.renderPass.camera=e}applySceneTheme(e){this.scene.background.set(e.background),this.scene.fog&&this.scene.fog.color.set(e.fogColor),this.bloomPass.strength=e.bloomStrength,this.bloomPass.threshold=e.bloomThreshold,this.bloomPass.radius=e.bloomRadius}render(e){this.renderPass.camera=e,this.composer.render()}add(...e){this.scene.add(...e)}remove(...e){this.scene.remove(...e)}dispose(){window.removeEventListener("resize",this.onResize),this.renderer.dispose()}}const g={INITIAL_MEDALS:120,INITIAL_SHOP_MONEY:0,MEDAL_BUY_PRICE:5,BASE_QUOTA:40,QUOTA_MULTIPLIER:1.2,STAGES_PER_PHASE:3,FIELD_WIDTH:8,FIELD_DEPTH:12,FIELD_HEIGHT:.1,PUSHER_WIDTH:8,PUSHER_DEPTH:7.2,PUSHER_HEIGHT:1.2,PUSHER_RANGE:3.5,PUSHER_PERIOD_MS:2e3,MEDAL_RADIUS:.5,MEDAL_RADIUS_LARGE:.75,MEDAL_RADIUS_TRIPLE:.55,MEDAL_THICKNESS:.05,MEDAL_MASS:1,MAX_MEDALS_ON_FIELD:200,INITIAL_FIELD_MEDALS:4,INITIAL_PUSHER_MEDALS:3,MEDAL_PROB_NORMAL:58,MEDAL_PROB_DOUBLE:78,MEDAL_PROB_TRIPLE:88,ITEMS_PER_STAGE:3,SKILL_CHOICES:3,GRAVITY:-9.81,CAMERA_FOV:45,CAMERA_NEAR:.1,CAMERA_FAR:100,JACKPOT_THRESHOLD:20,JACKPOT_MEDAL_REWARD:20,OPEN_ZONE_START:4,MEDAL_CLEANUP_Y:-8};function nt(){return window.innerWidth<window.innerHeight?window.innerHeight:window.innerWidth}function ot(){return window.innerWidth<window.innerHeight?window.innerWidth:window.innerHeight}class Js{constructor(){l(this,"camera");l(this,"target",new se(0,0,-1.5));l(this,"basePosition",new se(0,6,15));l(this,"shakeOffset",new se);l(this,"shakeIntensity",0);l(this,"shakeDecay",0);l(this,"titleMode",!1);l(this,"titleAngle",0);l(this,"idleTime",0);l(this,"onResize",()=>{this.camera.aspect=nt()/ot(),this.camera.updateProjectionMatrix(),this.updateCameraForAspect()});this.camera=new Zt(g.CAMERA_FOV,nt()/ot(),g.CAMERA_NEAR,g.CAMERA_FAR),this.setFrontView(),window.addEventListener("resize",this.onResize)}updateCameraForAspect(){nt()/ot()<1.3?(this.basePosition.set(0,8,13),this.target.set(0,0,-1.5)):(this.basePosition.set(0,6,15),this.target.set(0,0,-1.5)),this.titleMode||(this.camera.position.copy(this.basePosition),this.camera.lookAt(this.target))}setFrontView(){this.updateCameraForAspect()}setTitleMode(e){this.titleMode=e,e||this.setFrontView()}shake(e,s){this.shakeIntensity=e,this.shakeDecay=s>0?-Math.log(.01)/s:0}update(e){if(this.titleMode){this.titleAngle+=e*.18;const t=Math.sin(this.titleAngle)*3,a=6.5+Math.sin(this.titleAngle*.55)*1,n=14.5+Math.cos(this.titleAngle*.7)*1.5;this.camera.position.set(t,a,n),this.camera.lookAt(t*.2,1.5,-2);return}this.idleTime+=e;const s=Math.sin(this.idleTime*.22)*.055,i=Math.sin(this.idleTime*.31)*.038;this.shakeIntensity>.001?(this.shakeOffset.set((Math.random()*2-1)*this.shakeIntensity+s,(Math.random()*2-1)*this.shakeIntensity+i,0),this.camera.position.copy(this.basePosition).add(this.shakeOffset),this.shakeIntensity*=Math.exp(-this.shakeDecay*e)):(this.shakeIntensity=0,this.camera.position.copy(this.basePosition),this.camera.position.x+=s,this.camera.position.y+=i),this.camera.lookAt(this.target)}lookAt(e){this.target.copy(e),this.camera.lookAt(this.target)}dispose(){window.removeEventListener("resize",this.onResize)}}class ei{constructor(e){l(this,"ambient");l(this,"dirLight");l(this,"fillLight");l(this,"warmPoint");l(this,"coolPoint");l(this,"sideLeft");l(this,"sideRight");l(this,"fieldSpot");l(this,"backSpot");l(this,"graze");l(this,"scanLight");l(this,"feverActive",!1);this.ambient=new Cs(4210784,.55),this.dirLight=new Xe(16775408,1.4),this.dirLight.position.set(6,14,8),this.dirLight.castShadow=!0,this.dirLight.shadow.mapSize.width=2048,this.dirLight.shadow.mapSize.height=2048,this.dirLight.shadow.camera.near=.1,this.dirLight.shadow.camera.far=55,this.dirLight.shadow.camera.left=-14,this.dirLight.shadow.camera.right=14,this.dirLight.shadow.camera.top=14,this.dirLight.shadow.camera.bottom=-14,this.dirLight.shadow.bias=-4e-4,this.fillLight=new Xe(5267711,.28),this.fillLight.position.set(-6,4,6),this.warmPoint=new Ee(16760928,1,18),this.warmPoint.position.set(0,7,5),this.coolPoint=new Ee(3364351,.65,22),this.coolPoint.position.set(0,5,-9),this.sideLeft=new Ee(16771280,.55,24),this.sideLeft.position.set(-10,5,2),this.sideRight=new Ee(16771280,.55,24),this.sideRight.position.set(10,5,2),this.fieldSpot=new Mt(16774376,1.6,32,Math.PI/4.5,.35,1.2),this.fieldSpot.position.set(0,11,2),this.fieldSpot.target.position.set(0,0,-.5),this.fieldSpot.castShadow=!1,this.backSpot=new Mt(8952319,.8,22,Math.PI/6,.45,1.6),this.backSpot.position.set(0,10,-11),this.backSpot.target.position.set(0,1,0),this.backSpot.castShadow=!1,this.graze=new Xe(16767136,.55),this.graze.position.set(14,2,4),this.scanLight=new Ee(16775912,1.3,12),this.scanLight.position.set(0,8,-1),e.add(this.ambient,this.dirLight,this.fillLight,this.warmPoint,this.coolPoint,this.sideLeft,this.sideRight,this.fieldSpot,this.fieldSpot.target,this.backSpot,this.backSpot.target,this.graze,this.scanLight)}update(e){this.scanLight.position.x=Math.sin(e*.57)*4.8,this.scanLight.position.z=Math.cos(e*.38)*1.5-3,this.scanLight.intensity=(this.feverActive?2.2:1.3)+Math.sin(e*1.1)*(this.feverActive?.35:.18)}applyTheme(e){this.ambient.color.set(e.ambientColor),this.ambient.intensity=e.ambientIntensity,this.fillLight.color.set(e.fillColor),this.fillLight.intensity=e.fillIntensity,this.warmPoint.color.set(e.warmPointColor),this.warmPoint.intensity=e.warmPointIntensity,this.coolPoint.color.set(e.coolPointColor),this.coolPoint.intensity=e.coolPointIntensity}setFeverMode(e){this.feverActive=e,this.fieldSpot.intensity=e?2.2:1.6,this.fieldSpot.color.set(e?16772710:16774376),this.scanLight.color.set(e?16763972:16775912)}}class ti{constructor(e){l(this,"stars");l(this,"starMat");l(this,"brightStars");l(this,"brightStarMat");l(this,"grid");l(this,"scene");l(this,"dustMotes");l(this,"dustPos");l(this,"_t",0);this.scene=e;const s=2800,i=new Float32Array(s*3),t=65;for(let m=0;m<s;m++){const y=Math.random()*Math.PI*2,x=Math.acos(2*Math.random()-1),v=(.3+Math.random()*.7)*t;i[m*3]=v*Math.sin(x)*Math.cos(y),i[m*3+1]=v*Math.sin(x)*Math.sin(y),i[m*3+2]=v*Math.cos(x)}const a=new Ve;a.setAttribute("position",new ze(i,3)),this.starMat=new Ke({size:.13,color:8952319,transparent:!0,opacity:.88,sizeAttenuation:!0}),this.stars=new Je(a,this.starMat),e.add(this.stars);const n=200,o=new Float32Array(n*3),r=new Float32Array(n*3),d=[new Y(16765088),new Y(10070783),new Y(16769152),new Y(16756991),new Y(8454143)];for(let m=0;m<n;m++){const y=Math.random()*Math.PI*2,x=Math.acos(2*Math.random()-1),v=(.5+Math.random()*.45)*t;o[m*3]=v*Math.sin(x)*Math.cos(y),o[m*3+1]=v*Math.sin(x)*Math.sin(y),o[m*3+2]=v*Math.cos(x);const E=d[Math.floor(Math.random()*d.length)];r[m*3]=E.r,r[m*3+1]=E.g,r[m*3+2]=E.b}const p=new Ve;p.setAttribute("position",new ze(o,3)),p.setAttribute("color",new ze(r,3)),this.brightStarMat=new Ke({size:.4,vertexColors:!0,transparent:!0,opacity:.95,sizeAttenuation:!0}),this.brightStars=new Je(p,this.brightStarMat),e.add(this.brightStars),this.grid=new Ct(80,40,1714782,924218),this.grid.position.y=-.56,e.add(this.grid);const u=160;this.dustPos=new Float32Array(u*3);for(let m=0;m<u;m++)this.dustPos[m*3]=(Math.random()-.5)*12,this.dustPos[m*3+1]=Math.random()*7,this.dustPos[m*3+2]=(Math.random()-.5)*14;const f=new Ve;f.setAttribute("position",new ze(this.dustPos,3));const h=new Ke({size:.045,color:16765088,transparent:!0,opacity:.32,sizeAttenuation:!0,depthWrite:!1});this.dustMotes=new Je(f,h),e.add(this.dustMotes)}applyTheme(e){this.starMat.color.set(e.starColor),this.scene.remove(this.grid),this.grid.geometry.dispose(),this.grid.material.dispose(),this.grid=new Ct(80,40,e.gridColorA,e.gridColorB),this.grid.position.y=-.56,this.scene.add(this.grid)}update(e){this._t+=e,this.stars.rotation.y+=.008*e,this.brightStars.rotation.y-=.003*e,this.brightStars.rotation.x+=.001*e,this.starMat.opacity=.8+Math.sin(this._t*.45)*.08,this.brightStarMat.opacity=.88+Math.sin(this._t*.62+1.1)*.07;const s=this.dustPos.length/3;for(let i=0;i<s;i++)this.dustPos[i*3]+=Math.sin(i*2.3+this.dustPos[i*3+1]*.7)*6e-4*e,this.dustPos[i*3+1]+=(.006+i%7*5e-4)*e,this.dustPos[i*3+1]>7.5&&(this.dustPos[i*3]=(Math.random()-.5)*12,this.dustPos[i*3+1]=-.2,this.dustPos[i*3+2]=(Math.random()-.5)*14);this.dustMotes.geometry.attributes.position.needsUpdate=!0}}class si{constructor(){l(this,"world");l(this,"_initialized",!1)}async init(){await $e.init(),this.world=new $e.World({x:0,y:g.GRAVITY,z:0});const e=this.world.integrationParameters;e.numSolverIterations=16,e.numAdditionalFrictionIterations=8,e.numInternalPgsIterations=2,e.maxCcdSubsteps=8,this._initialized=!0}get rapier(){return $e}get instance(){if(!this._initialized)throw new Error("PhysicsWorld not initialized");return this.world}get initialized(){return this._initialized}step(){this.world.step()}createRigidBody(e){return this.world.createRigidBody(e)}createCollider(e,s){return this.world.createCollider(e,s)}removeRigidBody(e){this.world.removeRigidBody(e)}getEventQueue(){return new $e.EventQueue(!0)}stepWithEvents(e){this.world.step(e)}forEachActiveRigidBody(e){this.world.forEachActiveRigidBody(e)}setTimestep(e){this._initialized&&(this.world.integrationParameters.dt=e)}dispose(){this._initialized&&(this.world.free(),this._initialized=!1)}}class ii{constructor(){l(this,"bodyToMesh",new Map)}register(e,s){this.bodyToMesh.set(e.handle,s)}unregister(e){this.bodyToMesh.delete(e.handle)}sync(e){e.forEachActiveRigidBody(s=>{const i=this.bodyToMesh.get(s.handle);if(!i)return;const t=s.translation(),a=s.rotation(),n=i.userData.physicsYOffset??0;i.position.set(t.x,t.y+n,t.z),i.quaternion.set(a.x,a.y,a.z,a.w)})}clear(){this.bodyToMesh.clear()}get count(){return this.bodyToMesh.size}}class ai{constructor(){l(this,"handles",new Map);l(this,"dropZoneHandles",new Set);l(this,"eventQueue");l(this,"medalCollectedCallback");l(this,"itemCollectedCallback")}init(e){this.eventQueue=e.getEventQueue()}registerHandle(e,s){this.handles.set(e,s),s==="drop_zone"&&this.dropZoneHandles.add(e)}unregisterHandle(e){this.handles.delete(e),this.dropZoneHandles.delete(e)}onMedalCollected(e){this.medalCollectedCallback=e}onItemCollected(e){this.itemCollectedCallback=e}processEvents(e,s=1){for(let i=0;i<s;i++)e.stepWithEvents(this.eventQueue);this.eventQueue.drainCollisionEvents((i,t,a)=>{var d,p;if(!a)return;const n=this.handles.get(i),o=this.handles.get(t);if(n==="drop_zone"&&(o==="medal"||o==="item")||o==="drop_zone"&&(n==="medal"||n==="item")){const u=n==="drop_zone"?t:i,f=n==="drop_zone"?o:n;f==="medal"?(d=this.medalCollectedCallback)==null||d.call(this,u):f==="item"&&((p=this.itemCollectedCallback)==null||p.call(this,u))}})}getTag(e){return this.handles.get(e)}clear(){this.handles.clear(),this.dropZoneHandles.clear(),this.medalCollectedCallback=void 0,this.itemCollectedCallback=void 0}}class ni{constructor(){l(this,"body");l(this,"time",0);l(this,"zBase");l(this,"initialized",!1);l(this,"speedMultiplier",1);this.zBase=-12/2+g.PUSHER_DEPTH/2-g.PUSHER_RANGE}async initPhysics(e){const s=e.rapier,i=s.RigidBodyDesc.kinematicVelocityBased().setTranslation(0,g.PUSHER_HEIGHT/2,this.zBase);this.body=e.createRigidBody(i);const t=s.ColliderDesc.cuboid(g.PUSHER_WIDTH/2,g.PUSHER_HEIGHT/2,g.PUSHER_DEPTH/2).setFriction(1.2);e.createCollider(t,this.body),this.initialized=!0}update(e){this.time+=e*this.speedMultiplier;const s=g.PUSHER_PERIOD_MS/1e3,i=this.time%s/s,t=(1-Math.cos(i*Math.PI*2))/2*g.PUSHER_RANGE;if(this.initialized){const a=Math.PI*g.PUSHER_RANGE/s*Math.sin(i*Math.PI*2);this.body.setLinvel({x:0,y:0,z:a},!0),i<e/s&&this.body.setTranslation({x:0,y:g.PUSHER_HEIGHT/2,z:this.zBase},!0)}return t}get currentZOffset(){const e=g.PUSHER_PERIOD_MS/1e3,s=this.time%e/e;return(1-Math.cos(s*Math.PI*2))/2*g.PUSHER_RANGE}get restZ(){return this.zBase}}function Fe(c){return[c>>16&255,c>>8&255,c&255]}function rt(c){const e=c.replace("#","");return[parseInt(e.slice(0,2),16),parseInt(e.slice(2,4),16),parseInt(e.slice(4,6),16)]}function K(c,e,s,i){return`rgb(${Math.min(255,c+i)},${Math.min(255,e+i)},${Math.min(255,s+i)})`}function De(c,e,s,i){return`rgb(${Math.max(0,c-i)},${Math.max(0,e-i)},${Math.max(0,s-i)})`}function Rt(c,e,s){return`rgb(${c},${e},${s})`}function ce(c,e,s,i,t){return`rgba(${Math.min(255,c+i)},${Math.min(255,e+i)},${Math.min(255,s+i)},${t})`}const Ce=class Ce{static get(e,s){if(!this.cache.has(e)){const i=s(),t=new Is(i);this.cache.set(e,t)}return this.cache.get(e)}static getMedalTexture(e){return this.get(`medal_${e.toString(16)}`,()=>{const i=document.createElement("canvas");i.width=i.height=256;const t=i.getContext("2d"),a=256/2,n=256/2,o=256/2-2,[r,d,p]=Fe(e),u=Rt(r,d,p),f=K(r,d,p,75),h=K(r,d,p,38),m=De(r,d,p,60),y=De(r,d,p,90),x=t.createRadialGradient(a-32,n-32,4,a,n,o);x.addColorStop(0,f),x.addColorStop(.25,K(r,d,p,55)),x.addColorStop(.55,h),x.addColorStop(.8,u),x.addColorStop(1,m),t.fillStyle=x,t.beginPath(),t.arc(a,n,o,0,Math.PI*2),t.fill(),t.save(),t.globalCompositeOperation="source-over";const v=480;for(let I=0;I<v;I++){const _=I/v*Math.PI*2,z=.012+Math.random()*.028,F=Math.random()>.5;t.strokeStyle=F?`rgba(${Math.min(255,r+45)},${Math.min(255,d+40)},${Math.min(255,p+35)},${z})`:`rgba(${Math.max(0,r-20)},${Math.max(0,d-18)},${Math.max(0,p-15)},${z*.7})`,t.lineWidth=.5+Math.random()*.6,t.beginPath(),t.moveTo(a+Math.cos(_)*16,n+Math.sin(_)*16),t.lineTo(a+Math.cos(_)*(o-20),n+Math.sin(_)*(o-20)),t.stroke()}t.restore();for(let I=0;I<4;I++){const _=o-6-I*8;t.strokeStyle=De(r,d,p,35+I*10),t.lineWidth=2,t.beginPath(),t.arc(a,n,_,0,Math.PI*2),t.stroke(),t.strokeStyle=K(r,d,p,22+I*6),t.lineWidth=.9,t.beginPath(),t.arc(a,n,_+2.5,0,Math.PI*2),t.stroke()}t.strokeStyle=y,t.lineWidth=8,t.beginPath(),t.arc(a,n,o-5,0,Math.PI*2),t.stroke(),t.save(),t.strokeStyle=K(r,d,p,60),t.globalAlpha=.55,t.lineWidth=3,t.beginPath(),t.arc(a,n,o-3,Math.PI*.9,Math.PI*1.8),t.stroke(),t.restore();const E=68,C=t.createRadialGradient(a-10,n-10,0,a,n,E);C.addColorStop(0,K(r,d,p,65)),C.addColorStop(.4,K(r,d,p,30)),C.addColorStop(.75,h),C.addColorStop(.92,u),C.addColorStop(1,m),t.fillStyle=C,t.beginPath(),t.arc(a,n,E,0,Math.PI*2),t.fill(),t.strokeStyle=De(r,d,p,50),t.lineWidth=2.5,t.beginPath(),t.arc(a,n,E+.5,0,Math.PI*2),t.stroke(),t.strokeStyle=K(r,d,p,48),t.lineWidth=1.2,t.beginPath(),t.arc(a,n,E-2.5,0,Math.PI*2),t.stroke(),t.lineCap="round";for(let I=0;I<24;I++){const _=I*Math.PI/12,z=I%2===0,F=z?16:22,$=z?56:48,W=z?.28:.18;t.strokeStyle=`rgba(${Math.min(255,r+50)},${Math.min(255,d+45)},${Math.min(255,p+38)},${W})`,t.lineWidth=z?2.5:1.5,t.beginPath(),t.moveTo(a+Math.cos(_)*F,n+Math.sin(_)*F),t.lineTo(a+Math.cos(_)*$,n+Math.sin(_)*$),t.stroke()}const w=e===13691135;if(w||e===16719968){const I=w?"×2":"×3",_=22,z=t.createRadialGradient(a-5,n-5,0,a,n,_);z.addColorStop(0,K(r,d,p,100)),z.addColorStop(.6,h),z.addColorStop(1,m),t.fillStyle=z,t.beginPath(),t.arc(a,n,_,0,Math.PI*2),t.fill(),t.strokeStyle=y,t.lineWidth=2,t.beginPath(),t.arc(a,n,_,0,Math.PI*2),t.stroke(),t.font="bold 26px sans-serif",t.textAlign="center",t.textBaseline="middle",t.fillStyle="rgba(255,255,255,0.96)",t.shadowColor="rgba(0,0,0,0.85)",t.shadowBlur=6,t.fillText(I,a,n+1),t.shadowBlur=0,t.textAlign="left"}else{const F=Math.PI/5,$=t.createRadialGradient(a-4,n-4,0,a,n,13);$.addColorStop(0,f),$.addColorStop(.5,h),$.addColorStop(1,m),t.fillStyle=$,t.beginPath();for(let W=0;W<10;W++){const j=W%2===0?13:5.5,te=W*F-Math.PI/2;W===0?t.moveTo(a+j*Math.cos(te),n+j*Math.sin(te)):t.lineTo(a+j*Math.cos(te),n+j*Math.sin(te))}t.closePath(),t.fill(),t.strokeStyle=y,t.lineWidth=1.5,t.stroke()}const b=t.createRadialGradient(a-48,n-48,0,a-48,n-48,95);b.addColorStop(0,"rgba(255,255,255,0.72)"),b.addColorStop(.2,"rgba(255,255,255,0.32)"),b.addColorStop(.5,"rgba(255,255,255,0.08)"),b.addColorStop(1,"rgba(255,255,255,0)"),t.fillStyle=b,t.beginPath(),t.arc(a,n,o-2,0,Math.PI*2),t.fill();const H=t.createRadialGradient(a+52,n+50,0,a+52,n+50,60);H.addColorStop(0,"rgba(255,255,255,0.22)"),H.addColorStop(.4,"rgba(255,255,255,0.06)"),H.addColorStop(1,"rgba(255,255,255,0)"),t.fillStyle=H,t.beginPath(),t.arc(a,n,o-2,0,Math.PI*2),t.fill();const D=t.getImageData(0,0,256,256),P=D.data;for(let I=0;I<P.length;I+=4){const _=(Math.random()-.5)*10;P[I]=Math.max(0,Math.min(255,P[I]+_)),P[I+1]=Math.max(0,Math.min(255,P[I+1]+_)),P[I+2]=Math.max(0,Math.min(255,P[I+2]+_))}return t.putImageData(D,0,0),i})}static getFieldTexture(e="#2a2a4e"){return this.get(`field_${e}`,()=>{const i=document.createElement("canvas");i.width=i.height=512;const t=i.getContext("2d"),[a,n,o]=rt(e),r=a>o+20;if(t.fillStyle=e,t.fillRect(0,0,512,512),r){const d=t.getImageData(0,0,512,512),p=d.data;for(let h=0;h<p.length;h+=4){const m=(Math.random()-.5)*22;p[h]=Math.max(0,Math.min(255,a+m)),p[h+1]=Math.max(0,Math.min(255,n+m)),p[h+2]=Math.max(0,Math.min(255,o+m)),p[h+3]=255}t.putImageData(d,0,0);for(let h=0;h<512;h+=3){const m=.07+Math.random()*.06,y=Math.random()>.5;t.strokeStyle=y?`rgba(${Math.min(255,a+18)},${Math.min(255,n+14)},${Math.min(255,o+10)},${m})`:`rgba(${Math.max(0,a-14)},${Math.max(0,n-10)},${Math.max(0,o-8)},${m})`,t.lineWidth=1+Math.random()*1.5,t.beginPath(),t.moveTo(0,h+.5),t.lineTo(512,h+.5),t.stroke()}t.save(),t.globalAlpha=.1;const u=36;t.strokeStyle=K(a,n,o,50),t.lineWidth=.8,t.translate(512/2,512/2),t.rotate(Math.PI/4),t.translate(-512/2,-512/2);for(let h=-512;h<=512*2;h+=u)t.beginPath(),t.moveTo(h,-512),t.lineTo(h,512*2),t.stroke();for(let h=-512;h<=512*2;h+=u)t.beginPath(),t.moveTo(-512,h),t.lineTo(512*2,h),t.stroke();t.restore();const f=t.createRadialGradient(512/2,512/2,512*.25,512/2,512/2,512*.75);f.addColorStop(0,"rgba(0,0,0,0)"),f.addColorStop(1,"rgba(0,0,0,0.28)"),t.fillStyle=f,t.fillRect(0,0,512,512)}else{const d=t.getImageData(0,0,512,512),p=d.data;for(let h=0;h<p.length;h+=4){const m=(Math.random()-.5)*18;p[h]=Math.max(0,Math.min(255,a+m)),p[h+1]=Math.max(0,Math.min(255,n+m)),p[h+2]=Math.max(0,Math.min(255,o+m)),p[h+3]=255}t.putImageData(d,0,0),t.save(),t.globalAlpha=.14;const u=40;t.strokeStyle=K(a,n,o,60),t.lineWidth=.8,t.translate(512/2,512/2),t.rotate(Math.PI/4),t.translate(-512/2,-512/2);for(let h=-512;h<=512*2;h+=u)t.beginPath(),t.moveTo(h,-512),t.lineTo(h,512*2),t.stroke();for(let h=-512;h<=512*2;h+=u)t.beginPath(),t.moveTo(-512,h),t.lineTo(512*2,h),t.stroke();t.restore(),t.save(),t.globalAlpha=.25,t.fillStyle=K(a,n,o,80),t.translate(512/2,512/2),t.rotate(Math.PI/4),t.translate(-512/2,-512/2);for(let h=0;h<=512*2;h+=u)for(let m=0;m<=512*2;m+=u)t.beginPath(),t.arc(h-512/2,m-512/2,1.8,0,Math.PI*2),t.fill();t.restore();for(let h=0;h<512;h+=4){const m=.04+Math.random()*.04,y=Math.random()>.5;t.strokeStyle=y?`rgba(${Math.min(255,a+20)},${Math.min(255,n+16)},${Math.min(255,o+14)},${m})`:`rgba(${Math.max(0,a-10)},${Math.max(0,n-8)},${Math.max(0,o-8)},${m})`,t.lineWidth=1+Math.random()*1.2,t.beginPath(),t.moveTo(0,h+.5),t.lineTo(512,h+.5),t.stroke()}const f=t.createRadialGradient(512/2,512/2,512*.2,512/2,512/2,512*.72);f.addColorStop(0,"rgba(0,0,0,0)"),f.addColorStop(1,"rgba(0,0,0,0.30)"),t.fillStyle=f,t.fillRect(0,0,512,512)}return i})}static getPusherTexture(e="#3a3a6e"){return this.get(`pusher_${e}`,()=>{const t=document.createElement("canvas");t.width=256,t.height=128;const a=t.getContext("2d"),[n,o,r]=rt(e),d=n>r+20;if(a.fillStyle=e,a.fillRect(0,0,256,128),d){a.strokeStyle=ce(n,o,r,90,.38),a.lineWidth=.8;const f=14;for(let h=-128;h<384;h+=f)a.beginPath(),a.moveTo(h,0),a.lineTo(h+128,128),a.stroke();for(let h=0;h<512;h+=f)a.beginPath(),a.moveTo(h,0),a.lineTo(h-128,128),a.stroke();a.fillStyle=K(n,o,r,90);for(let h=0;h<2;h++){const m=10+h*108;for(let y=20;y<256;y+=36)a.fillStyle=K(n,o,r,80),a.beginPath(),a.arc(y,m,4.5,0,Math.PI*2),a.fill(),a.fillStyle=ce(n,o,r,150,.7),a.beginPath(),a.arc(y-1,m-1,2,0,Math.PI*2),a.fill(),a.fillStyle="rgba(0,0,0,0.45)",a.beginPath(),a.arc(y+1,m+1,3,.5,Math.PI*2),a.fill()}}else{for(let f=0;f<128;f++){const h=.015+Math.random()*.055;a.strokeStyle=ce(n,o,r,100,h),a.lineWidth=1,a.beginPath(),a.moveTo(0,f+.5),a.lineTo(256,f+.5),a.stroke()}a.fillStyle=ce(n,o,r,120,.35);for(let f=24;f<256;f+=48)a.beginPath(),a.arc(f,8,3,0,Math.PI*2),a.fill()}const p=a.createLinearGradient(0,0,0,18);p.addColorStop(0,ce(n,o,r,150,.6)),p.addColorStop(1,ce(n,o,r,150,0)),a.fillStyle=p,a.fillRect(0,0,256,18);const u=a.createLinearGradient(0,114,0,128);return u.addColorStop(0,"rgba(0,0,0,0)"),u.addColorStop(1,"rgba(0,0,0,0.55)"),a.fillStyle=u,a.fillRect(0,114,256,14),t})}static getWallTexture(e="#1a1a3e"){return this.get(`wall_${e}`,()=>{const i=document.createElement("canvas");i.width=i.height=256;const t=i.getContext("2d"),[a,n,o]=rt(e),r=a>o+20;if(t.fillStyle=e,t.fillRect(0,0,256,256),r)for(let f=0;f<256;f+=40){const h=t.createLinearGradient(0,f,0,f+40);h.addColorStop(0,K(a,n,o,18)),h.addColorStop(.5,Rt(a,n,o)),h.addColorStop(1,De(a,n,o,12)),t.fillStyle=h,t.fillRect(0,f,256,40),t.strokeStyle="rgba(0,0,0,0.55)",t.lineWidth=2,t.beginPath(),t.moveTo(0,f+40-1),t.lineTo(256,f+40-1),t.stroke(),t.strokeStyle=ce(a,n,o,70,.45),t.lineWidth=1,t.beginPath(),t.moveTo(0,f+1),t.lineTo(256,f+1),t.stroke();for(let m=24;m<256;m+=48){const y=f+40-7;t.fillStyle=K(a,n,o,55),t.beginPath(),t.arc(m,y,4,0,Math.PI*2),t.fill(),t.fillStyle=ce(a,n,o,130,.6),t.beginPath(),t.arc(m-1,y-1,1.5,0,Math.PI*2),t.fill(),t.fillStyle="rgba(0,0,0,0.5)",t.beginPath(),t.arc(m+1,y+1,2.5,.4,Math.PI*2),t.fill()}}else{for(let m=0;m<256;m+=64){const y=t.createLinearGradient(m,0,m+64,0);y.addColorStop(0,"rgba(0,0,0,0.22)"),y.addColorStop(.12,"rgba(0,0,0,0)"),y.addColorStop(.88,"rgba(0,0,0,0)"),y.addColorStop(1,"rgba(0,0,0,0.22)"),t.fillStyle=y,t.fillRect(m,0,64,256),t.strokeStyle="rgba(0,0,0,0.55)",t.lineWidth=2,t.beginPath(),t.moveTo(m,0),t.lineTo(m,256),t.stroke(),t.strokeStyle=ce(a,n,o,72,.28),t.lineWidth=.9,t.beginPath(),t.moveTo(m+2.5,0),t.lineTo(m+2.5,256),t.stroke()}const f=56;for(let m=0;m<256;m+=f){t.strokeStyle="rgba(0,0,0,0.50)",t.lineWidth=2,t.beginPath(),t.moveTo(0,m),t.lineTo(256,m),t.stroke(),t.strokeStyle=ce(a,n,o,62,.22),t.lineWidth=.9,t.beginPath(),t.moveTo(0,m+2.5),t.lineTo(256,m+2.5),t.stroke(),t.save(),t.globalAlpha=.6;for(let y=0;y<256;y+=64)t.fillStyle=K(a,n,o,85),t.beginPath(),t.arc(y,m,2.2,0,Math.PI*2),t.fill(),t.fillStyle="rgba(0,0,0,0.45)",t.beginPath(),t.arc(y+.6,m+.6,1.1,0,Math.PI*2),t.fill();t.restore()}t.save(),t.globalAlpha=.04,t.strokeStyle=K(a,n,o,55),t.lineWidth=.6;for(let m=-256;m<256*2;m+=10)t.beginPath(),t.moveTo(m,0),t.lineTo(m+256*.5,256),t.stroke();t.restore();const h=t.createRadialGradient(256/2,256/2,256*.2,256/2,256/2,256*.72);h.addColorStop(0,"rgba(0,0,0,0)"),h.addColorStop(1,"rgba(0,0,0,0.32)"),t.fillStyle=h,t.fillRect(0,0,256,256)}const d=t.getImageData(0,0,256,256),p=d.data;for(let u=0;u<p.length;u+=4){const f=(Math.random()-.5)*(r?8:10);p[u]=Math.max(0,Math.min(255,p[u]+f)),p[u+1]=Math.max(0,Math.min(255,p[u+1]+f)),p[u+2]=Math.max(0,Math.min(255,p[u+2]+f))}return t.putImageData(d,0,0),i})}static getScreenTexture(e,s){return this.get(`screen_${e.toString(16)}_${s.toString(16)}`,()=>{const a=document.createElement("canvas");a.width=512,a.height=256;const n=a.getContext("2d"),[o,r,d]=Fe(s),p=n.createRadialGradient(512/2,256*.7,0,512/2,256*.7,512*.65);p.addColorStop(0,`rgb(${Math.min(o+28,60)},${Math.min(r+20,52)},${Math.min(d+28,68)})`),p.addColorStop(1,`rgb(${Math.max(o-4,0)},${Math.max(r-4,0)},${Math.max(d-4,0)})`),n.fillStyle=p,n.fillRect(0,0,512,256);const[u,f,h]=Fe(e),m=`rgb(${u},${f},${h})`,y=`rgba(${u},${f},${h},0.60)`,x=`rgba(${u},${f},${h},0.25)`;n.strokeStyle=y,n.lineWidth=1.5,n.strokeRect(10,10,492,236),n.strokeStyle=x,n.lineWidth=.8,n.strokeRect(16,16,480,224);const v=["♠","♥","♦","♣"],E=[[32,38],[480,38],[32,234],[480,234]];n.textAlign="center",n.textBaseline="middle",n.font="bold 20px serif";for(let D=0;D<4;D++)n.fillStyle=x,n.fillText(v[D],E[D][0],E[D][1]);n.strokeStyle=x,n.lineWidth=1.5;for(const[D,P]of[[22,22],[490,22],[22,234],[490,234]])n.beginPath(),n.moveTo(D-7,P),n.lineTo(D+7,P),n.moveTo(D,P-7),n.lineTo(D,P+7),n.stroke();n.textAlign="center",n.textBaseline="top",n.font="bold 12px monospace",n.fillStyle=x,n.fillText("✦  INSERT COIN  ✦",512/2,22),n.strokeStyle=x,n.lineWidth=1,n.beginPath(),n.moveTo(20,52),n.lineTo(492,52),n.stroke(),n.textAlign="left",n.textBaseline="top",n.font="bold 11px monospace",n.fillStyle=x,n.fillText("JACKPOT",32,64),n.fillText("HIGH SCORE",512/2+20,64),n.font="bold 22px monospace",n.fillStyle=y,n.fillText("000000",32,80),n.fillText("999999",512/2+20,80),n.strokeStyle=y,n.lineWidth=1,n.beginPath(),n.moveTo(20,116),n.lineTo(492,116),n.stroke(),n.textAlign="center",n.textBaseline="alphabetic",n.font="bold 52px monospace",n.shadowColor=m,n.shadowBlur=26,n.fillStyle=m,n.fillText("YUKIMEDAL",512/2,206),n.shadowBlur=0,n.font="14px monospace",n.fillStyle=y,n.fillText("ROGUELIKE  MEDAL  PUSHER",512/2,234);const[C,w,T]=Fe(s),b=`rgb(${Math.max(C-4,0)},${Math.max(w-4,0)},${Math.max(T-4,0)})`,H=n;return Promise.resolve().then(()=>{const D=`screen_${e.toString(16)}_${s.toString(16)}`,P=Ce.cache.get(D);P&&(Ce._screen={ctx:H,tex:P,nr:u,ng:f,nb:h,clearRgb:b,W:512,H:256})}),a})}static refreshJackpot(e){const s=this._screen;if(!s)return;const{ctx:i,tex:t,nr:a,ng:n,nb:o,clearRgb:r,W:d}=s,p=`rgba(${a},${n},${o},0.60)`,u=`rgba(${a},${n},${o},0.25)`;i.fillStyle=r,i.fillRect(28,62,220,40),i.textAlign="left",i.textBaseline="top",i.font="bold 11px monospace",i.fillStyle=u,i.fillText("JACKPOT",32,64),i.font="bold 22px monospace",i.fillStyle=p,i.fillText(Math.min(e,999999).toString().padStart(6,"0"),32,80),t.needsUpdate=!0}static disposeAll(){this.cache.forEach(e=>e.dispose()),this.cache.clear()}};l(Ce,"cache",new Map),l(Ce,"_screen",null);let oe=Ce;const oi=new ie(g.MEDAL_RADIUS,g.MEDAL_RADIUS,g.MEDAL_THICKNESS,48),ri=new ie(g.MEDAL_RADIUS_LARGE,g.MEDAL_RADIUS_LARGE,g.MEDAL_THICKNESS,48),li=new ie(g.MEDAL_RADIUS_TRIPLE,g.MEDAL_RADIUS_TRIPLE,g.MEDAL_THICKNESS*1.3,48),ci={normal:16766720,double:13691135,large:15245312,triple:16719968},di={normal:1,double:2,large:1,triple:3};function hi(c){const e=c*100;return e<g.MEDAL_PROB_NORMAL?"normal":e<g.MEDAL_PROB_DOUBLE?"double":e<g.MEDAL_PROB_TRIPLE?"triple":"large"}function pi(c){return c==="large"?ri:c==="triple"?li:oi}function Pt(c){c.traverse(e=>{if(e instanceof k){e.geometry.dispose();const s=e.material;Array.isArray(s)?s.forEach(i=>i.dispose()):s.dispose()}})}function mi(c){return[c>>16&255,c>>8&255,c&255]}function lt(c){return Math.max(0,Math.min(255,c))}function xt(c,e){const[s,i,t]=mi(c);return lt(s+e)<<16|lt(i+e)<<8|lt(t+e)}function ui(c,e,s){const i=c*.27,t=c*.118,a=5,n=Math.max(e*.55,.012),o=i*.1,r=new As;for(let f=0;f<a*2;f++){const h=f%2===0?i:t,m=f*Math.PI/a-Math.PI/2;f===0?r.moveTo(h*Math.cos(m),h*Math.sin(m)):r.lineTo(h*Math.cos(m),h*Math.sin(m))}r.closePath();const d=new Rs(r,{depth:n,bevelEnabled:!0,bevelSize:o,bevelThickness:n*.5,bevelSegments:3});d.rotateX(-Math.PI/2);const p=new ye({color:xt(s,48),metalness:.98,roughness:.06,clearcoat:.9,clearcoatRoughness:.02,envMapIntensity:1.8}),u=new k(d,p);return u.position.y=e/2,u.castShadow=!0,u}function kt(c,e,s,i){const t=c*(i?.4:.32),a=c*.032,n=new Ie(t,a,8,36),o=new ye({color:xt(s,65),emissive:new Y(s),emissiveIntensity:i?.55:.25,metalness:.95,roughness:.06,clearcoat:.85,clearcoatRoughness:.03,envMapIntensity:1.8}),r=new k(n,o);return r.rotation.x=Math.PI/2,r.position.y=e/2+a,r.castShadow=!0,r}class fi{constructor(){l(this,"medals",new Map);l(this,"pendingRemoval",new Set);l(this,"spawnCounter",0)}spawn(e,s,i,t,a,n,o,r,d){if(this.medals.size>=g.MAX_MEDALS_ON_FIELD)return;const p=t.rapier,u=d??hi(Math.random()),f=u==="large"?g.MEDAL_RADIUS_LARGE:u==="triple"?g.MEDAL_RADIUS_TRIPLE:g.MEDAL_RADIUS,h=di[u],m=p.RigidBodyDesc.dynamic().setTranslation(e,s,i).setLinearDamping(.5).setAngularDamping(4).setCcdEnabled(!0),y=t.createRigidBody(m);y.setEnabledRotations(!0,!1,!0,!0),r&&y.setLinvel(r,!0);const x=p.ColliderDesc.cylinder(g.MEDAL_THICKNESS/2,f).setRestitution(.05).setFriction(.65).setDensity(g.MEDAL_MASS).setActiveEvents(p.ActiveEvents.COLLISION_EVENTS),v=t.createCollider(x,y);n.registerHandle(v.handle,"medal");const E=ci[u],C=oe.getMedalTexture(E);C.wrapS=C.wrapT=_s;const w=u==="triple",T=u==="double",b=.12+Math.random()*.12,H=(Math.random()-.5)*.14,D=new Y(Math.min(1,1+H),Math.min(1,1+H*.85),Math.min(1,1-H*.25)),P=new ye({color:w||T?16777215:D,map:C,metalness:.9,roughness:b,clearcoat:.4,clearcoatRoughness:.05+Math.random()*.06,reflectivity:.95,envMapIntensity:.85,emissive:w||T?new Y(E):new Y(0),emissiveIntensity:w?.18:T?.07:0}),I=new k(pi(u),P);I.castShadow=!0,I.receiveShadow=!1;const _=g.MEDAL_THICKNESS*.58,z=new Ie(f-_*.45,_,10,48),F=new ye({color:xt(E,18),metalness:.95,roughness:.1,clearcoat:.6,clearcoatRoughness:.04,envMapIntensity:.9,emissive:w||T?new Y(E):new Y(0),emissiveIntensity:w?.18:T?.06:0}),$=new k(z,F);$.rotation.x=Math.PI/2,I.add($);const W=Math.random()*Math.PI*2;if(!w&&!T){const j=ui(f,g.MEDAL_THICKNESS,E);j.rotation.y=W,I.add(j)}else{const j=kt(f,g.MEDAL_THICKNESS,E,w);if(I.add(j),w){const te=kt(f,g.MEDAL_THICKNESS,E,!1);te.scale.setScalar(1.35),te.position.y=g.MEDAL_THICKNESS/2+.005,I.add(te)}}I.userData.physicsYOffset=.03,I.position.set(e,s,i),o.add(I),a.register(y,I),this.medals.set(v.handle,{body:y,collider:v,mesh:I,type:u,quotaValue:h}),this.spawnCounter++}getQuotaValue(e){var s;return((s=this.medals.get(e))==null?void 0:s.quotaValue)??1}getMedalPosition(e){const s=this.medals.get(e);if(!s)return{x:0,y:0,z:0};const i=s.body.translation();return{x:i.x,y:i.y,z:i.z}}markForRemoval(e){this.pendingRemoval.add(e)}nudgeDeadZone(e,s){for(const[,i]of this.medals){if(this.pendingRemoval.has(i.collider.handle))continue;const t=i.body.translation(),a=i.body.linvel();t.z>s-.8&&t.z<s&&t.y>-.2&&Math.sqrt(a.x*a.x+a.z*a.z)<.15&&i.body.applyImpulse({x:(Math.random()-.5)*.4,y:.05,z:.6+Math.random()*.3},!0)}}shakeAll(e=3){for(const[,s]of this.medals){if(this.pendingRemoval.has(s.collider.handle))continue;const i=(Math.random()-.5)*e,t=Math.random()*e*.4+.5,a=(Math.random()-.5)*e*.5-e*.3;s.body.applyImpulse({x:i,y:t,z:a},!0)}}flushRemovals(e,s,i,t){let a=0;for(const n of this.pendingRemoval){const o=this.medals.get(n);o&&(s.unregister(o.body),i.unregisterHandle(n),t.remove(o.mesh),e.removeRigidBody(o.body),Pt(o.mesh),this.medals.delete(n),a++)}return this.pendingRemoval.clear(),a}cleanupFallen(e,s,i,t,a,n){let o=0;for(const[r,d]of this.medals)d.body.translation().y<e&&!this.pendingRemoval.has(r)&&(this.pendingRemoval.add(r),n==null||n(r),o++);return o}get count(){return this.medals.size}clear(e,s,i,t){for(const[a,n]of this.medals)s.unregister(n.body),i.unregisterHandle(a),t.remove(n.mesh),e.removeRigidBody(n.body),Pt(n.mesh);this.medals.clear(),this.pendingRemoval.clear()}}class gi{constructor(){l(this,"body");l(this,"collider")}async initPhysics(e,s){const i=e.rapier,t=g.OPEN_ZONE_START,a=g.FIELD_DEPTH/2+15,n=(t+a)/2,o=(a-t)/2,r=i.RigidBodyDesc.fixed().setTranslation(0,-2,n);this.body=e.createRigidBody(r);const d=i.ColliderDesc.cuboid(g.FIELD_WIDTH/2+1,1.5,o).setActiveEvents(i.ActiveEvents.COLLISION_EVENTS).setSensor(!0);this.collider=e.createCollider(d,this.body),s.registerHandle(this.collider.handle,"drop_zone")}}class yi{constructor(){l(this,"time",0)}setupStage(e,s,i,t){this.clear(t)}getBonusMultiplierAt(e,s){return 1}update(e){this.time+=e}clear(e){this.time=0}}var O=(c=>(c.Common="Common",c.Rare="Rare",c.Epic="Epic",c.Legendary="Legendary",c))(O||{});const Jt={[O.Common]:11184810,[O.Rare]:3381759,[O.Epic]:13387007,[O.Legendary]:16763904},xi={[O.Common]:3355443,[O.Rare]:1127304,[O.Epic]:6689160,[O.Legendary]:8939008},bi={[O.Common]:.45,[O.Rare]:.75,[O.Epic]:.85,[O.Legendary]:.95};function vi(c){const e=Jt[c],s=xi[c],i=bi[c],t=new Xt,a=c===O.Legendary?.4:c===O.Epic?.3:c===O.Rare?.2:.1,n=new ye({color:e,emissive:s,emissiveIntensity:i,metalness:c===O.Legendary?.1:.25,roughness:.1,clearcoat:1,clearcoatRoughness:.04,transmission:a,ior:1.55,transparent:!0,opacity:.92,envMapIntensity:2});let o;switch(c){case O.Legendary:o=new Ls(.24,.07,80,12,2,3);break;case O.Epic:o=new ks(.32,0);break;case O.Rare:{const d=new It(.22,.3,8,1),p=new It(.22,.26,8,1),u=new k(p,n.clone());u.rotation.x=Math.PI,u.position.y=-.03;const f=new k(d,n);return f.castShadow=!0,u.castShadow=!0,t.add(f,u),o=d,Lt(t,c),t}default:o=new Ps(.3,0);break}const r=new k(o,n);if(r.castShadow=!0,t.add(r),c!==O.Common){const d=new ye({color:e,emissive:e,emissiveIntensity:c===O.Legendary?2:1.4,metalness:0,roughness:.4,clearcoat:.5,clearcoatRoughness:.1,transparent:!0,opacity:.45}),p=o.clone(),u=new k(p,d);u.scale.setScalar(.65),t.add(u)}return Lt(t,c),t}function Lt(c,e){const s=Jt[e];if(e===O.Common)return;const i=e===O.Legendary?.4:e===O.Epic?.36:.3,t=new Ie(i,.018,8,48),a=new ye({color:s,emissive:s,emissiveIntensity:e===O.Legendary?2.5:1.8,metalness:0,roughness:.05,clearcoat:.8,clearcoatRoughness:.02,transparent:!0,opacity:.9}),n=new k(t,a);if(n.rotation.x=Math.PI/3,c.add(n),e===O.Legendary){const o=new k(new Ie(i*.88,.012,6,40),a.clone());o.rotation.x=Math.PI/3,o.rotation.y=Math.PI/2,c.add(o)}}class wi{constructor(e){l(this,"mesh");this.mesh=vi(e),this.mesh.castShadow=!0}update(e){this.mesh.rotation.y+=.025;for(const s of this.mesh.children)s instanceof k&&s.geometry instanceof Ie&&(s.rotation.z+=.018)}setPosition(e,s,i){this.mesh.position.set(e,s,i)}dispose(){this.mesh.traverse(e=>{if(e instanceof k){e.geometry.dispose();const s=e.material;Array.isArray(s)?s.forEach(i=>i.dispose()):s.dispose()}})}}class bt{constructor(e=Date.now()){l(this,"seed");this.seed=e}next(){this.seed|=0,this.seed=this.seed+1831565813|0;let e=Math.imul(this.seed^this.seed>>>15,1|this.seed);return e=e+Math.imul(e^e>>>7,61|e)^e,((e^e>>>14)>>>0)/4294967296}nextInt(e,s){return Math.floor(this.next()*(s-e+1))+e}nextFloat(e,s){return this.next()*(s-e)+e}shuffle(e){const s=[...e];for(let i=s.length-1;i>0;i--){const t=Math.floor(this.next()*(i+1));[s[i],s[t]]=[s[t],s[i]]}return s}weightedPick(e,s){const i=s.reduce((a,n)=>a+n,0);let t=this.next()*i;for(let a=0;a<e.length;a++)if(t-=s[a],t<=0)return e[a];return e[e.length-1]}}class Ti{constructor(){l(this,"items",new Map);l(this,"pendingRemoval",new Set)}spawnItems(e,s,i,t,a,n){const o=new bt(n);for(const r of e){const d=o.nextFloat(-3,g.FIELD_WIDTH/2-1),p=o.nextFloat(-2,3),f=.4+.05;this.spawnSingle(r,d,f,p,s,i,t,a)}}spawnSingle(e,s,i,t,a,n,o,r){const d=a.rapier,p=d.RigidBodyDesc.dynamic().setTranslation(s,i,t).setLinearDamping(.7).setAngularDamping(.8),u=a.createRigidBody(p),f=d.ColliderDesc.ball(.4).setRestitution(.4).setFriction(.5).setDensity(2).setActiveEvents(d.ActiveEvents.COLLISION_EVENTS),h=a.createCollider(f,u);o.registerHandle(h.handle,"item");const m=new wi(e.rarity);m.setPosition(s,i,t),r.add(m.mesh),n.register(u,m.mesh),this.items.set(h.handle,{body:u,collider:h,mesh:m,definitionId:e.id})}getDefinitionId(e){var s;return(s=this.items.get(e))==null?void 0:s.definitionId}getItemPosition(e){const s=this.items.get(e);if(!s)return{x:0,y:0,z:0};const i=s.body.translation();return{x:i.x,y:i.y,z:i.z}}cleanupFallen(e,s){for(const[i,t]of this.items)t.body.translation().y<e&&!this.pendingRemoval.has(i)&&(this.pendingRemoval.add(i),s==null||s(i))}markForRemoval(e){this.pendingRemoval.add(e)}flushRemovals(e,s,i,t){for(const a of this.pendingRemoval){const n=this.items.get(a);n&&(s.unregister(n.body),i.unregisterHandle(a),t.remove(n.mesh.mesh),e.removeRigidBody(n.body),n.mesh.dispose(),this.items.delete(a))}this.pendingRemoval.clear()}update(e){for(const s of this.items.values())s.mesh.update(e)}clear(e,s,i,t){for(const[a,n]of this.items)s.unregister(n.body),i.unregisterHandle(a),t.remove(n.mesh.mesh),e.removeRigidBody(n.body),n.mesh.dispose();this.items.clear(),this.pendingRemoval.clear()}}const pt=[{id:"rusty_gear",name:"さびたギア",quotaValue:5,sellPrice:3,rarity:O.Common,description:"古びたギア。それなりの価値はある。"},{id:"chipped_crystal",name:"欠けた水晶",quotaValue:8,sellPrice:5,rarity:O.Common,description:"割れた水晶の破片。かすかに輝いている。"},{id:"silver_coin",name:"銀貨",quotaValue:12,sellPrice:8,rarity:O.Common,description:"磨けば光る銀の硬貨。"},{id:"strange_mushroom",name:"怪しいキノコ",quotaValue:10,sellPrice:6,rarity:O.Common,description:"食べたら何かが起きそうな不思議なキノコ。"},{id:"ancient_compass",name:"古羅針盤",quotaValue:20,sellPrice:15,rarity:O.Rare,description:"方角を示す古い羅針盤。コレクターに人気。"},{id:"glowing_orb",name:"発光する球体",quotaValue:25,sellPrice:18,rarity:O.Rare,description:"ぼんやりと光を放つ不思議な球体。"},{id:"clockwork_bird",name:"ぜんまい仕掛けの鳥",quotaValue:30,sellPrice:22,rarity:O.Rare,description:"ネジを巻くと動き出す精巧な機械鳥。"},{id:"philosophers_stone",name:"賢者の石（模造品）",quotaValue:50,sellPrice:40,rarity:O.Epic,description:"本物かどうかは不明。でも高く売れる。"},{id:"dragon_scale",name:"ドラゴンの鱗",quotaValue:60,sellPrice:50,rarity:O.Epic,description:"龍から採れた鱗。強靭で美しい。"},{id:"starfall_fragment",name:"星落の欠片",quotaValue:100,sellPrice:80,rarity:O.Legendary,description:"流れ星が落とした神秘の欠片。伝説級のお宝。"}];function Ae(c){return pt.find(e=>e.id===c)}const Dt={[O.Common]:60,[O.Rare]:30,[O.Epic]:8,[O.Legendary]:2};class Si{constructor(e){l(this,"rng");this.rng=new bt(e)}pickRandom(e){const s=[];for(let i=0;i<e;i++){const t=this.pickRarity(),a=pt.filter(o=>o.rarity===t);if(a.length===0){s.push(pt[0]);continue}const n=Math.floor(this.rng.next()*a.length);s.push(a[n])}return s}pickRarity(){const e=Object.keys(Dt),s=e.map(i=>Dt[i]);return this.rng.weightedPick(e,s)}}function R(c,e,s=!1){const i=new k(c,e);return s&&(i.castShadow=!0,i.receiveShadow=!0),i}function Ht(c,e=1){return new N({color:c,emissive:c,emissiveIntensity:e,roughness:.5,metalness:.3})}class G{constructor(e){l(this,"group");l(this,"pusherMesh",null);l(this,"wallMeshes",[]);l(this,"sideGuardMeshes",[]);l(this,"collectionGlowMat",null);l(this,"gaugeMats",[]);l(this,"ledStripMats",[]);l(this,"collectionFlashRemaining",0);l(this,"pusherZBase",-12/2+g.PUSHER_DEPTH/2-g.PUSHER_RANGE);this.group=new Xt,this.rebuild(e)}rebuild(e){this.group.traverse(s=>{if(s!==this.group&&s instanceof k){s.geometry.dispose();const i=s.material;Array.isArray(i)?i.forEach(t=>t.dispose()):i.dispose()}}),this.group.clear(),this.wallMeshes=[],this.sideGuardMeshes=[],this.collectionGlowMat=null,this.gaugeMats=[],this.ledStripMats=[],this.buildFieldSurface(e),this.buildPusher(e),this.addPusherDetails(e),this.createWalls(e),this.buildCabinet(e),this.buildCabinetDetails(e)}static cabinetMat(e){return new N({color:e.cabinetColor,roughness:.72,metalness:.42})}static brassMat(e){return new N({color:e.brassColor,roughness:e.brassRoughness,metalness:e.brassMetalness})}buildFieldSurface(e){const s=g.FIELD_DEPTH/2+g.OPEN_ZONE_START,i=-12/2+s/2,t=oe.getFieldTexture(e.fieldTexBase);t.wrapS=t.wrapT=Le,t.repeat.set(g.FIELD_WIDTH/2,s/2);const a=new N({map:t,color:16777215,roughness:.92,metalness:0}),n=new A(g.FIELD_WIDTH,g.FIELD_HEIGHT,s),o=new k(n,a);o.receiveShadow=!0,o.position.set(0,-.1/2,i),this.group.add(o);const r=-12/2,d=g.OPEN_ZONE_START,p=g.FIELD_WIDTH,u=[{z:r+(d-r)*.35,color:e.secondaryNeon,intensity:.45},{z:r+(d-r)*.65,color:e.tertiaryNeon,intensity:.4}];for(const{z:f,color:h,intensity:m}of u){const y=new N({color:h,emissive:h,emissiveIntensity:m,roughness:.2,metalness:.05}),x=new k(new A(p-.3,.015,.04),y);x.position.set(0,.01,f),this.group.add(x)}}buildPusher(e){const s=oe.getPusherTexture(e.pusherTexBase);s.wrapS=s.wrapT=Le,s.repeat.set(g.PUSHER_WIDTH/2,g.PUSHER_HEIGHT/1);const i=new N({map:s,color:16777215,roughness:.35,metalness:.65}),t=new A(g.PUSHER_WIDTH,g.PUSHER_HEIGHT,g.PUSHER_DEPTH);this.pusherMesh=new k(t,i),this.pusherMesh.castShadow=!0,this.pusherMesh.position.set(0,g.PUSHER_HEIGHT/2,this.pusherZBase),this.group.add(this.pusherMesh)}addPusherDetails(e){const s=g.PUSHER_WIDTH,i=g.PUSHER_HEIGHT,t=g.PUSHER_DEPTH,a=R(new A(s+.06,.14,.14),G.brassMat(e));a.position.set(0,-i/2+.07,t/2),this.pusherMesh.add(a);const n=R(new A(s+.06,.06,.06),G.brassMat(e));n.position.set(0,i/2,t/2),this.pusherMesh.add(n);for(const d of[-1,1]){const p=R(new A(.1,i,.1),G.brassMat(e));p.position.set(d*(s/2-.05),0,t/2),this.pusherMesh.add(p)}const o=new N({color:e.primaryNeon,emissive:new Y(e.primaryNeon),emissiveIntensity:.85,roughness:.2,metalness:.05}),r=R(new A(s-.12,.045,.055),o);r.position.set(0,i*.1,t/2+.03),this.pusherMesh.add(r),this.ledStripMats.push({mat:o,baseIntensity:.85,phase:Math.PI*.5,speed:1.4})}createWalls(e){const t=oe.getWallTexture(e.wallTexBase);t.wrapS=t.wrapT=Le;const a=()=>{const w=t.clone();return w.wrapS=w.wrapT=Le,w.needsUpdate=!0,new N({map:w,color:16777215,roughness:.8,metalness:.15})},n=g.OPEN_ZONE_START- -12/2,o=-12/2+n/2,r=a();r.map.repeat.set(n/2,3.5/2);const d=new A(.3,3.5,n),p=new k(d,r);p.position.set(-8/2-.3/2,3.5/2,o),this.group.add(p),this.wallMeshes.push(p);const u=a();u.map.repeat.set(n/2,3.5/2);const f=new A(.3,3.5,n),h=new k(f,u);h.position.set(g.FIELD_WIDTH/2+.3/2,3.5/2,o),this.group.add(h),this.wallMeshes.push(h);const m=a(),y=g.FIELD_WIDTH+.3*2;m.map.repeat.set(y/2,3.5/2);const x=new A(y,3.5,.3),v=new k(x,m);v.position.set(0,3.5/2,-12/2-.3/2),this.group.add(v),this.wallMeshes.push(v);const E=-12/2+n/2,C=[{y:.8,color:e.secondaryNeon,baseIntensity:.8,phase:0,speed:2.4},{y:2.1,color:e.tertiaryNeon,baseIntensity:.65,phase:1.57,speed:1.8}];for(const{y:w,color:T,baseIntensity:b,phase:H,speed:D}of C){const P=new N({color:T,emissive:T,emissiveIntensity:b,roughness:.2,metalness:.05});this.ledStripMats.push({mat:P,baseIntensity:b,phase:H,speed:D});for(const _ of[-1,1]){const z=_*(g.FIELD_WIDTH/2+.3+.02),F=new k(new A(.3*.4,.038,n),P);F.position.set(z,w,E),this.group.add(F)}const I=new k(new A(y,.038,.3*.4),P);I.position.set(0,w,-12/2-.3+.02),this.group.add(I)}}buildCabinet(e){const s=g.FIELD_WIDTH,i=g.FIELD_DEPTH,t=-i/2,a=i/2,n=R(new A(12,1,17),G.cabinetMat(e),!0);n.position.set(0,-.52,-.5),this.group.add(n);const o=R(new A(12,.1,.1),G.brassMat(e));o.position.set(0,0,a+2.55),this.group.add(o);const r=1.1,d=7.2,p=13.5,u=s/2+.75,f=-.25;for(const Q of[-1,1]){const ee=R(new A(r,d,p),G.cabinetMat(e),!0);ee.position.set(Q*u,d/2-.5,f),this.group.add(ee);const ue=R(new A(r+.08,.14,p+.08),G.brassMat(e));ue.position.set(Q*u,d-.5+.07,f),this.group.add(ue);const he=R(new A(r+.08,.1,p+.08),G.brassMat(e));he.position.set(Q*u,-.02,f),this.group.add(he);const ke=R(new A(.06,d*.75,p*.7),new N({color:e.insetColor,roughness:.9,metalness:.1}));ke.position.set(Q*(u-(r/2+.01)),d/2-.5,f),this.group.add(ke);const Ne=R(new A(.06,d*.8,.06),G.brassMat(e));Ne.position.set(Q*(u-r/2-.04),d/2-.5,f),this.group.add(Ne)}for(const Q of[-1,1]){for(const he of[-.22,.22]){const ke=new N({color:e.secondaryNeon,emissive:e.secondaryNeon,emissiveIntensity:.72,roughness:.2,metalness:.05}),Ne=he>0?Math.PI*.6:0;this.ledStripMats.push({mat:ke,baseIntensity:.72,phase:Ne,speed:1.6});const St=R(new A(.032,d*.82,.032),ke);St.position.set(Q*(u+he),d*.41+.04,f+p/2+.09),this.group.add(St)}const ee=new N({color:e.primaryNeon,emissive:e.primaryNeon,emissiveIntensity:1.5,roughness:.1,metalness:.2});this.ledStripMats.push({mat:ee,baseIntensity:1.5,phase:Q>0?.8:2,speed:2.2});const ue=R(new gt(.14,8,6),ee);ue.position.set(Q*u,d-.5+.34,f+p/2+.09),this.group.add(ue)}const h=10.5,m=1.3,y=t-1.15,x=oe.getWallTexture(e.wallTexBase).clone();x.wrapS=x.wrapT=Le,x.repeat.set(6,5),x.needsUpdate=!0;const v=new N({map:x,color:16777215,roughness:.75,metalness:.18}),E=R(new A(12,h,m),v,!0);E.position.set(0,h/2-.5,y),this.group.add(E);const C=R(new A(12.1,.15,m+.1),G.brassMat(e));C.position.set(0,h-.5+.07,y),this.group.add(C);const w=2,T=8.5,b=5.2,H=y+m/2+.06,D=oe.getScreenTexture(e.primaryNeon,e.screenBase),P=new N({color:328965,emissive:16777215,emissiveMap:D,emissiveIntensity:1.4,roughness:.45,metalness:.4}),I=R(new A(T,w,.08),P);I.position.set(0,b,y+m/2+.04),this.group.add(I);const _=R(new A(T+.24,w+.24,.06),G.brassMat(e));_.position.set(0,b,y+m/2),this.group.add(_);const z=R(new A(12.1,.08,.08),G.brassMat(e));z.position.set(0,h-.5+.18,y+m/2),this.group.add(z);const F=R(new A(12.1,.08,.08),G.brassMat(e));F.position.set(0,3.7,y+m/2),this.group.add(F);const $=new N({color:e.primaryNeon,emissive:e.primaryNeon,emissiveIntensity:1.2,roughness:.2,metalness:.1}),W=R(new A(.06,w*.9,.06),$);W.position.set(-T/2-.18,b,H),this.group.add(W);const j=R(new A(.06,w*.9,.06),$.clone());j.position.set(T/2+.18,b,H),this.group.add(j);const te=R(new A(T+.6,.04,.04),$.clone());te.position.set(0,b-w/2-.22,H),this.group.add(te);for(let Q=0;Q<3;Q++){const ee=b+w*.28-Q*(w*.3),ue=new N({color:e.primaryNeon,emissive:e.primaryNeon,emissiveIntensity:.45-Q*.05,roughness:.3,metalness:0,transparent:!0,opacity:.55}),he=R(new A(T-.5,.025,.01),ue);he.position.set(0,ee,H),this.group.add(he)}const xe=R(new A(12,1.1,4.5),G.cabinetMat(e),!0);xe.position.set(0,-.56,a+2.25),this.group.add(xe);const Be=R(new A(12,.12,.12),G.brassMat(e));Be.position.set(0,0,a+4.45),this.group.add(Be);const be=R(new A(12,.1,.08),G.brassMat(e));be.position.set(0,.06,a+4.5),this.group.add(be);const Ze=new N({color:e.primaryNeon,emissive:e.primaryNeon,emissiveIntensity:.04,roughness:.12,metalness:.85,transparent:!0,opacity:.45}),Ge=R(new A(11.6,.02,4),Ze);Ge.position.set(0,.01,a+2.25),this.group.add(Ge);const Pe=new N({color:e.primaryNeon,emissive:e.primaryNeon,emissiveIntensity:.28,roughness:.2,metalness:.1}),me=R(new A(.04,.03,4.1),Pe);me.position.set(-5.8,.02,a+2.25),this.group.add(me);const ve=R(new A(.04,.03,4.1),Pe.clone());ve.position.set(5.8,.02,a+2.25),this.group.add(ve);const S=R(new A(11.6,.03,.04),Pe.clone());S.position.set(0,.02,a+.27),this.group.add(S);const B=R(new A(12,.5,p),G.cabinetMat(e),!0);B.position.set(0,6.7,f),this.group.add(B);const V=R(new A(12,.1,.1),G.brassMat(e));V.position.set(0,6.96,a+.1),this.group.add(V);for(const Q of[-1,1]){const ee=R(new A(.09,.09,i+.5),G.brassMat(e));ee.position.set(Q*(s/2+.04),.05,f),this.group.add(ee)}const Z=R(new A(s+.2,3.6,.18),new N({color:e.pusherHousingColor,roughness:.65,metalness:.5}));Z.position.set(0,1.8,t-.08),this.group.add(Z);const J=R(new A(s-.2,.08,.08),G.brassMat(e));J.position.set(0,3.65,t+.01),this.group.add(J);const re=R(new A(s+.1,.07,.07),G.brassMat(e));re.position.set(0,.06,g.OPEN_ZONE_START),this.group.add(re);const we=new N({color:e.primaryNeon,emissive:e.primaryNeon,emissiveIntensity:1,roughness:.2,metalness:.1,transparent:!0,opacity:.88});this.collectionGlowMat=we;const ae=R(new A(s+.2,.03,.22),we);ae.position.set(0,.015,g.OPEN_ZONE_START),this.group.add(ae);const le=R(new A(s+.1,.07,.07),G.brassMat(e));le.position.set(0,.06,t+.04),this.group.add(le);const Te=i/2+g.OPEN_ZONE_START,as=t+Te/2;for(const Q of[-1,1]){const ee=R(new A(.07,.07,Te),G.brassMat(e));ee.position.set(Q*s/2,.06,as),this.group.add(ee)}const wt=g.OPEN_ZONE_START-t,ns=t+wt/2;for(const Q of[-1,1]){const ee=R(new A(.08,.08,wt),G.brassMat(e));ee.position.set(Q*(s/2),3.55,ns),this.group.add(ee)}const Tt=new k(new A(100,.2,100),new N({color:e.groundColor,emissive:e.groundColor,emissiveIntensity:.1,roughness:.95,metalness:0}));Tt.position.set(0,-.65,0),this.group.add(Tt)}buildCabinetDetails(e){const s=g.FIELD_DEPTH/2,i=-12/2,t=1.1,a=7.2,n=13.5,o=g.FIELD_WIDTH/2+.75,r=-.25,d=1.3,p=i-1.15;for(const w of[-1,1]){for(let b=0;b<2;b++){const H=b===0?-.26:.16,D=a*.6,P=w*(o+H),I=r+n/2+.07,_=R(new ie(.05,.05,D,8),G.brassMat(e));_.position.set(P,D/2+.3,I),this.group.add(_);const z=4;for(let F=0;F<=z;F++){const $=.3+F*(D/z),W=R(new ie(.09,.09,.07,10),G.brassMat(e));W.position.set(P,$,I),this.group.add(W)}}const T=R(new A(.48,.1,.1),G.brassMat(e));T.position.set(w*o,a*.6+.3+.05,r+n/2+.07),this.group.add(T)}for(const w of[-1,1]){const T=w*(o-t/2-.025),b=R(new ie(.24,.24,.06,18),G.brassMat(e));b.rotation.z=Math.PI/2,b.position.set(T,a*.52,r+.8),this.group.add(b);const H=Ht(e.secondaryNeon,.55),D=R(new ie(.18,.18,.03,18),H);D.rotation.z=Math.PI/2,D.position.set(T-w*.035,a*.52,r+.8),this.group.add(D),this.gaugeMats.push(H);const P=R(new ie(.16,.16,.05,14),G.brassMat(e));P.rotation.z=Math.PI/2,P.position.set(T,a*.28,r-1.2),this.group.add(P);const I=Ht(e.primaryNeon,.45),_=R(new ie(.11,.11,.025,14),I);_.rotation.z=Math.PI/2,_.position.set(T-w*.03,a*.28,r-1.2),this.group.add(_),this.gaugeMats.push(I)}const u=3.2,f=p+d/2+.05,h=R(new Ie(.82,.1,10,28),G.brassMat(e));h.position.set(0,u,f),this.group.add(h);const m=R(new ie(.74,.74,.04,28),new N({color:e.screenBase,emissive:e.screenEmissive,emissiveIntensity:.55,transparent:!0,opacity:.82,roughness:.05,metalness:0}));m.rotation.x=Math.PI/2,m.position.set(0,u,f),this.group.add(m);for(let w=0;w<4;w++){const T=w/4*Math.PI*2+Math.PI/4,b=R(new ie(.045,.045,.06,8),G.brassMat(e));b.rotation.x=Math.PI/2,b.position.set(Math.cos(T)*.88,u+Math.sin(T)*.88,f+.03),this.group.add(b)}const y=R(new A(5.5,.05,.05),new N({color:e.secondaryNeon,emissive:e.secondaryNeon,emissiveIntensity:.9,roughness:.2,metalness:.1}));y.position.set(0,u+1.12,f),this.group.add(y);{const w=t+.12,T=.12,b=n+.12;for(const H of[-1,1])for(const D of[.33,.66]){const P=R(new A(w,T,b),G.brassMat(e));P.position.set(H*o,D*a-.5,r),this.group.add(P)}}const x=s+4.45,v=R(new A(1.3,.16,.05),new N({color:e.insetColor,roughness:.9,metalness:.1}));v.position.set(0,-.08,x),this.group.add(v);const E=R(new A(1.5,.3,.04),G.brassMat(e));E.position.set(0,-.08,x-.01),this.group.add(E);const C=R(new A(.9,.045,.06),new N({color:0,roughness:1,metalness:0}));C.position.set(0,-.06,x+.01),this.group.add(C)}addSideGuardMeshes(e){const t=g.FIELD_DEPTH/2-g.OPEN_ZONE_START,a=g.OPEN_ZONE_START+t/2;for(const n of[-1,1]){const o=n*(g.FIELD_WIDTH/2+.1),r=new A(.2,2,t),d=new N({color:4500223,emissive:4500223,emissiveIntensity:.55,transparent:!0,opacity:.55,roughness:.2,metalness:.1}),p=new k(r,d);p.position.set(o,2/2,a),e.add(p),this.sideGuardMeshes.push(p)}}removeSideGuardMeshes(e){for(const s of this.sideGuardMeshes)e.remove(s),s.geometry.dispose(),s.material.dispose();this.sideGuardMeshes=[]}updatePusher(e){this.pusherMesh.position.z=this.pusherZBase+e}triggerCollectionFlash(){this.collectionFlashRemaining=.3}update(e,s=.016){if(this.collectionGlowMat)if(this.collectionFlashRemaining>0){const i=this.collectionFlashRemaining/.3;this.collectionGlowMat.emissiveIntensity=.55+i*1.45,this.collectionFlashRemaining-=s}else this.collectionGlowMat.emissiveIntensity=.35+Math.sin(e*3.8)*.2;for(let i=0;i<this.gaugeMats.length;i++){const t=i%2===0?.55:.45,a=.3,n=i%2===0?2.1:1.5,o=i*1.1;this.gaugeMats[i].emissiveIntensity=t+Math.sin(e*n+o)*a}for(const{mat:i,baseIntensity:t,phase:a,speed:n}of this.ledStripMats)i.emissiveIntensity=t+Math.sin(e*n+a)*(t*.28)}}class Ei{constructor(e,s,i,t){l(this,"physicsWorld");l(this,"physicsSync");l(this,"collisionHandler");l(this,"pusher");l(this,"medalSpawner");l(this,"itemSpawner");l(this,"dropZone");l(this,"gimmickManager");l(this,"fieldMesh");l(this,"time",0);l(this,"antiJamTimer",0);l(this,"getMedalQuotaMultiplier",()=>1);l(this,"sideGuardActive",!1);l(this,"sideGuardBodies",[]);this.sceneManager=e,this.quotaManager=s,this.inventory=i,this.physicsWorld=new si,this.physicsSync=new ii,this.collisionHandler=new ai,this.pusher=new ni,this.medalSpawner=new fi,this.itemSpawner=new Ti,this.dropZone=new gi,this.gimmickManager=new yi,this.fieldMesh=new G(t)}setMedalQuotaMultiplierFn(e){this.getMedalQuotaMultiplier=e}rebuildFieldMesh(e){oe.disposeAll(),this.fieldMesh.rebuild(e)}async init(){await this.physicsWorld.init(),this.collisionHandler.init(this.physicsWorld),await this.buildFieldPhysics(),await this.pusher.initPhysics(this.physicsWorld),await this.dropZone.initPhysics(this.physicsWorld,this.collisionHandler),this.collisionHandler.onMedalCollected(e=>{const s=this.medalSpawner.getQuotaValue(e),i=this.medalSpawner.getMedalPosition(e);this.medalSpawner.markForRemoval(e);const t=this.getMedalQuotaMultiplier();this.quotaManager.addMedals(s,t),L.emit("medal:collected",{count:s,x:i.x,y:i.y,z:i.z})}),this.collisionHandler.onItemCollected(e=>{const s=this.itemSpawner.getDefinitionId(e);if(!s)return;const i=this.itemSpawner.getItemPosition(e);this.itemSpawner.markForRemoval(e);const t=this.inventory.addItem(s),a=Ae(s);a&&(this.quotaManager.addItem(a.quotaValue),L.emit("item:collected",{itemId:s,instanceId:t.instanceId,quotaValue:a.quotaValue,x:i.x,y:i.y,z:i.z}))}),this.sceneManager.add(this.fieldMesh.group)}async buildFieldPhysics(){const e=this.physicsWorld.rapier,s=(g.FIELD_DEPTH/2+g.OPEN_ZONE_START)/2,i=-12/2+s,t=e.RigidBodyDesc.fixed().setTranslation(0,-.05,i),a=this.physicsWorld.createRigidBody(t),n=e.ColliderDesc.cuboid(g.FIELD_WIDTH/2,.05,s).setFriction(.15).setRestitution(.05);this.physicsWorld.createCollider(n,a);const o=3.5,r=.2,d=g.OPEN_ZONE_START- -12/2,p=-12/2+d/2,u=e.RigidBodyDesc.fixed().setTranslation(-8/2-r/2,o/2,p),f=this.physicsWorld.createRigidBody(u);this.physicsWorld.createCollider(e.ColliderDesc.cuboid(r/2,o/2,d/2),f);const h=e.RigidBodyDesc.fixed().setTranslation(g.FIELD_WIDTH/2+r/2,o/2,p),m=this.physicsWorld.createRigidBody(h);this.physicsWorld.createCollider(e.ColliderDesc.cuboid(r/2,o/2,d/2),m);const y=8,x=.5,v=e.RigidBodyDesc.fixed().setTranslation(0,y/2,-12/2-x/2),E=this.physicsWorld.createRigidBody(v);this.physicsWorld.createCollider(e.ColliderDesc.cuboid(g.FIELD_WIDTH/2+x,y/2,x/2),E)}startStage(e,s){this.spawnInitialMedals(),this.gimmickManager.setupStage(e,s,this.physicsWorld,this.sceneManager);const t=new Si(e*1e3+s).pickRandom(g.ITEMS_PER_STAGE);this.itemSpawner.spawnItems(t,this.physicsWorld,this.physicsSync,this.collisionHandler,this.sceneManager,e*1e3+s+7)}spawnInitialMedals(){const e=-6+g.PUSHER_DEPTH-g.PUSHER_RANGE,s=g.OPEN_ZONE_START-g.MEDAL_RADIUS,i=g.FIELD_WIDTH/2-g.MEDAL_RADIUS,t=s-e,a=e;for(let h=0;h<g.INITIAL_FIELD_MEDALS;h++){const m=(Math.random()*2-1)*i,y=a+Math.random()*t,x=g.MEDAL_THICKNESS/2+Math.random()*.5,v=Math.random()<.25?"large":"normal";this.medalSpawner.spawn(m,x,y,this.physicsWorld,this.physicsSync,this.collisionHandler,this.sceneManager,void 0,v)}const n=-12/2+g.MEDAL_RADIUS,r=e-g.MEDAL_RADIUS-n,d=6,p=Math.ceil(g.INITIAL_PUSHER_MEDALS/d),u=i*2/(d-1),f=r/Math.max(p-1,1);for(let h=0;h<g.INITIAL_PUSHER_MEDALS;h++){const m=h%d,y=Math.floor(h/d),x=-i+m*u+(Math.random()-.5)*.15,v=n+y*f+(Math.random()-.5)*.15,E=g.PUSHER_HEIGHT+g.MEDAL_THICKNESS/2+.8+y*.25;this.medalSpawner.spawn(x,E,v,this.physicsWorld,this.physicsSync,this.collisionHandler,this.sceneManager,void 0,"normal")}}throwMedal(e,s){const i=g.FIELD_DEPTH/2-.5,t=2,n=-(12+(-s+1)/2*7);this.medalSpawner.spawn(e,t,i,this.physicsWorld,this.physicsSync,this.collisionHandler,this.sceneManager,{x:0,y:6,z:n})}update(e){this.time+=e,this.fieldMesh.update(this.time,e);const s=4,i=Math.min(e,1/15);if(this.physicsWorld.setTimestep(i/s),this.collisionHandler.processEvents(this.physicsWorld,s),this.medalSpawner.cleanupFallen(g.MEDAL_CLEANUP_Y,this.physicsWorld,this.physicsSync,this.collisionHandler,this.sceneManager,a=>{const n=this.medalSpawner.getQuotaValue(a),o=this.getMedalQuotaMultiplier();this.quotaManager.addMedals(n,o);const r=this.medalSpawner.getMedalPosition(a);L.emit("medal:collected",{count:n,x:r.x,y:r.y,z:r.z})}),this.itemSpawner.cleanupFallen(g.MEDAL_CLEANUP_Y,a=>{const n=this.itemSpawner.getDefinitionId(a);if(!n)return;const o=this.itemSpawner.getItemPosition(a),r=this.inventory.addItem(n),d=Ae(n);d&&(this.quotaManager.addItem(d.quotaValue),L.emit("item:collected",{itemId:n,instanceId:r.instanceId,quotaValue:d.quotaValue,x:o.x,y:o.y,z:o.z}))}),this.medalSpawner.flushRemovals(this.physicsWorld,this.physicsSync,this.collisionHandler,this.sceneManager),this.itemSpawner.flushRemovals(this.physicsWorld,this.physicsSync,this.collisionHandler,this.sceneManager),this.physicsSync.sync(this.physicsWorld),this.antiJamTimer+=e,this.antiJamTimer>=2.5){this.antiJamTimer=0;const a=-12/2+g.PUSHER_DEPTH;this.medalSpawner.nudgeDeadZone(a,g.OPEN_ZONE_START)}const t=this.pusher.update(e);this.fieldMesh.updatePusher(t),this.gimmickManager.update(e),this.itemSpawner.update(this.time)}endStage(){this.gimmickManager.clear(this.sceneManager),this.medalSpawner.clear(this.physicsWorld,this.physicsSync,this.collisionHandler,this.sceneManager),this.itemSpawner.clear(this.physicsWorld,this.physicsSync,this.collisionHandler,this.sceneManager)}shakeAllMedals(e=3){this.medalSpawner.shakeAll(e)}addSideGuardWalls(){if(this.sideGuardActive||!this.physicsWorld.initialized)return;this.sideGuardActive=!0;const e=this.physicsWorld.rapier,s=2,i=.2,t=g.FIELD_DEPTH/2-g.OPEN_ZONE_START,a=g.OPEN_ZONE_START+t/2;for(const n of[-1,1]){const o=n*(g.FIELD_WIDTH/2+i/2),r=e.RigidBodyDesc.fixed().setTranslation(o,s/2,a),d=this.physicsWorld.createRigidBody(r);this.physicsWorld.createCollider(e.ColliderDesc.cuboid(i/2,s/2,t/2),d),this.sideGuardBodies.push(d)}}removeSideGuardWalls(){for(const e of this.sideGuardBodies)this.physicsWorld.removeRigidBody(e);this.sideGuardBodies=[],this.sideGuardActive=!1}get isSideGuardActive(){return this.sideGuardActive}dispose(){this.sceneManager.remove(this.fieldMesh.group),this.physicsWorld.dispose()}}class Mi{constructor(){l(this,"current",0);l(this,"target",0);l(this,"phase",1);l(this,"stage",1);l(this,"reached",!1)}startStage(e,s){this.phase=e,this.stage=s,this.current=0,this.reached=!1,this.target=this.calcTarget(e,s),L.emit("stage:started",{phase:e,stage:s,quotaTarget:this.target}),L.emit("quota:updated",{current:this.current,target:this.target})}calcTarget(e,s){const i=(e-1)*g.STAGES_PER_PHASE+s;return Math.ceil(g.BASE_QUOTA*Math.pow(g.QUOTA_MULTIPLIER,i-1))}addMedals(e,s=1){this.current+=e*s,L.emit("quota:updated",{current:this.current,target:this.target}),!this.reached&&this.current>=this.target&&(this.reached=!0,L.emit("quota:reached",{phase:this.phase,stage:this.stage}))}addItem(e,s=1){this.current+=e*s,L.emit("quota:updated",{current:this.current,target:this.target}),!this.reached&&this.current>=this.target&&(this.reached=!0,L.emit("quota:reached",{phase:this.phase,stage:this.stage}))}get currentValue(){return this.current}get targetValue(){return this.target}get isReached(){return this.current>=this.target}get progress(){return Math.min(this.current/this.target,1)}}class Ci{constructor(e){l(this,"phase",1);l(this,"stage",1);this.fsm=e}get currentPhase(){return this.phase}get currentStage(){return this.stage}get isLastStageOfPhase(){return this.stage===g.STAGES_PER_PHASE}startCurrentStage(){this.fsm.transition(M.PLAYING)}clearCurrentStage(){L.emit("stage:cleared",{phase:this.phase,stage:this.stage}),this.fsm.transition(M.STAGE_CLEAR),this.stage===g.STAGES_PER_PHASE&&L.emit("phase:cleared",{phase:this.phase})}advanceStage(){this.stage<g.STAGES_PER_PHASE&&this.stage++,this.fsm.transition(M.STAGE_START)}advancePhase(){this.phase++,this.stage=1}reset(){this.phase=1,this.stage=1}}function Ii(){return`${Date.now().toString(36)}-${Math.random().toString(36).slice(2,9)}`}class _i{constructor(){l(this,"items",[])}addItem(e){const s={instanceId:Ii(),definitionId:e,collectedAt:Date.now()};return this.items.push(s),s}removeItem(e){const s=this.items.findIndex(i=>i.instanceId===e);return s===-1?!1:(this.items.splice(s,1),!0)}getAll(){return[...this.items]}getDefinition(e){const s=this.items.find(i=>i.instanceId===e);if(s)return Ae(s.definitionId)}get count(){return this.items.length}clear(){this.items=[]}totalSellPrice(){return this.items.reduce((e,s)=>{const i=Ae(s.definitionId);return e+((i==null?void 0:i.sellPrice)??0)},0)}}class Ai{constructor(){l(this,"data",{phase:1,stage:1,totalMedalsCollected:0,totalItemsCollected:0,shopMoneyEarned:0});L.on("medal:collected",({count:e})=>{this.data.totalMedalsCollected+=e}),L.on("item:collected",()=>{this.data.totalItemsCollected++}),L.on("stage:cleared",({phase:e,stage:s})=>{this.data.phase=e,this.data.stage=s})}addShopMoney(e){this.data.shopMoneyEarned+=e}get snapshot(){return{...this.data}}reset(){this.data={phase:1,stage:1,totalMedalsCollected:0,totalItemsCollected:0,shopMoneyEarned:0}}}class Ri{calculate(e,s){const i=s.bestPhase*3+s.bestStage,a=e.phase*3+e.stage>i;return s.updateBest(e.phase,e.stage),s.incrementRuns(),{phase:e.phase,stage:e.stage,totalMedalsCollected:e.totalMedalsCollected,totalItemsCollected:e.totalItemsCollected,isNewBest:a,bestPhase:s.bestPhase,bestStage:s.bestStage}}}var q=(c=>(c.Gold="Gold",c.Alchemy="Alchemy",c.Throw="Throw",c.Guard="Guard",c))(q||{}),U=(c=>(c.Common="Common",c.Rare="Rare",c.Epic="Epic",c))(U||{});const es=[{id:"gold_touch",name:"黄金の手",description:"メダル1枚あたりのノルマ加算値が+20%",tag:q.Gold,rarity:U.Common,effects:[{type:"QUOTA_PER_MEDAL",value:1.2}]},{id:"lucky_fall",name:"幸運の落下",description:"メダル1枚あたりのノルマ加算値が+50%",tag:q.Gold,rarity:U.Rare,effects:[{type:"QUOTA_PER_MEDAL",value:1.5}]},{id:"golden_shower",name:"黄金雨",description:"メダル1枚あたりのノルマ加算値が+100%",tag:q.Gold,rarity:U.Epic,effects:[{type:"QUOTA_PER_MEDAL",value:2}]},{id:"coin_magnet",name:"コインマグネット",description:"ステージクリア時にボーナスメダル+5枚",tag:q.Gold,rarity:U.Common,effects:[{type:"ON_CLEAR_BONUS_MEDAL",value:5}]},{id:"fortune_wheel",name:"幸運の輪",description:"ステージクリア時にボーナスメダル+15枚",tag:q.Gold,rarity:U.Rare,effects:[{type:"ON_CLEAR_BONUS_MEDAL",value:15}]},{id:"appraiser",name:"鑑定士",description:"アイテムのノルマ加算値が1.5倍",tag:q.Alchemy,rarity:U.Common,effects:[{type:"ITEM_QUOTA_MULTIPLIER",value:1.5}]},{id:"master_appraiser",name:"大鑑定士",description:"アイテムのノルマ加算値が2.5倍",tag:q.Alchemy,rarity:U.Rare,effects:[{type:"ITEM_QUOTA_MULTIPLIER",value:2.5}]},{id:"transmutation",name:"錬成",description:"アイテムの売却価格が1.5倍",tag:q.Alchemy,rarity:U.Common,effects:[{type:"ITEM_SELL_MULTIPLIER",value:1.5}]},{id:"great_transmutation",name:"大錬成",description:"アイテムの売却価格が2倍",tag:q.Alchemy,rarity:U.Rare,effects:[{type:"ITEM_SELL_MULTIPLIER",value:2}]},{id:"philosopher",name:"賢者",description:"アイテムのノルマ加算値3倍+売却価格2倍",tag:q.Alchemy,rarity:U.Epic,effects:[{type:"ITEM_QUOTA_MULTIPLIER",value:3},{type:"ITEM_SELL_MULTIPLIER",value:2}]},{id:"double_throw",name:"ダブル投擲",description:"一度に投入するメダルが2枚になる",tag:q.Throw,rarity:U.Common,effects:[{type:"MEDAL_THROW_COUNT",value:2}]},{id:"triple_throw",name:"トリプル投擲",description:"一度に投入するメダルが3枚になる",tag:q.Throw,rarity:U.Rare,effects:[{type:"MEDAL_THROW_COUNT",value:3}]},{id:"barrage",name:"弾幕",description:"一度に投入するメダルが5枚になる",tag:q.Throw,rarity:U.Epic,effects:[{type:"MEDAL_THROW_COUNT",value:5}]},{id:"quick_draw",name:"クイックドロー",description:"一度に投入するメダルが2枚+クリアボーナス+3枚",tag:q.Throw,rarity:U.Rare,effects:[{type:"MEDAL_THROW_COUNT",value:2},{type:"ON_CLEAR_BONUS_MEDAL",value:3}]},{id:"focused_aim",name:"集中狙い",description:"メダル1枚あたりのノルマ加算+30%",tag:q.Throw,rarity:U.Common,effects:[{type:"QUOTA_PER_MEDAL",value:1.3}]},{id:"safety_net",name:"セーフティネット",description:"ゲームオーバーを一度だけ無効化する",tag:q.Guard,rarity:U.Rare,effects:[{type:"GAME_OVER_SHIELD",value:1}]},{id:"double_safety",name:"ダブルセーフティ",description:"ゲームオーバーを二度まで無効化する",tag:q.Guard,rarity:U.Epic,effects:[{type:"GAME_OVER_SHIELD",value:2}]},{id:"guardian_angel",name:"守護天使",description:"ゲームオーバー無効+クリアボーナスメダル+8枚",tag:q.Guard,rarity:U.Epic,effects:[{type:"GAME_OVER_SHIELD",value:1},{type:"ON_CLEAR_BONUS_MEDAL",value:8}]},{id:"resilience",name:"回復力",description:"クリアボーナスメダル+10枚",tag:q.Guard,rarity:U.Common,effects:[{type:"ON_CLEAR_BONUS_MEDAL",value:10}]},{id:"fortress",name:"要塞",description:"ゲームオーバー無効+アイテムノルマ加算+50%",tag:q.Guard,rarity:U.Epic,effects:[{type:"GAME_OVER_SHIELD",value:1},{type:"ITEM_QUOTA_MULTIPLIER",value:1.5}]}];function Ot(c){return es.find(e=>e.id===c)}class Pi{constructor(){l(this,"owned",[])}addSkill(e,s){this.owned.push({definitionId:e,acquiredAt:s}),L.emit("skill:selected",{skillId:e})}getOwnedSkills(){return[...this.owned]}getEffectMultiplier(e){let s=1;for(const i of this.owned){const t=Ot(i.definitionId);if(t)for(const a of t.effects)a.type===e&&(s*=a.value)}return s}getEffectSum(e){let s=0;for(const i of this.owned){const t=Ot(i.definitionId);if(t)for(const a of t.effects)a.type===e&&(s+=a.value)}return s}get medalThrowCount(){const e=this.getEffectSum("MEDAL_THROW_COUNT");return e>0?e:1}get gameOverShields(){return this.getEffectSum("GAME_OVER_SHIELD")}get quotaPerMedalMultiplier(){return this.getEffectMultiplier("QUOTA_PER_MEDAL")}get itemQuotaMultiplier(){return this.getEffectMultiplier("ITEM_QUOTA_MULTIPLIER")}get itemSellMultiplier(){return this.getEffectMultiplier("ITEM_SELL_MULTIPLIER")}get onClearBonusMedals(){return this.getEffectSum("ON_CLEAR_BONUS_MEDAL")}consumeShield(){return!1}reset(){this.owned=[]}}const Bt={[U.Common]:60,[U.Rare]:30,[U.Epic]:10};class ki{pickChoices(e,s,i){const t=new bt(i),a=new Set(s.map(d=>d.definitionId)),n=es.filter(d=>!a.has(d.id));if(n.length===0)return[];const o=[],r=new Set;for(let d=0;d<e&&o.length<n.length;d++){const p=Object.keys(Bt),u=p.map(y=>Bt[y]),f=t.weightedPick(p,u),h=n.filter(y=>y.rarity===f&&!r.has(y.id));if(h.length===0){const y=n.filter(v=>!r.has(v.id));if(y.length===0)break;const x=y[Math.floor(t.next()*y.length)];o.push(x),r.add(x.id);continue}const m=h[Math.floor(t.next()*h.length)];o.push(m),r.add(m.id)}return o}}const vt=[{id:"side_guard",name:"サイドガード",description:"30秒間サイドの壁を復活",price:160,durationMs:3e4,color:"#44aaff"},{id:"medal_fever",name:"メダルフィーバー",description:"30秒間メダルのノルマ2倍",price:100,durationMs:3e4,color:"#ffaa00"},{id:"medal_shower",name:"メダルシャワー",description:"即座に20枚のメダルが降ってくる",price:120,durationMs:0,color:"#ff60a0"},{id:"earthquake",name:"地震",description:"フィールドのメダルを激しく揺らして詰まりを解消",price:80,durationMs:0,color:"#ff8844"}];function Gt(c){return vt.find(e=>e.id===c)}class Li{constructor(){l(this,"shopMoney");l(this,"medals");l(this,"sellMultiplier",1);l(this,"ownedActiveItems",new Map);this.shopMoney=g.INITIAL_SHOP_MONEY,this.medals=g.INITIAL_MEDALS}setSellMultiplier(e){this.sellMultiplier=e}get money(){return this.shopMoney}get currentMedals(){return this.medals}setMedals(e){this.medals=e}addMoney(e){this.shopMoney+=e}spendMedal(){return this.medals<=0?!1:(this.medals--,!0)}addMedals(e){this.medals+=e}sellItem(e,s){const i=s.getDefinition(e);if(!i)return 0;const t=Math.floor(i.sellPrice*this.sellMultiplier);return s.removeItem(e),this.shopMoney+=t,t}buyMedals(e){const s=e*g.MEDAL_BUY_PRICE;return this.shopMoney<s?!1:(this.shopMoney-=s,this.medals+=e,!0)}buyActiveItem(e){const s=vt.find(i=>i.id===e);return!s||this.shopMoney<s.price?!1:(this.shopMoney-=s.price,this.ownedActiveItems.set(e,(this.ownedActiveItems.get(e)??0)+1),!0)}useActiveItem(e){const s=this.ownedActiveItems.get(e)??0;return s<=0?!1:(s===1?this.ownedActiveItems.delete(e):this.ownedActiveItems.set(e,s-1),!0)}getOwnedActiveItems(){return Array.from(this.ownedActiveItems.entries()).map(([e,s])=>({id:e,count:s}))}reset(){this.shopMoney=g.INITIAL_SHOP_MONEY,this.medals=g.INITIAL_MEDALS,this.sellMultiplier=1,this.ownedActiveItems.clear()}}let Nt=!1;function Di(){if(Nt)return;Nt=!0;const c=document.createElement("style");c.textContent=`
    @keyframes titleGlow {
  ...
  `,document.head.appendChild(c)}class Hi{constructor(e){l(this,"el");l(this,"titleEl");l(this,"onStartCallbacks",[]);l(this,"onSettingsCallbacks",[]);l(this,"hideTimer",null);Di(),this.el=document.createElement("div"),this.el.style.cssText=`
      position: absolute;
      inset: 0;
      display: none;
  ...
  `,document.head.appendChild(c)}class Gi{constructor(e){l(this,"container");l(this,"bar");l(this,"label");l(this,"reached",!1);l(this,"urgent",!1);l(this,"danger",!1);Bi(),this.container=document.createElement("div"),this.container.style.cssText=`
      position: absolute;
      top: 16px;
      left: 50%;
  ...
  `,document.head.appendChild(c)}class $i{constructor(e){l(this,"el");l(this,"medalCounter");l(this,"quotaBar");l(this,"phaseIndicator");l(this,"throwHint");l(this,"inventoryPanel");l(this,"activeItemPanel");l(this,"countdownEl");l(this,"feverBannerEl");l(this,"comboEl");l(this,"edgeGlowEl");l(this,"onUseActiveCallbacks",[]);l(this,"hideTimer",null);l(this,"jackpotHudEl");l(this,"jackpotBarEl");l(this,"comboHideTimer",null);l(this,"aimIndicatorEl");l(this,"stageCountEl");this.el=document.createElement("div"),this.el.style.cssText=`
    ...
    `,this.medalCounter=new Oi(this.el),this.quotaBar=new Gi(this.el),this.phaseIndicator=new Ni(this.el),this.throwHint=document.createElement("div"),this.throwHint.style.cssText=`
      position: absolute;
      bottom: 24px;
      left: 50%;
      transform: translateX(-50%);
    ...
    `,t.textContent="▸ ITEMS",this.inventoryPanel.appendChild(t);for(const a of e){const n=Ae(a.definitionId);if(!n)continue;const o=String(n.rarity),r=s[o]??"#9999aa",d=i[o]??"◇",p=document.createElement("div");p.style.cssText=`
      ...
      `,p.innerHTML=`
        <span style="color:${r};font-size:0.75rem;flex-shrink:0">${d}</span>
  ...
  `,document.head.appendChild(c)}class Wi{constructor(e){l(this,"el");l(this,"onContinueCallbacks",[]);l(this,"onSkipCallbacks",[]);l(this,"continueBtn");l(this,"shopBtn");l(this,"hideTimer",null);l(this,"countUpTimer",null);Fi(),this.el=document.createElement("div"),this.el.style.cssText=`
      position: absolute;
      inset: 0;
      display: none;
      flex-direction: column;
  ...
  `,document.head.appendChild(c)}class Vi{constructor(e){l(this,"el");l(this,"onRetryCallbacks",[]);l(this,"onTitleCallbacks",[]);l(this,"hideTimer",null);Ui(),this.el=document.createElement("div"),this.el.style.cssText=`
      position: absolute;
      inset: 0;
      display: none;
      flex-direction: column;
    ...
    `;const o=[{icon:"🏆",label:"Reached",value:`Phase ${e.phase} · Stage ${e.stage}`,highlight:!1},{icon:"🪙",label:"Medals Collected",value:String(e.totalMedalsCollected),highlight:!0},{icon:"✨",label:"Items Collected",value:String(e.totalItemsCollected),highlight:!1},{icon:"📈",label:"Best Run",value:`Phase ${e.bestPhase} · Stage ${e.bestStage}`,highlight:!1}];o.forEach((f,h)=>{const m=document.createElement("div");m.style.cssText=`
      ...
      `,n.appendChild(m)}),s.appendChild(n);const r=document.createElement("div"),d=.15+o.length*.08;r.style.cssText=`
  ...
  `,document.head.appendChild(c)}const qi={Gold:"💰",Alchemy:"⚗️",Throw:"🎯",Guard:"🛡️"},Qi={Gold:"#ffd700",Alchemy:"#00ff88",Throw:"#ff8800",Guard:"#4488ff"},ji={Common:"★",Uncommon:"★★",Rare:"★★★",Epic:"★★★★",Legendary:"★★★★★"},Zi={Common:"#aaaaaa",Uncommon:"#44cc77",Rare:"#4488ff",Epic:"#aa44ff",Legendary:"#ffaa00"};class Xi{constructor(e){l(this,"el");l(this,"onSelectCallbacks",[]);l(this,"hideTimer",null);Yi(),this.el=document.createElement("div"),this.el.style.cssText=`
    ...
    `;const r=document.createElement("div");r.style.cssText=`
      ...
      font-size: 3rem;
    `,r.textContent=t;const d=document.createElement("div");d.style.cssText="padding: 16px 18px;";const p=document.createElement("div");p.style.cssText="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;";const u=document.createElement("span");u.style.cssText=`
      font-size: 0.65rem;
      color: ${i};
      background: ${i}22;
...
`;class Ki{constructor(e){l(this,"el");l(this,"moneyEl");l(this,"inventoryEl");l(this,"onBuyMedalsCallbacks",[]);l(this,"onSellCallbacks",[]);l(this,"onContinueCallbacks",[]);l(this,"onBuyActiveCallbacks",[]);l(this,"hideTimer",null);this.el=document.createElement("div"),this.el.style.cssText=`
  ...
  `,document.head.appendChild(c)}class sa{constructor(e){l(this,"el");l(this,"onVolumeChangeCallbacks",[]);l(this,"onThemeChangeCallbacks",[]);l(this,"onCloseCallbacks",[]);l(this,"hideTimer",null);l(this,"themeBtns",new Map);ta(),this.el=document.createElement("div"),this.el.style.cssText=`
      position: absolute;
      inset: 0;
      display: none;
      flex-direction: column;
    ...
    `;const i=document.createElement("h2");i.style.cssText="font-size: 1.6rem; color: var(--t-primary); margin-bottom: 32px; letter-spacing: 0.2em; text-align: center;",i.textContent="SETTINGS",s.appendChild(i);const t=document.createElement("div");t.style.cssText="margin-bottom: 32px;";const a=document.createElement("div");a.style.cssText="font-size: 0.75rem; color: var(--t-text-dim); letter-spacing: 0.15em; margin-bottom: 16px; text-transform: uppercase;",a.textContent="VOLUME",t.appendChild(a);const n=[{label:"Master",type:"master",value:e.masterVolume},{label:"BGM",type:"bgm",value:e.bgmVolume},{label:"SFX",type:"sfx",value:e.sfxVolume}];for(const m of n){const y=document.createElement("div");y.style.cssText="display: flex; align-items: center; gap: 12px; margin-bottom: 14px;";const x=document.createElement("div");x.style.cssText="font-size: 0.85rem; color: var(--t-text-bright); width: 52px; flex-shrink: 0;",x.textContent=m.label;const v=document.createElement("input");v.type="range",v.min="0",v.max="1",v.step="0.05",v.value=String(m.value),v.className="settings-slider",v.style.cssText="flex: 1;";const E=document.createElement("div");E.style.cssText="font-size: 0.8rem; color: var(--t-primary); width: 36px; text-align: right; flex-shrink: 0;",E.textContent=`${Math.round(m.value*100)}%`,v.addEventListener("input",()=>{const C=parseFloat(v.value);E.textContent=`${Math.round(C*100)}%`,this.onVolumeChangeCallbacks.forEach(w=>w(m.type,C))}),y.appendChild(x),y.appendChild(v),y.appendChild(E),t.appendChild(y)}s.appendChild(t);const o=document.createElement("hr");o.style.cssText="border: none; border-top: 1px solid var(--t-border-faint); margin-bottom: 24px;",s.appendChild(o);const r=document.createElement("div");r.style.cssText="margin-bottom: 32px;";const d=document.createElement("div");d.style.cssText="font-size: 0.75rem; color: var(--t-text-dim); letter-spacing: 0.15em; margin-bottom: 16px; text-transform: uppercase;",d.textContent="THEME",r.appendChild(d);const p=document.createElement("div");p.style.cssText="display: flex; gap: 10px; flex-wrap: wrap;";const u=["royal","cyber","steampunk"];for(const m of u){const y=m===e.theme,x=document.createElement("button");x.style.cssText=`
      ...
      `,x.textContent=ss[m].displayName,x.addEventListener("click",()=>{this.selectTheme(m),this.onThemeChangeCallbacks.forEach(v=>v(m))}),this.themeBtns.set(m,x),p.appendChild(x)}r.appendChild(p),s.appendChild(r);const f=document.createElement("hr");f.style.cssText="border: none; border-top: 1px solid var(--t-border-faint); margin-bottom: 24px;",s.appendChild(f);const h=document.createElement("button");h.style.cssText=`
      width: 100%;
      padding: 12px;
      background: transparent;
  ...
  `,document.head.appendChild(c)}class aa{constructor(e){l(this,"el");l(this,"reelEls",[]);l(this,"reelWrapperEls",[]);l(this,"resultEl");l(this,"hideTimer",null);ia(),this.el=document.createElement("div"),this.el.style.cssText=`
      position: absolute;
      inset: 0;
      display: none;
      flex-direction: column;
...
}`,this._currentName=e,this._currentTheme=s,this._callbacks.forEach(t=>t(s))}onChange(e){this._callbacks.push(e)}};l(ge,"_instance",null);let ft=ge;const de=class de{constructor(){l(this,"comboCount",0);l(this,"lastCollectMs",0);l(this,"feverEndMs",0);l(this,"_wasInFever",!1)}onMedalCollected(e){const s=Date.now();s-this.lastCollectMs<de.COMBO_WINDOW_MS?this.comboCount+=e:this.comboCount=e,this.lastCollectMs=s,L.emit("combo:updated",{count:this.comboCount}),this.comboCount>=de.COMBO_TO_FEVER&&!this.isFever&&this._triggerFever()}update(){const e=this.isFever;this._wasInFever&&!e&&(this._wasInFever=!1,this.comboCount=0,L.emit("fever:ended",void 0)),this._wasInFever=e}get isFever(){return Date.now()<this.feverEndMs}get feverRemainingMs(){return Math.max(0,this.feverEndMs-Date.now())}get comboCountValue(){return this.comboCount}reset(){this.comboCount=0,this.lastCollectMs=0,this.feverEndMs=0,this._wasInFever=!1}_triggerFever(){this.feverEndMs=Date.now()+de.FEVER_DURATION_MS,this.comboCount=0,this._wasInFever=!0,L.emit("fever:started",void 0)}};l(de,"COMBO_WINDOW_MS",5e3),l(de,"COMBO_TO_FEVER",6),l(de,"FEVER_DURATION_MS",1e4),l(de,"FEVER_SPEED_MULT",1.6);let je=de;const Ue=new gt(.05,4,4),ca=new ie(.06,.06,.02,8),da=new Ds(.06,0),ha=new gt(.028,4,4);class pa{constructor(e){l(this,"particles",[]);l(this,"flashRings",[]);l(this,"scene");this.scene=e}spawnFlashRing(e,s,i,t){const a=new et(.1,.38,20),n=new Oe({color:t,transparent:!0,opacity:.9,side:tt}),o=new k(a,n);o.position.set(e,s,i),o.rotation.x=-Math.PI/2,this.scene.add(o),this.flashRings.push({mesh:o,life:0,maxLife:.25});const r=new et(.05,.22,16),d=new Oe({color:t,transparent:!0,opacity:.65,side:tt}),p=new k(r,d);p.position.set(e,s+.01,i),p.rotation.x=-Math.PI/2,this.scene.add(p),this.flashRings.push({mesh:p,life:-.06,maxLife:.35})}spawnMedalCollect(e,s,i){this.spawnFlashRing(e,s,i,16766720);const t=14;for(let a=0;a<t;a++){const n=a<5,o=n?ca:Ue,r=new N({color:n?16763904:16766720,emissive:new Y(n?14522624:16766720),emissiveIntensity:n?.6:1,metalness:n?.9:.3,roughness:n?.2:.5,transparent:!0}),d=new k(o,r);d.position.set(e,s,i);const p=a/t*Math.PI*2,u=1.5+Math.random()*3.5,f=new se(Math.cos(p)*u*.55,2.5+Math.random()*3.5,Math.sin(p)*u*.55);this.scene.add(d),this.particles.push({mesh:d,velocity:f,life:0,maxLife:.7+Math.random()*.5})}}spawnItemCollect(e,s,i,t){this.spawnFlashRing(e,s,i,t),this.spawnFlashRing(e,s+.1,i,t);const a=new Y(t),n=24;for(let o=0;o<n;o++){const d=o%3===0?da:Ue,p=new N({color:t,emissive:a,emissiveIntensity:1,metalness:.1,roughness:.4,transparent:!0}),u=new k(d,p);u.position.set(e,s,i);const f=o/n*Math.PI*2+Math.random()*.4,h=2.5+Math.random()*3,m=new se(Math.cos(f)*h,3.5+Math.random()*2.5,Math.sin(f)*h);this.scene.add(u),this.particles.push({mesh:u,velocity:m,life:0,maxLife:1.2+Math.random()*.5})}}spawnThrow(e,s,i){for(let a=0;a<9;a++){const n=new N({color:16766720,emissive:new Y(16766720),emissiveIntensity:1,metalness:.5,roughness:.3,transparent:!0}),o=new k(Ue,n);o.position.set(e,s,i);const r=a/9*Math.PI*2,d=1.2+Math.random()*1.6,p=new se(Math.cos(r)*d*.4,2.5+Math.random()*2,Math.sin(r)*d*.2);this.scene.add(o),this.particles.push({mesh:o,velocity:p,life:0,maxLife:.35+Math.random()*.2})}}spawnCoinGlints(e,s,i,t=3){const a=[16774314,16769152,16766720,16777215,16771248];for(let n=0;n<t;n++){const o=a[Math.floor(Math.random()*a.length)],r=new N({color:o,emissive:new Y(o),emissiveIntensity:2.5,transparent:!0,opacity:.9}),d=new k(ha,r),p=(Math.random()-.5)*1.2,u=(Math.random()-.5)*1.2;d.position.set(e+p,s+Math.random()*.1,i+u);const f=Math.random()*Math.PI*2,h=.4+Math.random()*.6,m=new se(Math.cos(f)*h*.3,.8+Math.random()*1.2,Math.sin(f)*h*.3);this.scene.add(d),this.particles.push({mesh:d,velocity:m,life:0,maxLife:.35+Math.random()*.25})}}spawnJackpot(e,s,i){this.spawnFlashRing(e,s,i,16766720);const t=new et(.3,.8,32),a=new Oe({color:16777215,transparent:!0,opacity:.85,side:tt}),n=new k(t,a);n.position.set(e,s,i),n.rotation.x=-Math.PI/2,this.scene.add(n),this.flashRings.push({mesh:n,life:0,maxLife:.4});const o=30;for(let r=0;r<o;r++){const d=r/o*360,p=new Y(`hsl(${d}, 100%, 60%)`),u=r%4===0,f=new N({color:p,emissive:p,emissiveIntensity:1,metalness:u?.8:.2,roughness:.3,transparent:!0}),h=new k(Ue,f);h.position.set(e,s,i);const m=r/o*Math.PI*2+Math.random()*.3,y=3.5+Math.random()*4.5,x=new se(Math.cos(m)*y,4+Math.random()*5,Math.sin(m)*y);this.scene.add(h),this.particles.push({mesh:h,velocity:x,life:0,maxLife:1.6+Math.random()*.6})}}update(e){const i=[];for(const a of this.particles){a.life+=e;const n=a.life/a.maxLife;a.velocity.y+=-9.8*e,a.mesh.position.addScaledVector(a.velocity,e),a.mesh.rotation.x+=e*5,a.mesh.rotation.y+=e*4,a.mesh.rotation.z+=e*3;const o=Math.max(0,1-n*.65);a.mesh.scale.setScalar(o),a.mesh.material.opacity=Math.pow(1-n,1.6),n>=1&&i.push(a)}for(const a of i)this.scene.remove(a.mesh),a.mesh.material.dispose(),this.particles.splice(this.particles.indexOf(a),1);const t=[];for(const a of this.flashRings){if(a.life+=e,a.life<0)continue;const n=a.life/a.maxLife,r=1+(1-Math.pow(1-n,2.2))*3.2;a.mesh.scale.set(r,r,r);const d=a.mesh.material.opacity>.7?.9:.65;a.mesh.material.opacity=d*Math.pow(1-n,.7),n>=1&&t.push(a)}for(const a of t)this.scene.remove(a.mesh),a.mesh.geometry.dispose(),a.mesh.material.dispose(),this.flashRings.splice(this.flashRings.indexOf(a),1)}clear(){for(const e of this.particles)this.scene.remove(e.mesh),e.mesh.material.dispose();this.particles=[];for(const e of this.flashRings)this.scene.remove(e.mesh),e.mesh.geometry.dispose(),e.mesh.material.dispose();this.flashRings=[]}}class ma{constructor(){l(this,"counter",0);l(this,"jackpotCount",0)}onQuotaAdded(e){this.counter+=e,L.emit("jackpot:progress",{current:this.counter,target:g.JACKPOT_THRESHOLD}),this.counter>=g.JACKPOT_THRESHOLD&&(this.counter-=g.JACKPOT_THRESHOLD,this.jackpotCount++,L.emit("jackpot:triggered",{count:this.jackpotCount}))}reset(){this.counter=0,this.jackpotCount=0}get progress(){return Math.min(1,this.counter/g.JACKPOT_THRESHOLD)}get current(){return this.counter}get target(){return g.JACKPOT_THRESHOLD}}const dt=1280,ht=720;function is(){const c=document.getElementById("ui-root");if(!c)return;const e=window.innerWidth<window.innerHeight,s=e?window.innerHeight:window.innerWidth,i=e?window.innerWidth:window.innerHeight,t=s/dt,a=i/ht,n=Math.min(t,a),o=Math.round((s-dt*n)/2),r=Math.round((i-ht*n)/2);c.style.width=`${dt}px`,c.style.height=`${ht}px`,c.style.transform=`translate(${o}px, ${r}px) scale(${n})`,c.style.transformOrigin="top left",c.style.inset="unset",c.style.top="0",c.style.left="0"}is();window.addEventListener("resize",is);screen.orientation&&"lock"in screen.orientation&&screen.orientation.lock("landscape").catch(()=>{});async function ua(){const c=ut.getInstance(),e=ft.getInstance();e.applyTheme(c.theme);const s=new Bs,i=new Gs,t=new zs,a=new Ai,n=new Ri;let o=0;const r=document.getElementById("app"),d=document.getElementById("ui-root"),p=new Ks(r),u=new Js,f=new ei(p),h=new ti(p.scene);p.setCamera(u.camera);const m=e.currentTheme;p.applySceneTheme(m.scene),f.applyTheme(m.lights),h.applyTheme(m.scene);const y=new Mi,x=new Ci(s),v=new _i,E=new Pi,C=new ki,w=new Li,T=new Ei(p,y,v,m.scene);T.setMedalQuotaMultiplierFn(()=>E.quotaPerMedalMultiplier);const b=new na(d),H=new la(p.renderer.domElement);b.titleScreen.applyTheme(c.theme);const D=new je,P=new pa(p.scene),I=new ma,_=new mt;_.setMasterVolume(c.masterVolume),_.setBgmVolume(c.bgmVolume),_.setSfxVolume(c.sfxVolume),e.onChange(S=>{p.applySceneTheme(S.scene),f.applyTheme(S.lights),h.applyTheme(S.scene),b.titleScreen.applyTheme(S.name),T.physicsWorld.initialized&&T.rebuildFieldMesh(S.scene)}),b.titleScreen.onSettings(()=>{b.settingsScreen.show(c.snapshot)}),b.settingsScreen.onClose(()=>{b.settingsScreen.hide()}),b.settingsScreen.onVolumeChange((S,B)=>{S==="master"?(c.setMasterVolume(B),_.setMasterVolume(B)):S==="bgm"?(c.setBgmVolume(B),_.setBgmVolume(B)):(c.setSfxVolume(B),_.setSfxVolume(B))}),b.settingsScreen.onThemeChange(S=>{c.setTheme(S),e.applyTheme(S)});let z=0,F=!1,$=0,W=0,j=0;b.titleScreen.onStart(()=>{s.is(M.TITLE)&&Be()}),b.stageResultScreen.onContinue(()=>{b.stageResultScreen.hide(),x.advanceStage(),be()}),b.stageResultScreen.onSkip(()=>{b.stageResultScreen.hide(),x.advancePhase(),Ze()}),b.shopScreen.onBuyMedals(S=>{const B=S*g.MEDAL_BUY_PRICE;w.buyMedals(S)?b.shopScreen.show(w.money,v.getAll(),w.getOwnedActiveItems()):console.log(`Not enough shop money (need ${B} G, have ${w.money} G)`)}),b.shopScreen.onSell(S=>{const B=w.sellItem(S,v);a.addShopMoney(B),b.shopScreen.show(w.money,v.getAll(),w.getOwnedActiveItems())}),b.shopScreen.onBuyActive(S=>{w.buyActiveItem(S)&&b.shopScreen.show(w.money,v.getAll(),w.getOwnedActiveItems())}),b.shopScreen.onContinue(()=>{b.shopScreen.hide(),Ge()}),b.skillSelectScreen.onSelect(S=>{E.addSkill(S,x.currentPhase),w.setSellMultiplier(E.itemSellMultiplier),b.skillSelectScreen.hide(),s.transition(M.STAGE_START),be()}),b.resultScreen.onRetry(()=>{b.resultScreen.hide(),s.transition(M.TITLE),b.titleScreen.show()}),b.resultScreen.onTitle(()=>{b.resultScreen.hide(),s.transition(M.TITLE),b.titleScreen.show()}),b.gameScreen.onUseActive(S=>{if(!s.is(M.PLAYING)||!w.useActiveItem(S))return;const B=Gt(S);if(!B)return;const V=Date.now()+B.durationMs;if(S==="side_guard")j=V,T.addSideGuardWalls(),T.fieldMesh.addSideGuardMeshes(T.fieldMesh.group);else if(S==="medal_fever")W=V;else if(S==="medal_shower"){for(let Z=0;Z<20;Z++)setTimeout(()=>{if(!s.is(M.PLAYING))return;const J=(Math.random()*2-1)*(g.FIELD_WIDTH/2-.5),re=(Math.random()-.5)*(g.FIELD_DEPTH/2);T.medalSpawner.spawn(J,5,re,T.physicsWorld,T.physicsSync,T.collisionHandler,p)},Z*150);u.shake(.12,.3)}else S==="earthquake"&&(T.shakeAllMedals(4),u.shake(.4,.5),b.gameScreen.showFloatingText("🌋 地震！","var(--t-secondary)"))}),H.onAim(S=>{s.is(M.PLAYING)?b.gameScreen.showAim(S):b.gameScreen.hideAim()}),H.onThrow((S,B)=>{if(!s.is(M.PLAYING))return;const V=S*(g.FIELD_WIDTH/2+.5),Z=E.medalThrowCount;let J=0;for(let re=0;re<Z&&w.spendMedal();re++){const we=(re-Math.floor(Z/2))*.6;T.throwMedal(V+we,B),J++}J>0&&(L.emit("medal:thrown",{count:J}),P.spawnThrow(V,2,g.FIELD_DEPTH/2-.5))}),L.on("quota:reached",()=>{s.is(M.PLAYING)&&(H.disable(),setTimeout(()=>{if(!s.is(M.PLAYING))return;const S=E.onClearBonusMedals;S>0&&w.addMedals(S);const B=Math.max(0,Math.floor((y.currentValue/y.targetValue-1)*100)),V=15+Math.min(30,B);w.addMoney(V),x.clearCurrentStage(),b.chanceScreen.show(Z=>{Z.medals>0&&(w.addMedals(Z.medals),b.gameScreen.showFloatingText(`+${Z.medals}`,"var(--t-primary)"));const J=x.isLastStageOfPhase;b.stageResultScreen.show(x.currentPhase,x.currentStage,J,y.currentValue,y.targetValue)})},500))}),L.on("medal:collected",({count:S,x:B,y:V,z:Z})=>{if(s.is(M.PLAYING)){const J=(B/g.FIELD_WIDTH*2+1)/2*72+14;b.gameScreen.showFloatingText(`+${S}`,S>=2?"var(--t-secondary)":"var(--t-primary)",J),w.addMedals(S),D.onMedalCollected(S),I.onQuotaAdded(S),P.spawnMedalCollect(B,Math.max(V,0),Z),o+=S*150+Math.floor(Math.random()*50),oe.refreshJackpot(o),T.fieldMesh.triggerCollectionFlash()}}),L.on("item:collected",({x:S,y:B,z:V})=>{s.is(M.PLAYING)&&P.spawnItemCollect(S,Math.max(B,0),V,59647)}),L.on("jackpot:progress",({current:S,target:B})=>{s.is(M.PLAYING)&&b.gameScreen.updateJackpot(S,B)}),L.on("jackpot:triggered",()=>{if(!s.is(M.PLAYING))return;w.addMedals(g.JACKPOT_MEDAL_REWARD),b.gameScreen.showFloatingText(`JACKPOT! +${g.JACKPOT_MEDAL_REWARD}`,"var(--t-primary)"),_.playJackpotFanfare(),u.shake(.35,.6),P.spawnJackpot(0,2,-2),b.gameScreen.resetJackpot(g.JACKPOT_THRESHOLD)}),L.on("fever:started",()=>{T.pusher.speedMultiplier=je.FEVER_SPEED_MULT;const B=1.5*(W>Date.now()?2:1)*E.quotaPerMedalMultiplier;b.gameScreen.showFever(1e4,B),_.playFeverStart(),f.setFeverMode(!0),_.startBGM(!0),u.shake(.2,.4);for(let V=0;V<12;V++)setTimeout(()=>{if(!s.is(M.PLAYING))return;const Z=(Math.random()*2-1)*(g.FIELD_WIDTH/2-.5),J=(Math.random()*2-1)*(g.FIELD_DEPTH/4);T.medalSpawner.spawn(Z,4.5,J,T.physicsWorld,T.physicsSync,T.collisionHandler,p)},V*250)}),L.on("fever:ended",()=>{T.pusher.speedMultiplier=1,b.gameScreen.hideFever(),b.gameScreen.hideCombo(),_.playFeverEnd(),f.setFeverMode(!1),_.startBGM(!1)}),L.on("combo:updated",({count:S})=>{s.is(M.PLAYING)&&S>=2&&(b.gameScreen.showCombo(S),_.playCombo(S))}),L.on("medal:thrown",()=>{_.playThrow(),b.gameScreen.flashAim()}),L.on("medal:collected",()=>_.playMedalCollected()),L.on("quota:reached",()=>_.playQuotaReached()),L.on("stage:cleared",()=>_.playStageCleared()),L.on("game:over",()=>_.playGameOver()),L.on("skill:selected",()=>_.playSkillSelected()),L.on("medal:collected",()=>u.shake(.04,.08)),L.on("quota:reached",()=>u.shake(.15,.3)),L.on("stage:cleared",()=>u.shake(.28,.5)),L.on("game:over",()=>u.shake(.5,.8)),L.on("state:changed",({to:S})=>{S===M.PLAYING?_.startBGM(!1):_.stopBGM(),u.setTitleMode(S===M.TITLE)});let te=0,xe=0;i.addUpdateFn(S=>{if(te+=S,s.is(M.PLAYING)){const B=Date.now();j>0&&B>j&&(j=0,T.removeSideGuardWalls(),T.fieldMesh.removeSideGuardMeshes(T.fieldMesh.group)),W>0&&B>W&&(W=0);const V=W>Date.now()?2:1,Z=D.isFever?1.5:1,J=V*Z;T.setMedalQuotaMultiplierFn(()=>E.quotaPerMedalMultiplier*J),T.update(S),xe+=S;const re=D.isFever?.25:.55;if(xe>=re&&T.medalSpawner.count>0){xe=0;const ae=(Math.random()-.5)*5,le=-2+(Math.random()-.5)*4,Te=D.isFever?5:2;P.spawnCoinGlints(ae,.5,le,Te)}const we=w.getOwnedActiveItems().map(ae=>{const le=Gt(ae.id),Te=ae.id==="side_guard"?Math.max(0,j-Date.now()):ae.id==="medal_fever"?Math.max(0,W-Date.now()):0;return{...ae,name:le.name,color:le.color,remainingMs:Te}});if(b.updateGameHUD(w.currentMedals,y.currentValue,y.targetValue,x.currentPhase,x.currentStage,v.getAll(),we),!F&&w.currentMedals<=0&&!y.isReached&&(F=!0,$=10,H.disable(),b.gameScreen.quotaBar.setDanger(!0)),F&&$>0){const ae=Math.ceil($);$-=S;const le=Math.ceil($);le!==ae&&le>0&&_.playCountdownTick(),$>0?b.gameScreen.showCountdown($):(b.gameScreen.hideCountdown(),Pe())}}D.update(),P.update(S),h.update(S),f.update(te),u.update(S),p.render(u.camera)});function Be(){t.incrementRuns(),w.reset(),v.clear(),E.reset(),a.reset(),x.reset(),z=0,F=!1,$=0,W=0,j=0,D.reset(),I.reset(),T.pusher.speedMultiplier=1,o=0,oe.refreshJackpot(0),s.transition(M.STAGE_START),be()}async function be(){const S=x.currentPhase,B=x.currentStage;F=!1,$=0,b.gameScreen.hideCountdown(),b.gameScreen.quotaBar.setDanger(!1),D.reset(),I.reset(),T.pusher.speedMultiplier=1,b.gameScreen.hideFever(),b.gameScreen.hideCombo(),b.gameScreen.resetJackpot(g.JACKPOT_THRESHOLD),y.startStage(S,B);try{T.physicsWorld.initialized?T.endStage():(ve(!0),await T.init(),ve(!1))}catch(V){console.error("Field init failed:",V),ve(!1);return}T.startStage(S,B),x.startCurrentStage(),b.gameScreen.showStageCountdown(S,B,()=>{s.is(M.PLAYING)&&H.enable()})}function Ze(){T.endStage(),s.transition(M.SHOP),b.shopScreen.show(w.money,v.getAll(),w.getOwnedActiveItems())}function Ge(){s.transition(M.SKILL_SELECT);const S=C.pickChoices(g.SKILL_CHOICES,E.getOwnedSkills(),Date.now());b.skillSelectScreen.show(S)}function Pe(){if(z>0){z--,$=0,b.gameScreen.hideCountdown(),H.enable(),F=!1;return}T.endStage();const S=n.calculate(a.snapshot,t);t.updateBest(S.phase,S.stage),s.transition(M.GAME_OVER),s.transition(M.RESULT),b.resultScreen.show(S)}const me=document.createElement("div");me.style.cssText=`
    position: absolute; inset: 0; display: none;
    align-items: center; justify-content: center;
    background: var(--t-bg-overlay-dark); color: var(--t-primary);
    font-size: 1.2rem; letter-spacing: 0.2em;
  `,me.textContent="LOADING...",d.appendChild(me);function ve(S){me.style.display=S?"flex":"none"}L.on("skill:selected",()=>{z=Math.max(z,E.gameOverShields)}),i.start(),u.setTitleMode(!0),s.transition(M.TITLE),b.titleScreen.show(),console.log("YukiMedal initialized")}ua().catch(console.error);
