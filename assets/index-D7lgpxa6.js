var ot=Object.defineProperty;var lt=(o,e,t)=>e in o?ot(o,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):o[e]=t;var r=(o,e,t)=>lt(o,typeof e!="symbol"?e+"":e,t);import{M as K,O as ct,B as et,F as Be,S as ce,U as Se,V as X,W as xe,H as Ee,N as dt,C as ht,a as fe,b as ee,A as ut,c as pt,R as mt,d as ft,e as gt,L as yt,f as bt,g as Tt,h as tt,i as xt,j as Et,k as St,l as vt,m as wt,P as Ct,n as Mt,o as st,p as _t,D as Ge,q as ye,r as It,s as At,t as Pt,G as Ne,u as Rt,v as Q,w as Lt,I as kt,x as V,y as Dt,z as be,E as M,T as Ht}from"./three--ETyBs3O.js";import{O as Te}from"./rapier-DpxwuBBO.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const a of n.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function t(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(s){if(s.ep)return;s.ep=!0;const n=t(s);fetch(s.href,n)}})();var v=(o=>(o.INIT="INIT",o.TITLE="TITLE",o.STAGE_START="STAGE_START",o.PLAYING="PLAYING",o.STAGE_CLEAR="STAGE_CLEAR",o.SKIP_PROMPT="SKIP_PROMPT",o.GAME_OVER="GAME_OVER",o.SHOP="SHOP",o.SKILL_SELECT="SKILL_SELECT",o.RESULT="RESULT",o))(v||{});class Bt{constructor(){r(this,"listeners",new Map)}on(e,t){this.listeners.has(e)||this.listeners.set(e,new Set);const i=this.listeners.get(e);return i.add(t),()=>i.delete(t)}once(e,t){const i=this.on(e,s=>{t(s),i()})}emit(e,t){const i=this.listeners.get(e);if(i)for(const s of i)s(t)}off(e,t){var i;(i=this.listeners.get(e))==null||i.delete(t)}clear(){this.listeners.clear()}}const A=new Bt,Gt=[{from:v.INIT,to:v.TITLE},{from:v.TITLE,to:v.STAGE_START},{from:v.STAGE_START,to:v.PLAYING},{from:v.PLAYING,to:v.STAGE_CLEAR},{from:v.PLAYING,to:v.GAME_OVER},{from:v.STAGE_CLEAR,to:v.STAGE_START},{from:v.STAGE_CLEAR,to:v.SKIP_PROMPT},{from:v.STAGE_CLEAR,to:v.SHOP},{from:v.SKIP_PROMPT,to:v.SHOP},{from:v.SKIP_PROMPT,to:v.STAGE_START},{from:v.SHOP,to:v.SKILL_SELECT},{from:v.SKILL_SELECT,to:v.STAGE_START},{from:v.GAME_OVER,to:v.RESULT},{from:v.RESULT,to:v.TITLE}];class Nt{constructor(){r(this,"current",v.INIT)}get state(){return this.current}canTransition(e){return Gt.some(t=>(Array.isArray(t.from)?t.from:[t.from]).includes(this.current)&&t.to===e)}transition(e){if(!this.canTransition(e))throw new Error(`Invalid state transition: ${this.current} → ${e}`);const t=this.current;this.current=e,A.emit("state:changed",{from:t,to:e})}is(e){return this.current===e}isAny(...e){return e.includes(this.current)}}class Ot{constructor(){r(this,"updateFns",[]);r(this,"rafId",null);r(this,"lastTime",0);r(this,"maxDelta",1/20)}addUpdateFn(e){this.updateFns.push(e)}removeUpdateFn(e){const t=this.updateFns.indexOf(e);t!==-1&&this.updateFns.splice(t,1)}start(){if(this.rafId!==null)return;this.lastTime=performance.now();const e=t=>{this.rafId=requestAnimationFrame(e);const i=(t-this.lastTime)/1e3;this.lastTime=t;const s=Math.min(i,this.maxDelta);for(const n of this.updateFns)n(s)};this.rafId=requestAnimationFrame(e)}stop(){this.rafId!==null&&(cancelAnimationFrame(this.rafId),this.rafId=null)}get isRunning(){return this.rafId!==null}}const Oe="yukimedal_save",Ut="yukimedal_best",ve={bestPhase:0,bestStage:0,totalRuns:0,lastPlayedAt:0};class Ft{constructor(){r(this,"data");this.data=this.load()}load(){try{const e=localStorage.getItem(Oe);return e?{...ve,...JSON.parse(e)}:{...ve}}catch{return{...ve}}}save(){try{localStorage.setItem(Oe,JSON.stringify(this.data))}catch{}}updateBest(e,t){const i=e*3+t,s=this.data.bestPhase*3+this.data.bestStage;i>s&&(this.data.bestPhase=e,this.data.bestStage=t,localStorage.setItem(Ut,JSON.stringify({phase:e,stage:t}))),this.data.lastPlayedAt=Date.now(),this.save()}incrementRuns(){this.data.totalRuns++,this.save()}get bestPhase(){return this.data.bestPhase}get bestStage(){return this.data.bestStage}get totalRuns(){return this.data.totalRuns}}const it={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		}`};class Xt extends he{constructor(){super();const e=Kt;this.uniforms=Se.clone(e.uniforms),this.material=new mt({name:e.name,uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader}),this.fsQuad=new Pe(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,i){this.uniforms.tDiffuse.value=i.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},ft.getTransfer(this._outputColorSpace)===gt&&(this.material.defines.SRGB_TRANSFER=""),this._toneMapping===yt?this.material.defines.LINEAR_TONE_MAPPING="":this._toneMapping===bt?this.material.defines.REINHARD_TONE_MAPPING="":this._toneMapping===Tt?this.material.defines.CINEON_TONE_MAPPING="":this._toneMapping===tt?this.material.defines.ACES_FILMIC_TONE_MAPPING="":this._toneMapping===xt?this.material.defines.AGX_TONE_MAPPING="":this._toneMapping===Et&&(this.material.defines.NEUTRAL_TONE_MAPPING=""),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this.fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this.fsQuad.render(e))}dispose(){this.material.dispose(),this.fsQuad.dispose()}}class jt{constructor(e){r(this,"scene");r(this,"renderer");r(this,"composer");r(this,"renderPass");r(this,"bloomPass");r(this,"onResize",()=>{this.renderer.setSize(window.innerWidth,window.innerHeight),this.composer.setSize(window.innerWidth,window.innerHeight)});this.scene=new St,this.scene.background=new fe(1710638),this.scene.fog=new vt(1710638,20,60),this.renderer=new wt({antialias:!0}),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=Ct,this.renderer.toneMapping=tt,this.renderer.toneMappingExposure=1.1,this.renderer.outputColorSpace=Mt,e.appendChild(this.renderer.domElement);const t=window.innerWidth,i=window.innerHeight,s=new st(60,t/i,.1,200);this.renderPass=new Qt(this.scene,s),this.bloomPass=new de(new X(t,i),.75,.4,.82);const n=new Xt;this.composer=new qt(this.renderer),this.composer.addPass(this.renderPass),this.composer.addPass(this.bloomPass),this.composer.addPass(n),window.addEventListener("resize",this.onResize)}setCamera(e){this.renderPass.camera=e}applySceneTheme(e){this.scene.background.set(e.background),this.scene.fog&&this.scene.fog.color.set(e.fogColor),this.bloomPass.strength=e.bloomStrength,this.bloomPass.threshold=e.bloomThreshold,this.bloomPass.radius=e.bloomRadius}render(e){this.renderPass.camera=e,this.composer.render()}add(...e){this.scene.add(...e)}remove(...e){this.scene.remove(...e)}dispose(){window.removeEventListener("resize",this.onResize),this.renderer.dispose()}}const h={INITIAL_MEDALS:50,INITIAL_SHOP_MONEY:0,MEDAL_BUY_PRICE:5,BASE_QUOTA:30,QUOTA_MULTIPLIER:1.6,STAGES_PER_PHASE:3,FIELD_WIDTH:8,FIELD_DEPTH:12,FIELD_HEIGHT:.1,PUSHER_WIDTH:8,PUSHER_DEPTH:6.5,PUSHER_HEIGHT:1.2,PUSHER_RANGE:2.5,PUSHER_PERIOD_MS:4e3,MEDAL_RADIUS:.5,MEDAL_RADIUS_LARGE:.75,MEDAL_THICKNESS:.05,MEDAL_MASS:1,MAX_MEDALS_ON_FIELD:200,INITIAL_FIELD_MEDALS:40,INITIAL_PUSHER_MEDALS:20,MEDAL_PROB_NORMAL:60,MEDAL_PROB_DOUBLE:85,ITEMS_PER_STAGE:3,SKILL_CHOICES:3,GRAVITY:-9.81,CAMERA_FOV:45,CAMERA_NEAR:.1,CAMERA_FAR:100,OPEN_ZONE_START:.5,MEDAL_CLEANUP_Y:-6};class Jt{constructor(){r(this,"camera");r(this,"target",new ee(0,0,-1));r(this,"basePosition",new ee(0,7,16));r(this,"shakeOffset",new ee);r(this,"shakeIntensity",0);r(this,"shakeDecay",0);r(this,"onResize",()=>{this.camera.aspect=window.innerWidth/window.innerHeight,this.camera.updateProjectionMatrix()});this.camera=new st(h.CAMERA_FOV,window.innerWidth/window.innerHeight,h.CAMERA_NEAR,h.CAMERA_FAR),this.setFrontView(),window.addEventListener("resize",this.onResize)}setFrontView(){this.basePosition.set(0,7,16),this.camera.position.copy(this.basePosition),this.camera.lookAt(this.target)}shake(e,t){this.shakeIntensity=e,this.shakeDecay=t>0?-Math.log(.01)/t:0}update(e){this.shakeIntensity>.001?(this.shakeOffset.set((Math.random()*2-1)*this.shakeIntensity,(Math.random()*2-1)*this.shakeIntensity,0),this.camera.position.copy(this.basePosition).add(this.shakeOffset),this.shakeIntensity*=Math.exp(-this.shakeDecay*e)):(this.shakeIntensity=0,this.camera.position.copy(this.basePosition)),this.camera.lookAt(this.target)}lookAt(e){this.target.copy(e),this.camera.lookAt(this.target)}dispose(){window.removeEventListener("resize",this.onResize)}}class es{constructor(e){r(this,"ambient");r(this,"dirLight");r(this,"fillLight");r(this,"warmPoint");r(this,"coolPoint");r(this,"sideLeft");r(this,"sideRight");this.ambient=new _t(4210784,.6),this.dirLight=new Ge(16777215,1.8),this.dirLight.position.set(5,10,5),this.dirLight.castShadow=!0,this.dirLight.shadow.mapSize.width=2048,this.dirLight.shadow.mapSize.height=2048,this.dirLight.shadow.camera.near=.1,this.dirLight.shadow.camera.far=40,this.dirLight.shadow.camera.left=-10,this.dirLight.shadow.camera.right=10,this.dirLight.shadow.camera.top=10,this.dirLight.shadow.camera.bottom=-10,this.fillLight=new Ge(4210943,.3),this.fillLight.position.set(-5,5,-5),this.warmPoint=new ye(16765056,1.8,25),this.warmPoint.position.set(0,6,8),this.coolPoint=new ye(4482815,1.2,20),this.coolPoint.position.set(0,4,-8),this.sideLeft=new ye(16773344,1,22),this.sideLeft.position.set(-9,4,2),this.sideRight=new ye(16773344,1,22),this.sideRight.position.set(9,4,2),e.add(this.ambient,this.dirLight,this.fillLight,this.warmPoint,this.coolPoint,this.sideLeft,this.sideRight)}applyTheme(e){this.ambient.color.set(e.ambientColor),this.ambient.intensity=e.ambientIntensity,this.fillLight.color.set(e.fillColor),this.fillLight.intensity=e.fillIntensity,this.warmPoint.color.set(e.warmPointColor),this.warmPoint.intensity=e.warmPointIntensity,this.coolPoint.color.set(e.coolPointColor),this.coolPoint.intensity=e.coolPointIntensity}}class ts{constructor(e){r(this,"stars");r(this,"starMat");r(this,"grid");r(this,"scene");this.scene=e;const t=2e3,i=new Float32Array(t*3),s=60;for(let a=0;a<t;a++){const l=Math.random()*Math.PI*2,c=Math.acos(2*Math.random()-1),u=Math.cbrt(Math.random())*s;i[a*3]=u*Math.sin(c)*Math.cos(l),i[a*3+1]=u*Math.sin(c)*Math.sin(l),i[a*3+2]=u*Math.cos(c)}const n=new et;n.setAttribute("position",new It(i,3)),this.starMat=new At({size:.07,color:8952319,transparent:!0,opacity:.65,sizeAttenuation:!0}),this.stars=new Pt(n,this.starMat),e.add(this.stars),this.grid=new Ne(80,40,1714782,924218),this.grid.position.y=-4,e.add(this.grid)}applyTheme(e){this.starMat.color.set(e.starColor),this.scene.remove(this.grid),this.grid.geometry.dispose(),this.grid.material.dispose(),this.grid=new Ne(80,40,e.gridColorA,e.gridColorB),this.grid.position.y=-4,this.scene.add(this.grid)}update(e){this.stars.rotation.y+=.008*e}}class ss{constructor(){r(this,"world");r(this,"_initialized",!1)}async init(){await Te.init(),this.world=new Te.World({x:0,y:h.GRAVITY,z:0});const e=this.world.integrationParameters;e.numSolverIterations=16,e.numAdditionalFrictionIterations=8,e.numInternalPgsIterations=2,e.maxCcdSubsteps=8,this._initialized=!0}get rapier(){return Te}get instance(){if(!this._initialized)throw new Error("PhysicsWorld not initialized");return this.world}get initialized(){return this._initialized}step(){this.world.step()}createRigidBody(e){return this.world.createRigidBody(e)}createCollider(e,t){return this.world.createCollider(e,t)}removeRigidBody(e){this.world.removeRigidBody(e)}getEventQueue(){return new Te.EventQueue(!0)}stepWithEvents(e){this.world.step(e)}forEachActiveRigidBody(e){this.world.forEachActiveRigidBody(e)}setTimestep(e){this._initialized&&(this.world.integrationParameters.dt=e)}dispose(){this._initialized&&(this.world.free(),this._initialized=!1)}}class is{constructor(){r(this,"bodyToMesh",new Map)}register(e,t){this.bodyToMesh.set(e.handle,t)}unregister(e){this.bodyToMesh.delete(e.handle)}sync(e){e.forEachActiveRigidBody(t=>{const i=this.bodyToMesh.get(t.handle);if(!i)return;const s=t.translation(),n=t.rotation();i.position.set(s.x,s.y,s.z),i.quaternion.set(n.x,n.y,n.z,n.w)})}clear(){this.bodyToMesh.clear()}get count(){return this.bodyToMesh.size}}class ns{constructor(){r(this,"handles",new Map);r(this,"dropZoneHandles",new Set);r(this,"eventQueue");r(this,"medalCollectedCallback");r(this,"itemCollectedCallback")}init(e){this.eventQueue=e.getEventQueue()}registerHandle(e,t){this.handles.set(e,t),t==="drop_zone"&&this.dropZoneHandles.add(e)}unregisterHandle(e){this.handles.delete(e),this.dropZoneHandles.delete(e)}onMedalCollected(e){this.medalCollectedCallback=e}onItemCollected(e){this.itemCollectedCallback=e}processEvents(e,t=1){for(let i=0;i<t;i++)e.stepWithEvents(this.eventQueue);this.eventQueue.drainCollisionEvents((i,s,n)=>{var u,y;if(!n)return;const a=this.handles.get(i),l=this.handles.get(s);if(a==="drop_zone"&&(l==="medal"||l==="item")||l==="drop_zone"&&(a==="medal"||a==="item")){const d=a==="drop_zone"?s:i,p=a==="drop_zone"?l:a;p==="medal"?(u=this.medalCollectedCallback)==null||u.call(this,d):p==="item"&&((y=this.itemCollectedCallback)==null||y.call(this,d))}})}getTag(e){return this.handles.get(e)}clear(){this.handles.clear(),this.dropZoneHandles.clear(),this.medalCollectedCallback=void 0,this.itemCollectedCallback=void 0}}class as{constructor(){r(this,"body");r(this,"time",0);r(this,"zBase");r(this,"initialized",!1);this.zBase=-12/2+h.PUSHER_DEPTH/2-h.PUSHER_RANGE}async initPhysics(e){const t=e.rapier,i=t.RigidBodyDesc.kinematicVelocityBased().setTranslation(0,h.PUSHER_HEIGHT/2,this.zBase);this.body=e.createRigidBody(i);const s=t.ColliderDesc.cuboid(h.PUSHER_WIDTH/2,h.PUSHER_HEIGHT/2,h.PUSHER_DEPTH/2);e.createCollider(s,this.body),this.initialized=!0}update(e){this.time+=e;const t=h.PUSHER_PERIOD_MS/1e3,i=this.time%t/t,s=(1-Math.cos(i*Math.PI*2))/2*h.PUSHER_RANGE;if(this.initialized){const n=Math.PI*h.PUSHER_RANGE/t*Math.sin(i*Math.PI*2);this.body.setLinvel({x:0,y:0,z:n},!0),i<e/t&&this.body.setTranslation({x:0,y:h.PUSHER_HEIGHT/2,z:this.zBase},!0)}return s}get currentZOffset(){const e=h.PUSHER_PERIOD_MS/1e3,t=this.time%e/e;return(1-Math.cos(t*Math.PI*2))/2*h.PUSHER_RANGE}get restZ(){return this.zBase}}function rs(o){return[o>>16&255,o>>8&255,o&255]}function we(o){const e=o.replace("#","");return[parseInt(e.slice(0,2),16),parseInt(e.slice(2,4),16),parseInt(e.slice(4,6),16)]}function le(o,e,t,i){return`rgb(${Math.min(255,o+i)},${Math.min(255,e+i)},${Math.min(255,t+i)})`}function Ce(o,e,t,i){return`rgb(${Math.max(0,o-i)},${Math.max(0,e-i)},${Math.max(0,t-i)})`}function Fe(o,e,t){return`rgb(${o},${e},${t})`}function q(o,e,t,i,s){return`rgba(${Math.min(255,o+i)},${Math.min(255,e+i)},${Math.min(255,t+i)},${s})`}class me{static get(e,t){if(!this.cache.has(e)){const i=t(),s=new Rt(i);this.cache.set(e,s)}return this.cache.get(e)}static getMedalTexture(e){return this.get(`medal_${e.toString(16)}`,()=>{const i=document.createElement("canvas");i.width=i.height=128;const s=i.getContext("2d"),n=128/2,a=128/2,l=128/2-1,[c,u,y]=rs(e),d=Fe(c,u,y),p=le(c,u,y,65),m=le(c,u,y,30),b=Ce(c,u,y,55),f=Ce(c,u,y,80),g=s.createRadialGradient(n-18,a-18,4,n,a,l);g.addColorStop(0,p),g.addColorStop(.45,m),g.addColorStop(.8,d),g.addColorStop(1,b),s.fillStyle=g,s.beginPath(),s.arc(n,a,l,0,Math.PI*2),s.fill(),s.strokeStyle=f,s.lineWidth=5,s.beginPath(),s.arc(n,a,l-5,0,Math.PI*2),s.stroke();const x=s.createRadialGradient(n,a,0,n,a,38);x.addColorStop(0,m),x.addColorStop(.7,d),x.addColorStop(1,b),s.fillStyle=x,s.beginPath(),s.arc(n,a,38,0,Math.PI*2),s.fill(),s.strokeStyle=f,s.lineWidth=1.5,s.stroke(),s.strokeStyle=p,s.lineWidth=2.5,s.lineCap="round";for(let I=0;I<6;I++){const E=I*Math.PI/3-Math.PI/6;s.beginPath(),s.moveTo(n+Math.cos(E)*7,a+Math.sin(E)*7),s.lineTo(n+Math.cos(E)*28,a+Math.sin(E)*28),s.stroke()}const w=s.createRadialGradient(n-2,a-2,0,n,a,8);w.addColorStop(0,p),w.addColorStop(1,d),s.fillStyle=w,s.beginPath(),s.arc(n,a,8,0,Math.PI*2),s.fill();const T=s.createRadialGradient(n-26,a-26,0,n-26,a-26,50);return T.addColorStop(0,"rgba(255,255,255,0.5)"),T.addColorStop(.4,"rgba(255,255,255,0.12)"),T.addColorStop(1,"rgba(255,255,255,0)"),s.fillStyle=T,s.beginPath(),s.arc(n,a,l-2,0,Math.PI*2),s.fill(),i})}static getFieldTexture(e="#2a2a4e"){return this.get(`field_${e}`,()=>{const i=document.createElement("canvas");i.width=i.height=256;const s=i.getContext("2d"),[n,a,l]=we(e),c=n>l+20;if(s.fillStyle=e,s.fillRect(0,0,256,256),c){for(let p=0;p<22;p++){const m=256*p/22,b=p%3===0,f=b?.55:.45;s.strokeStyle=b?`rgba(${Math.max(0,n-22)},${Math.max(0,a-16)},${Math.max(0,l-8)},${f})`:`rgba(${Math.min(255,n+22)},${Math.min(255,a+16)},${Math.min(255,l+8)},${f})`,s.lineWidth=2+Math.random()*4,s.beginPath();for(let g=0;g<=256;g+=4){const x=m+Math.sin(g*.035+p)*2.5+(Math.random()-.5)*.8;g===0?s.moveTo(g,x):s.lineTo(g,x)}s.stroke()}s.strokeStyle=q(n,a,l,40,.12),s.lineWidth=.5;for(let p=0;p<256;p+=6)s.beginPath(),s.moveTo(0,p+.5),s.lineTo(256,p+.5),s.stroke()}else{s.strokeStyle=q(n,a,l,80,.14),s.lineWidth=1;for(let d=0;d<=256;d+=32)s.beginPath(),s.moveTo(d,0),s.lineTo(d,256),s.stroke();for(let d=0;d<=256;d+=32)s.beginPath(),s.moveTo(0,d),s.lineTo(256,d),s.stroke()}const u=s.getImageData(0,0,256,256),y=u.data;for(let d=0;d<y.length;d+=4){const p=(Math.random()-.5)*(c?14:18);y[d]=Math.max(0,Math.min(255,y[d]+p)),y[d+1]=Math.max(0,Math.min(255,y[d+1]+p)),y[d+2]=Math.max(0,Math.min(255,y[d+2]+p))}return s.putImageData(u,0,0),i})}static getPusherTexture(e="#3a3a6e"){return this.get(`pusher_${e}`,()=>{const s=document.createElement("canvas");s.width=256,s.height=128;const n=s.getContext("2d"),[a,l,c]=we(e),u=a>c+20;if(n.fillStyle=e,n.fillRect(0,0,256,128),u){n.strokeStyle=q(a,l,c,90,.38),n.lineWidth=.8;const p=14;for(let m=-128;m<384;m+=p)n.beginPath(),n.moveTo(m,0),n.lineTo(m+128,128),n.stroke();for(let m=0;m<512;m+=p)n.beginPath(),n.moveTo(m,0),n.lineTo(m-128,128),n.stroke();n.fillStyle=le(a,l,c,90);for(let m=0;m<2;m++){const b=10+m*108;for(let f=20;f<256;f+=36)n.fillStyle=le(a,l,c,80),n.beginPath(),n.arc(f,b,4.5,0,Math.PI*2),n.fill(),n.fillStyle=q(a,l,c,150,.7),n.beginPath(),n.arc(f-1,b-1,2,0,Math.PI*2),n.fill(),n.fillStyle="rgba(0,0,0,0.45)",n.beginPath(),n.arc(f+1,b+1,3,.5,Math.PI*2),n.fill()}}else{for(let p=0;p<128;p++){const m=.015+Math.random()*.055;n.strokeStyle=q(a,l,c,100,m),n.lineWidth=1,n.beginPath(),n.moveTo(0,p+.5),n.lineTo(256,p+.5),n.stroke()}n.fillStyle=q(a,l,c,120,.35);for(let p=24;p<256;p+=48)n.beginPath(),n.arc(p,8,3,0,Math.PI*2),n.fill()}const y=n.createLinearGradient(0,0,0,18);y.addColorStop(0,q(a,l,c,150,.6)),y.addColorStop(1,q(a,l,c,150,0)),n.fillStyle=y,n.fillRect(0,0,256,18);const d=n.createLinearGradient(0,114,0,128);return d.addColorStop(0,"rgba(0,0,0,0)"),d.addColorStop(1,"rgba(0,0,0,0.55)"),n.fillStyle=d,n.fillRect(0,114,256,14),s})}static getWallTexture(e="#1a1a3e"){return this.get(`wall_${e}`,()=>{const i=document.createElement("canvas");i.width=i.height=256;const s=i.getContext("2d"),[n,a,l]=we(e),c=n>l+20;if(s.fillStyle=e,s.fillRect(0,0,256,256),c)for(let p=0;p<256;p+=40){const m=s.createLinearGradient(0,p,0,p+40);m.addColorStop(0,le(n,a,l,18)),m.addColorStop(.5,Fe(n,a,l)),m.addColorStop(1,Ce(n,a,l,12)),s.fillStyle=m,s.fillRect(0,p,256,40),s.strokeStyle="rgba(0,0,0,0.55)",s.lineWidth=2,s.beginPath(),s.moveTo(0,p+40-1),s.lineTo(256,p+40-1),s.stroke(),s.strokeStyle=q(n,a,l,70,.45),s.lineWidth=1,s.beginPath(),s.moveTo(0,p+1),s.lineTo(256,p+1),s.stroke();for(let b=24;b<256;b+=48){const f=p+40-7;s.fillStyle=le(n,a,l,55),s.beginPath(),s.arc(b,f,4,0,Math.PI*2),s.fill(),s.fillStyle=q(n,a,l,130,.6),s.beginPath(),s.arc(b-1,f-1,1.5,0,Math.PI*2),s.fill(),s.fillStyle="rgba(0,0,0,0.5)",s.beginPath(),s.arc(b+1,f+1,2.5,.4,Math.PI*2),s.fill()}}else for(let d=0;d<256;d+=48){const p=s.createLinearGradient(0,d,0,d+6);p.addColorStop(0,"rgba(0,0,0,0.4)"),p.addColorStop(1,"rgba(0,0,0,0)"),s.fillStyle=p,s.fillRect(0,d,256,6);const m=s.createLinearGradient(0,d-4,0,d);m.addColorStop(0,q(n,a,l,80,0)),m.addColorStop(1,q(n,a,l,80,.2)),s.fillStyle=m,s.fillRect(0,d-4,256,4)}const u=s.getImageData(0,0,256,256),y=u.data;for(let d=0;d<y.length;d+=4){const p=(Math.random()-.5)*(c?8:10);y[d]=Math.max(0,Math.min(255,y[d]+p)),y[d+1]=Math.max(0,Math.min(255,y[d+1]+p)),y[d+2]=Math.max(0,Math.min(255,y[d+2]+p))}return s.putImageData(u,0,0),i})}static disposeAll(){this.cache.forEach(e=>e.dispose()),this.cache.clear()}}r(me,"cache",new Map);const os=new Q(h.MEDAL_RADIUS,h.MEDAL_RADIUS,h.MEDAL_THICKNESS,24),ls=new Q(h.MEDAL_RADIUS_LARGE,h.MEDAL_RADIUS_LARGE,h.MEDAL_THICKNESS,24),cs={normal:16766720,double:13691135,large:15245312},ds={normal:1,double:2,large:1};function hs(o){const e=o*100;return e<h.MEDAL_PROB_NORMAL?"normal":e<h.MEDAL_PROB_DOUBLE?"double":"large"}function us(o){return o==="large"?ls:os}class Re{static getMaterial(e){const t=e.toString(16);if(this.materialCache.has(t))return this.materialCache.get(t);const i=new Lt({color:e,flatShading:!0});return this.materialCache.set(t,i),i}static createMesh(e,t,i=!0,s=!1){const n=this.getMaterial(t).clone(),a=new K(e,n);return a.castShadow=i,a.receiveShadow=s,a}static disposeAll(){this.materialCache.forEach(e=>e.dispose()),this.materialCache.clear()}}r(Re,"materialCache",new Map);class ps{constructor(){r(this,"medals",new Map);r(this,"pendingRemoval",new Set);r(this,"spawnCounter",0)}spawn(e,t,i,s,n,a,l,c,u){if(this.medals.size>=h.MAX_MEDALS_ON_FIELD)return;const y=s.rapier,d=u??hs(Math.random()),p=d==="large"?h.MEDAL_RADIUS_LARGE:h.MEDAL_RADIUS,m=ds[d],b=y.RigidBodyDesc.dynamic().setTranslation(e,t,i).setLinearDamping(1.5).setAngularDamping(5).setCcdEnabled(!0),f=s.createRigidBody(b);f.setEnabledRotations(!0,!1,!0,!0),c&&f.setLinvel(c,!0);const g=y.ColliderDesc.cylinder(h.MEDAL_THICKNESS/2,p).setRestitution(.05).setFriction(.7).setDensity(h.MEDAL_MASS).setActiveEvents(y.ActiveEvents.COLLISION_EVENTS),x=s.createCollider(g,f);a.registerHandle(x.handle,"medal");const w=Re.createMesh(us(d),cs[d],!0,!1);w.position.set(e,t,i),l.add(w),n.register(f,w),this.medals.set(x.handle,{body:f,collider:x,mesh:w,type:d,quotaValue:m}),this.spawnCounter++}getQuotaValue(e){var t;return((t=this.medals.get(e))==null?void 0:t.quotaValue)??1}markForRemoval(e){this.pendingRemoval.add(e)}flushRemovals(e,t,i,s){let n=0;for(const a of this.pendingRemoval){const l=this.medals.get(a);l&&(t.unregister(l.body),i.unregisterHandle(a),s.remove(l.mesh),e.removeRigidBody(l.body),l.mesh.material.dispose(),this.medals.delete(a),n++)}return this.pendingRemoval.clear(),n}cleanupFallen(e,t,i,s,n){let a=0;for(const[l,c]of this.medals)c.body.translation().y<e&&!this.pendingRemoval.has(l)&&(this.pendingRemoval.add(l),a++);return a}get count(){return this.medals.size}clear(e,t,i,s){for(const[n,a]of this.medals)t.unregister(a.body),i.unregisterHandle(n),s.remove(a.mesh),e.removeRigidBody(a.body),a.mesh.material.dispose();this.medals.clear(),this.pendingRemoval.clear()}}class ms{constructor(){r(this,"body");r(this,"collider")}async initPhysics(e,t){const i=e.rapier,s=i.RigidBodyDesc.fixed().setTranslation(0,-2,h.FIELD_DEPTH/2+1);this.body=e.createRigidBody(s);const n=i.ColliderDesc.cuboid(h.FIELD_WIDTH/2+1,1,2).setActiveEvents(i.ActiveEvents.COLLISION_EVENTS).setSensor(!0);this.collider=e.createCollider(n,this.body),t.registerHandle(this.collider.handle,"drop_zone")}}class fs{constructor(){r(this,"time",0)}setupStage(e,t,i,s){this.clear(s)}getBonusMultiplierAt(e,t){return 1}update(e){this.time+=e}clear(e){this.time=0}}var O=(o=>(o.Common="Common",o.Rare="Rare",o.Epic="Epic",o.Legendary="Legendary",o))(O||{});const gs={[O.Common]:8947848,[O.Rare]:4474111,[O.Epic]:11141375,[O.Legendary]:16746496},ys=new kt(.4,0);class bs{constructor(e){r(this,"mesh");r(this,"animationOffset");const t=gs[e],i=new V({color:t,emissive:t,emissiveIntensity:.45,metalness:.2,roughness:.55,flatShading:!0});this.mesh=new K(ys,i),this.mesh.castShadow=!0,this.animationOffset=Math.random()*Math.PI*2}update(e){this.mesh.position.y+=Math.sin(e*2+this.animationOffset)*.002,this.mesh.rotation.y+=.02}setPosition(e,t,i){this.mesh.position.set(e,t,i)}dispose(){this.mesh.material.dispose()}}class Le{constructor(e=Date.now()){r(this,"seed");this.seed=e}next(){this.seed|=0,this.seed=this.seed+1831565813|0;let e=Math.imul(this.seed^this.seed>>>15,1|this.seed);return e=e+Math.imul(e^e>>>7,61|e)^e,((e^e>>>14)>>>0)/4294967296}nextInt(e,t){return Math.floor(this.next()*(t-e+1))+e}nextFloat(e,t){return this.next()*(t-e)+e}shuffle(e){const t=[...e];for(let i=t.length-1;i>0;i--){const s=Math.floor(this.next()*(i+1));[t[i],t[s]]=[t[s],t[i]]}return t}weightedPick(e,t){const i=t.reduce((n,a)=>n+a,0);let s=this.next()*i;for(let n=0;n<e.length;n++)if(s-=t[n],s<=0)return e[n];return e[e.length-1]}}class Ts{constructor(){r(this,"items",new Map);r(this,"pendingRemoval",new Set)}spawnItems(e,t,i,s,n,a){const l=new Le(a);for(const c of e){const u=l.nextFloat(-3,h.FIELD_WIDTH/2-1),y=l.nextFloat(-12/4,h.FIELD_DEPTH/4);this.spawnSingle(c,u,2,y,t,i,s,n)}}spawnSingle(e,t,i,s,n,a,l,c){const u=n.rapier,y=u.RigidBodyDesc.dynamic().setTranslation(t,i,s).setLinearDamping(.7).setAngularDamping(.8),d=n.createRigidBody(y),p=u.ColliderDesc.ball(.4).setRestitution(.4).setFriction(.5).setDensity(2).setActiveEvents(u.ActiveEvents.COLLISION_EVENTS),m=n.createCollider(p,d);l.registerHandle(m.handle,"item");const b=new bs(e.rarity);b.setPosition(t,i,s),c.add(b.mesh),a.register(d,b.mesh),this.items.set(m.handle,{body:d,collider:m,mesh:b,definitionId:e.id})}getDefinitionId(e){var t;return(t=this.items.get(e))==null?void 0:t.definitionId}markForRemoval(e){this.pendingRemoval.add(e)}flushRemovals(e,t,i,s){for(const n of this.pendingRemoval){const a=this.items.get(n);a&&(t.unregister(a.body),i.unregisterHandle(n),s.remove(a.mesh.mesh),e.removeRigidBody(a.body),a.mesh.dispose(),this.items.delete(n))}this.pendingRemoval.clear()}update(e){for(const t of this.items.values())t.mesh.update(e)}clear(e,t,i,s){for(const[n,a]of this.items)t.unregister(a.body),i.unregisterHandle(n),s.remove(a.mesh.mesh),e.removeRigidBody(a.body),a.mesh.dispose();this.items.clear(),this.pendingRemoval.clear()}}const Me=[{id:"rusty_gear",name:"さびたギア",quotaValue:5,sellPrice:3,rarity:O.Common,description:"古びたギア。それなりの価値はある。"},{id:"chipped_crystal",name:"欠けた水晶",quotaValue:8,sellPrice:5,rarity:O.Common,description:"割れた水晶の破片。かすかに輝いている。"},{id:"silver_coin",name:"銀貨",quotaValue:12,sellPrice:8,rarity:O.Common,description:"磨けば光る銀の硬貨。"},{id:"strange_mushroom",name:"怪しいキノコ",quotaValue:10,sellPrice:6,rarity:O.Common,description:"食べたら何かが起きそうな不思議なキノコ。"},{id:"ancient_compass",name:"古羅針盤",quotaValue:20,sellPrice:15,rarity:O.Rare,description:"方角を示す古い羅針盤。コレクターに人気。"},{id:"glowing_orb",name:"発光する球体",quotaValue:25,sellPrice:18,rarity:O.Rare,description:"ぼんやりと光を放つ不思議な球体。"},{id:"clockwork_bird",name:"ぜんまい仕掛けの鳥",quotaValue:30,sellPrice:22,rarity:O.Rare,description:"ネジを巻くと動き出す精巧な機械鳥。"},{id:"philosophers_stone",name:"賢者の石（模造品）",quotaValue:50,sellPrice:40,rarity:O.Epic,description:"本物かどうかは不明。でも高く売れる。"},{id:"dragon_scale",name:"ドラゴンの鱗",quotaValue:60,sellPrice:50,rarity:O.Epic,description:"龍から採れた鱗。強靭で美しい。"},{id:"starfall_fragment",name:"星落の欠片",quotaValue:100,sellPrice:80,rarity:O.Legendary,description:"流れ星が落とした神秘の欠片。伝説級のお宝。"}];function ge(o){return Me.find(e=>e.id===o)}const ze={[O.Common]:60,[O.Rare]:30,[O.Epic]:8,[O.Legendary]:2};class xs{constructor(e){r(this,"rng");this.rng=new Le(e)}pickRandom(e){const t=[];for(let i=0;i<e;i++){const s=this.pickRarity(),n=Me.filter(l=>l.rarity===s);if(n.length===0){t.push(Me[0]);continue}const a=Math.floor(this.rng.next()*n.length);t.push(n[a])}return t}pickRarity(){const e=Object.keys(ze),t=e.map(i=>ze[i]);return this.rng.weightedPick(e,t)}}function C(o,e,t=!1){const i=new K(o,e);return t&&(i.castShadow=!0,i.receiveShadow=!0),i}function z(o,e=1){return new V({color:o,emissive:o,emissiveIntensity:e,roughness:.5,metalness:.3})}class P{constructor(e){r(this,"group");r(this,"pusherMesh",null);r(this,"wallMeshes",[]);r(this,"sideGuardMeshes",[]);r(this,"pusherZBase",-12/2+h.PUSHER_DEPTH/2-h.PUSHER_RANGE);this.group=new Dt,this.rebuild(e)}rebuild(e){this.group.traverse(t=>{if(t!==this.group&&t instanceof K){t.geometry.dispose();const i=t.material;Array.isArray(i)?i.forEach(s=>s.dispose()):i.dispose()}}),this.group.clear(),this.wallMeshes=[],this.sideGuardMeshes=[],this.buildFieldSurface(e),this.buildPusher(e),this.addPusherDetails(e),this.createWalls(e),this.buildCabinet(e),this.buildCabinetDetails(e)}static cabinetMat(e){return new V({color:e.cabinetColor,roughness:.72,metalness:.42})}static brassMat(e){return new V({color:e.brassColor,roughness:e.brassRoughness,metalness:e.brassMetalness})}buildFieldSurface(e){const t=me.getFieldTexture(e.fieldTexBase);t.wrapS=t.wrapT=be,t.repeat.set(h.FIELD_WIDTH/2,h.FIELD_DEPTH/2);const i=new V({map:t,color:16777215,roughness:.92,metalness:0}),s=new M(h.FIELD_WIDTH,h.FIELD_HEIGHT,h.FIELD_DEPTH),n=new K(s,i);n.receiveShadow=!0,n.position.y=-.1/2,this.group.add(n)}buildPusher(e){const t=me.getPusherTexture(e.pusherTexBase);t.wrapS=t.wrapT=be,t.repeat.set(h.PUSHER_WIDTH/2,h.PUSHER_HEIGHT/1);const i=new V({map:t,color:16777215,roughness:.35,metalness:.65}),s=new M(h.PUSHER_WIDTH,h.PUSHER_HEIGHT,h.PUSHER_DEPTH);this.pusherMesh=new K(s,i),this.pusherMesh.castShadow=!0,this.pusherMesh.position.set(0,h.PUSHER_HEIGHT/2,this.pusherZBase),this.group.add(this.pusherMesh)}addPusherDetails(e){const t=h.PUSHER_WIDTH,i=h.PUSHER_HEIGHT,s=h.PUSHER_DEPTH,n=C(new M(t+.06,.14,.14),P.brassMat(e));n.position.set(0,-i/2+.07,s/2),this.pusherMesh.add(n);const a=C(new M(t,.07,s),P.brassMat(e));a.position.set(0,i/2+.035,0),this.pusherMesh.add(a);const l=C(new M(t-.2,.06,.06),z(e.secondaryNeon,1.2));l.position.set(0,i/2+.06,s/2-.05),this.pusherMesh.add(l);for(const c of[-1,1]){const u=C(new M(.1,i,.1),P.brassMat(e));u.position.set(c*(t/2-.05),0,s/2),this.pusherMesh.add(u)}}createWalls(e){const s=me.getWallTexture(e.wallTexBase);s.wrapS=s.wrapT=be;const n=()=>{const w=s.clone();return w.wrapS=w.wrapT=be,w.needsUpdate=!0,new V({map:w,color:16777215,roughness:.8,metalness:.15})},a=h.OPEN_ZONE_START- -12/2,l=-12/2+a/2,c=n();c.map.repeat.set(a/2,3.5/2);const u=new M(.3,3.5,a),y=new K(u,c);y.position.set(-8/2-.3/2,3.5/2,l),this.group.add(y),this.wallMeshes.push(y);const d=n();d.map.repeat.set(a/2,3.5/2);const p=new M(.3,3.5,a),m=new K(p,d);m.position.set(h.FIELD_WIDTH/2+.3/2,3.5/2,l),this.group.add(m),this.wallMeshes.push(m);const b=n(),f=h.FIELD_WIDTH+.3*2;b.map.repeat.set(f/2,3.5/2);const g=new M(f,3.5,.3),x=new K(g,b);x.position.set(0,3.5/2,-12/2-.3/2),this.group.add(x),this.wallMeshes.push(x)}buildCabinet(e){const t=h.FIELD_WIDTH,i=h.FIELD_DEPTH,s=-i/2,n=i/2,a=C(new M(12,1,17),P.cabinetMat(e),!0);a.position.set(0,-.52,-.5),this.group.add(a);const l=C(new M(12,.1,.1),P.brassMat(e));l.position.set(0,0,n+2.55),this.group.add(l);const c=1.1,u=7.2,y=13.5,d=t/2+.75,p=-.25;for(const k of[-1,1]){const N=C(new M(c,u,y),P.cabinetMat(e),!0);N.position.set(k*d,u/2-.5,p),this.group.add(N);const W=C(new M(c+.08,.14,y+.08),P.brassMat(e));W.position.set(k*d,u-.5+.07,p),this.group.add(W);const Y=C(new M(c+.08,.1,y+.08),P.brassMat(e));Y.position.set(k*d,-.02,p),this.group.add(Y);const oe=C(new M(.06,u*.75,y*.7),new V({color:e.insetColor,roughness:.9,metalness:.1}));oe.position.set(k*(d-(c/2+.01)),u/2-.5,p),this.group.add(oe);const De=C(new M(.055,u*.8,.055),z(e.primaryNeon,1.1));De.position.set(k*(d-c/2-.05),u/2-.5,p),this.group.add(De);const He=C(new M(.05,u*.6,.05),z(e.tertiaryNeon,.9));He.position.set(k*(d-c/2-.05),u/2-.5,n+.3),this.group.add(He)}const m=10.5,b=1.3,f=s-1.15,g=C(new M(12,m,b),P.cabinetMat(e),!0);g.position.set(0,m/2-.5,f),this.group.add(g);const x=C(new M(12.1,.15,b+.1),P.brassMat(e));x.position.set(0,m-.5+.07,f),this.group.add(x);const w=3.8,T=9.8,I=new V({color:e.screenBase,emissive:e.screenEmissive,emissiveIntensity:.9,roughness:.3,metalness:.5}),E=C(new M(T,w,.08),I);E.position.set(0,m-.5-w/2-.3,f+b/2+.04),this.group.add(E);const L=C(new M(T+.24,w+.24,.06),P.brassMat(e));L.position.set(0,m-.5-w/2-.3,f+b/2),this.group.add(L);const _=m-.5-w/2-.3;for(let k=0;k<4;k++){const N=C(new M(T-.4,.05,.07),z(e.tertiaryNeon,.8));N.position.set(0,_-w/2+.5+k*.75,f+b/2+.06),this.group.add(N)}const H=C(new M(12,.07,.07),z(e.tertiaryNeon,1.2));H.position.set(0,m-.5+.18,f+b/2),this.group.add(H);const F=C(new M(12,.07,.07),z(e.primaryNeon,.9));F.position.set(0,3.7,f+b/2),this.group.add(F);const B=C(new M(12,1.1,4.5),P.cabinetMat(e),!0);B.position.set(0,-.56,n+2.25),this.group.add(B);const U=C(new M(12,.12,.12),P.brassMat(e));U.position.set(0,0,n+4.45),this.group.add(U);const $=C(new M(12,.06,.06),z(e.secondaryNeon,1));$.position.set(0,.06,n+4.5),this.group.add($);const te=C(new M(12,.5,y),P.cabinetMat(e),!0);te.position.set(0,6.7,p),this.group.add(te);const j=C(new M(12,.07,.07),z(e.primaryNeon,1));j.position.set(0,6.96,n+.1),this.group.add(j);for(const k of[-1,1]){const N=C(new M(.09,.09,i+.5),P.brassMat(e));N.position.set(k*(t/2+.04),.05,p),this.group.add(N)}const J=C(new M(t+.2,3.6,.18),new V({color:e.pusherHousingColor,roughness:.65,metalness:.5}));J.position.set(0,1.8,s-.08),this.group.add(J);const re=C(new M(t-.2,.06,.06),z(e.secondaryNeon,1));re.position.set(0,3.65,s+.01),this.group.add(re);const se=C(new M(t+.1,.07,.07),z(e.secondaryNeon,1.4));se.position.set(0,.07,n),this.group.add(se);const ie=C(new M(t+.1,.07,.07),z(e.primaryNeon,1.4));ie.position.set(0,.07,s+.04),this.group.add(ie);for(const k of[-1,1]){const N=C(new M(.07,.07,i),z(e.primaryNeon,1.2));N.position.set(k*t/2,.07,(s+n)/2),this.group.add(N)}const ue=h.OPEN_ZONE_START-s,S=s+ue/2;for(const k of[-1,1]){const N=C(new M(.055,3.4,.055),z(e.tertiaryNeon,.9));N.position.set(k*(t/2),1.7,S),this.group.add(N)}const R=new K(new M(100,.2,100),new V({color:e.groundColor,roughness:.95,metalness:0}));R.position.set(0,-.65,0),this.group.add(R)}buildCabinetDetails(e){const t=h.FIELD_DEPTH/2,i=-12/2,s=1.1,n=7.2,a=13.5,l=h.FIELD_WIDTH/2+.75,c=-.25,u=1.3,y=i-1.15;for(const L of[-1,1]){for(let H=0;H<2;H++){const F=H===0?-.26:.16,B=n*.6,U=L*(l+F),$=c+a/2+.07,te=C(new Q(.05,.05,B,8),P.brassMat(e));te.position.set(U,B/2+.3,$),this.group.add(te);const j=4;for(let J=0;J<=j;J++){const re=.3+J*(B/j),se=C(new Q(.09,.09,.07,10),P.brassMat(e));se.position.set(U,re,$),this.group.add(se)}}const _=C(new M(.48,.1,.1),P.brassMat(e));_.position.set(L*l,n*.6+.3+.05,c+a/2+.07),this.group.add(_)}for(const L of[-1,1]){const _=L*(l-s/2-.025),H=C(new Q(.24,.24,.06,18),P.brassMat(e));H.rotation.z=Math.PI/2,H.position.set(_,n*.52,c+.8),this.group.add(H);const F=C(new Q(.18,.18,.03,18),z(e.secondaryNeon,.55));F.rotation.z=Math.PI/2,F.position.set(_-L*.035,n*.52,c+.8),this.group.add(F);const B=C(new Q(.16,.16,.05,14),P.brassMat(e));B.rotation.z=Math.PI/2,B.position.set(_,n*.28,c-1.2),this.group.add(B);const U=C(new Q(.11,.11,.025,14),z(e.primaryNeon,.45));U.rotation.z=Math.PI/2,U.position.set(_-L*.03,n*.28,c-1.2),this.group.add(U)}const d=3.2,p=y+u/2+.05,m=C(new Ht(.82,.1,10,28),P.brassMat(e));m.position.set(0,d,p),this.group.add(m);const b=C(new Q(.74,.74,.04,28),new V({color:e.screenBase,emissive:e.screenEmissive,emissiveIntensity:.55,transparent:!0,opacity:.82,roughness:.05,metalness:0}));b.rotation.x=Math.PI/2,b.position.set(0,d,p),this.group.add(b);for(let L=0;L<4;L++){const _=L/4*Math.PI*2+Math.PI/4,H=C(new Q(.045,.045,.06,8),P.brassMat(e));H.rotation.x=Math.PI/2,H.position.set(Math.cos(_)*.88,d+Math.sin(_)*.88,p+.03),this.group.add(H)}const f=n*.82,g=h.FIELD_WIDTH+1.3,x=C(new Q(.07,.07,g,10),P.brassMat(e));x.rotation.z=Math.PI/2,x.position.set(0,f,t+.45),this.group.add(x);for(const L of[-1,1]){const _=C(new Q(.12,.12,.12,10),P.brassMat(e));_.rotation.z=Math.PI/2,_.position.set(L*(g/2+.06),f,t+.45),this.group.add(_)}const w=t+4.45,T=C(new M(1.3,.16,.05),new V({color:e.insetColor,roughness:.9,metalness:.1}));T.position.set(0,-.08,w),this.group.add(T);const I=C(new M(1.5,.3,.04),P.brassMat(e));I.position.set(0,-.08,w-.01),this.group.add(I);const E=C(new M(.9,.045,.06),new V({color:0,roughness:1,metalness:0}));E.position.set(0,-.06,w+.01),this.group.add(E)}addSideGuardMeshes(e){const s=h.FIELD_DEPTH/2-h.OPEN_ZONE_START,n=h.OPEN_ZONE_START+s/2;for(const a of[-1,1]){const l=a*(h.FIELD_WIDTH/2+.1),c=new M(.2,2,s),u=Re.createMesh(c,4500223,!1,!1);u.position.set(l,2/2,n),e.add(u),this.sideGuardMeshes.push(u)}}removeSideGuardMeshes(e){for(const t of this.sideGuardMeshes)e.remove(t),t.geometry.dispose(),t.material.dispose();this.sideGuardMeshes=[]}updatePusher(e){this.pusherMesh.position.z=this.pusherZBase+e}}class Es{constructor(e,t,i,s){r(this,"physicsWorld");r(this,"physicsSync");r(this,"collisionHandler");r(this,"pusher");r(this,"medalSpawner");r(this,"itemSpawner");r(this,"dropZone");r(this,"gimmickManager");r(this,"fieldMesh");r(this,"time",0);r(this,"getMedalQuotaMultiplier",()=>1);r(this,"sideGuardActive",!1);r(this,"sideGuardBodies",[]);this.sceneManager=e,this.quotaManager=t,this.inventory=i,this.physicsWorld=new ss,this.physicsSync=new is,this.collisionHandler=new ns,this.pusher=new as,this.medalSpawner=new ps,this.itemSpawner=new Ts,this.dropZone=new ms,this.gimmickManager=new fs,this.fieldMesh=new P(s)}setMedalQuotaMultiplierFn(e){this.getMedalQuotaMultiplier=e}rebuildFieldMesh(e){me.disposeAll(),this.fieldMesh.rebuild(e)}async init(){await this.physicsWorld.init(),this.collisionHandler.init(this.physicsWorld),await this.buildFieldPhysics(),await this.pusher.initPhysics(this.physicsWorld),await this.dropZone.initPhysics(this.physicsWorld,this.collisionHandler),this.collisionHandler.onMedalCollected(e=>{const t=this.medalSpawner.getQuotaValue(e);this.medalSpawner.markForRemoval(e);const i=this.getMedalQuotaMultiplier();this.quotaManager.addMedals(t,i),A.emit("medal:collected",{count:t})}),this.collisionHandler.onItemCollected(e=>{const t=this.itemSpawner.getDefinitionId(e);if(!t)return;this.itemSpawner.markForRemoval(e);const i=this.inventory.addItem(t),s=ge(t);s&&(this.quotaManager.addItem(s.quotaValue),A.emit("item:collected",{itemId:t,instanceId:i.instanceId,quotaValue:s.quotaValue}))}),this.sceneManager.add(this.fieldMesh.group)}async buildFieldPhysics(){const e=this.physicsWorld.rapier,t=e.RigidBodyDesc.fixed().setTranslation(0,-.05,0),i=this.physicsWorld.createRigidBody(t),s=e.ColliderDesc.cuboid(h.FIELD_WIDTH/2,.05,h.FIELD_DEPTH/2).setFriction(.6).setRestitution(.05);this.physicsWorld.createCollider(s,i);const n=3.5,a=.2,l=h.OPEN_ZONE_START- -12/2,c=-12/2+l/2,u=e.RigidBodyDesc.fixed().setTranslation(-8/2-a/2,n/2,c),y=this.physicsWorld.createRigidBody(u);this.physicsWorld.createCollider(e.ColliderDesc.cuboid(a/2,n/2,l/2),y);const d=e.RigidBodyDesc.fixed().setTranslation(h.FIELD_WIDTH/2+a/2,n/2,c),p=this.physicsWorld.createRigidBody(d);this.physicsWorld.createCollider(e.ColliderDesc.cuboid(a/2,n/2,l/2),p);const m=8,b=.5,f=e.RigidBodyDesc.fixed().setTranslation(0,m/2,-12/2-b/2),g=this.physicsWorld.createRigidBody(f);this.physicsWorld.createCollider(e.ColliderDesc.cuboid(h.FIELD_WIDTH/2+b,m/2,b/2),g)}startStage(e,t){this.spawnInitialMedals(),this.gimmickManager.setupStage(e,t,this.physicsWorld,this.sceneManager);const s=new xs(e*1e3+t).pickRandom(h.ITEMS_PER_STAGE);this.itemSpawner.spawnItems(s,this.physicsWorld,this.physicsSync,this.collisionHandler,this.sceneManager,e*1e3+t+7)}spawnInitialMedals(){const e=-6+h.PUSHER_DEPTH-h.PUSHER_RANGE,t=h.FIELD_DEPTH/2-h.MEDAL_RADIUS,i=h.FIELD_WIDTH/2-h.MEDAL_RADIUS;for(let d=0;d<h.INITIAL_FIELD_MEDALS;d++){const p=(Math.random()*2-1)*i,m=e+Math.random()*(t-e),b=h.MEDAL_THICKNESS/2+Math.random()*.5;this.medalSpawner.spawn(p,b,m,this.physicsWorld,this.physicsSync,this.collisionHandler,this.sceneManager,void 0,"normal")}const s=-12/2+h.MEDAL_RADIUS,a=e-h.MEDAL_RADIUS-s,l=6,c=Math.ceil(h.INITIAL_PUSHER_MEDALS/l),u=i*2/(l-1),y=a/Math.max(c-1,1);for(let d=0;d<h.INITIAL_PUSHER_MEDALS;d++){const p=d%l,m=Math.floor(d/l),b=-i+p*u+(Math.random()-.5)*.15,f=s+m*y+(Math.random()-.5)*.15,g=h.PUSHER_HEIGHT+h.MEDAL_THICKNESS/2+m*.03+.005;this.medalSpawner.spawn(b,g,f,this.physicsWorld,this.physicsSync,this.collisionHandler,this.sceneManager,void 0,"normal")}}throwMedal(e,t){const i=h.FIELD_DEPTH/2-.5,s=2,a=-(12+(-t+1)/2*7);this.medalSpawner.spawn(e,s,i,this.physicsWorld,this.physicsSync,this.collisionHandler,this.sceneManager,{x:0,y:6,z:a})}update(e){this.time+=e;const t=4,i=Math.min(e,1/15);this.physicsWorld.setTimestep(i/t),this.collisionHandler.processEvents(this.physicsWorld,t),this.medalSpawner.cleanupFallen(h.MEDAL_CLEANUP_Y,this.physicsWorld,this.physicsSync,this.collisionHandler,this.sceneManager),this.medalSpawner.flushRemovals(this.physicsWorld,this.physicsSync,this.collisionHandler,this.sceneManager),this.itemSpawner.flushRemovals(this.physicsWorld,this.physicsSync,this.collisionHandler,this.sceneManager),this.physicsSync.sync(this.physicsWorld);const s=this.pusher.update(e);this.fieldMesh.updatePusher(s),this.gimmickManager.update(e),this.itemSpawner.update(this.time)}endStage(){this.gimmickManager.clear(this.sceneManager),this.medalSpawner.clear(this.physicsWorld,this.physicsSync,this.collisionHandler,this.sceneManager),this.itemSpawner.clear(this.physicsWorld,this.physicsSync,this.collisionHandler,this.sceneManager)}addSideGuardWalls(){if(this.sideGuardActive||!this.physicsWorld.initialized)return;this.sideGuardActive=!0;const e=this.physicsWorld.rapier,t=2,i=.2,s=h.FIELD_DEPTH/2-h.OPEN_ZONE_START,n=h.OPEN_ZONE_START+s/2;for(const a of[-1,1]){const l=a*(h.FIELD_WIDTH/2+i/2),c=e.RigidBodyDesc.fixed().setTranslation(l,t/2,n),u=this.physicsWorld.createRigidBody(c);this.physicsWorld.createCollider(e.ColliderDesc.cuboid(i/2,t/2,s/2),u),this.sideGuardBodies.push(u)}}removeSideGuardWalls(){for(const e of this.sideGuardBodies)this.physicsWorld.removeRigidBody(e);this.sideGuardBodies=[],this.sideGuardActive=!1}get isSideGuardActive(){return this.sideGuardActive}dispose(){this.sceneManager.remove(this.fieldMesh.group),this.physicsWorld.dispose()}}class Ss{constructor(){r(this,"current",0);r(this,"target",0);r(this,"phase",1);r(this,"stage",1)}startStage(e,t){this.phase=e,this.stage=t,this.current=0,this.target=this.calcTarget(e,t),A.emit("stage:started",{phase:e,stage:t,quotaTarget:this.target}),A.emit("quota:updated",{current:this.current,target:this.target})}calcTarget(e,t){const i=(e-1)*h.STAGES_PER_PHASE+t;return Math.ceil(h.BASE_QUOTA*Math.pow(h.QUOTA_MULTIPLIER,i-1))}addMedals(e,t=1){this.current+=e*t,A.emit("quota:updated",{current:this.current,target:this.target}),this.current>=this.target&&A.emit("quota:reached",{phase:this.phase,stage:this.stage})}addItem(e,t=1){this.current+=e*t,A.emit("quota:updated",{current:this.current,target:this.target}),this.current>=this.target&&A.emit("quota:reached",{phase:this.phase,stage:this.stage})}get currentValue(){return this.current}get targetValue(){return this.target}get isReached(){return this.current>=this.target}get progress(){return Math.min(this.current/this.target,1)}}class vs{constructor(e){r(this,"phase",1);r(this,"stage",1);this.fsm=e}get currentPhase(){return this.phase}get currentStage(){return this.stage}get isLastStageOfPhase(){return this.stage===h.STAGES_PER_PHASE}startCurrentStage(){this.fsm.transition(v.PLAYING)}clearCurrentStage(){A.emit("stage:cleared",{phase:this.phase,stage:this.stage}),this.fsm.transition(v.STAGE_CLEAR),this.stage===h.STAGES_PER_PHASE&&A.emit("phase:cleared",{phase:this.phase})}advanceStage(){this.stage<h.STAGES_PER_PHASE&&this.stage++,this.fsm.transition(v.STAGE_START)}advancePhase(){this.phase++,this.stage=1}reset(){this.phase=1,this.stage=1}}function ws(){return`${Date.now().toString(36)}-${Math.random().toString(36).slice(2,9)}`}class Cs{constructor(){r(this,"items",[])}addItem(e){const t={instanceId:ws(),definitionId:e,collectedAt:Date.now()};return this.items.push(t),t}removeItem(e){const t=this.items.findIndex(i=>i.instanceId===e);return t===-1?!1:(this.items.splice(t,1),!0)}getAll(){return[...this.items]}getDefinition(e){const t=this.items.find(i=>i.instanceId===e);if(t)return ge(t.definitionId)}get count(){return this.items.length}clear(){this.items=[]}totalSellPrice(){return this.items.reduce((e,t)=>{const i=ge(t.definitionId);return e+((i==null?void 0:i.sellPrice)??0)},0)}}class Ms{constructor(){r(this,"data",{phase:1,stage:1,totalMedalsCollected:0,totalItemsCollected:0,shopMoneyEarned:0});A.on("medal:collected",({count:e})=>{this.data.totalMedalsCollected+=e}),A.on("item:collected",()=>{this.data.totalItemsCollected++}),A.on("stage:cleared",({phase:e,stage:t})=>{this.data.phase=e,this.data.stage=t})}addShopMoney(e){this.data.shopMoneyEarned+=e}get snapshot(){return{...this.data}}reset(){this.data={phase:1,stage:1,totalMedalsCollected:0,totalItemsCollected:0,shopMoneyEarned:0}}}class _s{calculate(e,t){const i=t.bestPhase*3+t.bestStage,n=e.phase*3+e.stage>i;return t.updateBest(e.phase,e.stage),t.incrementRuns(),{phase:e.phase,stage:e.stage,totalMedalsCollected:e.totalMedalsCollected,totalItemsCollected:e.totalItemsCollected,isNewBest:n,bestPhase:t.bestPhase,bestStage:t.bestStage}}}var G=(o=>(o.Gold="Gold",o.Alchemy="Alchemy",o.Throw="Throw",o.Guard="Guard",o))(G||{}),D=(o=>(o.Common="Common",o.Rare="Rare",o.Epic="Epic",o))(D||{});const nt=[{id:"gold_touch",name:"黄金の手",description:"メダル1枚あたりのノルマ加算値が+20%",tag:G.Gold,rarity:D.Common,effects:[{type:"QUOTA_PER_MEDAL",value:1.2}]},{id:"lucky_fall",name:"幸運の落下",description:"メダル1枚あたりのノルマ加算値が+50%",tag:G.Gold,rarity:D.Rare,effects:[{type:"QUOTA_PER_MEDAL",value:1.5}]},{id:"golden_shower",name:"黄金雨",description:"メダル1枚あたりのノルマ加算値が+100%",tag:G.Gold,rarity:D.Epic,effects:[{type:"QUOTA_PER_MEDAL",value:2}]},{id:"coin_magnet",name:"コインマグネット",description:"ステージクリア時にボーナスメダル+5枚",tag:G.Gold,rarity:D.Common,effects:[{type:"ON_CLEAR_BONUS_MEDAL",value:5}]},{id:"fortune_wheel",name:"幸運の輪",description:"ステージクリア時にボーナスメダル+15枚",tag:G.Gold,rarity:D.Rare,effects:[{type:"ON_CLEAR_BONUS_MEDAL",value:15}]},{id:"appraiser",name:"鑑定士",description:"アイテムのノルマ加算値が1.5倍",tag:G.Alchemy,rarity:D.Common,effects:[{type:"ITEM_QUOTA_MULTIPLIER",value:1.5}]},{id:"master_appraiser",name:"大鑑定士",description:"アイテムのノルマ加算値が2.5倍",tag:G.Alchemy,rarity:D.Rare,effects:[{type:"ITEM_QUOTA_MULTIPLIER",value:2.5}]},{id:"transmutation",name:"錬成",description:"アイテムの売却価格が1.5倍",tag:G.Alchemy,rarity:D.Common,effects:[{type:"ITEM_SELL_MULTIPLIER",value:1.5}]},{id:"great_transmutation",name:"大錬成",description:"アイテムの売却価格が2倍",tag:G.Alchemy,rarity:D.Rare,effects:[{type:"ITEM_SELL_MULTIPLIER",value:2}]},{id:"philosopher",name:"賢者",description:"アイテムのノルマ加算値3倍+売却価格2倍",tag:G.Alchemy,rarity:D.Epic,effects:[{type:"ITEM_QUOTA_MULTIPLIER",value:3},{type:"ITEM_SELL_MULTIPLIER",value:2}]},{id:"double_throw",name:"ダブル投擲",description:"一度に投入するメダルが2枚になる",tag:G.Throw,rarity:D.Common,effects:[{type:"MEDAL_THROW_COUNT",value:2}]},{id:"triple_throw",name:"トリプル投擲",description:"一度に投入するメダルが3枚になる",tag:G.Throw,rarity:D.Rare,effects:[{type:"MEDAL_THROW_COUNT",value:3}]},{id:"barrage",name:"弾幕",description:"一度に投入するメダルが5枚になる",tag:G.Throw,rarity:D.Epic,effects:[{type:"MEDAL_THROW_COUNT",value:5}]},{id:"quick_draw",name:"クイックドロー",description:"一度に投入するメダルが2枚+クリアボーナス+3枚",tag:G.Throw,rarity:D.Rare,effects:[{type:"MEDAL_THROW_COUNT",value:2},{type:"ON_CLEAR_BONUS_MEDAL",value:3}]},{id:"focused_aim",name:"集中狙い",description:"メダル1枚あたりのノルマ加算+30%",tag:G.Throw,rarity:D.Common,effects:[{type:"QUOTA_PER_MEDAL",value:1.3}]},{id:"safety_net",name:"セーフティネット",description:"ゲームオーバーを一度だけ無効化する",tag:G.Guard,rarity:D.Rare,effects:[{type:"GAME_OVER_SHIELD",value:1}]},{id:"double_safety",name:"ダブルセーフティ",description:"ゲームオーバーを二度まで無効化する",tag:G.Guard,rarity:D.Epic,effects:[{type:"GAME_OVER_SHIELD",value:2}]},{id:"guardian_angel",name:"守護天使",description:"ゲームオーバー無効+クリアボーナスメダル+8枚",tag:G.Guard,rarity:D.Epic,effects:[{type:"GAME_OVER_SHIELD",value:1},{type:"ON_CLEAR_BONUS_MEDAL",value:8}]},{id:"resilience",name:"回復力",description:"クリアボーナスメダル+10枚",tag:G.Guard,rarity:D.Common,effects:[{type:"ON_CLEAR_BONUS_MEDAL",value:10}]},{id:"fortress",name:"要塞",description:"ゲームオーバー無効+アイテムノルマ加算+50%",tag:G.Guard,rarity:D.Epic,effects:[{type:"GAME_OVER_SHIELD",value:1},{type:"ITEM_QUOTA_MULTIPLIER",value:1.5}]}];function Ve(o){return nt.find(e=>e.id===o)}class Is{constructor(){r(this,"owned",[])}addSkill(e,t){this.owned.push({definitionId:e,acquiredAt:t}),A.emit("skill:selected",{skillId:e})}getOwnedSkills(){return[...this.owned]}getEffectMultiplier(e){let t=1;for(const i of this.owned){const s=Ve(i.definitionId);if(s)for(const n of s.effects)n.type===e&&(t*=n.value)}return t}getEffectSum(e){let t=0;for(const i of this.owned){const s=Ve(i.definitionId);if(s)for(const n of s.effects)n.type===e&&(t+=n.value)}return t}get medalThrowCount(){const e=this.getEffectSum("MEDAL_THROW_COUNT");return e>0?e:1}get gameOverShields(){return this.getEffectSum("GAME_OVER_SHIELD")}get quotaPerMedalMultiplier(){return this.getEffectMultiplier("QUOTA_PER_MEDAL")}get itemQuotaMultiplier(){return this.getEffectMultiplier("ITEM_QUOTA_MULTIPLIER")}get itemSellMultiplier(){return this.getEffectMultiplier("ITEM_SELL_MULTIPLIER")}get onClearBonusMedals(){return this.getEffectSum("ON_CLEAR_BONUS_MEDAL")}consumeShield(){return!1}reset(){this.owned=[]}}const We={[D.Common]:60,[D.Rare]:30,[D.Epic]:10};class As{pickChoices(e,t,i){const s=new Le(i),n=new Set(t.map(u=>u.definitionId)),a=nt.filter(u=>!n.has(u.id));if(a.length===0)return[];const l=[],c=new Set;for(let u=0;u<e&&l.length<a.length;u++){const y=Object.keys(We),d=y.map(f=>We[f]),p=s.weightedPick(y,d),m=a.filter(f=>f.rarity===p&&!c.has(f.id));if(m.length===0){const f=a.filter(x=>!c.has(x.id));if(f.length===0)break;const g=f[Math.floor(s.next()*f.length)];l.push(g),c.add(g.id);continue}const b=m[Math.floor(s.next()*m.length)];l.push(b),c.add(b.id)}return l}}const ke=[{id:"side_guard",name:"サイドガード",description:"30秒間サイドの壁を復活",price:300,durationMs:3e4,color:"#44aaff"},{id:"medal_fever",name:"メダルフィーバー",description:"30秒間メダルのノルマ2倍",price:200,durationMs:3e4,color:"#ffaa00"}];function $e(o){return ke.find(e=>e.id===o)}class Ps{constructor(){r(this,"shopMoney");r(this,"medals");r(this,"sellMultiplier",1);r(this,"ownedActiveItems",new Map);this.shopMoney=h.INITIAL_SHOP_MONEY,this.medals=h.INITIAL_MEDALS}setSellMultiplier(e){this.sellMultiplier=e}get money(){return this.shopMoney}get currentMedals(){return this.medals}setMedals(e){this.medals=e}addMoney(e){this.shopMoney+=e}spendMedal(){return this.medals<=0?!1:(this.medals--,!0)}addMedals(e){this.medals+=e}sellItem(e,t){const i=t.getDefinition(e);if(!i)return 0;const s=Math.floor(i.sellPrice*this.sellMultiplier);return t.removeItem(e),this.shopMoney+=s,s}buyMedals(e){const t=e*h.MEDAL_BUY_PRICE;return this.shopMoney<t?!1:(this.shopMoney-=t,this.medals+=e,!0)}buyActiveItem(e){const t=ke.find(i=>i.id===e);return!t||this.shopMoney<t.price?!1:(this.shopMoney-=t.price,this.ownedActiveItems.set(e,(this.ownedActiveItems.get(e)??0)+1),!0)}useActiveItem(e){const t=this.ownedActiveItems.get(e)??0;return t<=0?!1:(t===1?this.ownedActiveItems.delete(e):this.ownedActiveItems.set(e,t-1),!0)}getOwnedActiveItems(){return Array.from(this.ownedActiveItems.entries()).map(([e,t])=>({id:e,count:t}))}reset(){this.shopMoney=h.INITIAL_SHOP_MONEY,this.medals=h.INITIAL_MEDALS,this.sellMultiplier=1,this.ownedActiveItems.clear()}}let Ye=!1;function Rs(){if(Ye)return;Ye=!0;const o=document.createElement("style");o.textContent=`
  ...
  `,document.head.appendChild(o)}class Ns{constructor(e){r(this,"el");r(this,"medalCounter");r(this,"quotaBar");r(this,"phaseIndicator");r(this,"throwHint");r(this,"inventoryPanel");r(this,"activeItemPanel");r(this,"countdownEl");r(this,"onUseActiveCallbacks",[]);r(this,"hideTimer",null);this.el=document.createElement("div"),this.el.style.cssText=`
    ...
    `,this.el.appendChild(this.countdownEl),e.appendChild(this.el),Gs()}update(e,t,i,s,n){this.medalCounter.update(e),this.quotaBar.update(t,i),this.phaseIndicator.update(s,n)}showFloatingText(e,t="var(--t-primary)"){let i="2rem";const s=parseInt(e.replace("+",""),10);isNaN(s)||(s>=5?i="2.6rem":s>=2?i="2.2rem":i="1.6rem");const n=document.createElement("div");n.style.cssText=`
      position: absolute;
      bottom: 30%;
      left: 50%;
    ...
    `,n.textContent=e,this.el.appendChild(n),setTimeout(()=>{n.style.animation="floatUp 1.2s ease-out forwards"},120),setTimeout(()=>n.remove(),1320)}updateInventory(e){if(this.inventoryPanel.innerHTML="",e.length===0)return;const t=document.createElement("div");t.style.cssText="color: var(--t-text-dim); font-size: 0.7rem; margin-bottom: 4px; text-transform: uppercase;",t.textContent="Items",this.inventoryPanel.appendChild(t);for(const i of e){const s=ge(i.definitionId);if(!s)continue;const n=document.createElement("div");n.style.cssText=`
  ...
  `,document.head.appendChild(o)}class zs{constructor(e){r(this,"el");r(this,"onRetryCallbacks",[]);r(this,"hideTimer",null);Fs(),this.el=document.createElement("div"),this.el.style.cssText=`
    ...
    `,t.textContent="GAME OVER";const i=e.isNewBest?document.createElement("div"):null;i&&(i.style.cssText=`
      ...
      `,i.textContent="★ NEW BEST! ★");const s=[`Reached: Phase ${e.phase} - Stage ${e.stage}`,`Medals Collected: ${e.totalMedalsCollected}`,`Items Collected: ${e.totalItemsCollected}`,`Best: Phase ${e.bestPhase} - Stage ${e.bestStage}`],n=document.createElement("div");n.style.cssText="margin: 8px 0 24px; text-align: center;",s.forEach((l,c)=>{const u=document.createElement("div");u.style.cssText=`
        ...
        opacity: 0;
      `,u.textContent=l,n.appendChild(u)});const a=document.createElement("button");a.style.cssText=`
      font-size: 1.1rem;
      padding: 12px 40px;
      background: transparent;
...
`;class $s{constructor(e){r(this,"el");r(this,"moneyEl");r(this,"inventoryEl");r(this,"onBuyMedalsCallbacks",[]);r(this,"onSellCallbacks",[]);r(this,"onContinueCallbacks",[]);r(this,"onBuyActiveCallbacks",[]);r(this,"hideTimer",null);this.el=document.createElement("div"),this.el.style.cssText=`
  ...
  `,document.head.appendChild(o)}class Qs{constructor(e){r(this,"el");r(this,"onVolumeChangeCallbacks",[]);r(this,"onThemeChangeCallbacks",[]);r(this,"onCloseCallbacks",[]);r(this,"hideTimer",null);r(this,"themeBtns",new Map);qs(),this.el=document.createElement("div"),this.el.style.cssText=`
    ...
    `,e.appendChild(this.el)}show(e){this.hideTimer!==null&&(clearTimeout(this.hideTimer),this.hideTimer=null),this.el.innerHTML="",this.themeBtns.clear(),this.buildContent(e),this.el.style.opacity="0",this.el.style.display="flex",requestAnimationFrame(()=>{this.el.style.opacity="1"})}buildContent(e){const t=document.createElement("div");t.style.cssText=`
      ...
      max-width: 520px;
      width: 90%;
    `;const i=document.createElement("h2");i.style.cssText="font-size: 1.6rem; color: var(--t-primary); margin-bottom: 32px; letter-spacing: 0.2em; text-align: center;",i.textContent="SETTINGS",t.appendChild(i);const s=document.createElement("div");s.style.cssText="margin-bottom: 32px;";const n=document.createElement("div");n.style.cssText="font-size: 0.75rem; color: var(--t-text-dim); letter-spacing: 0.15em; margin-bottom: 16px; text-transform: uppercase;",n.textContent="VOLUME",s.appendChild(n);const a=[{label:"Master",type:"master",value:e.masterVolume},{label:"BGM",type:"bgm",value:e.bgmVolume},{label:"SFX",type:"sfx",value:e.sfxVolume}];for(const b of a){const f=document.createElement("div");f.style.cssText="display: flex; align-items: center; gap: 12px; margin-bottom: 14px;";const g=document.createElement("div");g.style.cssText="font-size: 0.85rem; color: var(--t-text-bright); width: 52px; flex-shrink: 0;",g.textContent=b.label;const x=document.createElement("input");x.type="range",x.min="0",x.max="1",x.step="0.05",x.value=String(b.value),x.className="settings-slider",x.style.cssText="flex: 1;";const w=document.createElement("div");w.style.cssText="font-size: 0.8rem; color: var(--t-primary); width: 36px; text-align: right; flex-shrink: 0;",w.textContent=`${Math.round(b.value*100)}%`,x.addEventListener("input",()=>{const T=parseFloat(x.value);w.textContent=`${Math.round(T*100)}%`,this.onVolumeChangeCallbacks.forEach(I=>I(b.type,T))}),f.appendChild(g),f.appendChild(x),f.appendChild(w),s.appendChild(f)}t.appendChild(s);const l=document.createElement("hr");l.style.cssText="border: none; border-top: 1px solid var(--t-border-faint); margin-bottom: 24px;",t.appendChild(l);const c=document.createElement("div");c.style.cssText="margin-bottom: 32px;";const u=document.createElement("div");u.style.cssText="font-size: 0.75rem; color: var(--t-text-dim); letter-spacing: 0.15em; margin-bottom: 16px; text-transform: uppercase;",u.textContent="THEME",c.appendChild(u);const y=document.createElement("div");y.style.cssText="display: flex; gap: 12px;";const d=["cyber","steampunk"];for(const b of d){const f=b===e.theme,g=document.createElement("button");g.style.cssText=`
        flex: 1;
        padding: 12px 16px;
      ...
      letter-spacing: 0.15em;
      transition: all 0.2s;
    `,m.textContent="CLOSE",m.addEventListener("mouseenter",()=>{m.style.borderColor="var(--t-primary)",m.style.color="var(--t-primary)"}),m.addEventListener("mouseleave",()=>{m.style.borderColor="var(--t-border-faint)",m.style.color="var(--t-text-dim)"}),m.addEventListener("click",()=>{this.onCloseCallbacks.forEach(b=>b())}),t.appendChild(m),this.el.appendChild(t)}selectTheme(e){this.themeBtns.forEach((t,i)=>{const s=i===e;t.style.background=s?"var(--t-primary)":"transparent",t.style.color=s?"var(--t-bg-overlay-dark)":"var(--t-primary)",t.style.fontWeight=s?"bold":"normal"})}hide(){this.hideTimer!==null&&(clearTimeout(this.hideTimer),this.hideTimer=null),this.el.style.opacity="0",this.hideTimer=setTimeout(()=>{this.el.style.display="none",this.hideTimer=null},280)}onVolumeChange(e){this.onVolumeChangeCallbacks.push(e)}onThemeChange(e){this.onThemeChangeCallbacks.push(e)}onClose(e){this.onCloseCallbacks.push(e)}}class Zs{constructor(e){r(this,"titleScreen");r(this,"gameScreen");r(this,"stageResultScreen");r(this,"resultScreen");r(this,"skillSelectScreen");r(this,"shopScreen");r(this,"settingsScreen");this.titleScreen=new Ls(e),this.gameScreen=new Ns(e),this.stageResultScreen=new Us(e),this.resultScreen=new zs(e),this.skillSelectScreen=new Ws(e),this.shopScreen=new $s(e),this.settingsScreen=new Qs(e),A.on("state:changed",({to:t})=>{this.handleStateChange(t)})}handleStateChange(e){switch(this.gameScreen.hide(),this.stageResultScreen.hide(),this.skillSelectScreen.hide(),this.shopScreen.hide(),e){case v.TITLE:this.titleScreen.show();break;case v.PLAYING:this.titleScreen.hide(),this.gameScreen.show();break;case v.STAGE_CLEAR:break;case v.RESULT:this.gameScreen.hide();break}}updateGameHUD(e,t,i,s,n,a,l){this.gameScreen.update(e,t,i,s,n),a&&this.gameScreen.updateInventory(a),l&&this.gameScreen.updateActiveItems(l)}}class Ks{constructor(e){r(this,"throwCallbacks",[]);r(this,"enabled",!1);r(this,"onClick",e=>{if(!this.enabled)return;const t=e.clientX/window.innerWidth*2-1,i=e.clientY/window.innerHeight*2-1;this.throwCallbacks.forEach(s=>s(t,i))});r(this,"onTouch",e=>{if(!this.enabled)return;e.preventDefault();const t=e.changedTouches[0];if(!t)return;const i=t.clientX/window.innerWidth*2-1,s=t.clientY/window.innerHeight*2-1;this.throwCallbacks.forEach(n=>n(i,s))});this.canvas=e,e.addEventListener("click",this.onClick),e.addEventListener("touchend",this.onTouch,{passive:!1})}enable(){this.enabled=!0}disable(){this.enabled=!1}onThrow(e){return this.throwCallbacks.push(e),()=>{const t=this.throwCallbacks.indexOf(e);t!==-1&&this.throwCallbacks.splice(t,1)}}dispose(){this.canvas.removeEventListener("click",this.onClick),this.canvas.removeEventListener("touchend",this.onTouch)}}const Z=class Z{constructor(){r(this,"ctx",null);r(this,"masterGain",null);r(this,"sfxGain",null);r(this,"bgmGain",null);r(this,"bgmPlaying",!1);r(this,"bgmNextTime",0);r(this,"bgmSchedulerTimer",null);r(this,"bgmBeatIndex",0)}getCtx(){return this.ctx||(this.ctx=new AudioContext,this.masterGain=this.ctx.createGain(),this.masterGain.gain.value=.7,this.masterGain.connect(this.ctx.destination),this.sfxGain=this.ctx.createGain(),this.sfxGain.gain.value=1,this.sfxGain.connect(this.masterGain),this.bgmGain=this.ctx.createGain(),this.bgmGain.gain.value=.8,this.bgmGain.connect(this.masterGain)),this.ctx.state==="suspended"&&this.ctx.resume(),this.ctx}getSfxGain(){return this.getCtx(),this.sfxGain}getBgmGain(){return this.getCtx(),this.bgmGain}setMasterVolume(e){this.getCtx(),this.masterGain&&(this.masterGain.gain.value=Math.max(0,Math.min(1,e)))}setBgmVolume(e){this.getCtx(),this.bgmGain&&(this.bgmGain.gain.value=Math.max(0,Math.min(1,e)))}setSfxVolume(e){this.getCtx(),this.sfxGain&&(this.sfxGain.gain.value=Math.max(0,Math.min(1,e)))}playThrow(){const e=this.getCtx(),t=this.getSfxGain(),i=e.sampleRate*.12,s=e.createBuffer(1,i,e.sampleRate),n=s.getChannelData(0);for(let u=0;u<i;u++)n[u]=Math.random()*2-1;const a=e.createBufferSource();a.buffer=s;const l=e.createBiquadFilter();l.type="bandpass",l.frequency.setValueAtTime(800,e.currentTime),l.frequency.linearRampToValueAtTime(2400,e.currentTime+.1),l.Q.value=1.5;const c=e.createGain();c.gain.setValueAtTime(.4,e.currentTime),c.gain.exponentialRampToValueAtTime(.001,e.currentTime+.12),a.connect(l),l.connect(c),c.connect(t),a.start(),a.stop(e.currentTime+.12)}playMedalCollected(){const e=this.getCtx(),t=this.getSfxGain(),i=e.createOscillator();i.type="triangle",i.frequency.setValueAtTime(880,e.currentTime),i.frequency.linearRampToValueAtTime(1320,e.currentTime+.15);const s=e.createGain();s.gain.setValueAtTime(.3,e.currentTime),s.gain.exponentialRampToValueAtTime(.001,e.currentTime+.3),i.connect(s),s.connect(t),i.start(),i.stop(e.currentTime+.3)}playQuotaReached(){const e=this.getCtx(),t=this.getSfxGain();[523.25,659.25,783.99,1046.5].forEach((s,n)=>{this._playNote(e,t,"sine",s,e.currentTime+n*.08,.25,.25)})}playStageCleared(){const e=this.getCtx(),t=this.getSfxGain();[[523.25,0,.15],[783.99,.15,.15],[1318.5,.3,.35]].forEach(([s,n,a])=>{this._playNote(e,t,"square",s,e.currentTime+n,a,.2)})}playGameOver(){const e=this.getCtx(),t=this.getSfxGain();[440,349.23,293.66,220].forEach((s,n)=>{this._playNote(e,t,"sawtooth",s,e.currentTime+n*.22,.3,.18)})}playSkillSelected(){const e=this.getCtx(),t=this.getSfxGain();this._playNote(e,t,"sine",600,e.currentTime,.2,.25)}playCountdownTick(){const e=this.getCtx(),t=this.getSfxGain(),i=Math.floor(e.sampleRate*.02),s=e.createBuffer(1,i,e.sampleRate),n=s.getChannelData(0);for(let c=0;c<n.length;c++)n[c]=(Math.random()*2-1)*(1-c/n.length);const a=e.createBufferSource();a.buffer=s;const l=e.createGain();l.gain.value=.35,a.connect(l),l.connect(t),a.start()}startBGM(){if(this.bgmPlaying)return;this.bgmPlaying=!0;const e=this.getCtx();this.bgmNextTime=e.currentTime+.1,this.bgmBeatIndex=0,this._scheduleBGM()}stopBGM(){this.bgmPlaying&&(this.bgmPlaying=!1,this.bgmSchedulerTimer!==null&&(clearTimeout(this.bgmSchedulerTimer),this.bgmSchedulerTimer=null))}_scheduleBGM(){if(!this.bgmPlaying||!this.ctx)return;const e=this.ctx,t=this.getBgmGain(),i=.3,s=100;for(;this.bgmNextTime<e.currentTime+i;)this._scheduleBGMBeat(e,t,this.bgmNextTime),this.bgmNextTime+=Z.BEAT,this.bgmBeatIndex++;this.bgmSchedulerTimer=setTimeout(()=>this._scheduleBGM(),s)}_scheduleBGMBeat(e,t,i){const s=this.bgmBeatIndex,n=Z.BASS_FREQS,a=Math.floor(s/2)%n.length;s%2===0&&this._scheduleNote(e,t,"sawtooth",n[a],i,Z.BEAT*1.8,.12);const l=Z.MELODY;let c=s%8,u=0;for(const[f,g]of l){if(c>=u&&c<u+g){f>0&&this._scheduleNote(e,t,"square",f,i,Z.BEAT*g*.85,.1);break}u+=g}const y=e.createBuffer(1,Math.floor(e.sampleRate*.03),e.sampleRate),d=y.getChannelData(0);for(let f=0;f<d.length;f++)d[f]=(Math.random()*2-1)*(1-f/d.length);const p=e.createBufferSource();p.buffer=y;const m=e.createBiquadFilter();m.type="highpass",m.frequency.value=8e3;const b=e.createGain();b.gain.value=.04,p.connect(m),m.connect(b),b.connect(t),p.start(i)}_playNote(e,t,i,s,n,a,l){const c=e.createOscillator();c.type=i,c.frequency.value=s;const u=e.createGain();u.gain.setValueAtTime(l,n),u.gain.exponentialRampToValueAtTime(.001,n+a),c.connect(u),u.connect(t),c.start(n),c.stop(n+a)}_scheduleNote(e,t,i,s,n,a,l){this._playNote(e,t,i,s,n,a,l)}};r(Z,"BPM",110),r(Z,"BEAT",60/Z.BPM),r(Z,"BASS_FREQS",[110,98,82.41,110]),r(Z,"MELODY",[[220,1],[261.63,1],[293.66,1],[329.63,1],[0,.5],[392,.5],[329.63,1],[261.63,2]]);let _e=Z;const Je="yukimedal_settings",pe={masterVolume:.7,bgmVolume:.8,sfxVolume:1,theme:"steampunk"},ne=class ne{constructor(){r(this,"_data");this._data=this._load()}static getInstance(){return ne._instance||(ne._instance=new ne),ne._instance}get masterVolume(){return this._data.masterVolume}get bgmVolume(){return this._data.bgmVolume}get sfxVolume(){return this._data.sfxVolume}get theme(){return this._data.theme}get snapshot(){return{...this._data}}setMasterVolume(e){this._data.masterVolume=Math.max(0,Math.min(1,e)),this._save()}setBgmVolume(e){this._data.bgmVolume=Math.max(0,Math.min(1,e)),this._save()}setSfxVolume(e){this._data.sfxVolume=Math.max(0,Math.min(1,e)),this._save()}setTheme(e){this._data.theme=e,this._save()}_load(){try{const e=localStorage.getItem(Je);if(e){const t=JSON.parse(e);return{masterVolume:typeof t.masterVolume=="number"?t.masterVolume:pe.masterVolume,bgmVolume:typeof t.bgmVolume=="number"?t.bgmVolume:pe.bgmVolume,sfxVolume:typeof t.sfxVolume=="number"?t.sfxVolume:pe.sfxVolume,theme:t.theme==="cyber"||t.theme==="steampunk"?t.theme:pe.theme}}}catch{}return{...pe}}_save(){try{localStorage.setItem(Je,JSON.stringify(this._data))}catch{}}};r(ne,"_instance",null);let Ie=ne;const ae=class ae{constructor(){r(this,"_currentName","steampunk");r(this,"_currentTheme",at);r(this,"_callbacks",[]);r(this,"_styleEl",null)}static getInstance(){return ae._instance||(ae._instance=new ae),ae._instance}get currentName(){return this._currentName}get currentTheme(){return this._currentTheme}applyTheme(e){const t=rt[e];if(!t)return;this._styleEl||(this._styleEl=document.getElementById("theme-vars"),this._styleEl||(this._styleEl=document.createElement("style"),this._styleEl.id="theme-vars",document.head.appendChild(this._styleEl)));const i=t.ui;this._styleEl.textContent=`:root {
