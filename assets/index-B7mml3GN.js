var cs=Object.defineProperty;var ds=(p,e,s)=>e in p?cs(p,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):p[e]=s;var l=(p,e,s)=>ds(p,typeof e!="symbol"?e+"":e,s);import{M as k,O as hs,B as je,F as Ct,S as Se,U as Ke,V as ae,W as Ze,H as Xe,N as ps,C as ms,a as Y,b as se,A as us,c as Be,R as fs,d as gs,e as ys,L as xs,f as bs,g as vs,h as Xt,i as ws,j as Ss,k as Kt,l as R,m as G,n as Ts,P as we,o as Es,p as Ms,q as Cs,r as Jt,s as Is,t as es,u as As,D as et,v as It,w as We,x as tt,y as st,G as At,z as ts,E as ie,I as Rs,J as ye,T as Ee,K as _s,Q as Ps,X as ss,Y as ks,Z as Rt,_ as Ls,$ as Ds,a0 as Ue,a1 as bt,a2 as Hs,a3 as it,a4 as at}from"./three-CzJWjZO5.js";import{O as Ve}from"./rapier-DpxwuBBO.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))i(t);new MutationObserver(t=>{for(const a of t)if(a.type==="childList")for(const n of a.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function s(t){const a={};return t.integrity&&(a.integrity=t.integrity),t.referrerPolicy&&(a.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?a.credentials="include":t.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(t){if(t.ep)return;t.ep=!0;const a=s(t);fetch(t.href,a)}})();var E=(p=>(p.INIT="INIT",p.TITLE="TITLE",p.STAGE_START="STAGE_START",p.PLAYING="PLAYING",p.STAGE_CLEAR="STAGE_CLEAR",p.SKIP_PROMPT="SKIP_PROMPT",p.GAME_OVER="GAME_OVER",p.SHOP="SHOP",p.SKILL_SELECT="SKILL_SELECT",p.RESULT="RESULT",p))(E||{});class Bs{constructor(){l(this,"listeners",new Map)}on(e,s){this.listeners.has(e)||this.listeners.set(e,new Set);const i=this.listeners.get(e);return i.add(s),()=>i.delete(s)}once(e,s){const i=this.on(e,t=>{s(t),i()})}emit(e,s){const i=this.listeners.get(e);if(i)for(const t of i)t(s)}off(e,s){var i;(i=this.listeners.get(e))==null||i.delete(s)}clear(){this.listeners.clear()}}const P=new Bs,Os=[{from:E.INIT,to:E.TITLE},{from:E.TITLE,to:E.STAGE_START},{from:E.STAGE_START,to:E.PLAYING},{from:E.PLAYING,to:E.STAGE_CLEAR},{from:E.PLAYING,to:E.GAME_OVER},{from:E.STAGE_CLEAR,to:E.STAGE_START},{from:E.STAGE_CLEAR,to:E.SKIP_PROMPT},{from:E.STAGE_CLEAR,to:E.SHOP},{from:E.SKIP_PROMPT,to:E.SHOP},{from:E.SKIP_PROMPT,to:E.STAGE_START},{from:E.SHOP,to:E.SKILL_SELECT},{from:E.SKILL_SELECT,to:E.STAGE_START},{from:E.GAME_OVER,to:E.RESULT},{from:E.RESULT,to:E.TITLE}];class Ns{constructor(){l(this,"current",E.INIT)}get state(){return this.current}canTransition(e){return Os.some(s=>(Array.isArray(s.from)?s.from:[s.from]).includes(this.current)&&s.to===e)}transition(e){if(!this.canTransition(e))throw new Error(`Invalid state transition: ${this.current} → ${e}`);const s=this.current;this.current=e,P.emit("state:changed",{from:s,to:e})}is(e){return this.current===e}isAny(...e){return e.includes(this.current)}}class Gs{constructor(){l(this,"updateFns",[]);l(this,"rafId",null);l(this,"lastTime",0);l(this,"maxDelta",1/20)}addUpdateFn(e){this.updateFns.push(e)}removeUpdateFn(e){const s=this.updateFns.indexOf(e);s!==-1&&this.updateFns.splice(s,1)}start(){if(this.rafId!==null)return;this.lastTime=performance.now();const e=s=>{this.rafId=requestAnimationFrame(e);const i=(s-this.lastTime)/1e3;this.lastTime=s;const t=Math.min(i,this.maxDelta);for(const a of this.updateFns)a(t)};this.rafId=requestAnimationFrame(e)}stop(){this.rafId!==null&&(cancelAnimationFrame(this.rafId),this.rafId=null)}get isRunning(){return this.rafId!==null}}const _t="yukimedal_save",zs="yukimedal_best",nt={bestPhase:0,bestStage:0,totalRuns:0,lastPlayedAt:0};class $s{constructor(){l(this,"data");this.data=this.load()}load(){try{const e=localStorage.getItem(_t);return e?{...nt,...JSON.parse(e)}:{...nt}}catch{return{...nt}}}save(){try{localStorage.setItem(_t,JSON.stringify(this.data))}catch{}}updateBest(e,s){const i=e*3+s,t=this.data.bestPhase*3+this.data.bestStage;i>t&&(this.data.bestPhase=e,this.data.bestStage=s,localStorage.setItem(zs,JSON.stringify({phase:e,stage:s}))),this.data.lastPlayedAt=Date.now(),this.save()}incrementRuns(){this.data.totalRuns++,this.save()}get bestPhase(){return this.data.bestPhase}get bestStage(){return this.data.bestStage}get totalRuns(){return this.data.totalRuns}}const is={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
		...
		}`};class Me extends Ie{constructor(e,s,i,t){super(),this.strength=s!==void 0?s:1,this.radius=i,this.threshold=t,this.resolution=e!==void 0?new ae(e.x,e.y):new ae(256,256),this.clearColor=new Y(0,0,0),this.renderTargetsHorizontal=[],this.renderTargetsVertical=[],this.nMips=5;let a=Math.round(this.resolution.x/2),n=Math.round(this.resolution.y/2);this.renderTargetBright=new Ze(a,n,{type:Xe}),this.renderTargetBright.texture.name="UnrealBloomPass.bright",this.renderTargetBright.texture.generateMipmaps=!1;for(let d=0;d<this.nMips;d++){const u=new Ze(a,n,{type:Xe});u.texture.name="UnrealBloomPass.h"+d,u.texture.generateMipmaps=!1,this.renderTargetsHorizontal.push(u);const c=new Ze(a,n,{type:Xe});c.texture.name="UnrealBloomPass.v"+d,c.texture.generateMipmaps=!1,this.renderTargetsVertical.push(c),a=Math.round(a/2),n=Math.round(n/2)}const o=js;this.highPassUniforms=Ke.clone(o.uniforms),this.highPassUniforms.luminosityThreshold.value=t,this.highPassUniforms.smoothWidth.value=.01,this.materialHighPassFilter=new Se({uniforms:this.highPassUniforms,vertexShader:o.vertexShader,fragmentShader:o.fragmentShader}),this.separableBlurMaterials=[];const r=[3,5,7,9,11];a=Math.round(this.resolution.x/2),n=Math.round(this.resolution.y/2);for(let d=0;d<this.nMips;d++)this.separableBlurMaterials.push(this.getSeperableBlurMaterial(r[d])),this.separableBlurMaterials[d].uniforms.invSize.value=new ae(1/a,1/n),a=Math.round(a/2),n=Math.round(n/2);this.compositeMaterial=this.getCompositeMaterial(this.nMips),this.compositeMaterial.uniforms.blurTexture1.value=this.renderTargetsVertical[0].texture,this.compositeMaterial.uniforms.blurTexture2.value=this.renderTargetsVertical[1].texture,this.compositeMaterial.uniforms.blurTexture3.value=this.renderTargetsVertical[2].texture,this.compositeMaterial.uniforms.blurTexture4.value=this.renderTargetsVertical[3].texture,this.compositeMaterial.uniforms.blurTexture5.value=this.renderTargetsVertical[4].texture,this.compositeMaterial.uniforms.bloomStrength.value=s,this.compositeMaterial.uniforms.bloomRadius.value=.1;const f=[1,.8,.6,.4,.2];this.compositeMaterial.uniforms.bloomFactors.value=f,this.bloomTintColors=[new se(1,1,1),new se(1,1,1),new se(1,1,1),new se(1,1,1),new se(1,1,1)],this.compositeMaterial.uniforms.bloomTintColors.value=this.bloomTintColors;const m=is;this.copyUniforms=Ke.clone(m.uniforms),this.blendMaterial=new Se({uniforms:this.copyUniforms,vertexShader:m.vertexShader,fragmentShader:m.fragmentShader,blending:us,depthTest:!1,depthWrite:!1,transparent:!0}),this.enabled=!0,this.needsSwap=!1,this._oldClearColor=new Y,this.oldClearAlpha=1,this.basic=new Be,this.fsQuad=new vt(null)}dispose(){for(let e=0;e<this.renderTargetsHorizontal.length;e++)this.renderTargetsHorizontal[e].dispose();for(let e=0;e<this.renderTargetsVertical.length;e++)this.renderTargetsVertical[e].dispose();this.renderTargetBright.dispose();for(let e=0;e<this.separableBlurMaterials.length;e++)this.separableBlurMaterials[e].dispose();this.compositeMaterial.dispose(),this.blendMaterial.dispose(),this.basic.dispose(),this.fsQuad.dispose()}setSize(e,s){let i=Math.round(e/2),t=Math.round(s/2);this.renderTargetBright.setSize(i,t);for(let a=0;a<this.nMips;a++)this.renderTargetsHorizontal[a].setSize(i,t),this.renderTargetsVertical[a].setSize(i,t),this.separableBlurMaterials[a].uniforms.invSize.value=new ae(1/i,1/t),i=Math.round(i/2),t=Math.round(t/2)}render(e,s,i,t,a){e.getClearColor(this._oldClearColor),this.oldClearAlpha=e.getClearAlpha();const n=e.autoClear;e.autoClear=!1,e.setClearColor(this.clearColor,0),a&&e.state.buffers.stencil.setTest(!1),this.renderToScreen&&(this.fsQuad.material=this.basic,this.basic.map=i.texture,e.setRenderTarget(null),e.clear(),this.fsQuad.render(e)),this.highPassUniforms.tDiffuse.value=i.texture,this.highPassUniforms.luminosityThreshold.value=this.threshold,this.fsQuad.material=this.materialHighPassFilter,e.setRenderTarget(this.renderTargetBright),e.clear(),this.fsQuad.render(e);let o=this.renderTargetBright;for(let r=0;r<this.nMips;r++)this.fsQuad.material=this.separableBlurMaterials[r],this.separableBlurMaterials[r].uniforms.colorTexture.value=o.texture,this.separableBlurMaterials[r].uniforms.direction.value=Me.BlurDirectionX,e.setRenderTarget(this.renderTargetsHorizontal[r]),e.clear(),this.fsQuad.render(e),this.separableBlurMaterials[r].uniforms.colorTexture.value=this.renderTargetsHorizontal[r].texture,this.separableBlurMaterials[r].uniforms.direction.value=Me.BlurDirectionY,e.setRenderTarget(this.renderTargetsVertical[r]),e.clear(),this.fsQuad.render(e),o=this.renderTargetsVertical[r];this.fsQuad.material=this.compositeMaterial,this.compositeMaterial.uniforms.bloomStrength.value=this.strength,this.compositeMaterial.uniforms.bloomRadius.value=this.radius,this.compositeMaterial.uniforms.bloomTintColors.value=this.bloomTintColors,e.setRenderTarget(this.renderTargetsHorizontal[0]),e.clear(),this.fsQuad.render(e),this.fsQuad.material=this.blendMaterial,this.copyUniforms.tDiffuse.value=this.renderTargetsHorizontal[0].texture,a&&e.state.buffers.stencil.setTest(!0),this.renderToScreen?(e.setRenderTarget(null),this.fsQuad.render(e)):(e.setRenderTarget(i),this.fsQuad.render(e)),e.setClearColor(this._oldClearColor,this.oldClearAlpha),e.autoClear=n}getSeperableBlurMaterial(e){const s=[];for(let i=0;i<e;i++)s.push(.39894*Math.exp(-.5*i*i/(e*e))/e);return new Se({defines:{KERNEL_RADIUS:e},uniforms:{colorTexture:{value:null},invSize:{value:new ae(.5,.5)},direction:{value:new ae(.5,.5)},gaussianCoefficients:{value:s}},vertexShader:`varying vec2 vUv;
				void main() {
					vUv = uv;
					gl_Position = projectionMatrix * modelViewMatrix * vec4( position, 1.0 );
				...
				}`})}getCompositeMaterial(e){return new Se({defines:{NUM_MIPS:e},uniforms:{blurTexture1:{value:null},blurTexture2:{value:null},blurTexture3:{value:null},blurTexture4:{value:null},blurTexture5:{value:null},bloomStrength:{value:1},bloomFactors:{value:null},bloomTintColors:{value:null},bloomRadius:{value:0}},vertexShader:`varying vec2 vUv;
				void main() {
					vUv = uv;
					gl_Position = projectionMatrix * modelViewMatrix * vec4( position, 1.0 );
				...
				}`})}}Me.BlurDirectionX=new ae(1,0);Me.BlurDirectionY=new ae(0,1);const Zs={name:"OutputShader",uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		...
		}`};class Xs extends Ie{constructor(){super();const e=Zs;this.uniforms=Ke.clone(e.uniforms),this.material=new fs({name:e.name,uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader}),this.fsQuad=new vt(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,s,i){this.uniforms.tDiffuse.value=i.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},gs.getTransfer(this._outputColorSpace)===ys&&(this.material.defines.SRGB_TRANSFER=""),this._toneMapping===xs?this.material.defines.LINEAR_TONE_MAPPING="":this._toneMapping===bs?this.material.defines.REINHARD_TONE_MAPPING="":this._toneMapping===vs?this.material.defines.CINEON_TONE_MAPPING="":this._toneMapping===Xt?this.material.defines.ACES_FILMIC_TONE_MAPPING="":this._toneMapping===ws?this.material.defines.AGX_TONE_MAPPING="":this._toneMapping===Ss&&(this.material.defines.NEUTRAL_TONE_MAPPING=""),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this.fsQuad.render(e)):(e.setRenderTarget(s),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this.fsQuad.render(e))}dispose(){this.material.dispose(),this.fsQuad.dispose()}}class Ks extends Kt{constructor(){super();const e=new R;e.deleteAttribute("uv");const s=new G({side:Ts}),i=new G,t=new we(16777215,900,28,2);t.position.set(.418,16.199,.3),this.add(t);const a=new k(e,s);a.position.set(-.757,13.219,.717),a.scale.set(31.713,28.305,28.591),this.add(a);const n=new k(e,i);n.position.set(-10.906,2.009,1.846),n.rotation.set(0,-.195,0),n.scale.set(2.328,7.905,4.651),this.add(n);const o=new k(e,i);o.position.set(-5.607,-.754,-.758),o.rotation.set(0,.994,0),o.scale.set(1.97,1.534,3.955),this.add(o);const r=new k(e,i);r.position.set(6.167,.857,7.803),r.rotation.set(0,.561,0),r.scale.set(3.927,6.285,3.687),this.add(r);const f=new k(e,i);f.position.set(-2.017,.018,6.124),f.rotation.set(0,.333,0),f.scale.set(2.002,4.566,2.064),this.add(f);const m=new k(e,i);m.position.set(2.291,-.756,-2.621),m.rotation.set(0,-.286,0),m.scale.set(1.546,1.552,1.496),this.add(m);const d=new k(e,i);d.position.set(-2.193,-.369,-5.547),d.rotation.set(0,.516,0),d.scale.set(3.875,3.487,2.986),this.add(d);const u=new k(e,ve(50));u.position.set(-16.116,14.37,8.208),u.scale.set(.1,2.428,2.739),this.add(u);const c=new k(e,ve(50));c.position.set(-16.109,18.021,-8.207),c.scale.set(.1,2.425,2.751),this.add(c);const h=new k(e,ve(17));h.position.set(14.904,12.198,-1.832),h.scale.set(.15,4.265,6.331),this.add(h);const y=new k(e,ve(43));y.position.set(-.462,8.89,14.52),y.scale.set(4.38,5.441,.088),this.add(y);const x=new k(e,ve(20));x.position.set(3.235,11.486,-12.541),x.scale.set(2.5,2,.1),this.add(x);const v=new k(e,ve(100));v.position.set(0,20,0),v.scale.set(1,.1,1),this.add(v)}dispose(){const e=new Set;this.traverse(s=>{s.isMesh&&(e.add(s.geometry),e.add(s.material))});for(const s of e)s.dispose()}}function ve(p){const e=new Be;return e.color.setScalar(p),e}function ot(){return window.innerWidth<window.innerHeight?window.innerHeight:window.innerWidth}function rt(){return window.innerWidth<window.innerHeight?window.innerWidth:window.innerHeight}class Js{constructor(e){l(this,"scene");l(this,"renderer");l(this,"composer");l(this,"renderPass");l(this,"bloomPass");l(this,"onResize",()=>{const e=ot(),s=rt();this.renderer.setSize(e,s),this.composer.setSize(e,s)});this.scene=new Kt,this.scene.background=new Y(1710638),this.scene.fog=new Es(1710638,30,80),this.renderer=new Ms({antialias:!0}),this.renderer.setSize(ot(),rt()),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=Cs,this.renderer.toneMapping=Xt,this.renderer.toneMappingExposure=1.05,this.renderer.outputColorSpace=Jt,e.appendChild(this.renderer.domElement);const s=new Is(this.renderer);s.compileEquirectangularShader();const i=s.fromScene(new Ks,.04).texture;this.scene.environment=i,s.dispose();const t=ot(),a=rt(),n=new es(60,t/a,.1,200);this.renderPass=new Qs(this.scene,n),this.bloomPass=new Me(new ae(t,a),.88,.42,.72);const o=new Xs;this.composer=new qs(this.renderer),this.composer.addPass(this.renderPass),this.composer.addPass(this.bloomPass),this.composer.addPass(o),window.addEventListener("resize",this.onResize)}setCamera(e){this.renderPass.camera=e}applySceneTheme(e){this.scene.background.set(e.background),this.scene.fog&&this.scene.fog.color.set(e.fogColor),this.bloomPass.strength=e.bloomStrength,this.bloomPass.threshold=e.bloomThreshold,this.bloomPass.radius=e.bloomRadius}render(e){this.renderPass.camera=e,this.composer.render()}add(...e){this.scene.add(...e)}remove(...e){this.scene.remove(...e)}dispose(){window.removeEventListener("resize",this.onResize),this.renderer.dispose()}}const g={INITIAL_MEDALS:90,INITIAL_SHOP_MONEY:0,MEDAL_BUY_PRICE:5,BASE_QUOTA:40,QUOTA_MULTIPLIER:1.28,STAGES_PER_PHASE:3,FIELD_WIDTH:8,FIELD_DEPTH:12,FIELD_HEIGHT:.1,PUSHER_WIDTH:8,PUSHER_DEPTH:4.5,PUSHER_HEIGHT:1.2,PUSHER_RANGE:1.5,PUSHER_PERIOD_MS:2e3,MEDAL_RADIUS:.5,MEDAL_RADIUS_LARGE:.75,MEDAL_RADIUS_TRIPLE:.55,MEDAL_THICKNESS:.05,MEDAL_MASS:1,MAX_MEDALS_ON_FIELD:200,INITIAL_FIELD_MEDALS:8,INITIAL_PUSHER_MEDALS:5,MEDAL_PROB_NORMAL:58,MEDAL_PROB_DOUBLE:78,MEDAL_PROB_TRIPLE:88,ITEMS_PER_STAGE:3,SKILL_CHOICES:3,GRAVITY:-9.81,CAMERA_FOV:45,CAMERA_NEAR:.1,CAMERA_FAR:100,JACKPOT_THRESHOLD:25,JACKPOT_MEDAL_REWARD:15,OPEN_ZONE_START:3.5,MEDAL_CLEANUP_Y:-3};function lt(){return window.innerWidth<window.innerHeight?window.innerHeight:window.innerWidth}function ct(){return window.innerWidth<window.innerHeight?window.innerWidth:window.innerHeight}class ei{constructor(){l(this,"camera");l(this,"target",new se(0,0,2));l(this,"basePosition",new se(0,5,13));l(this,"shakeOffset",new se);l(this,"shakeIntensity",0);l(this,"shakeDecay",0);l(this,"titleMode",!1);l(this,"titleAngle",0);l(this,"idleTime",0);l(this,"onResize",()=>{this.camera.aspect=lt()/ct(),this.camera.updateProjectionMatrix(),this.updateCameraForAspect()});this.camera=new es(g.CAMERA_FOV,lt()/ct(),g.CAMERA_NEAR,g.CAMERA_FAR),this.setFrontView(),window.addEventListener("resize",this.onResize)}updateCameraForAspect(){lt()/ct()<1.3?(this.basePosition.set(0,7,11),this.target.set(0,0,2)):(this.basePosition.set(0,5,13),this.target.set(0,0,2)),this.titleMode||(this.camera.position.copy(this.basePosition),this.camera.lookAt(this.target))}setFrontView(){this.updateCameraForAspect()}setTitleMode(e){this.titleMode=e,e||this.setFrontView()}shake(e,s){this.shakeIntensity=e,this.shakeDecay=s>0?-Math.log(.01)/s:0}update(e){if(this.titleMode){this.titleAngle+=e*.18;const t=Math.sin(this.titleAngle)*3,a=7.5+Math.sin(this.titleAngle*.55)*1,n=12+Math.cos(this.titleAngle*.7)*1.2;this.camera.position.set(t,a,n),this.camera.lookAt(t*.2,1.5,1.5);return}this.idleTime+=e;const s=Math.sin(this.idleTime*.22)*.055,i=Math.sin(this.idleTime*.31)*.038;this.shakeIntensity>.001?(this.shakeOffset.set((Math.random()*2-1)*this.shakeIntensity+s,(Math.random()*2-1)*this.shakeIntensity+i,0),this.camera.position.copy(this.basePosition).add(this.shakeOffset),this.shakeIntensity*=Math.exp(-this.shakeDecay*e)):(this.shakeIntensity=0,this.camera.position.copy(this.basePosition),this.camera.position.x+=s,this.camera.position.y+=i),this.camera.lookAt(this.target)}lookAt(e){this.target.copy(e),this.camera.lookAt(this.target)}dispose(){window.removeEventListener("resize",this.onResize)}}class ti{constructor(e){l(this,"ambient");l(this,"dirLight");l(this,"fillLight");l(this,"warmPoint");l(this,"coolPoint");l(this,"sideLeft");l(this,"sideRight");l(this,"fieldSpot");l(this,"backSpot");l(this,"graze");l(this,"scanLight");l(this,"feverActive",!1);this.ambient=new As(4210784,.55),this.dirLight=new et(16775408,1.4),this.dirLight.position.set(6,14,8),this.dirLight.castShadow=!0,this.dirLight.shadow.mapSize.width=2048,this.dirLight.shadow.mapSize.height=2048,this.dirLight.shadow.camera.near=.1,this.dirLight.shadow.camera.far=55,this.dirLight.shadow.camera.left=-14,this.dirLight.shadow.camera.right=14,this.dirLight.shadow.camera.top=14,this.dirLight.shadow.camera.bottom=-14,this.dirLight.shadow.bias=-4e-4,this.fillLight=new et(5267711,.28),this.fillLight.position.set(-6,4,6),this.warmPoint=new we(16760928,1,18),this.warmPoint.position.set(0,7,5),this.coolPoint=new we(3364351,.65,22),this.coolPoint.position.set(0,5,-9),this.sideLeft=new we(16771280,.55,24),this.sideLeft.position.set(-10,5,2),this.sideRight=new we(16771280,.55,24),this.sideRight.position.set(10,5,2),this.fieldSpot=new It(16774376,1.6,32,Math.PI/4.5,.35,1.2),this.fieldSpot.position.set(0,11,2),this.fieldSpot.target.position.set(0,0,-.5),this.fieldSpot.castShadow=!1,this.backSpot=new It(8952319,.8,22,Math.PI/6,.45,1.6),this.backSpot.position.set(0,10,-11),this.backSpot.target.position.set(0,1,0),this.backSpot.castShadow=!1,this.graze=new et(16767136,.55),this.graze.position.set(14,2,4),this.scanLight=new we(16775912,1.3,12),this.scanLight.position.set(0,8,-1),e.add(this.ambient,this.dirLight,this.fillLight,this.warmPoint,this.coolPoint,this.sideLeft,this.sideRight,this.fieldSpot,this.fieldSpot.target,this.backSpot,this.backSpot.target,this.graze,this.scanLight)}update(e){this.scanLight.position.x=Math.sin(e*.57)*4.8,this.scanLight.position.z=Math.cos(e*.38)*1.5-3,this.scanLight.intensity=(this.feverActive?2.2:1.3)+Math.sin(e*1.1)*(this.feverActive?.35:.18)}applyTheme(e){this.ambient.color.set(e.ambientColor),this.ambient.intensity=e.ambientIntensity,this.fillLight.color.set(e.fillColor),this.fillLight.intensity=e.fillIntensity,this.warmPoint.color.set(e.warmPointColor),this.warmPoint.intensity=e.warmPointIntensity,this.coolPoint.color.set(e.coolPointColor),this.coolPoint.intensity=e.coolPointIntensity}setFeverMode(e){this.feverActive=e,this.fieldSpot.intensity=e?2.2:1.6,this.fieldSpot.color.set(e?16772710:16774376),this.scanLight.color.set(e?16763972:16775912)}}class si{constructor(e){l(this,"stars");l(this,"starMat");l(this,"brightStars");l(this,"brightStarMat");l(this,"grid");l(this,"scene");l(this,"dustMotes");l(this,"dustPos");l(this,"_t",0);this.scene=e;const s=2800,i=new Float32Array(s*3),t=65;for(let h=0;h<s;h++){const y=Math.random()*Math.PI*2,x=Math.acos(2*Math.random()-1),v=(.3+Math.random()*.7)*t;i[h*3]=v*Math.sin(x)*Math.cos(y),i[h*3+1]=v*Math.sin(x)*Math.sin(y),i[h*3+2]=v*Math.cos(x)}const a=new je;a.setAttribute("position",new We(i,3)),this.starMat=new tt({size:.13,color:8952319,transparent:!0,opacity:.88,sizeAttenuation:!0}),this.stars=new st(a,this.starMat),e.add(this.stars);const n=200,o=new Float32Array(n*3),r=new Float32Array(n*3),f=[new Y(16765088),new Y(10070783),new Y(16769152),new Y(16756991),new Y(8454143)];for(let h=0;h<n;h++){const y=Math.random()*Math.PI*2,x=Math.acos(2*Math.random()-1),v=(.5+Math.random()*.45)*t;o[h*3]=v*Math.sin(x)*Math.cos(y),o[h*3+1]=v*Math.sin(x)*Math.sin(y),o[h*3+2]=v*Math.cos(x);const M=f[Math.floor(Math.random()*f.length)];r[h*3]=M.r,r[h*3+1]=M.g,r[h*3+2]=M.b}const m=new je;m.setAttribute("position",new We(o,3)),m.setAttribute("color",new We(r,3)),this.brightStarMat=new tt({size:.4,vertexColors:!0,transparent:!0,opacity:.95,sizeAttenuation:!0}),this.brightStars=new st(m,this.brightStarMat),e.add(this.brightStars),this.grid=new At(80,40,1714782,924218),this.grid.position.y=-.56,e.add(this.grid);const d=160;this.dustPos=new Float32Array(d*3);for(let h=0;h<d;h++)this.dustPos[h*3]=(Math.random()-.5)*12,this.dustPos[h*3+1]=Math.random()*7,this.dustPos[h*3+2]=(Math.random()-.5)*14;const u=new je;u.setAttribute("position",new We(this.dustPos,3));const c=new tt({size:.045,color:16765088,transparent:!0,opacity:.32,sizeAttenuation:!0,depthWrite:!1});this.dustMotes=new st(u,c),e.add(this.dustMotes)}applyTheme(e){this.starMat.color.set(e.starColor),this.scene.remove(this.grid),this.grid.geometry.dispose(),this.grid.material.dispose(),this.grid=new At(80,40,e.gridColorA,e.gridColorB),this.grid.position.y=-.56,this.scene.add(this.grid)}update(e){this._t+=e,this.stars.rotation.y+=.008*e,this.brightStars.rotation.y-=.003*e,this.brightStars.rotation.x+=.001*e,this.starMat.opacity=.8+Math.sin(this._t*.45)*.08,this.brightStarMat.opacity=.88+Math.sin(this._t*.62+1.1)*.07;const s=this.dustPos.length/3;for(let i=0;i<s;i++)this.dustPos[i*3]+=Math.sin(i*2.3+this.dustPos[i*3+1]*.7)*6e-4*e,this.dustPos[i*3+1]+=(.006+i%7*5e-4)*e,this.dustPos[i*3+1]>7.5&&(this.dustPos[i*3]=(Math.random()-.5)*12,this.dustPos[i*3+1]=-.2,this.dustPos[i*3+2]=(Math.random()-.5)*14);this.dustMotes.geometry.attributes.position.needsUpdate=!0}}class ii{constructor(){l(this,"world");l(this,"_initialized",!1)}async init(){await Ve.init(),this.world=new Ve.World({x:0,y:g.GRAVITY,z:0});const e=this.world.integrationParameters;e.numSolverIterations=4,e.numAdditionalFrictionIterations=2,e.numInternalPgsIterations=1,e.maxCcdSubsteps=4,this._initialized=!0}get rapier(){return Ve}get instance(){if(!this._initialized)throw new Error("PhysicsWorld not initialized");return this.world}get initialized(){return this._initialized}step(){this.world.step()}createRigidBody(e){return this.world.createRigidBody(e)}createCollider(e,s){return this.world.createCollider(e,s)}removeRigidBody(e){this.world.removeRigidBody(e)}getEventQueue(){return new Ve.EventQueue(!0)}stepWithEvents(e){this.world.step(e)}forEachActiveRigidBody(e){this.world.forEachActiveRigidBody(e)}setTimestep(e){this._initialized&&(this.world.integrationParameters.dt=e)}dispose(){this._initialized&&(this.world.free(),this._initialized=!1)}}class ai{constructor(){l(this,"bodyToMesh",new Map)}register(e,s){this.bodyToMesh.set(e.handle,s)}unregister(e){this.bodyToMesh.delete(e.handle)}sync(e){e.forEachActiveRigidBody(s=>{const i=this.bodyToMesh.get(s.handle);if(!i)return;const t=s.translation(),a=s.rotation(),n=i.userData.physicsYOffset??0;i.position.set(t.x,t.y+n,t.z),i.quaternion.set(a.x,a.y,a.z,a.w)})}clear(){this.bodyToMesh.clear()}get count(){return this.bodyToMesh.size}}class ni{constructor(){l(this,"handles",new Map);l(this,"dropZoneHandles",new Set);l(this,"eventQueue");l(this,"medalCollectedCallback");l(this,"itemCollectedCallback")}init(e){this.eventQueue=e.getEventQueue()}registerHandle(e,s){this.handles.set(e,s),s==="drop_zone"&&this.dropZoneHandles.add(e)}unregisterHandle(e){this.handles.delete(e),this.dropZoneHandles.delete(e)}onMedalCollected(e){this.medalCollectedCallback=e}onItemCollected(e){this.itemCollectedCallback=e}processEvents(e,s=1){for(let i=0;i<s;i++)e.stepWithEvents(this.eventQueue);this.eventQueue.drainCollisionEvents((i,t,a)=>{var f,m;if(!a)return;const n=this.handles.get(i),o=this.handles.get(t);if(n==="drop_zone"&&(o==="medal"||o==="item")||o==="drop_zone"&&(n==="medal"||n==="item")){const d=n==="drop_zone"?t:i,u=n==="drop_zone"?o:n;u==="medal"?(f=this.medalCollectedCallback)==null||f.call(this,d):u==="item"&&((m=this.itemCollectedCallback)==null||m.call(this,d))}})}getTag(e){return this.handles.get(e)}clear(){this.handles.clear(),this.dropZoneHandles.clear(),this.medalCollectedCallback=void 0,this.itemCollectedCallback=void 0}}class oi{constructor(){l(this,"body");l(this,"time",0);l(this,"zBase");l(this,"initialized",!1);l(this,"speedMultiplier",1);l(this,"paused",!1);this.zBase=-12/2+g.PUSHER_DEPTH/2-g.PUSHER_RANGE}async initPhysics(e){const s=e.rapier,i=s.RigidBodyDesc.kinematicVelocityBased().setTranslation(0,g.PUSHER_HEIGHT/2,this.zBase);this.body=e.createRigidBody(i);const t=s.ColliderDesc.cuboid(g.PUSHER_WIDTH/2,g.PUSHER_HEIGHT/2,g.PUSHER_DEPTH/2).setFriction(.25).setRestitution(0);e.createCollider(t,this.body),this.initialized=!0}update(e){if(this.paused)return this.initialized&&this.body.setLinvel({x:0,y:0,z:0},!0),this.currentZOffset;this.time+=e*this.speedMultiplier;const s=g.PUSHER_PERIOD_MS/1e3,i=this.time%s/s,t=(1-Math.cos(i*Math.PI*2))/2*g.PUSHER_RANGE;if(this.initialized){const a=Math.PI/s*Math.sin(i*Math.PI*2)*g.PUSHER_RANGE*this.speedMultiplier;this.body.setLinvel({x:0,y:0,z:a},!0)}return t}get currentZOffset(){const e=g.PUSHER_PERIOD_MS/1e3,s=this.time%e/e;return(1-Math.cos(s*Math.PI*2))/2*g.PUSHER_RANGE}get restZ(){return this.zBase}}function Ye(p){return[p>>16&255,p>>8&255,p&255]}function dt(p){const e=p.replace("#","");return[parseInt(e.slice(0,2),16),parseInt(e.slice(2,4),16),parseInt(e.slice(4,6),16)]}function K(p,e,s,i){return`rgb(${Math.min(255,p+i)},${Math.min(255,e+i)},${Math.min(255,s+i)})`}function De(p,e,s,i){return`rgb(${Math.max(0,p-i)},${Math.max(0,e-i)},${Math.max(0,s-i)})`}function kt(p,e,s){return`rgb(${p},${e},${s})`}function le(p,e,s,i,t){return`rgba(${Math.min(255,p+i)},${Math.min(255,e+i)},${Math.min(255,s+i)},${t})`}const Te=class Te{static get(e,s){if(!this.cache.has(e)){const i=s(),t=new ts(i);this.cache.set(e,t)}return this.cache.get(e)}static getMedalTexture(e){return this.get(`medal_${e.toString(16)}`,()=>{const i=document.createElement("canvas");i.width=i.height=256;const t=i.getContext("2d"),a=256/2,n=256/2,o=256/2-2,[r,f,m]=Ye(e),d=kt(r,f,m),u=K(r,f,m,75),c=K(r,f,m,38),h=De(r,f,m,60),y=De(r,f,m,90),x=t.createRadialGradient(a-32,n-32,4,a,n,o);x.addColorStop(0,u),x.addColorStop(.25,K(r,f,m,55)),x.addColorStop(.55,c),x.addColorStop(.8,d),x.addColorStop(1,h),t.fillStyle=x,t.beginPath(),t.arc(a,n,o,0,Math.PI*2),t.fill(),t.save(),t.globalCompositeOperation="source-over";const v=480;for(let I=0;I<v;I++){const C=I/v*Math.PI*2,$=.012+Math.random()*.028,F=Math.random()>.5;t.strokeStyle=F?`rgba(${Math.min(255,r+45)},${Math.min(255,f+40)},${Math.min(255,m+35)},${$})`:`rgba(${Math.max(0,r-20)},${Math.max(0,f-18)},${Math.max(0,m-15)},${$*.7})`,t.lineWidth=.5+Math.random()*.6,t.beginPath(),t.moveTo(a+Math.cos(C)*16,n+Math.sin(C)*16),t.lineTo(a+Math.cos(C)*(o-20),n+Math.sin(C)*(o-20)),t.stroke()}t.restore();for(let I=0;I<4;I++){const C=o-6-I*8;t.strokeStyle=De(r,f,m,35+I*10),t.lineWidth=2,t.beginPath(),t.arc(a,n,C,0,Math.PI*2),t.stroke(),t.strokeStyle=K(r,f,m,22+I*6),t.lineWidth=.9,t.beginPath(),t.arc(a,n,C+2.5,0,Math.PI*2),t.stroke()}t.strokeStyle=y,t.lineWidth=8,t.beginPath(),t.arc(a,n,o-5,0,Math.PI*2),t.stroke(),t.save(),t.strokeStyle=K(r,f,m,60),t.globalAlpha=.55,t.lineWidth=3,t.beginPath(),t.arc(a,n,o-3,Math.PI*.9,Math.PI*1.8),t.stroke(),t.restore();const M=68,D=t.createRadialGradient(a-10,n-10,0,a,n,M);D.addColorStop(0,K(r,f,m,65)),D.addColorStop(.4,K(r,f,m,30)),D.addColorStop(.75,c),D.addColorStop(.92,d),D.addColorStop(1,h),t.fillStyle=D,t.beginPath(),t.arc(a,n,M,0,Math.PI*2),t.fill(),t.strokeStyle=De(r,f,m,50),t.lineWidth=2.5,t.beginPath(),t.arc(a,n,M+.5,0,Math.PI*2),t.stroke(),t.strokeStyle=K(r,f,m,48),t.lineWidth=1.2,t.beginPath(),t.arc(a,n,M-2.5,0,Math.PI*2),t.stroke(),t.lineCap="round";for(let I=0;I<24;I++){const C=I*Math.PI/12,$=I%2===0,F=$?16:22,z=$?56:48,V=$?.28:.18;t.strokeStyle=`rgba(${Math.min(255,r+50)},${Math.min(255,f+45)},${Math.min(255,m+38)},${V})`,t.lineWidth=$?2.5:1.5,t.beginPath(),t.moveTo(a+Math.cos(C)*F,n+Math.sin(C)*F),t.lineTo(a+Math.cos(C)*z,n+Math.sin(C)*z),t.stroke()}const T=e===13691135;if(T||e===16719968){const I=T?"×2":"×3",C=22,$=t.createRadialGradient(a-5,n-5,0,a,n,C);$.addColorStop(0,K(r,f,m,100)),$.addColorStop(.6,c),$.addColorStop(1,h),t.fillStyle=$,t.beginPath(),t.arc(a,n,C,0,Math.PI*2),t.fill(),t.strokeStyle=y,t.lineWidth=2,t.beginPath(),t.arc(a,n,C,0,Math.PI*2),t.stroke(),t.font="bold 26px sans-serif",t.textAlign="center",t.textBaseline="middle",t.fillStyle="rgba(255,255,255,0.96)",t.shadowColor="rgba(0,0,0,0.85)",t.shadowBlur=6,t.fillText(I,a,n+1),t.shadowBlur=0,t.textAlign="left"}else{const F=Math.PI/5,z=t.createRadialGradient(a-4,n-4,0,a,n,13);z.addColorStop(0,u),z.addColorStop(.5,c),z.addColorStop(1,h),t.fillStyle=z,t.beginPath();for(let V=0;V<10;V++){const Q=V%2===0?13:5.5,j=V*F-Math.PI/2;V===0?t.moveTo(a+Q*Math.cos(j),n+Q*Math.sin(j)):t.lineTo(a+Q*Math.cos(j),n+Q*Math.sin(j))}t.closePath(),t.fill(),t.strokeStyle=y,t.lineWidth=1.5,t.stroke()}const b=t.createRadialGradient(a-48,n-48,0,a-48,n-48,95);b.addColorStop(0,"rgba(255,255,255,0.72)"),b.addColorStop(.2,"rgba(255,255,255,0.32)"),b.addColorStop(.5,"rgba(255,255,255,0.08)"),b.addColorStop(1,"rgba(255,255,255,0)"),t.fillStyle=b,t.beginPath(),t.arc(a,n,o-2,0,Math.PI*2),t.fill();const O=t.createRadialGradient(a+52,n+50,0,a+52,n+50,60);O.addColorStop(0,"rgba(255,255,255,0.22)"),O.addColorStop(.4,"rgba(255,255,255,0.06)"),O.addColorStop(1,"rgba(255,255,255,0)"),t.fillStyle=O,t.beginPath(),t.arc(a,n,o-2,0,Math.PI*2),t.fill();const L=t.getImageData(0,0,256,256),_=L.data;for(let I=0;I<_.length;I+=4){const C=(Math.random()-.5)*10;_[I]=Math.max(0,Math.min(255,_[I]+C)),_[I+1]=Math.max(0,Math.min(255,_[I+1]+C)),_[I+2]=Math.max(0,Math.min(255,_[I+2]+C))}return t.putImageData(L,0,0),i})}static getFieldTexture(e="#2a2a4e"){return this.get(`field_${e}`,()=>{const i=document.createElement("canvas");i.width=i.height=512;const t=i.getContext("2d"),[a,n,o]=dt(e),r=a>o+20;if(t.fillStyle=e,t.fillRect(0,0,512,512),r){const f=t.getImageData(0,0,512,512),m=f.data;for(let c=0;c<m.length;c+=4){const h=(Math.random()-.5)*22;m[c]=Math.max(0,Math.min(255,a+h)),m[c+1]=Math.max(0,Math.min(255,n+h)),m[c+2]=Math.max(0,Math.min(255,o+h)),m[c+3]=255}t.putImageData(f,0,0);for(let c=0;c<512;c+=3){const h=.07+Math.random()*.06,y=Math.random()>.5;t.strokeStyle=y?`rgba(${Math.min(255,a+18)},${Math.min(255,n+14)},${Math.min(255,o+10)},${h})`:`rgba(${Math.max(0,a-14)},${Math.max(0,n-10)},${Math.max(0,o-8)},${h})`,t.lineWidth=1+Math.random()*1.5,t.beginPath(),t.moveTo(0,c+.5),t.lineTo(512,c+.5),t.stroke()}t.save(),t.globalAlpha=.1;const d=36;t.strokeStyle=K(a,n,o,50),t.lineWidth=.8,t.translate(512/2,512/2),t.rotate(Math.PI/4),t.translate(-512/2,-512/2);for(let c=-512;c<=512*2;c+=d)t.beginPath(),t.moveTo(c,-512),t.lineTo(c,512*2),t.stroke();for(let c=-512;c<=512*2;c+=d)t.beginPath(),t.moveTo(-512,c),t.lineTo(512*2,c),t.stroke();t.restore();const u=t.createRadialGradient(512/2,512/2,512*.25,512/2,512/2,512*.75);u.addColorStop(0,"rgba(0,0,0,0)"),u.addColorStop(1,"rgba(0,0,0,0.28)"),t.fillStyle=u,t.fillRect(0,0,512,512)}else{const f=t.getImageData(0,0,512,512),m=f.data;for(let c=0;c<m.length;c+=4){const h=(Math.random()-.5)*18;m[c]=Math.max(0,Math.min(255,a+h)),m[c+1]=Math.max(0,Math.min(255,n+h)),m[c+2]=Math.max(0,Math.min(255,o+h)),m[c+3]=255}t.putImageData(f,0,0),t.save(),t.globalAlpha=.14;const d=40;t.strokeStyle=K(a,n,o,60),t.lineWidth=.8,t.translate(512/2,512/2),t.rotate(Math.PI/4),t.translate(-512/2,-512/2);for(let c=-512;c<=512*2;c+=d)t.beginPath(),t.moveTo(c,-512),t.lineTo(c,512*2),t.stroke();for(let c=-512;c<=512*2;c+=d)t.beginPath(),t.moveTo(-512,c),t.lineTo(512*2,c),t.stroke();t.restore(),t.save(),t.globalAlpha=.25,t.fillStyle=K(a,n,o,80),t.translate(512/2,512/2),t.rotate(Math.PI/4),t.translate(-512/2,-512/2);for(let c=0;c<=512*2;c+=d)for(let h=0;h<=512*2;h+=d)t.beginPath(),t.arc(c-512/2,h-512/2,1.8,0,Math.PI*2),t.fill();t.restore();for(let c=0;c<512;c+=4){const h=.04+Math.random()*.04,y=Math.random()>.5;t.strokeStyle=y?`rgba(${Math.min(255,a+20)},${Math.min(255,n+16)},${Math.min(255,o+14)},${h})`:`rgba(${Math.max(0,a-10)},${Math.max(0,n-8)},${Math.max(0,o-8)},${h})`,t.lineWidth=1+Math.random()*1.2,t.beginPath(),t.moveTo(0,c+.5),t.lineTo(512,c+.5),t.stroke()}const u=t.createRadialGradient(512/2,512/2,512*.2,512/2,512/2,512*.72);u.addColorStop(0,"rgba(0,0,0,0)"),u.addColorStop(1,"rgba(0,0,0,0.30)"),t.fillStyle=u,t.fillRect(0,0,512,512)}return i})}static getPusherTexture(e="#3a3a6e"){return this.get(`pusher_${e}`,()=>{const t=document.createElement("canvas");t.width=256,t.height=128;const a=t.getContext("2d"),[n,o,r]=dt(e),f=n>r+20;if(a.fillStyle=e,a.fillRect(0,0,256,128),f){a.strokeStyle=le(n,o,r,90,.38),a.lineWidth=.8;const u=14;for(let c=-128;c<384;c+=u)a.beginPath(),a.moveTo(c,0),a.lineTo(c+128,128),a.stroke();for(let c=0;c<512;c+=u)a.beginPath(),a.moveTo(c,0),a.lineTo(c-128,128),a.stroke();a.fillStyle=K(n,o,r,90);for(let c=0;c<2;c++){const h=10+c*108;for(let y=20;y<256;y+=36)a.fillStyle=K(n,o,r,80),a.beginPath(),a.arc(y,h,4.5,0,Math.PI*2),a.fill(),a.fillStyle=le(n,o,r,150,.7),a.beginPath(),a.arc(y-1,h-1,2,0,Math.PI*2),a.fill(),a.fillStyle="rgba(0,0,0,0.45)",a.beginPath(),a.arc(y+1,h+1,3,.5,Math.PI*2),a.fill()}}else{for(let u=0;u<128;u++){const c=.015+Math.random()*.055;a.strokeStyle=le(n,o,r,100,c),a.lineWidth=1,a.beginPath(),a.moveTo(0,u+.5),a.lineTo(256,u+.5),a.stroke()}a.fillStyle=le(n,o,r,120,.35);for(let u=24;u<256;u+=48)a.beginPath(),a.arc(u,8,3,0,Math.PI*2),a.fill()}const m=a.createLinearGradient(0,0,0,18);m.addColorStop(0,le(n,o,r,150,.6)),m.addColorStop(1,le(n,o,r,150,0)),a.fillStyle=m,a.fillRect(0,0,256,18);const d=a.createLinearGradient(0,114,0,128);return d.addColorStop(0,"rgba(0,0,0,0)"),d.addColorStop(1,"rgba(0,0,0,0.55)"),a.fillStyle=d,a.fillRect(0,114,256,14),t})}static getWallTexture(e="#1a1a3e"){return this.get(`wall_${e}`,()=>{const i=document.createElement("canvas");i.width=i.height=256;const t=i.getContext("2d"),[a,n,o]=dt(e),r=a>o+20;if(t.fillStyle=e,t.fillRect(0,0,256,256),r)for(let u=0;u<256;u+=40){const c=t.createLinearGradient(0,u,0,u+40);c.addColorStop(0,K(a,n,o,18)),c.addColorStop(.5,kt(a,n,o)),c.addColorStop(1,De(a,n,o,12)),t.fillStyle=c,t.fillRect(0,u,256,40),t.strokeStyle="rgba(0,0,0,0.55)",t.lineWidth=2,t.beginPath(),t.moveTo(0,u+40-1),t.lineTo(256,u+40-1),t.stroke(),t.strokeStyle=le(a,n,o,70,.45),t.lineWidth=1,t.beginPath(),t.moveTo(0,u+1),t.lineTo(256,u+1),t.stroke();for(let h=24;h<256;h+=48){const y=u+40-7;t.fillStyle=K(a,n,o,55),t.beginPath(),t.arc(h,y,4,0,Math.PI*2),t.fill(),t.fillStyle=le(a,n,o,130,.6),t.beginPath(),t.arc(h-1,y-1,1.5,0,Math.PI*2),t.fill(),t.fillStyle="rgba(0,0,0,0.5)",t.beginPath(),t.arc(h+1,y+1,2.5,.4,Math.PI*2),t.fill()}}else{for(let h=0;h<256;h+=64){const y=t.createLinearGradient(h,0,h+64,0);y.addColorStop(0,"rgba(0,0,0,0.22)"),y.addColorStop(.12,"rgba(0,0,0,0)"),y.addColorStop(.88,"rgba(0,0,0,0)"),y.addColorStop(1,"rgba(0,0,0,0.22)"),t.fillStyle=y,t.fillRect(h,0,64,256),t.strokeStyle="rgba(0,0,0,0.55)",t.lineWidth=2,t.beginPath(),t.moveTo(h,0),t.lineTo(h,256),t.stroke(),t.strokeStyle=le(a,n,o,72,.28),t.lineWidth=.9,t.beginPath(),t.moveTo(h+2.5,0),t.lineTo(h+2.5,256),t.stroke()}const u=56;for(let h=0;h<256;h+=u){t.strokeStyle="rgba(0,0,0,0.50)",t.lineWidth=2,t.beginPath(),t.moveTo(0,h),t.lineTo(256,h),t.stroke(),t.strokeStyle=le(a,n,o,62,.22),t.lineWidth=.9,t.beginPath(),t.moveTo(0,h+2.5),t.lineTo(256,h+2.5),t.stroke(),t.save(),t.globalAlpha=.6;for(let y=0;y<256;y+=64)t.fillStyle=K(a,n,o,85),t.beginPath(),t.arc(y,h,2.2,0,Math.PI*2),t.fill(),t.fillStyle="rgba(0,0,0,0.45)",t.beginPath(),t.arc(y+.6,h+.6,1.1,0,Math.PI*2),t.fill();t.restore()}t.save(),t.globalAlpha=.04,t.strokeStyle=K(a,n,o,55),t.lineWidth=.6;for(let h=-256;h<256*2;h+=10)t.beginPath(),t.moveTo(h,0),t.lineTo(h+256*.5,256),t.stroke();t.restore();const c=t.createRadialGradient(256/2,256/2,256*.2,256/2,256/2,256*.72);c.addColorStop(0,"rgba(0,0,0,0)"),c.addColorStop(1,"rgba(0,0,0,0.32)"),t.fillStyle=c,t.fillRect(0,0,256,256)}const f=t.getImageData(0,0,256,256),m=f.data;for(let d=0;d<m.length;d+=4){const u=(Math.random()-.5)*(r?8:10);m[d]=Math.max(0,Math.min(255,m[d]+u)),m[d+1]=Math.max(0,Math.min(255,m[d+1]+u)),m[d+2]=Math.max(0,Math.min(255,m[d+2]+u))}return t.putImageData(f,0,0),i})}static getScreenTexture(e,s){return this.get(`screen_${e.toString(16)}_${s.toString(16)}`,()=>{const a=document.createElement("canvas");a.width=512,a.height=256;const n=a.getContext("2d"),[o,r,f]=Ye(s),m=n.createRadialGradient(512/2,256*.7,0,512/2,256*.7,512*.65);m.addColorStop(0,`rgb(${Math.min(o+28,60)},${Math.min(r+20,52)},${Math.min(f+28,68)})`),m.addColorStop(1,`rgb(${Math.max(o-4,0)},${Math.max(r-4,0)},${Math.max(f-4,0)})`),n.fillStyle=m,n.fillRect(0,0,512,256);const[d,u,c]=Ye(e),h=`rgb(${d},${u},${c})`,y=`rgba(${d},${u},${c},0.60)`,x=`rgba(${d},${u},${c},0.25)`;n.strokeStyle=y,n.lineWidth=1.5,n.strokeRect(10,10,492,236),n.strokeStyle=x,n.lineWidth=.8,n.strokeRect(16,16,480,224);const v=["♠","♥","♦","♣"],M=[[32,38],[480,38],[32,234],[480,234]];n.textAlign="center",n.textBaseline="middle",n.font="bold 20px serif";for(let L=0;L<4;L++)n.fillStyle=x,n.fillText(v[L],M[L][0],M[L][1]);n.strokeStyle=x,n.lineWidth=1.5;for(const[L,_]of[[22,22],[490,22],[22,234],[490,234]])n.beginPath(),n.moveTo(L-7,_),n.lineTo(L+7,_),n.moveTo(L,_-7),n.lineTo(L,_+7),n.stroke();n.textAlign="center",n.textBaseline="top",n.font="bold 12px monospace",n.fillStyle=x,n.fillText("✦  INSERT COIN  ✦",512/2,22),n.strokeStyle=x,n.lineWidth=1,n.beginPath(),n.moveTo(20,52),n.lineTo(492,52),n.stroke(),n.textAlign="left",n.textBaseline="top",n.font="bold 11px monospace",n.fillStyle=x,n.fillText("JACKPOT",32,64),n.fillText("HIGH SCORE",512/2+20,64),n.font="bold 22px monospace",n.fillStyle=y,n.fillText("000000",32,80),n.fillText("999999",512/2+20,80),n.strokeStyle=y,n.lineWidth=1,n.beginPath(),n.moveTo(20,116),n.lineTo(492,116),n.stroke(),n.textAlign="center",n.textBaseline="alphabetic",n.font="bold 52px monospace",n.shadowColor=h,n.shadowBlur=26,n.fillStyle=h,n.fillText("YUKIMEDAL",512/2,206),n.shadowBlur=0,n.font="14px monospace",n.fillStyle=y,n.fillText("ROGUELIKE  MEDAL  PUSHER",512/2,234);const[D,T,S]=Ye(s),b=`rgb(${Math.max(D-4,0)},${Math.max(T-4,0)},${Math.max(S-4,0)})`,O=n;return Promise.resolve().then(()=>{const L=`screen_${e.toString(16)}_${s.toString(16)}`,_=Te.cache.get(L);_&&(Te._screen={ctx:O,tex:_,nr:d,ng:u,nb:c,clearRgb:b,W:512,H:256})}),a})}static refreshJackpot(e){const s=this._screen;if(!s)return;const{ctx:i,tex:t,nr:a,ng:n,nb:o,clearRgb:r,W:f}=s,m=`rgba(${a},${n},${o},0.60)`,d=`rgba(${a},${n},${o},0.25)`;i.fillStyle=r,i.fillRect(28,62,220,40),i.textAlign="left",i.textBaseline="top",i.font="bold 11px monospace",i.fillStyle=d,i.fillText("JACKPOT",32,64),i.font="bold 22px monospace",i.fillStyle=m,i.fillText(Math.min(e,999999).toString().padStart(6,"0"),32,80),t.needsUpdate=!0}static disposeAll(){this.cache.forEach(e=>e.dispose()),this.cache.clear()}};l(Te,"cache",new Map),l(Te,"_screen",null);let he=Te;const ri=new ie(g.MEDAL_RADIUS,g.MEDAL_RADIUS,g.MEDAL_THICKNESS,48),li=new ie(g.MEDAL_RADIUS_LARGE,g.MEDAL_RADIUS_LARGE,g.MEDAL_THICKNESS,48),ci=new ie(g.MEDAL_RADIUS_TRIPLE,g.MEDAL_RADIUS_TRIPLE,g.MEDAL_THICKNESS*1.3,48),di={normal:16766720,double:13691135,large:15245312,triple:16719968},hi={normal:1,double:2,large:1,triple:3};function pi(p){const e=p*100;return e<g.MEDAL_PROB_NORMAL?"normal":e<g.MEDAL_PROB_DOUBLE?"double":e<g.MEDAL_PROB_TRIPLE?"triple":"large"}function mi(p){return p==="large"?li:p==="triple"?ci:ri}function Lt(p){p.traverse(e=>{if(e instanceof k){e.geometry.dispose();const s=e.material;Array.isArray(s)?s.forEach(i=>i.dispose()):s.dispose()}})}function ui(p){return[p>>16&255,p>>8&255,p&255]}function ht(p){return Math.max(0,Math.min(255,p))}function wt(p,e){const[s,i,t]=ui(p);return ht(s+e)<<16|ht(i+e)<<8|ht(t+e)}function fi(p,e,s){const i=p*.27,t=p*.118,a=5,n=Math.max(e*.55,.012),o=i*.1,r=new _s;for(let u=0;u<a*2;u++){const c=u%2===0?i:t,h=u*Math.PI/a-Math.PI/2;u===0?r.moveTo(c*Math.cos(h),c*Math.sin(h)):r.lineTo(c*Math.cos(h),c*Math.sin(h))}r.closePath();const f=new Ps(r,{depth:n,bevelEnabled:!0,bevelSize:o,bevelThickness:n*.5,bevelSegments:3});f.rotateX(-Math.PI/2);const m=new ye({color:wt(s,48),metalness:.98,roughness:.06,clearcoat:.9,clearcoatRoughness:.02,envMapIntensity:1.8}),d=new k(f,m);return d.position.y=e/2,d.castShadow=!0,d}function Dt(p,e,s,i){const t=p*(i?.4:.32),a=p*.032,n=new Ee(t,a,8,36),o=new ye({color:wt(s,65),emissive:new Y(s),emissiveIntensity:i?.55:.25,metalness:.95,roughness:.06,clearcoat:.85,clearcoatRoughness:.03,envMapIntensity:1.8}),r=new k(n,o);return r.rotation.x=Math.PI/2,r.position.y=e/2+a,r.castShadow=!0,r}class gi{constructor(){l(this,"medals",new Map);l(this,"pendingRemoval",new Set);l(this,"spawnCounter",0)}spawn(e,s,i,t,a,n,o,r,f){if(this.medals.size>=g.MAX_MEDALS_ON_FIELD)return;const m=t.rapier,d=f??pi(Math.random()),u=d==="large"?g.MEDAL_RADIUS_LARGE:d==="triple"?g.MEDAL_RADIUS_TRIPLE:g.MEDAL_RADIUS,c=hi[d],h=m.RigidBodyDesc.dynamic().setTranslation(e,s,i).setLinearDamping(.5).setAngularDamping(4),y=t.createRigidBody(h);y.setEnabledRotations(!0,!1,!0,!0),r&&y.setLinvel(r,!0);const x=m.ColliderDesc.cylinder(g.MEDAL_THICKNESS/2,u).setRestitution(.01).setFriction(.15).setDensity(g.MEDAL_MASS).setActiveEvents(m.ActiveEvents.COLLISION_EVENTS),v=t.createCollider(x,y);n.registerHandle(v.handle,"medal");const M=di[d],D=he.getMedalTexture(M);D.wrapS=D.wrapT=Rs;const T=d==="triple",S=d==="double",b=.12+Math.random()*.12,O=(Math.random()-.5)*.14,L=new Y(Math.min(1,1+O),Math.min(1,1+O*.85),Math.min(1,1-O*.25)),_=new ye({color:T||S?16777215:L,map:D,metalness:.9,roughness:b,clearcoat:.4,clearcoatRoughness:.05+Math.random()*.06,reflectivity:.95,envMapIntensity:.85,emissive:T||S?new Y(M):new Y(0),emissiveIntensity:T?.18:S?.07:0}),I=new k(mi(d),_);I.castShadow=!0,I.receiveShadow=!1;const C=g.MEDAL_THICKNESS*.58,$=new Ee(u-C*.45,C,10,48),F=new ye({color:wt(M,18),metalness:.95,roughness:.1,clearcoat:.6,clearcoatRoughness:.04,envMapIntensity:.9,emissive:T||S?new Y(M):new Y(0),emissiveIntensity:T?.18:S?.06:0}),z=new k($,F);z.rotation.x=Math.PI/2,I.add(z);const V=Math.random()*Math.PI*2;if(!T&&!S){const Q=fi(u,g.MEDAL_THICKNESS,M);Q.rotation.y=V,I.add(Q)}else{const Q=Dt(u,g.MEDAL_THICKNESS,M,T);if(I.add(Q),T){const j=Dt(u,g.MEDAL_THICKNESS,M,!1);j.scale.setScalar(1.35),j.position.y=g.MEDAL_THICKNESS/2+.005,I.add(j)}}I.userData.physicsYOffset=.03,I.position.set(e,s,i),o.add(I),a.register(y,I),this.medals.set(v.handle,{body:y,collider:v,mesh:I,type:d,quotaValue:c}),this.spawnCounter++}getQuotaValue(e){var s;return((s=this.medals.get(e))==null?void 0:s.quotaValue)??1}getMedalPosition(e){const s=this.medals.get(e);if(!s)return{x:0,y:0,z:0};const i=s.body.translation();return{x:i.x,y:i.y,z:i.z}}markForRemoval(e){this.pendingRemoval.add(e)}nudgeDeadZone(e,s){for(const[,i]of this.medals){if(this.pendingRemoval.has(i.collider.handle))continue;const t=i.body.translation(),a=i.body.linvel();t.z>e-.2&&t.z<s&&t.y>-.2&&Math.sqrt(a.x*a.x+a.z*a.z)<.05&&i.body.setLinvel({x:(Math.random()-.5)*.2,y:0,z:3.5},!0)}}collectPastCliff(e,s,i){for(const[t,a]of this.medals){if(this.pendingRemoval.has(t))continue;const n=a.body.translation();n.z>e&&n.y<s&&(this.pendingRemoval.add(t),i(t))}}capVelocities(e){for(const[,s]of this.medals){if(this.pendingRemoval.has(s.collider.handle))continue;const i=s.body.linvel(),t=i.x*i.x+i.y*i.y+i.z*i.z;if(t>e*e){const a=e/Math.sqrt(t);s.body.setLinvel({x:i.x*a,y:i.y*a,z:i.z*a},!0)}}}shakeAll(e=3){for(const[,s]of this.medals){if(this.pendingRemoval.has(s.collider.handle))continue;const i=(Math.random()-.5)*e,t=Math.random()*e*.4+.5,a=(Math.random()-.5)*e*.5-e*.3;s.body.applyImpulse({x:i,y:t,z:a},!0)}}flushRemovals(e,s,i,t){let a=0;for(const n of this.pendingRemoval){const o=this.medals.get(n);o&&(s.unregister(o.body),i.unregisterHandle(n),t.remove(o.mesh),e.removeRigidBody(o.body),Lt(o.mesh),this.medals.delete(n),a++)}return this.pendingRemoval.clear(),a}cleanupFallen(e,s,i,t,a,n){let o=0;for(const[r,f]of this.medals)f.body.translation().y<e&&!this.pendingRemoval.has(r)&&(this.pendingRemoval.add(r),n==null||n(r),o++);return o}get count(){return this.medals.size}clear(e,s,i,t){for(const[a,n]of this.medals)s.unregister(n.body),i.unregisterHandle(a),t.remove(n.mesh),e.removeRigidBody(n.body),Lt(n.mesh);this.medals.clear(),this.pendingRemoval.clear()}}class yi{constructor(){l(this,"body");l(this,"collider")}async initPhysics(e,s){const i=e.rapier,t=g.OPEN_ZONE_START,a=g.FIELD_DEPTH/2+15,n=(t+a)/2,o=(a-t)/2,r=i.RigidBodyDesc.fixed().setTranslation(0,-2,n);this.body=e.createRigidBody(r);const f=i.ColliderDesc.cuboid(g.FIELD_WIDTH/2+1,1.5,o).setActiveEvents(i.ActiveEvents.COLLISION_EVENTS).setSensor(!0);this.collider=e.createCollider(f,this.body),s.registerHandle(this.collider.handle,"drop_zone")}}class xi{constructor(){l(this,"time",0)}setupStage(e,s,i,t){this.clear(t)}getBonusMultiplierAt(e,s){return 1}update(e){this.time+=e}clear(e){this.time=0}}var H=(p=>(p.Common="Common",p.Rare="Rare",p.Epic="Epic",p.Legendary="Legendary",p))(H||{});const as={[H.Common]:11184810,[H.Rare]:3381759,[H.Epic]:13387007,[H.Legendary]:16763904},bi={[H.Common]:3355443,[H.Rare]:1127304,[H.Epic]:6689160,[H.Legendary]:8939008},vi={[H.Common]:.45,[H.Rare]:.75,[H.Epic]:.85,[H.Legendary]:.95};function wi(p){const e=as[p],s=bi[p],i=vi[p],t=new ss,a=p===H.Legendary?.4:p===H.Epic?.3:p===H.Rare?.2:.1,n=new ye({color:e,emissive:s,emissiveIntensity:i,metalness:p===H.Legendary?.1:.25,roughness:.1,clearcoat:1,clearcoatRoughness:.04,transmission:a,ior:1.55,transparent:!0,opacity:.92,envMapIntensity:2});let o;switch(p){case H.Legendary:o=new Ds(.24,.07,80,12,2,3);break;case H.Epic:o=new Ls(.32,0);break;case H.Rare:{const f=new Rt(.22,.3,8,1),m=new Rt(.22,.26,8,1),d=new k(m,n.clone());d.rotation.x=Math.PI,d.position.y=-.03;const u=new k(f,n);return u.castShadow=!0,d.castShadow=!0,t.add(u,d),o=f,Ht(t,p),t}default:o=new ks(.3,0);break}const r=new k(o,n);if(r.castShadow=!0,t.add(r),p!==H.Common){const f=new ye({color:e,emissive:e,emissiveIntensity:p===H.Legendary?2:1.4,metalness:0,roughness:.4,clearcoat:.5,clearcoatRoughness:.1,transparent:!0,opacity:.45}),m=o.clone(),d=new k(m,f);d.scale.setScalar(.65),t.add(d)}return Ht(t,p),t}function Ht(p,e){const s=as[e];if(e===H.Common)return;const i=e===H.Legendary?.4:e===H.Epic?.36:.3,t=new Ee(i,.018,8,48),a=new ye({color:s,emissive:s,emissiveIntensity:e===H.Legendary?2.5:1.8,metalness:0,roughness:.05,clearcoat:.8,clearcoatRoughness:.02,transparent:!0,opacity:.9}),n=new k(t,a);if(n.rotation.x=Math.PI/3,p.add(n),e===H.Legendary){const o=new k(new Ee(i*.88,.012,6,40),a.clone());o.rotation.x=Math.PI/3,o.rotation.y=Math.PI/2,p.add(o)}}class Si{constructor(e){l(this,"mesh");this.mesh=wi(e),this.mesh.castShadow=!0}update(e){this.mesh.rotation.y+=.025;for(const s of this.mesh.children)s instanceof k&&s.geometry instanceof Ee&&(s.rotation.z+=.018)}setPosition(e,s,i){this.mesh.position.set(e,s,i)}dispose(){this.mesh.traverse(e=>{if(e instanceof k){e.geometry.dispose();const s=e.material;Array.isArray(s)?s.forEach(i=>i.dispose()):s.dispose()}})}}class St{constructor(e=Date.now()){l(this,"seed");this.seed=e}next(){this.seed|=0,this.seed=this.seed+1831565813|0;let e=Math.imul(this.seed^this.seed>>>15,1|this.seed);return e=e+Math.imul(e^e>>>7,61|e)^e,((e^e>>>14)>>>0)/4294967296}nextInt(e,s){return Math.floor(this.next()*(s-e+1))+e}nextFloat(e,s){return this.next()*(s-e)+e}shuffle(e){const s=[...e];for(let i=s.length-1;i>0;i--){const t=Math.floor(this.next()*(i+1));[s[i],s[t]]=[s[t],s[i]]}return s}weightedPick(e,s){const i=s.reduce((a,n)=>a+n,0);let t=this.next()*i;for(let a=0;a<e.length;a++)if(t-=s[a],t<=0)return e[a];return e[e.length-1]}}class Ti{constructor(){l(this,"items",new Map);l(this,"pendingRemoval",new Set)}spawnItems(e,s,i,t,a,n){const o=new St(n);for(const r of e){const f=o.nextFloat(-3,g.FIELD_WIDTH/2-1),m=o.nextFloat(-1.5,3),u=.4+.05;this.spawnSingle(r,f,u,m,s,i,t,a)}}spawnSingle(e,s,i,t,a,n,o,r){const f=a.rapier,m=f.RigidBodyDesc.dynamic().setTranslation(s,i,t).setLinearDamping(.7).setAngularDamping(.8),d=a.createRigidBody(m),u=f.ColliderDesc.ball(.4).setRestitution(.4).setFriction(.5).setDensity(2).setActiveEvents(f.ActiveEvents.COLLISION_EVENTS),c=a.createCollider(u,d);o.registerHandle(c.handle,"item");const h=new Si(e.rarity);h.setPosition(s,i,t),r.add(h.mesh),n.register(d,h.mesh),this.items.set(c.handle,{body:d,collider:c,mesh:h,definitionId:e.id})}getDefinitionId(e){var s;return(s=this.items.get(e))==null?void 0:s.definitionId}getItemPosition(e){const s=this.items.get(e);if(!s)return{x:0,y:0,z:0};const i=s.body.translation();return{x:i.x,y:i.y,z:i.z}}cleanupFallen(e,s){for(const[i,t]of this.items)t.body.translation().y<e&&!this.pendingRemoval.has(i)&&(this.pendingRemoval.add(i),s==null||s(i))}markForRemoval(e){this.pendingRemoval.add(e)}flushRemovals(e,s,i,t){for(const a of this.pendingRemoval){const n=this.items.get(a);n&&(s.unregister(n.body),i.unregisterHandle(a),t.remove(n.mesh.mesh),e.removeRigidBody(n.body),n.mesh.dispose(),this.items.delete(a))}this.pendingRemoval.clear()}update(e){for(const s of this.items.values())s.mesh.update(e)}clear(e,s,i,t){for(const[a,n]of this.items)s.unregister(n.body),i.unregisterHandle(a),t.remove(n.mesh.mesh),e.removeRigidBody(n.body),n.mesh.dispose();this.items.clear(),this.pendingRemoval.clear()}}const ft=[{id:"rusty_gear",name:"さびたギア",quotaValue:5,sellPrice:3,rarity:H.Common,description:"古びたギア。それなりの価値はある。"},{id:"chipped_crystal",name:"欠けた水晶",quotaValue:8,sellPrice:5,rarity:H.Common,description:"割れた水晶の破片。かすかに輝いている。"},{id:"silver_coin",name:"銀貨",quotaValue:12,sellPrice:8,rarity:H.Common,description:"磨けば光る銀の硬貨。"},{id:"strange_mushroom",name:"怪しいキノコ",quotaValue:10,sellPrice:6,rarity:H.Common,description:"食べたら何かが起きそうな不思議なキノコ。"},{id:"ancient_compass",name:"古羅針盤",quotaValue:20,sellPrice:15,rarity:H.Rare,description:"方角を示す古い羅針盤。コレクターに人気。"},{id:"glowing_orb",name:"発光する球体",quotaValue:25,sellPrice:18,rarity:H.Rare,description:"ぼんやりと光を放つ不思議な球体。"},{id:"clockwork_bird",name:"ぜんまい仕掛けの鳥",quotaValue:30,sellPrice:22,rarity:H.Rare,description:"ネジを巻くと動き出す精巧な機械鳥。"},{id:"philosophers_stone",name:"賢者の石（模造品）",quotaValue:50,sellPrice:40,rarity:H.Epic,description:"本物かどうかは不明。でも高く売れる。"},{id:"dragon_scale",name:"ドラゴンの鱗",quotaValue:60,sellPrice:50,rarity:H.Epic,description:"龍から採れた鱗。強靭で美しい。"},{id:"starfall_fragment",name:"星落の欠片",quotaValue:100,sellPrice:80,rarity:H.Legendary,description:"流れ星が落とした神秘の欠片。伝説級のお宝。"}];function Ce(p){return ft.find(e=>e.id===p)}const Bt={[H.Common]:60,[H.Rare]:30,[H.Epic]:8,[H.Legendary]:2};class Ot{constructor(e){l(this,"rng");this.rng=new St(e)}pickRandom(e){const s=[];for(let i=0;i<e;i++){const t=this.pickRarity(),a=ft.filter(o=>o.rarity===t);if(a.length===0){s.push(ft[0]);continue}const n=Math.floor(this.rng.next()*a.length);s.push(a[n])}return s}pickRarity(){const e=Object.keys(Bt),s=e.map(i=>Bt[i]);return this.rng.weightedPick(e,s)}}function A(p,e,s=!1){const i=new k(p,e);return s&&(i.castShadow=!0,i.receiveShadow=!0),i}function Nt(p,e=1){return new G({color:p,emissive:p,emissiveIntensity:e,roughness:.5,metalness:.3})}class N{constructor(e){l(this,"group");l(this,"pusherMesh",null);l(this,"wallMeshes",[]);l(this,"sideGuardMeshes",[]);l(this,"collectionGlowMat",null);l(this,"gaugeMats",[]);l(this,"ledStripMats",[]);l(this,"collectionFlashRemaining",0);l(this,"pusherZBase",-12/2+g.PUSHER_DEPTH/2-g.PUSHER_RANGE);l(this,"screenCanvas",null);l(this,"screenCtx",null);l(this,"screenCanvasTex",null);l(this,"screenNeonColor","#00ff88");this.group=new ss,this.rebuild(e)}rebuild(e){this.group.traverse(s=>{if(s!==this.group&&s instanceof k){s.geometry.dispose();const i=s.material;Array.isArray(i)?i.forEach(t=>t.dispose()):i.dispose()}}),this.group.clear(),this.wallMeshes=[],this.sideGuardMeshes=[],this.collectionGlowMat=null,this.gaugeMats=[],this.ledStripMats=[],this.screenCanvasTex&&(this.screenCanvasTex.dispose(),this.screenCanvasTex=null),this.screenCanvas=document.createElement("canvas"),this.screenCanvas.width=512,this.screenCanvas.height=300,this.screenCtx=this.screenCanvas.getContext("2d"),this.screenCanvasTex=new ts(this.screenCanvas),this.screenCanvasTex.colorSpace=Jt,this.screenNeonColor="#"+e.primaryNeon.toString(16).padStart(6,"0"),this.updateScreenDisplay(0,0,0,1,1),this.buildFieldSurface(e),this.buildPusher(e),this.addPusherDetails(e),this.createWalls(e),this.buildCabinet(e),this.buildCabinetDetails(e)}static cabinetMat(e){return new G({color:e.cabinetColor,roughness:.72,metalness:.42})}static brassMat(e){return new G({color:e.brassColor,roughness:e.brassRoughness,metalness:e.brassMetalness})}buildFieldSurface(e){const s=g.FIELD_DEPTH/2+g.OPEN_ZONE_START,i=-12/2+s/2,t=he.getFieldTexture(e.fieldTexBase);t.wrapS=t.wrapT=Ue,t.repeat.set(g.FIELD_WIDTH/2,s/2);const a=new G({map:t,color:16777215,roughness:.92,metalness:0}),n=new R(g.FIELD_WIDTH,g.FIELD_HEIGHT,s),o=new k(n,a);o.receiveShadow=!0,o.position.set(0,-.1/2,i),this.group.add(o);const r=-12/2,f=g.OPEN_ZONE_START,m=g.FIELD_WIDTH,d=[{z:r+(f-r)*.35,color:e.secondaryNeon,intensity:.45},{z:r+(f-r)*.65,color:e.tertiaryNeon,intensity:.4}];for(const{z:u,color:c,intensity:h}of d){const y=new G({color:c,emissive:c,emissiveIntensity:h,roughness:.2,metalness:.05}),x=new k(new R(m-.3,.015,.04),y);x.position.set(0,.01,u),this.group.add(x)}}buildPusher(e){const s=new R(g.PUSHER_WIDTH,g.PUSHER_HEIGHT,g.PUSHER_DEPTH),i=new G({color:e.pusherTexBase,roughness:.35,metalness:.65});this.pusherMesh=new k(s,i),this.pusherMesh.castShadow=!0,this.pusherMesh.position.set(0,g.PUSHER_HEIGHT/2,this.pusherZBase),this.group.add(this.pusherMesh)}addPusherDetails(e){const s=g.PUSHER_WIDTH,i=g.PUSHER_HEIGHT,t=g.PUSHER_DEPTH,a=A(new R(s+.06,.14,.14),N.brassMat(e));a.position.set(0,-i/2+.07,t/2),this.pusherMesh.add(a);const n=A(new R(s+.06,.06,.06),N.brassMat(e));n.position.set(0,i/2,t/2),this.pusherMesh.add(n);for(const f of[-1,1]){const m=A(new R(.1,i,.1),N.brassMat(e));m.position.set(f*(s/2-.05),0,t/2),this.pusherMesh.add(m)}const o=new G({color:e.primaryNeon,emissive:new Y(e.primaryNeon),emissiveIntensity:.85,roughness:.2,metalness:.05}),r=A(new R(s-.12,.045,.055),o);r.position.set(0,i*.1,t/2+.03),this.pusherMesh.add(r),this.ledStripMats.push({mat:o,baseIntensity:.85,phase:Math.PI*.5,speed:1.4})}createWalls(e){const t=he.getWallTexture(e.wallTexBase);t.wrapS=t.wrapT=Ue;const n=(()=>{const d=t.clone();return d.wrapS=d.wrapT=Ue,d.needsUpdate=!0,new G({map:d,color:16777215,roughness:.8,metalness:.15})})(),o=g.FIELD_WIDTH+.3*2;n.map.repeat.set(o/2,3.5/2);const r=new R(o,3.5,.3),f=new k(r,n);f.position.set(0,3.5/2,-12/2-.3/2),this.group.add(f),this.wallMeshes.push(f);const m=[{y:.8,color:e.secondaryNeon,baseIntensity:.8,phase:0,speed:2.4},{y:2.1,color:e.tertiaryNeon,baseIntensity:.65,phase:1.57,speed:1.8}];for(const{y:d,color:u,baseIntensity:c,phase:h,speed:y}of m){const x=new G({color:u,emissive:u,emissiveIntensity:c,roughness:.2,metalness:.05});this.ledStripMats.push({mat:x,baseIntensity:c,phase:h,speed:y});const v=new k(new R(o,.038,.3*.4),x);v.position.set(0,d,-12/2-.3+.02),this.group.add(v)}}buildCabinet(e){const s=g.FIELD_WIDTH,i=g.FIELD_DEPTH,t=-i/2,a=i/2,n=i/2+a+5.5,o=t+n/2-1,r=A(new R(12,1,n),N.cabinetMat(e),!0);r.position.set(0,-.52,o),this.group.add(r);const f=A(new R(12,.1,.1),N.brassMat(e));f.position.set(0,0,a+2.55),this.group.add(f);const m=i/2+g.OPEN_ZONE_START,d=1.1,u=7.2,c=s/2+.75,h=t+m/2;for(const ee of[-1,1]){const te=A(new R(d,u,m),N.cabinetMat(e),!0);te.position.set(ee*c,u/2-.5,h),this.group.add(te);const Pe=A(new R(d+.08,.14,m+.08),N.brassMat(e));Pe.position.set(ee*c,u-.5+.07,h),this.group.add(Pe);const ke=A(new R(d+.08,.1,m+.08),N.brassMat(e));ke.position.set(ee*c,-.02,h),this.group.add(ke);const Le=A(new R(.06,u*.75,m*.7),new G({color:e.insetColor,roughness:.9,metalness:.1}));Le.position.set(ee*(c-(d/2+.01)),u/2-.5,h),this.group.add(Le);const Fe=A(new R(.06,u*.8,.06),N.brassMat(e));Fe.position.set(ee*(c-d/2-.04),u/2-.5,h),this.group.add(Fe)}for(const ee of[-1,1]){for(const ke of[-.22,.22]){const Le=new G({color:e.secondaryNeon,emissive:e.secondaryNeon,emissiveIntensity:.72,roughness:.2,metalness:.05}),Fe=ke>0?Math.PI*.6:0;this.ledStripMats.push({mat:Le,baseIntensity:.72,phase:Fe,speed:1.6});const Mt=A(new R(.032,u*.82,.032),Le);Mt.position.set(ee*(c+ke),u*.41+.04,h+m/2+.09),this.group.add(Mt)}const te=new G({color:e.primaryNeon,emissive:e.primaryNeon,emissiveIntensity:1.5,roughness:.1,metalness:.2});this.ledStripMats.push({mat:te,baseIntensity:1.5,phase:ee>0?.8:2,speed:2.2});const Pe=A(new bt(.14,8,6),te);Pe.position.set(ee*c,u-.5+.34,h+m/2+.09),this.group.add(Pe)}const y=10.5,x=1.3,v=t-1.15,M=he.getWallTexture(e.wallTexBase).clone();M.wrapS=M.wrapT=Ue,M.repeat.set(6,5),M.needsUpdate=!0;const D=new G({map:M,color:16777215,roughness:.75,metalness:.18}),T=A(new R(12,y,x),D,!0);T.position.set(0,y/2-.5,v),this.group.add(T);const S=A(new R(12.1,.15,x+.1),N.brassMat(e));S.position.set(0,y-.5+.07,v),this.group.add(S);const b=3.5,O=7,L=2.25,_=t+.06,I=new G({color:0,emissive:16777215,emissiveMap:this.screenCanvasTex,emissiveIntensity:1,roughness:.3,metalness:0}),C=A(new R(O,b,.08),I);C.position.set(0,L,_),this.group.add(C);const $=A(new R(O+.24,b+.24,.06),N.brassMat(e));$.position.set(0,L,t+.01),this.group.add($);const F=A(new R(12.1,.08,.08),N.brassMat(e));F.position.set(0,y-.5+.18,v+x/2),this.group.add(F);const z=new G({color:e.primaryNeon,emissive:e.primaryNeon,emissiveIntensity:1.2,roughness:.2,metalness:.1}),V=A(new R(.06,b*.9,.06),z);V.position.set(-O/2-.18,L,_),this.group.add(V);const Q=A(new R(.06,b*.9,.06),z.clone());Q.position.set(O/2+.18,L,_),this.group.add(Q);const j=A(new R(O+.6,.04,.04),z.clone());j.position.set(0,L-b/2-.18,_),this.group.add(j);const ce=A(new R(12,1.1,4.5),N.cabinetMat(e),!0);ce.position.set(0,-.56,a+2.25),this.group.add(ce);const Oe=A(new R(12,.12,.12),N.brassMat(e));Oe.position.set(0,0,a+4.45),this.group.add(Oe);const Ae=A(new R(12,.1,.08),N.brassMat(e));Ae.position.set(0,.06,a+4.5),this.group.add(Ae);const Re=new G({color:e.primaryNeon,emissive:e.primaryNeon,emissiveIntensity:.04,roughness:.12,metalness:.85,transparent:!0,opacity:.45}),Ne=A(new R(11.6,.02,4),Re);Ne.position.set(0,.01,a+2.25),this.group.add(Ne);const me=new G({color:e.primaryNeon,emissive:e.primaryNeon,emissiveIntensity:.28,roughness:.2,metalness:.1}),Ge=A(new R(.04,.03,4.1),me);Ge.position.set(-5.8,.02,a+2.25),this.group.add(Ge);const ze=A(new R(.04,.03,4.1),me.clone());ze.position.set(5.8,.02,a+2.25),this.group.add(ze);const $e=A(new R(11.6,.03,.04),me.clone());$e.position.set(0,.02,a+.27),this.group.add($e);const ue=A(new R(12,.5,m),N.cabinetMat(e),!0);ue.position.set(0,6.7,h),this.group.add(ue);const xe=A(new R(12,.1,.1),N.brassMat(e));xe.position.set(0,6.96,g.OPEN_ZONE_START+.1),this.group.add(xe);for(const ee of[-1,1]){const te=A(new R(.09,.09,i+.5),N.brassMat(e));te.position.set(ee*(s/2+.04),.05,h),this.group.add(te)}const w=A(new R(s+.2,3.6,.18),new G({color:e.pusherHousingColor,roughness:.65,metalness:.5}));w.position.set(0,1.8,t-.08),this.group.add(w);const B=A(new R(s-.2,.08,.08),N.brassMat(e));B.position.set(0,3.65,t+.01),this.group.add(B);const U=A(new R(s+.1,.07,.07),N.brassMat(e));U.position.set(0,.06,g.OPEN_ZONE_START),this.group.add(U);const Z=new G({color:e.primaryNeon,emissive:e.primaryNeon,emissiveIntensity:1,roughness:.2,metalness:.1,transparent:!0,opacity:.88});this.collectionGlowMat=Z;const J=A(new R(s+.2,.03,.22),Z);J.position.set(0,.015,g.OPEN_ZONE_START),this.group.add(J);const ne=A(new R(s+.1,.07,.07),N.brassMat(e));ne.position.set(0,.06,t+.04),this.group.add(ne);const be=i/2+g.OPEN_ZONE_START,oe=t+be/2;for(const ee of[-1,1]){const te=A(new R(.07,.07,be),N.brassMat(e));te.position.set(ee*s/2,.06,oe),this.group.add(te)}const re=g.OPEN_ZONE_START-t,_e=t+re/2;for(const ee of[-1,1]){const te=A(new R(.08,.08,re),N.brassMat(e));te.position.set(ee*(s/2),3.55,_e),this.group.add(te)}const Et=new k(new R(100,.2,100),new G({color:e.groundColor,emissive:e.groundColor,emissiveIntensity:.1,roughness:.95,metalness:0}));Et.position.set(0,-.65,0),this.group.add(Et)}buildCabinetDetails(e){const s=g.FIELD_DEPTH/2,i=-12/2,t=1.1,a=7.2,n=g.FIELD_DEPTH/2+g.OPEN_ZONE_START,o=g.FIELD_WIDTH/2+.75,r=i+n/2,f=1.3,m=i-1.15;for(const T of[-1,1]){for(let b=0;b<2;b++){const O=b===0?-.26:.16,L=a*.6,_=T*(o+O),I=r+n/2+.07,C=A(new ie(.05,.05,L,8),N.brassMat(e));C.position.set(_,L/2+.3,I),this.group.add(C);const $=4;for(let F=0;F<=$;F++){const z=.3+F*(L/$),V=A(new ie(.09,.09,.07,10),N.brassMat(e));V.position.set(_,z,I),this.group.add(V)}}const S=A(new R(.48,.1,.1),N.brassMat(e));S.position.set(T*o,a*.6+.3+.05,r+n/2+.07),this.group.add(S)}for(const T of[-1,1]){const S=T*(o-t/2-.025),b=A(new ie(.24,.24,.06,18),N.brassMat(e));b.rotation.z=Math.PI/2,b.position.set(S,a*.52,r+.8),this.group.add(b);const O=Nt(e.secondaryNeon,.55),L=A(new ie(.18,.18,.03,18),O);L.rotation.z=Math.PI/2,L.position.set(S-T*.035,a*.52,r+.8),this.group.add(L),this.gaugeMats.push(O);const _=A(new ie(.16,.16,.05,14),N.brassMat(e));_.rotation.z=Math.PI/2,_.position.set(S,a*.28,r-1.2),this.group.add(_);const I=Nt(e.primaryNeon,.45),C=A(new ie(.11,.11,.025,14),I);C.rotation.z=Math.PI/2,C.position.set(S-T*.03,a*.28,r-1.2),this.group.add(C),this.gaugeMats.push(I)}const d=1.5,u=m+f/2+.05,c=A(new Ee(.82,.1,10,28),N.brassMat(e));c.position.set(0,d,u),this.group.add(c);const h=A(new ie(.74,.74,.04,28),new G({color:e.screenBase,emissive:e.screenEmissive,emissiveIntensity:.55,transparent:!0,opacity:.82,roughness:.05,metalness:0}));h.rotation.x=Math.PI/2,h.position.set(0,d,u),this.group.add(h);for(let T=0;T<4;T++){const S=T/4*Math.PI*2+Math.PI/4,b=A(new ie(.045,.045,.06,8),N.brassMat(e));b.rotation.x=Math.PI/2,b.position.set(Math.cos(S)*.88,d+Math.sin(S)*.88,u+.03),this.group.add(b)}const y=A(new R(5.5,.05,.05),new G({color:e.secondaryNeon,emissive:e.secondaryNeon,emissiveIntensity:.9,roughness:.2,metalness:.1}));y.position.set(0,d+1.12,u),this.group.add(y);{const T=t+.12,S=.12,b=n+.12;for(const O of[-1,1])for(const L of[.33,.66]){const _=A(new R(T,S,b),N.brassMat(e));_.position.set(O*o,L*a-.5,r),this.group.add(_)}}const x=s+4.45,v=A(new R(1.3,.16,.05),new G({color:e.insetColor,roughness:.9,metalness:.1}));v.position.set(0,-.08,x),this.group.add(v);const M=A(new R(1.5,.3,.04),N.brassMat(e));M.position.set(0,-.08,x-.01),this.group.add(M);const D=A(new R(.9,.045,.06),new G({color:0,roughness:1,metalness:0}));D.position.set(0,-.06,x+.01),this.group.add(D)}updateScreenDisplay(e,s,i,t,a){const n=this.screenCtx,o=this.screenCanvasTex;if(!n||!o)return;const r=this.screenCanvas.width,f=this.screenCanvas.height,m=this.screenNeonColor;n.globalAlpha=1,n.shadowBlur=0,n.textBaseline="alphabetic",n.fillStyle="#08101e",n.fillRect(0,0,r,f);for(let D=0;D<f;D+=3)n.fillStyle="rgba(0,0,0,0.12)",n.fillRect(0,D,r,1);n.font="bold 22px monospace",n.textAlign="center",n.fillStyle=m,n.shadowColor=m,n.shadowBlur=10,n.fillText("YUKIMEDAL",r/2,36),n.shadowBlur=0,n.globalAlpha=.35,n.strokeStyle=m,n.lineWidth=1,n.beginPath(),n.moveTo(20,48),n.lineTo(r-20,48),n.stroke(),n.globalAlpha=1,n.font="14px monospace",n.fillStyle="#6688aa",n.shadowBlur=0,n.textAlign="left",n.fillText("MEDALS",28,125),n.fillText("QUOTA",220,125),n.fillText("PHASE",390,125),n.font="bold 40px monospace",n.fillStyle=m,n.shadowColor=m,n.shadowBlur=14,n.fillText(String(e),28,168);const d=s>=i;n.fillStyle=d?"#44ff88":"#ffffff",n.shadowColor=d?"#44ff88":"#aaddff",n.shadowBlur=d?16:6,n.fillText(`${Math.floor(s)}/${i}`,220,168),n.fillStyle=m,n.shadowColor=m,n.shadowBlur=14,n.fillText(String(t),390,168),n.shadowBlur=0;const u=220,c=178,h=160,y=12;n.fillStyle="#1a2840",n.fillRect(u,c,h,y);const x=i>0?Math.min(s/i,1):0,v=Math.round(x*120),M=d?"#44ff88":`hsl(${v},100%,60%)`;n.fillStyle=M,n.shadowColor=M,n.shadowBlur=6,n.fillRect(u,c,h*x,y),n.shadowBlur=0,n.strokeStyle="#334466",n.lineWidth=1,n.strokeRect(u,c,h,y),n.font="20px monospace",n.fillStyle="#aabbcc",n.fillText(`S${a}/3`,390,204),n.globalAlpha=.3,n.strokeStyle=m,n.lineWidth=1,n.beginPath(),n.moveTo(20,213),n.lineTo(r-20,213),n.stroke(),n.globalAlpha=1,n.font="bold 48px monospace",n.textAlign="center",d?(n.fillStyle="#44ff88",n.shadowColor="#44ff88",n.shadowBlur=20,n.fillText("★ CLEAR! ★",r/2,268)):(n.fillStyle="#ffffff",n.shadowColor=m,n.shadowBlur=8,n.fillText(`${Math.floor(s)} / ${i}`,r/2,268)),n.font="12px monospace",n.fillStyle="#445566",n.shadowBlur=0,n.fillText("QUOTA",r/2,286),o.needsUpdate=!0}addSideGuardMeshes(e){const t=g.FIELD_DEPTH/2-g.OPEN_ZONE_START,a=g.OPEN_ZONE_START+t/2;for(const n of[-1,1]){const o=n*(g.FIELD_WIDTH/2+.2+.1),r=new R(.2,2,t),f=new G({color:4500223,emissive:4500223,emissiveIntensity:.55,transparent:!0,opacity:.55,roughness:.2,metalness:.1}),m=new k(r,f);m.position.set(o,2/2,a),e.add(m),this.sideGuardMeshes.push(m)}}removeSideGuardMeshes(e){for(const s of this.sideGuardMeshes)e.remove(s),s.geometry.dispose(),s.material.dispose();this.sideGuardMeshes=[]}updatePusher(e){this.pusherMesh.position.z=this.pusherZBase+e}triggerCollectionFlash(){this.collectionFlashRemaining=.3}update(e,s=.016){if(this.collectionGlowMat)if(this.collectionFlashRemaining>0){const i=this.collectionFlashRemaining/.3;this.collectionGlowMat.emissiveIntensity=.55+i*1.45,this.collectionFlashRemaining-=s}else this.collectionGlowMat.emissiveIntensity=.35+Math.sin(e*3.8)*.2;for(let i=0;i<this.gaugeMats.length;i++){const t=i%2===0?.55:.45,a=.3,n=i%2===0?2.1:1.5,o=i*1.1;this.gaugeMats[i].emissiveIntensity=t+Math.sin(e*n+o)*a}for(const{mat:i,baseIntensity:t,phase:a,speed:n}of this.ledStripMats)i.emissiveIntensity=t+Math.sin(e*n+a)*(t*.28)}}class Ei{constructor(e,s,i,t){l(this,"physicsWorld");l(this,"physicsSync");l(this,"collisionHandler");l(this,"pusher");l(this,"medalSpawner");l(this,"itemSpawner");l(this,"dropZone");l(this,"gimmickManager");l(this,"fieldMesh");l(this,"time",0);l(this,"antiJamTimer",0);l(this,"getMedalQuotaMultiplier",()=>1);l(this,"sideGuardActive",!1);l(this,"sideGuardBodies",[]);this.sceneManager=e,this.quotaManager=s,this.inventory=i,this.physicsWorld=new ii,this.physicsSync=new ai,this.collisionHandler=new ni,this.pusher=new oi,this.medalSpawner=new gi,this.itemSpawner=new Ti,this.dropZone=new yi,this.gimmickManager=new xi,this.fieldMesh=new N(t)}setMedalQuotaMultiplierFn(e){this.getMedalQuotaMultiplier=e}rebuildFieldMesh(e){he.disposeAll(),this.fieldMesh.rebuild(e)}async init(){await this.physicsWorld.init(),this.collisionHandler.init(this.physicsWorld),await this.buildFieldPhysics(),await this.pusher.initPhysics(this.physicsWorld),await this.dropZone.initPhysics(this.physicsWorld,this.collisionHandler),this.collisionHandler.onMedalCollected(e=>{const s=this.medalSpawner.getQuotaValue(e),i=this.medalSpawner.getMedalPosition(e);this.medalSpawner.markForRemoval(e);const t=this.getMedalQuotaMultiplier();this.quotaManager.addMedals(s,t),P.emit("medal:collected",{count:s,x:i.x,y:i.y,z:i.z})}),this.collisionHandler.onItemCollected(e=>{const s=this.itemSpawner.getDefinitionId(e);if(!s)return;const i=this.itemSpawner.getItemPosition(e);this.itemSpawner.markForRemoval(e);const t=this.inventory.addItem(s),a=Ce(s);a&&(this.quotaManager.addItem(a.quotaValue),P.emit("item:collected",{itemId:s,instanceId:t.instanceId,quotaValue:a.quotaValue,x:i.x,y:i.y,z:i.z}))}),this.sceneManager.add(this.fieldMesh.group)}async buildFieldPhysics(){const e=this.physicsWorld.rapier,s=-12/2+g.PUSHER_DEPTH,i=(s- -12/2)/2,t=-12/2+i,a=e.RigidBodyDesc.fixed().setTranslation(0,-.05,t),n=this.physicsWorld.createRigidBody(a);this.physicsWorld.createCollider(e.ColliderDesc.cuboid(g.FIELD_WIDTH/2,.05,i).setFriction(.35).setRestitution(.05),n);const o=(g.OPEN_ZONE_START-s)/2,r=s+o,f=e.RigidBodyDesc.fixed().setTranslation(0,-.05,r),m=this.physicsWorld.createRigidBody(f);this.physicsWorld.createCollider(e.ColliderDesc.cuboid(g.FIELD_WIDTH/2,.05,o).setFriction(.05).setRestitution(.01),m);const d=3.5,u=.2,c=g.OPEN_ZONE_START- -12/2,h=-12/2+c/2,y=g.FIELD_WIDTH/2+.2,x=e.RigidBodyDesc.fixed().setTranslation(-4.3,d/2,h),v=this.physicsWorld.createRigidBody(x);this.physicsWorld.createCollider(e.ColliderDesc.cuboid(u/2,d/2,c/2),v);const M=e.RigidBodyDesc.fixed().setTranslation(y+u/2,d/2,h),D=this.physicsWorld.createRigidBody(M);this.physicsWorld.createCollider(e.ColliderDesc.cuboid(u/2,d/2,c/2),D);const T=8,S=.5,b=e.RigidBodyDesc.fixed().setTranslation(0,T/2,-12/2-S/2),O=this.physicsWorld.createRigidBody(b);this.physicsWorld.createCollider(e.ColliderDesc.cuboid(g.FIELD_WIDTH/2+S,T/2,S/2),O)}startStage(e,s){this.spawnInitialMedals(),this.gimmickManager.setupStage(e,s,this.physicsWorld,this.sceneManager);const t=new Ot(e*1e3+s).pickRandom(g.ITEMS_PER_STAGE);this.itemSpawner.spawnItems(t,this.physicsWorld,this.physicsSync,this.collisionHandler,this.sceneManager,e*1e3+s+7)}spawnInitialMedals(){const e=-6+g.PUSHER_DEPTH-g.PUSHER_RANGE,s=g.OPEN_ZONE_START-g.MEDAL_RADIUS,i=g.FIELD_WIDTH/2-g.MEDAL_RADIUS,t=s-e,a=e;for(let c=0;c<g.INITIAL_FIELD_MEDALS;c++){const h=(Math.random()*2-1)*i,y=a+Math.random()*t,x=g.MEDAL_THICKNESS/2+Math.random()*.5,v=Math.random()<.25?"large":"normal";this.medalSpawner.spawn(h,x,y,this.physicsWorld,this.physicsSync,this.collisionHandler,this.sceneManager,void 0,v)}const n=-12/2+g.MEDAL_RADIUS,r=e-g.MEDAL_RADIUS-n,f=6,m=Math.ceil(g.INITIAL_PUSHER_MEDALS/f),d=i*2/(f-1),u=r/Math.max(m-1,1);for(let c=0;c<g.INITIAL_PUSHER_MEDALS;c++){const h=c%f,y=Math.floor(c/f),x=-i+h*d+(Math.random()-.5)*.15,v=n+y*u+(Math.random()-.5)*.15,M=g.PUSHER_HEIGHT+g.MEDAL_THICKNESS/2+.8+y*.25;this.medalSpawner.spawn(x,M,v,this.physicsWorld,this.physicsSync,this.collisionHandler,this.sceneManager,void 0,"normal")}}throwMedal(e,s){const i=g.FIELD_DEPTH/2+.5,t=3,n=-(5.5+(s+1)/2*7);this.medalSpawner.spawn(e,t,i,this.physicsWorld,this.physicsSync,this.collisionHandler,this.sceneManager,{x:0,y:4,z:n})}update(e){this.time+=e,this.fieldMesh.update(this.time,e);const s=this.pusher.update(e);this.fieldMesh.updatePusher(s);const i=4,t=Math.min(e,1/15);if(this.physicsWorld.setTimestep(t/i),this.collisionHandler.processEvents(this.physicsWorld,i),this.medalSpawner.cleanupFallen(g.MEDAL_CLEANUP_Y,this.physicsWorld,this.physicsSync,this.collisionHandler,this.sceneManager,a=>{const n=this.medalSpawner.getQuotaValue(a),o=this.getMedalQuotaMultiplier();this.quotaManager.addMedals(n,o);const r=this.medalSpawner.getMedalPosition(a);P.emit("medal:collected",{count:n,x:r.x,y:r.y,z:r.z})}),this.itemSpawner.cleanupFallen(g.MEDAL_CLEANUP_Y,a=>{const n=this.itemSpawner.getDefinitionId(a);if(!n)return;const o=this.itemSpawner.getItemPosition(a),r=this.inventory.addItem(n),f=Ce(n);f&&(this.quotaManager.addItem(f.quotaValue),P.emit("item:collected",{itemId:n,instanceId:r.instanceId,quotaValue:f.quotaValue,x:o.x,y:o.y,z:o.z}))}),this.medalSpawner.flushRemovals(this.physicsWorld,this.physicsSync,this.collisionHandler,this.sceneManager),this.itemSpawner.flushRemovals(this.physicsWorld,this.physicsSync,this.collisionHandler,this.sceneManager),this.physicsSync.sync(this.physicsWorld),this.antiJamTimer+=e,this.antiJamTimer>=2){this.antiJamTimer=0;const a=-12/2+g.PUSHER_DEPTH;this.medalSpawner.nudgeDeadZone(a,g.OPEN_ZONE_START)}this.medalSpawner.capVelocities(15),this.medalSpawner.collectPastCliff(g.OPEN_ZONE_START,-.3,a=>{const n=this.medalSpawner.getQuotaValue(a),o=this.getMedalQuotaMultiplier();this.quotaManager.addMedals(n,o);const r=this.medalSpawner.getMedalPosition(a);P.emit("medal:collected",{count:n,x:r.x,y:r.y,z:r.z})}),this.gimmickManager.update(e),this.itemSpawner.update(this.time)}endStage(){this.gimmickManager.clear(this.sceneManager),this.medalSpawner.clear(this.physicsWorld,this.physicsSync,this.collisionHandler,this.sceneManager),this.itemSpawner.clear(this.physicsWorld,this.physicsSync,this.collisionHandler,this.sceneManager)}endStageKeepMedals(){this.gimmickManager.clear(this.sceneManager),this.itemSpawner.clear(this.physicsWorld,this.physicsSync,this.collisionHandler,this.sceneManager)}startStageKeepMedals(e,s){this.gimmickManager.setupStage(e,s,this.physicsWorld,this.sceneManager);const t=new Ot(e*1e3+s).pickRandom(g.ITEMS_PER_STAGE);this.itemSpawner.spawnItems(t,this.physicsWorld,this.physicsSync,this.collisionHandler,this.sceneManager,e*1e3+s+7)}shakeAllMedals(e=3){this.medalSpawner.shakeAll(e)}addSideGuardWalls(){if(this.sideGuardActive||!this.physicsWorld.initialized)return;this.sideGuardActive=!0;const e=this.physicsWorld.rapier,s=2,i=.2,t=g.FIELD_DEPTH/2-g.OPEN_ZONE_START,a=g.OPEN_ZONE_START+t/2;for(const n of[-1,1]){const o=n*(g.FIELD_WIDTH/2+.2+i/2),r=e.RigidBodyDesc.fixed().setTranslation(o,s/2,a),f=this.physicsWorld.createRigidBody(r);this.physicsWorld.createCollider(e.ColliderDesc.cuboid(i/2,s/2,t/2),f),this.sideGuardBodies.push(f)}}removeSideGuardWalls(){for(const e of this.sideGuardBodies)this.physicsWorld.removeRigidBody(e);this.sideGuardBodies=[],this.sideGuardActive=!1}get isSideGuardActive(){return this.sideGuardActive}dispose(){this.sceneManager.remove(this.fieldMesh.group),this.physicsWorld.dispose()}}class Mi{constructor(){l(this,"current",0);l(this,"target",0);l(this,"phase",1);l(this,"stage",1);l(this,"reached",!1)}startStage(e,s){this.phase=e,this.stage=s,this.current=0,this.reached=!1,this.target=this.calcTarget(e,s),P.emit("stage:started",{phase:e,stage:s,quotaTarget:this.target}),P.emit("quota:updated",{current:this.current,target:this.target})}calcTarget(e,s){const i=(e-1)*g.STAGES_PER_PHASE+s;return Math.ceil(g.BASE_QUOTA*Math.pow(g.QUOTA_MULTIPLIER,i-1))}addMedals(e,s=1){this.current+=e*s,P.emit("quota:updated",{current:this.current,target:this.target}),!this.reached&&this.current>=this.target&&(this.reached=!0,P.emit("quota:reached",{phase:this.phase,stage:this.stage}))}addItem(e,s=1){this.current+=e*s,P.emit("quota:updated",{current:this.current,target:this.target}),!this.reached&&this.current>=this.target&&(this.reached=!0,P.emit("quota:reached",{phase:this.phase,stage:this.stage}))}get currentValue(){return this.current}get targetValue(){return this.target}get isReached(){return this.current>=this.target}get progress(){return Math.min(this.current/this.target,1)}}class Ci{constructor(e){l(this,"phase",1);l(this,"stage",1);this.fsm=e}get currentPhase(){return this.phase}get currentStage(){return this.stage}get isLastStageOfPhase(){return this.stage===g.STAGES_PER_PHASE}startCurrentStage(){this.fsm.transition(E.PLAYING)}clearCurrentStage(){P.emit("stage:cleared",{phase:this.phase,stage:this.stage}),this.fsm.transition(E.STAGE_CLEAR),this.stage===g.STAGES_PER_PHASE&&P.emit("phase:cleared",{phase:this.phase})}advanceStage(){this.stage<g.STAGES_PER_PHASE&&this.stage++,this.fsm.transition(E.STAGE_START)}advancePhase(){this.phase++,this.stage=1}reset(){this.phase=1,this.stage=1}}function Ii(){return`${Date.now().toString(36)}-${Math.random().toString(36).slice(2,9)}`}class Ai{constructor(){l(this,"items",[])}addItem(e){const s={instanceId:Ii(),definitionId:e,collectedAt:Date.now()};return this.items.push(s),s}removeItem(e){const s=this.items.findIndex(i=>i.instanceId===e);return s===-1?!1:(this.items.splice(s,1),!0)}getAll(){return[...this.items]}getDefinition(e){const s=this.items.find(i=>i.instanceId===e);if(s)return Ce(s.definitionId)}get count(){return this.items.length}clear(){this.items=[]}totalSellPrice(){return this.items.reduce((e,s)=>{const i=Ce(s.definitionId);return e+((i==null?void 0:i.sellPrice)??0)},0)}}class Ri{constructor(){l(this,"data",{phase:1,stage:1,totalMedalsCollected:0,totalItemsCollected:0,shopMoneyEarned:0});P.on("medal:collected",({count:e})=>{this.data.totalMedalsCollected+=e}),P.on("item:collected",()=>{this.data.totalItemsCollected++}),P.on("stage:cleared",({phase:e,stage:s})=>{this.data.phase=e,this.data.stage=s})}addShopMoney(e){this.data.shopMoneyEarned+=e}get snapshot(){return{...this.data}}reset(){this.data={phase:1,stage:1,totalMedalsCollected:0,totalItemsCollected:0,shopMoneyEarned:0}}}class _i{calculate(e,s){const i=s.bestPhase*3+s.bestStage,a=e.phase*3+e.stage>i;return s.updateBest(e.phase,e.stage),s.incrementRuns(),{phase:e.phase,stage:e.stage,totalMedalsCollected:e.totalMedalsCollected,totalItemsCollected:e.totalItemsCollected,isNewBest:a,bestPhase:s.bestPhase,bestStage:s.bestStage}}}var q=(p=>(p.Gold="Gold",p.Alchemy="Alchemy",p.Throw="Throw",p.Guard="Guard",p))(q||{}),W=(p=>(p.Common="Common",p.Rare="Rare",p.Epic="Epic",p))(W||{});const ns=[{id:"gold_touch",name:"黄金の手",description:"メダル1枚あたりのノルマ加算値が+20%",tag:q.Gold,rarity:W.Common,effects:[{type:"QUOTA_PER_MEDAL",value:1.2}]},{id:"lucky_fall",name:"幸運の落下",description:"メダル1枚あたりのノルマ加算値が+50%",tag:q.Gold,rarity:W.Rare,effects:[{type:"QUOTA_PER_MEDAL",value:1.5}]},{id:"golden_shower",name:"黄金雨",description:"メダル1枚あたりのノルマ加算値が+100%",tag:q.Gold,rarity:W.Epic,effects:[{type:"QUOTA_PER_MEDAL",value:2}]},{id:"coin_magnet",name:"コインマグネット",description:"ステージクリア時にボーナスメダル+5枚",tag:q.Gold,rarity:W.Common,effects:[{type:"ON_CLEAR_BONUS_MEDAL",value:5}]},{id:"fortune_wheel",name:"幸運の輪",description:"ステージクリア時にボーナスメダル+15枚",tag:q.Gold,rarity:W.Rare,effects:[{type:"ON_CLEAR_BONUS_MEDAL",value:15}]},{id:"appraiser",name:"鑑定士",description:"アイテムのノルマ加算値が1.5倍",tag:q.Alchemy,rarity:W.Common,effects:[{type:"ITEM_QUOTA_MULTIPLIER",value:1.5}]},{id:"master_appraiser",name:"大鑑定士",description:"アイテムのノルマ加算値が2.5倍",tag:q.Alchemy,rarity:W.Rare,effects:[{type:"ITEM_QUOTA_MULTIPLIER",value:2.5}]},{id:"transmutation",name:"錬成",description:"アイテムの売却価格が1.5倍",tag:q.Alchemy,rarity:W.Common,effects:[{type:"ITEM_SELL_MULTIPLIER",value:1.5}]},{id:"great_transmutation",name:"大錬成",description:"アイテムの売却価格が2倍",tag:q.Alchemy,rarity:W.Rare,effects:[{type:"ITEM_SELL_MULTIPLIER",value:2}]},{id:"philosopher",name:"賢者",description:"アイテムのノルマ加算値3倍+売却価格2倍",tag:q.Alchemy,rarity:W.Epic,effects:[{type:"ITEM_QUOTA_MULTIPLIER",value:3},{type:"ITEM_SELL_MULTIPLIER",value:2}]},{id:"double_throw",name:"ダブル投擲",description:"一度に投入するメダルが2枚になる",tag:q.Throw,rarity:W.Common,effects:[{type:"MEDAL_THROW_COUNT",value:2}]},{id:"triple_throw",name:"トリプル投擲",description:"一度に投入するメダルが3枚になる",tag:q.Throw,rarity:W.Rare,effects:[{type:"MEDAL_THROW_COUNT",value:3}]},{id:"barrage",name:"弾幕",description:"一度に投入するメダルが5枚になる",tag:q.Throw,rarity:W.Epic,effects:[{type:"MEDAL_THROW_COUNT",value:5}]},{id:"quick_draw",name:"クイックドロー",description:"一度に投入するメダルが2枚+クリアボーナス+3枚",tag:q.Throw,rarity:W.Rare,effects:[{type:"MEDAL_THROW_COUNT",value:2},{type:"ON_CLEAR_BONUS_MEDAL",value:3}]},{id:"focused_aim",name:"集中狙い",description:"メダル1枚あたりのノルマ加算+30%",tag:q.Throw,rarity:W.Common,effects:[{type:"QUOTA_PER_MEDAL",value:1.3}]},{id:"safety_net",name:"セーフティネット",description:"ゲームオーバーを一度だけ無効化する",tag:q.Guard,rarity:W.Rare,effects:[{type:"GAME_OVER_SHIELD",value:1}]},{id:"double_safety",name:"ダブルセーフティ",description:"ゲームオーバーを二度まで無効化する",tag:q.Guard,rarity:W.Epic,effects:[{type:"GAME_OVER_SHIELD",value:2}]},{id:"guardian_angel",name:"守護天使",description:"ゲームオーバー無効+クリアボーナスメダル+8枚",tag:q.Guard,rarity:W.Epic,effects:[{type:"GAME_OVER_SHIELD",value:1},{type:"ON_CLEAR_BONUS_MEDAL",value:8}]},{id:"resilience",name:"回復力",description:"クリアボーナスメダル+10枚",tag:q.Guard,rarity:W.Common,effects:[{type:"ON_CLEAR_BONUS_MEDAL",value:10}]},{id:"fortress",name:"要塞",description:"ゲームオーバー無効+アイテムノルマ加算+50%",tag:q.Guard,rarity:W.Epic,effects:[{type:"GAME_OVER_SHIELD",value:1},{type:"ITEM_QUOTA_MULTIPLIER",value:1.5}]}];function Gt(p){return ns.find(e=>e.id===p)}class Pi{constructor(){l(this,"owned",[])}addSkill(e,s){this.owned.push({definitionId:e,acquiredAt:s}),P.emit("skill:selected",{skillId:e})}getOwnedSkills(){return[...this.owned]}getEffectMultiplier(e){let s=1;for(const i of this.owned){const t=Gt(i.definitionId);if(t)for(const a of t.effects)a.type===e&&(s*=a.value)}return s}getEffectSum(e){let s=0;for(const i of this.owned){const t=Gt(i.definitionId);if(t)for(const a of t.effects)a.type===e&&(s+=a.value)}return s}get medalThrowCount(){const e=this.getEffectSum("MEDAL_THROW_COUNT");return e>0?e:1}get gameOverShields(){return this.getEffectSum("GAME_OVER_SHIELD")}get quotaPerMedalMultiplier(){return this.getEffectMultiplier("QUOTA_PER_MEDAL")}get itemQuotaMultiplier(){return this.getEffectMultiplier("ITEM_QUOTA_MULTIPLIER")}get itemSellMultiplier(){return this.getEffectMultiplier("ITEM_SELL_MULTIPLIER")}get onClearBonusMedals(){return this.getEffectSum("ON_CLEAR_BONUS_MEDAL")}consumeShield(){return!1}reset(){this.owned=[]}}const zt={[W.Common]:60,[W.Rare]:30,[W.Epic]:10};class ki{pickChoices(e,s,i){const t=new St(i),a=new Set(s.map(f=>f.definitionId)),n=ns.filter(f=>!a.has(f.id));if(n.length===0)return[];const o=[],r=new Set;for(let f=0;f<e&&o.length<n.length;f++){const m=Object.keys(zt),d=m.map(y=>zt[y]),u=t.weightedPick(m,d),c=n.filter(y=>y.rarity===u&&!r.has(y.id));if(c.length===0){const y=n.filter(v=>!r.has(v.id));if(y.length===0)break;const x=y[Math.floor(t.next()*y.length)];o.push(x),r.add(x.id);continue}const h=c[Math.floor(t.next()*c.length)];o.push(h),r.add(h.id)}return o}}const Tt=[{id:"side_guard",name:"サイドガード",description:"30秒間サイドの壁を復活",price:160,durationMs:3e4,color:"#44aaff"},{id:"medal_fever",name:"メダルフィーバー",description:"30秒間メダルのノルマ2倍",price:100,durationMs:3e4,color:"#ffaa00"},{id:"medal_shower",name:"メダルシャワー",description:"即座に20枚のメダルが降ってくる",price:120,durationMs:0,color:"#ff60a0"},{id:"earthquake",name:"地震",description:"フィールドのメダルを激しく揺らして詰まりを解消",price:80,durationMs:0,color:"#ff8844"}];function $t(p){return Tt.find(e=>e.id===p)}class Li{constructor(){l(this,"shopMoney");l(this,"medals");l(this,"sellMultiplier",1);l(this,"ownedActiveItems",new Map);this.shopMoney=g.INITIAL_SHOP_MONEY,this.medals=g.INITIAL_MEDALS}setSellMultiplier(e){this.sellMultiplier=e}get money(){return this.shopMoney}get currentMedals(){return this.medals}setMedals(e){this.medals=e}addMoney(e){this.shopMoney+=e}spendMedal(){return this.medals<=0?!1:(this.medals--,!0)}addMedals(e){this.medals+=e}sellItem(e,s){const i=s.getDefinition(e);if(!i)return 0;const t=Math.floor(i.sellPrice*this.sellMultiplier);return s.removeItem(e),this.shopMoney+=t,t}buyMedals(e){const s=e*g.MEDAL_BUY_PRICE;return this.shopMoney<s?!1:(this.shopMoney-=s,this.medals+=e,!0)}buyActiveItem(e){const s=Tt.find(i=>i.id===e);return!s||this.shopMoney<s.price?!1:(this.shopMoney-=s.price,this.ownedActiveItems.set(e,(this.ownedActiveItems.get(e)??0)+1),!0)}useActiveItem(e){const s=this.ownedActiveItems.get(e)??0;return s<=0?!1:(s===1?this.ownedActiveItems.delete(e):this.ownedActiveItems.set(e,s-1),!0)}getOwnedActiveItems(){return Array.from(this.ownedActiveItems.entries()).map(([e,s])=>({id:e,count:s}))}reset(){this.shopMoney=g.INITIAL_SHOP_MONEY,this.medals=g.INITIAL_MEDALS,this.sellMultiplier=1,this.ownedActiveItems.clear()}}let Ft=!1;function Di(){if(Ft)return;Ft=!0;const p=document.createElement("style");p.textContent=`
    @keyframes titleGlow {
  ...
  `,document.head.appendChild(p)}class Ni{constructor(e){l(this,"container");l(this,"bar");l(this,"label");l(this,"reached",!1);l(this,"urgent",!1);l(this,"danger",!1);Oi(),this.container=document.createElement("div"),this.container.style.cssText=`
    ...
    @keyframes bonusPulse {
      0%,100% { text-shadow: 0 0 20px var(--t-success), 0 0 40px var(--t-success); }
      50%     { text-shadow: 0 0 35px var(--t-success), 0 0 70px var(--t-success); }
    }
  `,document.head.appendChild(p)}class $i{constructor(e){l(this,"el");l(this,"medalCounter");l(this,"quotaBar");l(this,"phaseIndicator");l(this,"throwHint");l(this,"inventoryPanel");l(this,"activeItemPanel");l(this,"countdownEl");l(this,"feverBannerEl");l(this,"comboEl");l(this,"edgeGlowEl");l(this,"onUseActiveCallbacks",[]);l(this,"hideTimer",null);l(this,"jackpotHudEl");l(this,"jackpotBarEl");l(this,"comboHideTimer",null);l(this,"aimIndicatorEl");l(this,"stageCountEl");l(this,"bonusCountdownEl");this.el=document.createElement("div"),this.el.style.cssText=`
      position: absolute;
      inset: 0;
      display: none;
      pointer-events: none;
    ...
    `,this.el.appendChild(this.stageCountEl),this.bonusCountdownEl=document.createElement("div"),this.bonusCountdownEl.style.cssText=`
      display: none;
      position: absolute;
      top: 50%; left: 50%;
      transform: translateX(-50%) translateY(-50%);
      ...
      pointer-events: none;
      z-index: 14;
    `,this.bonusCountdownEl.innerHTML=`
      <div style="font-size:1.1rem;font-weight:700;letter-spacing:0.25em;
        color:var(--t-success);text-shadow:0 0 12px var(--t-success);
        margin-bottom:6px;">BONUS TIME!</div>
      <div class="bc-num" style="font-size:5rem;font-weight:900;line-height:1;
        color:var(--t-success);animation:bonusPulse 0.6s ease-in-out infinite;"></div>
      <div style="font-size:0.75rem;color:var(--t-text-dim);letter-spacing:0.15em;
        margin-top:8px;">投入を続けよう！</div>
    `,this.el.appendChild(this.bonusCountdownEl),this.aimIndicatorEl=document.createElement("div"),this.aimIndicatorEl.style.cssText=`
      position: absolute;
      bottom: 0;
      width: 2px;
      height: 38%;
    ...
    `,t.textContent="▸ ITEMS",this.inventoryPanel.appendChild(t);for(const a of e){const n=Ce(a.definitionId);if(!n)continue;const o=String(n.rarity),r=s[o]??"#9999aa",f=i[o]??"◇",m=document.createElement("div");m.style.cssText=`
...
`;class Ki{constructor(e){l(this,"el");l(this,"moneyEl");l(this,"inventoryEl");l(this,"onBuyMedalsCallbacks",[]);l(this,"onSellCallbacks",[]);l(this,"onContinueCallbacks",[]);l(this,"onBuyActiveCallbacks",[]);l(this,"hideTimer",null);this.el=document.createElement("div"),this.el.style.cssText=`
    ...
    `;const n=[{count:10,price:50,coins:"🪙🪙🪙"},{count:30,price:130,coins:"🪙🪙🪙🪙🪙",badge:"POPULAR"},{count:100,price:400,coins:"🪙🪙🪙🪙🪙🪙🪙",badge:"BEST VALUE"}];for(const d of n){const u=e>=d.price,c=document.createElement("div");if(c.style.cssText=`
      ...
      gap: 12px;
    `;const f=new Map(i.map(d=>[d.id,d.count]));for(const d of Tt){const u=e>=d.price,c=f.get(d.id)??0,h=document.createElement("div");h.style.cssText=`
        padding: 14px 12px;
        ${pt}
      ...
      `,D.textContent=`${d.price} G`,u&&(D.addEventListener("mouseenter",()=>{D.style.background=`${d.color}44`}),D.addEventListener("mouseleave",()=>{D.style.background=`${d.color}22`}),h.addEventListener("mouseenter",()=>{h.style.transform="translateY(-3px)",h.style.boxShadow=`0 8px 32px rgba(0,0,0,0.5), 0 0 14px ${d.color}44`}),h.addEventListener("mouseleave",()=>{h.style.transform="",h.style.boxShadow=""}),D.addEventListener("click",()=>this.onBuyActiveCallbacks.forEach(T=>T(d.id)))),v.appendChild(M),v.appendChild(D),h.appendChild(y),h.appendChild(x),h.appendChild(v),r.appendChild(h)}o.appendChild(r),this.inventoryEl.appendChild(o);const m=document.createElement("div");if(m.appendChild(this.sectionHeader("🎁 YOUR ITEMS  —  tap to sell","var(--t-text-dim)")),s.length===0){const d=document.createElement("p");d.style.cssText="color: var(--t-text-dim); opacity: 0.45; font-size: clamp(0.9rem, 1.8vw, 1rem);",d.textContent="No items collected yet.",m.appendChild(d)}else{const d=document.createElement("div");d.style.cssText=`
        ...
        gap: 12px;
      `;for(const u of s){const c=Ce(u.definitionId);if(!c)continue;const h=document.createElement("div"),x={Common:"#aaaaaa",Uncommon:"#44cc77",Rare:"#4488ff",Epic:"#aa44ff",Legendary:"#ffaa00"}[c.rarity]??"#aaaaaa";h.style.cssText=`
          padding: 12px 14px;
          ${pt}
          background: rgba(0,0,0,0.5);
  ...
  `,document.head.appendChild(p)}class sa{constructor(e){l(this,"el");l(this,"onVolumeChangeCallbacks",[]);l(this,"onThemeChangeCallbacks",[]);l(this,"onCloseCallbacks",[]);l(this,"hideTimer",null);l(this,"themeBtns",new Map);ta(),this.el=document.createElement("div"),this.el.style.cssText=`
    ...
    `;const i=document.createElement("h2");i.style.cssText="font-size: 1.6rem; color: var(--t-primary); margin-bottom: 32px; letter-spacing: 0.2em; text-align: center;",i.textContent="SETTINGS",s.appendChild(i);const t=document.createElement("div");t.style.cssText="margin-bottom: 32px;";const a=document.createElement("div");a.style.cssText="font-size: 0.75rem; color: var(--t-text-dim); letter-spacing: 0.15em; margin-bottom: 16px; text-transform: uppercase;",a.textContent="VOLUME",t.appendChild(a);const n=[{label:"Master",type:"master",value:e.masterVolume},{label:"BGM",type:"bgm",value:e.bgmVolume},{label:"SFX",type:"sfx",value:e.sfxVolume}];for(const h of n){const y=document.createElement("div");y.style.cssText="display: flex; align-items: center; gap: 12px; margin-bottom: 14px;";const x=document.createElement("div");x.style.cssText="font-size: 0.85rem; color: var(--t-text-bright); width: 52px; flex-shrink: 0;",x.textContent=h.label;const v=document.createElement("input");v.type="range",v.min="0",v.max="1",v.step="0.05",v.value=String(h.value),v.className="settings-slider",v.style.cssText="flex: 1;";const M=document.createElement("div");M.style.cssText="font-size: 0.8rem; color: var(--t-primary); width: 36px; text-align: right; flex-shrink: 0;",M.textContent=`${Math.round(h.value*100)}%`,v.addEventListener("input",()=>{const D=parseFloat(v.value);M.textContent=`${Math.round(D*100)}%`,this.onVolumeChangeCallbacks.forEach(T=>T(h.type,D))}),y.appendChild(x),y.appendChild(v),y.appendChild(M),t.appendChild(y)}s.appendChild(t);const o=document.createElement("hr");o.style.cssText="border: none; border-top: 1px solid var(--t-border-faint); margin-bottom: 24px;",s.appendChild(o);const r=document.createElement("div");r.style.cssText="margin-bottom: 32px;";const f=document.createElement("div");f.style.cssText="font-size: 0.75rem; color: var(--t-text-dim); letter-spacing: 0.15em; margin-bottom: 16px; text-transform: uppercase;",f.textContent="THEME",r.appendChild(f);const m=document.createElement("div");m.style.cssText="display: flex; gap: 10px; flex-wrap: wrap;";const d=["royal","cyber","steampunk"];for(const h of d){const y=h===e.theme,x=document.createElement("button");x.style.cssText=`
      ...
      `,x.textContent=rs[h].displayName,x.addEventListener("click",()=>{this.selectTheme(h),this.onThemeChangeCallbacks.forEach(v=>v(h))}),this.themeBtns.set(h,x),m.appendChild(x)}r.appendChild(m),s.appendChild(r);const u=document.createElement("hr");u.style.cssText="border: none; border-top: 1px solid var(--t-border-faint); margin-bottom: 24px;",s.appendChild(u);const c=document.createElement("button");c.style.cssText=`
      width: 100%;
      padding: 12px;
      background: transparent;
...
}`,this._currentName=e,this._currentTheme=s,this._callbacks.forEach(t=>t(s))}onChange(e){this._callbacks.push(e)}};l(ge,"_instance",null);let xt=ge;const de=class de{constructor(){l(this,"comboCount",0);l(this,"lastCollectMs",0);l(this,"feverEndMs",0);l(this,"_wasInFever",!1)}onMedalCollected(e){const s=Date.now();s-this.lastCollectMs<de.COMBO_WINDOW_MS?this.comboCount+=e:this.comboCount=e,this.lastCollectMs=s,P.emit("combo:updated",{count:this.comboCount}),this.comboCount>=de.COMBO_TO_FEVER&&!this.isFever&&this._triggerFever()}update(){const e=this.isFever;this._wasInFever&&!e&&(this._wasInFever=!1,this.comboCount=0,P.emit("fever:ended",void 0)),this._wasInFever=e}get isFever(){return Date.now()<this.feverEndMs}get feverRemainingMs(){return Math.max(0,this.feverEndMs-Date.now())}get comboCountValue(){return this.comboCount}reset(){this.comboCount=0,this.lastCollectMs=0,this.feverEndMs=0,this._wasInFever=!1}_triggerFever(){this.feverEndMs=Date.now()+de.FEVER_DURATION_MS,this.comboCount=0,this._wasInFever=!0,P.emit("fever:started",void 0)}};l(de,"COMBO_WINDOW_MS",5e3),l(de,"COMBO_TO_FEVER",6),l(de,"FEVER_DURATION_MS",1e4),l(de,"FEVER_SPEED_MULT",1.6);let Je=de;const Qe=new bt(.05,4,4),ca=new ie(.06,.06,.02,8),da=new Hs(.06,0),ha=new bt(.028,4,4);class pa{constructor(e){l(this,"particles",[]);l(this,"flashRings",[]);l(this,"scene");this.scene=e}spawnFlashRing(e,s,i,t){const a=new it(.1,.38,20),n=new Be({color:t,transparent:!0,opacity:.9,side:at}),o=new k(a,n);o.position.set(e,s,i),o.rotation.x=-Math.PI/2,this.scene.add(o),this.flashRings.push({mesh:o,life:0,maxLife:.25});const r=new it(.05,.22,16),f=new Be({color:t,transparent:!0,opacity:.65,side:at}),m=new k(r,f);m.position.set(e,s+.01,i),m.rotation.x=-Math.PI/2,this.scene.add(m),this.flashRings.push({mesh:m,life:-.06,maxLife:.35})}spawnMedalCollect(e,s,i){this.spawnFlashRing(e,s,i,16766720);const t=14;for(let a=0;a<t;a++){const n=a<5,o=n?ca:Qe,r=new G({color:n?16763904:16766720,emissive:new Y(n?14522624:16766720),emissiveIntensity:n?.6:1,metalness:n?.9:.3,roughness:n?.2:.5,transparent:!0}),f=new k(o,r);f.position.set(e,s,i);const m=a/t*Math.PI*2,d=1.5+Math.random()*3.5,u=new se(Math.cos(m)*d*.55,2.5+Math.random()*3.5,Math.sin(m)*d*.55);this.scene.add(f),this.particles.push({mesh:f,velocity:u,life:0,maxLife:.7+Math.random()*.5})}}spawnItemCollect(e,s,i,t){this.spawnFlashRing(e,s,i,t),this.spawnFlashRing(e,s+.1,i,t);const a=new Y(t),n=24;for(let o=0;o<n;o++){const f=o%3===0?da:Qe,m=new G({color:t,emissive:a,emissiveIntensity:1,metalness:.1,roughness:.4,transparent:!0}),d=new k(f,m);d.position.set(e,s,i);const u=o/n*Math.PI*2+Math.random()*.4,c=2.5+Math.random()*3,h=new se(Math.cos(u)*c,3.5+Math.random()*2.5,Math.sin(u)*c);this.scene.add(d),this.particles.push({mesh:d,velocity:h,life:0,maxLife:1.2+Math.random()*.5})}}spawnThrow(e,s,i){for(let a=0;a<9;a++){const n=new G({color:16766720,emissive:new Y(16766720),emissiveIntensity:1,metalness:.5,roughness:.3,transparent:!0}),o=new k(Qe,n);o.position.set(e,s,i);const r=a/9*Math.PI*2,f=1.2+Math.random()*1.6,m=new se(Math.cos(r)*f*.4,2.5+Math.random()*2,Math.sin(r)*f*.2);this.scene.add(o),this.particles.push({mesh:o,velocity:m,life:0,maxLife:.35+Math.random()*.2})}}spawnCoinGlints(e,s,i,t=3){const a=[16774314,16769152,16766720,16777215,16771248];for(let n=0;n<t;n++){const o=a[Math.floor(Math.random()*a.length)],r=new G({color:o,emissive:new Y(o),emissiveIntensity:2.5,transparent:!0,opacity:.9}),f=new k(ha,r),m=(Math.random()-.5)*1.2,d=(Math.random()-.5)*1.2;f.position.set(e+m,s+Math.random()*.1,i+d);const u=Math.random()*Math.PI*2,c=.4+Math.random()*.6,h=new se(Math.cos(u)*c*.3,.8+Math.random()*1.2,Math.sin(u)*c*.3);this.scene.add(f),this.particles.push({mesh:f,velocity:h,life:0,maxLife:.35+Math.random()*.25})}}spawnJackpot(e,s,i){this.spawnFlashRing(e,s,i,16766720);const t=new it(.3,.8,32),a=new Be({color:16777215,transparent:!0,opacity:.85,side:at}),n=new k(t,a);n.position.set(e,s,i),n.rotation.x=-Math.PI/2,this.scene.add(n),this.flashRings.push({mesh:n,life:0,maxLife:.4});const o=30;for(let r=0;r<o;r++){const f=r/o*360,m=new Y(`hsl(${f}, 100%, 60%)`),d=r%4===0,u=new G({color:m,emissive:m,emissiveIntensity:1,metalness:d?.8:.2,roughness:.3,transparent:!0}),c=new k(Qe,u);c.position.set(e,s,i);const h=r/o*Math.PI*2+Math.random()*.3,y=3.5+Math.random()*4.5,x=new se(Math.cos(h)*y,4+Math.random()*5,Math.sin(h)*y);this.scene.add(c),this.particles.push({mesh:c,velocity:x,life:0,maxLife:1.6+Math.random()*.6})}}update(e){const i=[];for(const a of this.particles){a.life+=e;const n=a.life/a.maxLife;a.velocity.y+=-9.8*e,a.mesh.position.addScaledVector(a.velocity,e),a.mesh.rotation.x+=e*5,a.mesh.rotation.y+=e*4,a.mesh.rotation.z+=e*3;const o=Math.max(0,1-n*.65);a.mesh.scale.setScalar(o),a.mesh.material.opacity=Math.pow(1-n,1.6),n>=1&&i.push(a)}for(const a of i)this.scene.remove(a.mesh),a.mesh.material.dispose(),this.particles.splice(this.particles.indexOf(a),1);const t=[];for(const a of this.flashRings){if(a.life+=e,a.life<0)continue;const n=a.life/a.maxLife,r=1+(1-Math.pow(1-n,2.2))*3.2;a.mesh.scale.set(r,r,r);const f=a.mesh.material.opacity>.7?.9:.65;a.mesh.material.opacity=f*Math.pow(1-n,.7),n>=1&&t.push(a)}for(const a of t)this.scene.remove(a.mesh),a.mesh.geometry.dispose(),a.mesh.material.dispose(),this.flashRings.splice(this.flashRings.indexOf(a),1)}clear(){for(const e of this.particles)this.scene.remove(e.mesh),e.mesh.material.dispose();this.particles=[];for(const e of this.flashRings)this.scene.remove(e.mesh),e.mesh.geometry.dispose(),e.mesh.material.dispose();this.flashRings=[]}}class ma{constructor(){l(this,"counter",0);l(this,"jackpotCount",0)}onQuotaAdded(e){this.counter+=e,P.emit("jackpot:progress",{current:this.counter,target:g.JACKPOT_THRESHOLD}),this.counter>=g.JACKPOT_THRESHOLD&&(this.counter-=g.JACKPOT_THRESHOLD,this.jackpotCount++,P.emit("jackpot:triggered",{count:this.jackpotCount}))}reset(){this.counter=0,this.jackpotCount=0}get progress(){return Math.min(1,this.counter/g.JACKPOT_THRESHOLD)}get current(){return this.counter}get target(){return g.JACKPOT_THRESHOLD}}const mt=1280,ut=720;function ls(){const p=document.getElementById("ui-root");if(!p)return;const e=window.innerWidth<window.innerHeight,s=e?window.innerHeight:window.innerWidth,i=e?window.innerWidth:window.innerHeight,t=s/mt,a=i/ut,n=Math.min(t,a),o=Math.round((s-mt*n)/2),r=Math.round((i-ut*n)/2);p.style.width=`${mt}px`,p.style.height=`${ut}px`,p.style.transform=`translate(${o}px, ${r}px) scale(${n})`,p.style.transformOrigin="top left",p.style.inset="unset",p.style.top="0",p.style.left="0"}ls();window.addEventListener("resize",ls);screen.orientation&&"lock"in screen.orientation&&screen.orientation.lock("landscape").catch(()=>{});async function ua(){const p=yt.getInstance(),e=xt.getInstance();e.applyTheme(p.theme);const s=new Ns,i=new Gs,t=new $s,a=new Ri,n=new _i;let o=0;const r=document.getElementById("app"),f=document.getElementById("ui-root"),m=new Js(r),d=new ei,u=new ti(m),c=new si(m.scene);m.setCamera(d.camera);const h=e.currentTheme;m.applySceneTheme(h.scene),u.applyTheme(h.lights),c.applyTheme(h.scene);const y=new Mi,x=new Ci(s),v=new Ai,M=new Pi,D=new ki,T=new Li,S=new Ei(m,y,v,h.scene);S.setMedalQuotaMultiplierFn(()=>M.quotaPerMedalMultiplier);const b=new na(f),O=new la(m.renderer.domElement);b.titleScreen.applyTheme(p.theme);const L=new Je,_=new pa(m.scene),I=new ma,C=new gt;C.setMasterVolume(p.masterVolume),C.setBgmVolume(p.bgmVolume),C.setSfxVolume(p.sfxVolume),e.onChange(w=>{m.applySceneTheme(w.scene),u.applyTheme(w.lights),c.applyTheme(w.scene),b.titleScreen.applyTheme(w.name),S.physicsWorld.initialized&&S.rebuildFieldMesh(w.scene)}),b.titleScreen.onSettings(()=>{b.settingsScreen.show(p.snapshot)}),b.settingsScreen.onClose(()=>{b.settingsScreen.hide()}),b.settingsScreen.onVolumeChange((w,B)=>{w==="master"?(p.setMasterVolume(B),C.setMasterVolume(B)):w==="bgm"?(p.setBgmVolume(B),C.setBgmVolume(B)):(p.setSfxVolume(B),C.setSfxVolume(B))}),b.settingsScreen.onThemeChange(w=>{p.setTheme(w),e.applyTheme(w)});let $=0,F=!1,z=0,V=!1,Q=0,j=0,ce=0;b.titleScreen.onStart(()=>{s.is(E.TITLE)&&Ne()}),b.stageResultScreen.onContinue(()=>{b.stageResultScreen.hide(),x.advanceStage(),me()}),b.stageResultScreen.onSkip(()=>{b.stageResultScreen.hide(),x.advancePhase(),Ge()}),b.shopScreen.onBuyMedals(w=>{const B=w*g.MEDAL_BUY_PRICE;T.buyMedals(w)?b.shopScreen.show(T.money,v.getAll(),T.getOwnedActiveItems()):console.log(`Not enough shop money (need ${B} G, have ${T.money} G)`)}),b.shopScreen.onSell(w=>{const B=T.sellItem(w,v);a.addShopMoney(B),b.shopScreen.show(T.money,v.getAll(),T.getOwnedActiveItems())}),b.shopScreen.onBuyActive(w=>{T.buyActiveItem(w)&&b.shopScreen.show(T.money,v.getAll(),T.getOwnedActiveItems())}),b.shopScreen.onContinue(()=>{b.shopScreen.hide(),ze()}),b.skillSelectScreen.onSelect(w=>{M.addSkill(w,x.currentPhase),T.setSellMultiplier(M.itemSellMultiplier),b.skillSelectScreen.hide(),s.transition(E.STAGE_START),me()}),b.resultScreen.onRetry(()=>{b.resultScreen.hide(),s.transition(E.TITLE),b.titleScreen.show()}),b.resultScreen.onTitle(()=>{b.resultScreen.hide(),s.transition(E.TITLE),b.titleScreen.show()}),b.gameScreen.onUseActive(w=>{if(!s.is(E.PLAYING)||!T.useActiveItem(w))return;const B=$t(w);if(!B)return;const U=Date.now()+B.durationMs;if(w==="side_guard")ce=U,S.addSideGuardWalls(),S.fieldMesh.addSideGuardMeshes(S.fieldMesh.group);else if(w==="medal_fever")j=U;else if(w==="medal_shower"){for(let Z=0;Z<20;Z++)setTimeout(()=>{if(!s.is(E.PLAYING))return;const J=(Math.random()*2-1)*(g.FIELD_WIDTH/2-.5),ne=(Math.random()-.5)*(g.FIELD_DEPTH/2);S.medalSpawner.spawn(J,5,ne,S.physicsWorld,S.physicsSync,S.collisionHandler,m)},Z*150);d.shake(.12,.3)}else w==="earthquake"&&(S.shakeAllMedals(4),d.shake(.4,.5),b.gameScreen.showFloatingText("🌋 地震！","var(--t-secondary)"))}),O.onAim(w=>{s.is(E.PLAYING)?b.gameScreen.showAim(w):b.gameScreen.hideAim()}),O.onThrow((w,B)=>{if(!s.is(E.PLAYING))return;const U=w*(g.FIELD_WIDTH/2+.5),Z=M.medalThrowCount;let J=0;for(let ne=0;ne<Z&&T.spendMedal();ne++){const be=(ne-Math.floor(Z/2))*.6;S.throwMedal(U+be,B),J++}J>0&&(P.emit("medal:thrown",{count:J}),_.spawnThrow(U,2,g.FIELD_DEPTH/2-.5))});function Oe(){O.disable();const w=M.onClearBonusMedals;w>0&&T.addMedals(w);const B=Math.max(0,Math.floor((y.currentValue/y.targetValue-1)*100)),U=15+Math.min(30,B);T.addMoney(U),x.clearCurrentStage(),b.chanceScreen.show(Z=>{Z.medals>0&&(T.addMedals(Z.medals),b.gameScreen.showFloatingText(`+${Z.medals}`,"var(--t-primary)"));const J=x.isLastStageOfPhase;b.stageResultScreen.show(x.currentPhase,x.currentStage,J,y.currentValue,y.targetValue)})}P.on("quota:reached",()=>{s.is(E.PLAYING)&&(V||(V=!0,Q=5,b.gameScreen.showBonusCountdown(Q)))}),P.on("medal:collected",({count:w,x:B,y:U,z:Z})=>{if(s.is(E.PLAYING)){const J=(B/g.FIELD_WIDTH*2+1)/2*72+14;b.gameScreen.showFloatingText(`+${w}`,w>=2?"var(--t-secondary)":"var(--t-primary)",J),T.addMedals(w),L.onMedalCollected(w),I.onQuotaAdded(w),_.spawnMedalCollect(B,Math.max(U,0),Z),o+=w*150+Math.floor(Math.random()*50),he.refreshJackpot(o),S.fieldMesh.triggerCollectionFlash()}}),P.on("item:collected",({x:w,y:B,z:U})=>{s.is(E.PLAYING)&&_.spawnItemCollect(w,Math.max(B,0),U,59647)}),P.on("jackpot:progress",({current:w,target:B})=>{s.is(E.PLAYING)&&b.gameScreen.updateJackpot(w,B)}),P.on("jackpot:triggered",()=>{if(!s.is(E.PLAYING))return;T.addMedals(g.JACKPOT_MEDAL_REWARD),b.gameScreen.showFloatingText(`JACKPOT! +${g.JACKPOT_MEDAL_REWARD}`,"var(--t-primary)"),C.playJackpotFanfare(),d.shake(.35,.6),_.spawnJackpot(0,2,-2),b.gameScreen.resetJackpot(g.JACKPOT_THRESHOLD)}),P.on("fever:started",()=>{S.pusher.speedMultiplier=Je.FEVER_SPEED_MULT;const B=1.5*(j>Date.now()?2:1)*M.quotaPerMedalMultiplier;b.gameScreen.showFever(1e4,B),C.playFeverStart(),u.setFeverMode(!0),C.startBGM(!0),d.shake(.2,.4);for(let U=0;U<12;U++)setTimeout(()=>{if(!s.is(E.PLAYING))return;const Z=(Math.random()*2-1)*(g.FIELD_WIDTH/2-.5),J=(Math.random()*2-1)*(g.FIELD_DEPTH/4);S.medalSpawner.spawn(Z,4.5,J,S.physicsWorld,S.physicsSync,S.collisionHandler,m)},U*250)}),P.on("fever:ended",()=>{S.pusher.speedMultiplier=1,b.gameScreen.hideFever(),b.gameScreen.hideCombo(),C.playFeverEnd(),u.setFeverMode(!1),C.startBGM(!1)}),P.on("combo:updated",({count:w})=>{s.is(E.PLAYING)&&w>=2&&(b.gameScreen.showCombo(w),C.playCombo(w))}),P.on("medal:thrown",()=>{C.playThrow(),b.gameScreen.flashAim()}),P.on("medal:collected",()=>C.playMedalCollected()),P.on("quota:reached",()=>C.playQuotaReached()),P.on("stage:cleared",()=>C.playStageCleared()),P.on("game:over",()=>C.playGameOver()),P.on("skill:selected",()=>C.playSkillSelected()),P.on("medal:collected",()=>d.shake(.04,.08)),P.on("quota:reached",()=>d.shake(.15,.3)),P.on("stage:cleared",()=>d.shake(.28,.5)),P.on("game:over",()=>d.shake(.5,.8)),P.on("state:changed",({to:w})=>{w===E.PLAYING?C.startBGM(!1):C.stopBGM(),d.setTitleMode(w===E.TITLE)});let Ae=0,Re=0;i.addUpdateFn(w=>{if(Ae+=w,s.is(E.PLAYING)){const B=Date.now();ce>0&&B>ce&&(ce=0,S.removeSideGuardWalls(),S.fieldMesh.removeSideGuardMeshes(S.fieldMesh.group)),j>0&&B>j&&(j=0);const U=j>Date.now()?2:1,Z=L.isFever?1.5:1,J=U*Z;S.setMedalQuotaMultiplierFn(()=>M.quotaPerMedalMultiplier*J),S.update(w),Re+=w;const ne=L.isFever?.25:.55;if(Re>=ne&&S.medalSpawner.count>0){Re=0;const oe=(Math.random()-.5)*5,re=-2+(Math.random()-.5)*4,_e=L.isFever?5:2;_.spawnCoinGlints(oe,.5,re,_e)}const be=T.getOwnedActiveItems().map(oe=>{const re=$t(oe.id),_e=oe.id==="side_guard"?Math.max(0,ce-Date.now()):oe.id==="medal_fever"?Math.max(0,j-Date.now()):0;return{...oe,name:re.name,color:re.color,remainingMs:_e}});if(b.updateGameHUD(T.currentMedals,y.currentValue,y.targetValue,x.currentPhase,x.currentStage,v.getAll(),be),S.fieldMesh.updateScreenDisplay(T.currentMedals,y.currentValue,y.targetValue,x.currentPhase,x.currentStage),V&&(Q-=w,Q>0?b.gameScreen.showBonusCountdown(Q):(V=!1,b.gameScreen.hideBonusCountdown(),s.is(E.PLAYING)&&Oe())),!F&&T.currentMedals<=0&&!y.isReached&&(F=!0,z=10,O.disable(),b.gameScreen.quotaBar.setDanger(!0)),F&&T.currentMedals>0&&(F=!1,z=0,b.gameScreen.hideCountdown(),b.gameScreen.quotaBar.setDanger(!1),O.enable()),F&&z>0){const oe=Math.ceil(z);z-=w;const re=Math.ceil(z);re!==oe&&re>0&&C.playCountdownTick(),z>0?b.gameScreen.showCountdown(z):(b.gameScreen.hideCountdown(),$e())}}L.update(),_.update(w),c.update(w),u.update(Ae),d.update(w),m.render(d.camera)});function Ne(){t.incrementRuns(),T.reset(),v.clear(),M.reset(),a.reset(),x.reset(),$=0,F=!1,z=0,V=!1,Q=0,j=0,ce=0,L.reset(),I.reset(),S.pusher.speedMultiplier=1,o=0,he.refreshJackpot(0),s.transition(E.STAGE_START),me()}async function me(){const w=x.currentPhase,B=x.currentStage;F=!1,z=0,V=!1,Q=0,b.gameScreen.hideCountdown(),b.gameScreen.hideBonusCountdown(),b.gameScreen.quotaBar.setDanger(!1),L.reset(),I.reset(),S.pusher.speedMultiplier=1,b.gameScreen.hideFever(),b.gameScreen.hideCombo(),b.gameScreen.resetJackpot(g.JACKPOT_THRESHOLD),y.startStage(w,B);try{S.physicsWorld.initialized?B===1?S.endStage():S.endStageKeepMedals():(xe(!0),await S.init(),xe(!1))}catch(U){console.error("Field init failed:",U),xe(!1);return}B===1?S.startStage(w,B):S.startStageKeepMedals(w,B),x.startCurrentStage(),S.pusher.paused=!0,b.gameScreen.showStageCountdown(w,B,()=>{S.pusher.paused=!1,s.is(E.PLAYING)&&O.enable()})}function Ge(){S.endStage(),s.transition(E.SHOP),b.shopScreen.show(T.money,v.getAll(),T.getOwnedActiveItems())}function ze(){s.transition(E.SKILL_SELECT);const w=D.pickChoices(g.SKILL_CHOICES,M.getOwnedSkills(),Date.now());b.skillSelectScreen.show(w)}function $e(){if($>0){$--,z=0,b.gameScreen.hideCountdown(),O.enable(),F=!1;return}S.endStage();const w=n.calculate(a.snapshot,t);t.updateBest(w.phase,w.stage),s.transition(E.GAME_OVER),s.transition(E.RESULT),b.resultScreen.show(w)}const ue=document.createElement("div");ue.style.cssText=`
    position: absolute; inset: 0; display: none;
    align-items: center; justify-content: center;
    background: var(--t-bg-overlay-dark); color: var(--t-primary);
    font-size: 1.2rem; letter-spacing: 0.2em;
  `,ue.textContent="LOADING...",f.appendChild(ue);function xe(w){ue.style.display=w?"flex":"none"}P.on("skill:selected",()=>{$=Math.max($,M.gameOverShields)}),i.start(),d.setTitleMode(!0),s.transition(E.TITLE),b.titleScreen.show(),console.log("YukiMedal initialized")}ua().catch(console.error);
