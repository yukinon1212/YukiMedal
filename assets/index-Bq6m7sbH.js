var Ne=Object.defineProperty;var Ue=(o,e,t)=>e in o?Ne(o,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):o[e]=t;var r=(o,e,t)=>Ue(o,typeof e!="symbol"?e+"":e,t);import{M as k,O as Fe,B as Ie,F as ue,S as W,U as te,V as H,W as X,H as J,N as ze,C as We,a as Q,b as F,A as Ve,c as $e,R as Qe,d as qe,e as Ye,L as Ze,f as Ke,g as je,h as Re,i as Xe,j as Je,k as et,l as tt,m as st,P as it,n as at,o as Pe,p as nt,D as pe,q as me,r as rt,s as ot,t as lt,G as ct,u as dt,v as Le,w as ht,I as ut,x as z,y as pt,z as K,E as G}from"./three-CMChFoeq.js";import{O as j}from"./rapier-DpxwuBBO.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const n of a.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function t(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(s){if(s.ep)return;s.ep=!0;const a=t(s);fetch(s.href,a)}})();var g=(o=>(o.INIT="INIT",o.TITLE="TITLE",o.STAGE_START="STAGE_START",o.PLAYING="PLAYING",o.STAGE_CLEAR="STAGE_CLEAR",o.SKIP_PROMPT="SKIP_PROMPT",o.GAME_OVER="GAME_OVER",o.SHOP="SHOP",o.SKILL_SELECT="SKILL_SELECT",o.RESULT="RESULT",o))(g||{});class mt{constructor(){r(this,"listeners",new Map)}on(e,t){this.listeners.has(e)||this.listeners.set(e,new Set);const i=this.listeners.get(e);return i.add(t),()=>i.delete(t)}once(e,t){const i=this.on(e,s=>{t(s),i()})}emit(e,t){const i=this.listeners.get(e);if(i)for(const s of i)s(t)}off(e,t){var i;(i=this.listeners.get(e))==null||i.delete(t)}clear(){this.listeners.clear()}}const x=new mt,ft=[{from:g.INIT,to:g.TITLE},{from:g.TITLE,to:g.STAGE_START},{from:g.STAGE_START,to:g.PLAYING},{from:g.PLAYING,to:g.STAGE_CLEAR},{from:g.PLAYING,to:g.GAME_OVER},{from:g.STAGE_CLEAR,to:g.STAGE_START},{from:g.STAGE_CLEAR,to:g.SKIP_PROMPT},{from:g.STAGE_CLEAR,to:g.SHOP},{from:g.SKIP_PROMPT,to:g.SHOP},{from:g.SKIP_PROMPT,to:g.STAGE_START},{from:g.SHOP,to:g.SKILL_SELECT},{from:g.SKILL_SELECT,to:g.STAGE_START},{from:g.GAME_OVER,to:g.RESULT},{from:g.RESULT,to:g.TITLE}];class gt{constructor(){r(this,"current",g.INIT)}get state(){return this.current}canTransition(e){return ft.some(t=>(Array.isArray(t.from)?t.from:[t.from]).includes(this.current)&&t.to===e)}transition(e){if(!this.canTransition(e))throw new Error(`Invalid state transition: ${this.current} → ${e}`);const t=this.current;this.current=e,x.emit("state:changed",{from:t,to:e})}is(e){return this.current===e}isAny(...e){return e.includes(this.current)}}class yt{constructor(){r(this,"updateFns",[]);r(this,"rafId",null);r(this,"lastTime",0);r(this,"maxDelta",1/20)}addUpdateFn(e){this.updateFns.push(e)}removeUpdateFn(e){const t=this.updateFns.indexOf(e);t!==-1&&this.updateFns.splice(t,1)}start(){if(this.rafId!==null)return;this.lastTime=performance.now();const e=t=>{this.rafId=requestAnimationFrame(e);const i=(t-this.lastTime)/1e3;this.lastTime=t;const s=Math.min(i,this.maxDelta);for(const a of this.updateFns)a(s)};this.rafId=requestAnimationFrame(e)}stop(){this.rafId!==null&&(cancelAnimationFrame(this.rafId),this.rafId=null)}get isRunning(){return this.rafId!==null}}const fe="yukimedal_save",Et="yukimedal_best",ne={bestPhase:0,bestStage:0,totalRuns:0,lastPlayedAt:0};class St{constructor(){r(this,"data");this.data=this.load()}load(){try{const e=localStorage.getItem(fe);return e?{...ne,...JSON.parse(e)}:{...ne}}catch{return{...ne}}}save(){try{localStorage.setItem(fe,JSON.stringify(this.data))}catch{}}updateBest(e,t){const i=e*3+t,s=this.data.bestPhase*3+this.data.bestStage;i>s&&(this.data.bestPhase=e,this.data.bestStage=t,localStorage.setItem(Et,JSON.stringify({phase:e,stage:t}))),this.data.lastPlayedAt=Date.now(),this.save()}incrementRuns(){this.data.totalRuns++,this.save()}get bestPhase(){return this.data.bestPhase}get bestStage(){return this.data.bestStage}get totalRuns(){return this.data.totalRuns}}const De={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
  ...
  `,document.head.appendChild(o)}class us{constructor(e){r(this,"el");r(this,"onStartCallbacks",[]);r(this,"hideTimer",null);hs(),this.el=document.createElement("div"),this.el.style.cssText=`
      position: absolute;
      inset: 0;
      display: none;
    ...
    `,e.appendChild(this.el)}update(e){const t=e!==this.prevMedals,i=this.prevMedals>0&&e===0;this.prevMedals=e,this.el.textContent=`🪙 ${e}`,t&&(i?this.el.style.color="#ff4444":this.el.style.color="#ffd700",this.el.style.transform="scale(1.25)",setTimeout(()=>{this.el.style.transform="scale(1)"},250))}show(){this.el.style.display="block"}hide(){this.el.style.display="none"}}let we=!1;function ms(){if(we)return;we=!0;const o=document.createElement("style");o.textContent=`
    @keyframes barPulse {
      0%, 100% { transform: scaleX(1); }
      50% { transform: scaleX(1.03); }
    }
  `,document.head.appendChild(o)}class fs{constructor(e){r(this,"container");r(this,"bar");r(this,"label");r(this,"reached",!1);ms(),this.container=document.createElement("div"),this.container.style.cssText=`
      position: absolute;
      top: 16px;
      left: 50%;
    ...
    `,this.bar.appendChild(i),t.appendChild(this.bar),this.container.appendChild(this.label),this.container.appendChild(t),e.appendChild(this.container)}update(e,t){const i=Math.min(e/t,1)*100;this.bar.style.width=`${i}%`,this.label.textContent=`QUOTA: ${Math.floor(e)} / ${t}`,e>=t&&!this.reached?(this.reached=!0,this.bar.style.background="linear-gradient(90deg, #00ff88, #ffd700)",this.bar.style.boxShadow="0 0 14px #00ff88aa",this.bar.style.animation="barPulse 0.6s ease infinite"):e<t&&this.reached&&(this.reached=!1,this.bar.style.background="linear-gradient(90deg, #4444ff, #00ffaa)",this.bar.style.boxShadow="",this.bar.style.animation="")}show(){this.container.style.display="block"}hide(){this.container.style.display="none"}}class gs{constructor(e){r(this,"el");this.el=document.createElement("div"),this.el.style.cssText=`
      ...
      box-shadow: 0 4px 24px rgba(0,0,0,0.4), inset 0 1px 0 rgba(255,255,255,0.08);
      text-align: right;
    `,e.appendChild(this.el)}update(e,t){this.el.innerHTML=`Phase <span style="color:#ffd700;font-weight:bold">${e}</span><br>Stage ${t} / 3`}show(){this.el.style.display="block"}hide(){this.el.style.display="none"}}let ve=!1;function ys(){if(ve)return;ve=!0;const o=document.createElement("style");o.textContent=`
    @keyframes floatUp {
  ...
  `,document.head.appendChild(o)}class Es{constructor(e){r(this,"el");r(this,"medalCounter");r(this,"quotaBar");r(this,"phaseIndicator");r(this,"throwHint");r(this,"inventoryPanel");r(this,"activeItemPanel");r(this,"countdownEl");r(this,"onUseActiveCallbacks",[]);r(this,"hideTimer",null);this.el=document.createElement("div"),this.el.style.cssText=`
    ...
    `,this.el.appendChild(this.countdownEl),e.appendChild(this.el),ys()}update(e,t,i,s,a){this.medalCounter.update(e),this.quotaBar.update(t,i),this.phaseIndicator.update(s,a)}showFloatingText(e,t="#ffd700"){let i="2rem";const s=parseInt(e.replace("+",""),10);isNaN(s)||(s>=5?i="2.6rem":s>=2?i="2.2rem":i="1.6rem");const a=document.createElement("div");a.style.cssText=`
      position: absolute;
      bottom: 30%;
      left: 50%;
...
`;class vs{constructor(e){r(this,"el");r(this,"moneyEl");r(this,"inventoryEl");r(this,"onBuyMedalsCallbacks",[]);r(this,"onSellCallbacks",[]);r(this,"onContinueCallbacks",[]);r(this,"onBuyActiveCallbacks",[]);r(this,"hideTimer",null);this.el=document.createElement("div"),this.el.style.cssText=`
    ...
    `,s.textContent="START NEXT PHASE →",s.addEventListener("mouseenter",()=>s.style.background="#00ff8822"),s.addEventListener("mouseleave",()=>s.style.background="transparent"),s.addEventListener("click",()=>this.onContinueCallbacks.forEach(a=>a())),t.appendChild(i),t.appendChild(this.moneyEl),t.appendChild(s),this.inventoryEl=document.createElement("div"),this.inventoryEl.style.cssText="margin-top: 16px;",this.el.appendChild(t),this.el.appendChild(this.inventoryEl),e.appendChild(this.el)}show(e,t,i=[]){this.hideTimer!==null&&(clearTimeout(this.hideTimer),this.hideTimer=null),this.moneyEl.textContent=`Shop Money: ${e} G`,this.renderContent(e,t,i),this.el.style.opacity="0",this.el.style.display="block",requestAnimationFrame(()=>{this.el.style.opacity="1"})}renderContent(e,t,i){this.inventoryEl.innerHTML="";const s=document.createElement("div");s.style.cssText="margin-bottom: 28px;";const a=document.createElement("h3");a.style.cssText="color: #ffd700; margin-bottom: 12px; border-bottom: 1px solid rgba(255,215,0,0.15); padding-bottom: 8px;",a.textContent="BUY MEDALS",s.appendChild(a);const n=document.createElement("div");n.style.cssText="display: flex; gap: 12px; flex-wrap: wrap;";const l=[{count:10,price:50,label:"10 medals"},{count:30,price:130,label:"30 medals"},{count:100,price:400,label:"100 medals"}];for(const u of l){const p=e>=u.price,M=document.createElement("button");M.style.cssText=`
      ...
      `,A.textContent=`Buy ${u.price} G`,p&&(A.addEventListener("mouseenter",()=>A.style.background=`${u.color}22`),A.addEventListener("mouseleave",()=>A.style.background="transparent"),E.addEventListener("mouseenter",()=>{E.style.transform="translateY(-2px)",E.style.boxShadow="0 8px 32px rgba(0,0,0,0.5)"}),E.addEventListener("mouseleave",()=>{E.style.transform="translateY(0)",E.style.boxShadow=""}),A.addEventListener("click",()=>{this.onBuyActiveCallbacks.forEach(N=>N(u.id))})),E.appendChild(R),E.appendChild(P),E.appendChild(L),E.appendChild(A),m.appendChild(E)}h.appendChild(m),this.inventoryEl.appendChild(h);const S=document.createElement("hr");S.style.cssText="border-color: rgba(255,255,255,0.1); margin: 8px 0 20px;",this.inventoryEl.appendChild(S);const w=document.createElement("div"),f=document.createElement("h3");if(f.style.cssText="color: #aaaacc; margin-bottom: 12px; border-bottom: 1px solid rgba(255,255,255,0.1); padding-bottom: 8px;",f.textContent="YOUR ITEMS (click to sell)",w.appendChild(f),t.length===0){const u=document.createElement("p");u.style.cssText="color: #555577;",u.textContent="No items collected yet.",w.appendChild(u)}else{const u=document.createElement("div");u.style.cssText="display: flex; flex-wrap: wrap; gap: 12px;";for(const p of t){const M=q(p.definitionId);if(!M)continue;const E=document.createElement("div");E.style.cssText=`
        ...
        `,E.addEventListener("mouseenter",()=>{E.style.borderColor="#ffd700",E.style.transform="translateY(-2px)",E.style.boxShadow="0 8px 32px rgba(0,0,0,0.5)"}),E.addEventListener("mouseleave",()=>{E.style.borderColor="#333355",E.style.transform="translateY(0)",E.style.boxShadow=""}),E.addEventListener("click",()=>{this.onSellCallbacks.forEach(R=>R(p.instanceId))}),u.appendChild(E)}w.appendChild(u)}this.inventoryEl.appendChild(w)}hide(){this.el.style.opacity="0",this.hideTimer=setTimeout(()=>{this.el.style.display="none",this.hideTimer=null},280)}onBuyMedals(e){this.onBuyMedalsCallbacks.push(e)}onSell(e){this.onSellCallbacks.push(e)}onContinue(e){this.onContinueCallbacks.push(e)}onBuyActive(e){this.onBuyActiveCallbacks.push(e)}}class Cs{constructor(e){r(this,"titleScreen");r(this,"gameScreen");r(this,"stageResultScreen");r(this,"resultScreen");r(this,"skillSelectScreen");r(this,"shopScreen");this.titleScreen=new us(e),this.gameScreen=new Es(e),this.stageResultScreen=new Ts(e),this.resultScreen=new Ms(e),this.skillSelectScreen=new ws(e),this.shopScreen=new vs(e),x.on("state:changed",({to:t})=>{this.handleStateChange(t)})}handleStateChange(e){switch(this.gameScreen.hide(),this.stageResultScreen.hide(),this.skillSelectScreen.hide(),this.shopScreen.hide(),e){case g.TITLE:this.titleScreen.show();break;case g.PLAYING:this.titleScreen.hide(),this.gameScreen.show();break;case g.STAGE_CLEAR:break;case g.RESULT:this.gameScreen.hide();break}}updateGameHUD(e,t,i,s,a,n,l){this.gameScreen.update(e,t,i,s,a),n&&this.gameScreen.updateInventory(n),l&&this.gameScreen.updateActiveItems(l)}}class _s{constructor(e){r(this,"throwCallbacks",[]);r(this,"enabled",!1);r(this,"onClick",e=>{if(!this.enabled)return;const t=e.clientX/window.innerWidth*2-1,i=e.clientY/window.innerHeight*2-1;this.throwCallbacks.forEach(s=>s(t,i))});r(this,"onTouch",e=>{if(!this.enabled)return;e.preventDefault();const t=e.changedTouches[0];if(!t)return;const i=t.clientX/window.innerWidth*2-1,s=t.clientY/window.innerHeight*2-1;this.throwCallbacks.forEach(a=>a(i,s))});this.canvas=e,e.addEventListener("click",this.onClick),e.addEventListener("touchend",this.onTouch,{passive:!1})}enable(){this.enabled=!0}disable(){this.enabled=!1}onThrow(e){return this.throwCallbacks.push(e),()=>{const t=this.throwCallbacks.indexOf(e);t!==-1&&this.throwCallbacks.splice(t,1)}}dispose(){this.canvas.removeEventListener("click",this.onClick),this.canvas.removeEventListener("touchend",this.onTouch)}}const D=class D{constructor(){r(this,"ctx",null);r(this,"masterGain",null);r(this,"bgmPlaying",!1);r(this,"bgmNextTime",0);r(this,"bgmSchedulerTimer",null);r(this,"bgmBeatIndex",0)}getCtx(){return this.ctx||(this.ctx=new AudioContext,this.masterGain=this.ctx.createGain(),this.masterGain.gain.value=.7,this.masterGain.connect(this.ctx.destination)),this.ctx.state==="suspended"&&this.ctx.resume(),this.ctx}getMaster(){return this.getCtx(),this.masterGain}playThrow(){const e=this.getCtx(),t=this.getMaster(),i=e.sampleRate*.12,s=e.createBuffer(1,i,e.sampleRate),a=s.getChannelData(0);for(let h=0;h<i;h++)a[h]=Math.random()*2-1;const n=e.createBufferSource();n.buffer=s;const l=e.createBiquadFilter();l.type="bandpass",l.frequency.setValueAtTime(800,e.currentTime),l.frequency.linearRampToValueAtTime(2400,e.currentTime+.1),l.Q.value=1.5;const c=e.createGain();c.gain.setValueAtTime(.4,e.currentTime),c.gain.exponentialRampToValueAtTime(.001,e.currentTime+.12),n.connect(l),l.connect(c),c.connect(t),n.start(),n.stop(e.currentTime+.12)}playMedalCollected(){const e=this.getCtx(),t=this.getMaster(),i=e.createOscillator();i.type="triangle",i.frequency.setValueAtTime(880,e.currentTime),i.frequency.linearRampToValueAtTime(1320,e.currentTime+.15);const s=e.createGain();s.gain.setValueAtTime(.3,e.currentTime),s.gain.exponentialRampToValueAtTime(.001,e.currentTime+.3),i.connect(s),s.connect(t),i.start(),i.stop(e.currentTime+.3)}playQuotaReached(){const e=this.getCtx(),t=this.getMaster();[523.25,659.25,783.99,1046.5].forEach((s,a)=>{this._playNote(e,t,"sine",s,e.currentTime+a*.08,.25,.25)})}playStageCleared(){const e=this.getCtx(),t=this.getMaster();[[523.25,0,.15],[783.99,.15,.15],[1318.5,.3,.35]].forEach(([s,a,n])=>{this._playNote(e,t,"square",s,e.currentTime+a,n,.2)})}playGameOver(){const e=this.getCtx(),t=this.getMaster();[440,349.23,293.66,220].forEach((s,a)=>{this._playNote(e,t,"sawtooth",s,e.currentTime+a*.22,.3,.18)})}playSkillSelected(){const e=this.getCtx(),t=this.getMaster();this._playNote(e,t,"sine",600,e.currentTime,.2,.25)}playCountdownTick(){const e=this.getCtx(),t=this.getMaster(),i=Math.floor(e.sampleRate*.02),s=e.createBuffer(1,i,e.sampleRate),a=s.getChannelData(0);for(let c=0;c<i;c++)a[c]=(Math.random()*2-1)*(1-c/i);const n=e.createBufferSource();n.buffer=s;const l=e.createGain();l.gain.value=.35,n.connect(l),l.connect(t),n.start()}startBGM(){if(this.bgmPlaying)return;this.bgmPlaying=!0;const e=this.getCtx();this.bgmNextTime=e.currentTime+.1,this.bgmBeatIndex=0,this._scheduleBGM()}stopBGM(){this.bgmPlaying&&(this.bgmPlaying=!1,this.bgmSchedulerTimer!==null&&(clearTimeout(this.bgmSchedulerTimer),this.bgmSchedulerTimer=null))}_scheduleBGM(){if(!this.bgmPlaying||!this.ctx)return;const e=this.ctx,t=this.getMaster(),i=.3,s=100;for(;this.bgmNextTime<e.currentTime+i;)this._scheduleBGMBeat(e,t,this.bgmNextTime),this.bgmNextTime+=D.BEAT,this.bgmBeatIndex++;this.bgmSchedulerTimer=setTimeout(()=>this._scheduleBGM(),s)}_scheduleBGMBeat(e,t,i){const s=this.bgmBeatIndex,a=D.BASS_FREQS,n=Math.floor(s/2)%a.length;s%2===0&&this._scheduleNote(e,t,"sawtooth",a[n],i,D.BEAT*1.8,.12);const l=D.MELODY;let c=s%8,h=0;for(const[f,u]of l){if(c>=h&&c<h+u){f>0&&this._scheduleNote(e,t,"square",f,i,D.BEAT*u*.85,.1);break}h+=u}const y=e.createBuffer(1,Math.floor(e.sampleRate*.03),e.sampleRate),m=y.getChannelData(0);for(let f=0;f<m.length;f++)m[f]=(Math.random()*2-1)*(1-f/m.length);const b=e.createBufferSource();b.buffer=y;const S=e.createBiquadFilter();S.type="highpass",S.frequency.value=8e3;const w=e.createGain();w.gain.value=.04,b.connect(S),S.connect(w),w.connect(t),b.start(i)}_playNote(e,t,i,s,a,n,l){const c=e.createOscillator();c.type=i,c.frequency.value=s;const h=e.createGain();h.gain.setValueAtTime(l,a),h.gain.exponentialRampToValueAtTime(.001,a+n),c.connect(h),h.connect(t),c.start(a),c.stop(a+n)}_scheduleNote(e,t,i,s,a,n,l){this._playNote(e,t,i,s,a,n,l)}};r(D,"BPM",110),r(D,"BEAT",60/D.BPM),r(D,"BASS_FREQS",[110,98,82.41,110]),r(D,"MELODY",[[220,1],[261.63,1],[293.66,1],[329.63,1],[0,.5],[392,.5],[329.63,1],[261.63,2]]);let oe=D;async function As(){const o=new gt,e=new yt,t=new St,i=new rs,s=new os,a=document.getElementById("app"),n=document.getElementById("ui-root"),l=new Rt(a),c=new Pt;new Lt(l);const h=new Dt(l.scene);l.setCamera(c.camera);const y=new ss,m=new is(o),b=new ns,S=new ls,w=new cs,f=new ds,u=new ts(l,y,b);u.setMedalQuotaMultiplierFn(()=>S.quotaPerMedalMultiplier);const p=new Cs(n),M=new _s(l.renderer.domElement),E=new oe;let R=0,P=!1,L=0,A=0,N=0;p.titleScreen.onStart(()=>{He()}),p.stageResultScreen.onContinue(()=>{p.stageResultScreen.hide(),m.advanceStage(),se()}),p.stageResultScreen.onSkip(()=>{p.stageResultScreen.hide(),m.advancePhase(),Oe()}),p.shopScreen.onBuyMedals(T=>{const I=T*d.MEDAL_BUY_PRICE;f.buyMedals(T)?p.shopScreen.show(f.money,b.getAll(),f.getOwnedActiveItems()):console.log(`Not enough shop money (need ${I} G, have ${f.money} G)`)}),p.shopScreen.onSell(T=>{const I=f.sellItem(T,b);i.addShopMoney(I),p.shopScreen.show(f.money,b.getAll(),f.getOwnedActiveItems())}),p.shopScreen.onBuyActive(T=>{f.buyActiveItem(T)&&p.shopScreen.show(f.money,b.getAll(),f.getOwnedActiveItems())}),p.shopScreen.onContinue(()=>{p.shopScreen.hide(),Be()}),p.skillSelectScreen.onSelect(T=>{S.addSkill(T,m.currentPhase),f.setSellMultiplier(S.itemSellMultiplier),p.skillSelectScreen.hide(),o.transition(g.STAGE_START),se()}),p.resultScreen.onRetry(()=>{p.resultScreen.hide(),o.transition(g.TITLE),p.titleScreen.show()}),p.gameScreen.onUseActive(T=>{if(!o.is(g.PLAYING)||!f.useActiveItem(T))return;const I=Me(T);if(!I)return;const U=Date.now()+I.durationMs;T==="side_guard"?(N=U,u.addSideGuardWalls(),u.fieldMesh.addSideGuardMeshes(u.fieldMesh.group)):T==="medal_fever"&&(A=U)}),M.onThrow((T,I)=>{if(!o.is(g.PLAYING))return;const U=T*(d.FIELD_WIDTH/2-.5),Z=S.medalThrowCount;let O=0;for(let B=0;B<Z&&f.spendMedal();B++){const ae=(B-Math.floor(Z/2))*.6;u.throwMedal(U+ae,I),O++}O>0&&x.emit("medal:thrown",{count:O})}),x.on("quota:reached",()=>{o.is(g.PLAYING)&&(M.disable(),setTimeout(()=>{const T=S.onClearBonusMedals;T>0&&f.addMedals(T),m.clearCurrentStage();const I=m.isLastStageOfPhase;p.stageResultScreen.show(m.currentPhase,m.currentStage,I,y.currentValue,y.targetValue)},500))}),x.on("medal:collected",({count:T})=>{o.is(g.PLAYING)&&p.gameScreen.showFloatingText(`+${T}`)}),x.on("medal:thrown",()=>E.playThrow()),x.on("medal:collected",()=>E.playMedalCollected()),x.on("quota:reached",()=>E.playQuotaReached()),x.on("stage:cleared",()=>E.playStageCleared()),x.on("game:over",()=>E.playGameOver()),x.on("skill:selected",()=>E.playSkillSelected()),x.on("medal:collected",()=>c.shake(.04,.08)),x.on("quota:reached",()=>c.shake(.15,.3)),x.on("stage:cleared",()=>c.shake(.28,.5)),x.on("game:over",()=>c.shake(.5,.8)),x.on("state:changed",({to:T})=>{T===g.PLAYING?E.startBGM():E.stopBGM()}),e.addUpdateFn(T=>{if(o.is(g.PLAYING)){const I=Date.now();N>0&&I>N&&(N=0,u.removeSideGuardWalls(),u.fieldMesh.removeSideGuardMeshes(u.fieldMesh.group)),A>0&&I>A&&(A=0);const U=A>Date.now()?2:1;u.setMedalQuotaMultiplierFn(()=>S.quotaPerMedalMultiplier*U),u.update(T);const Z=f.getOwnedActiveItems().map(O=>{const B=Me(O.id),ae=O.id==="side_guard"?Math.max(0,N-Date.now()):O.id==="medal_fever"?Math.max(0,A-Date.now()):0;return{...O,name:B.name,color:B.color,remainingMs:ae}});if(p.updateGameHUD(f.currentMedals,y.currentValue,y.targetValue,m.currentPhase,m.currentStage,b.getAll(),Z),!P&&f.currentMedals<=0&&!y.isReached&&(P=!0,L=10,M.disable()),P&&L>0){const O=Math.ceil(L);L-=T;const B=Math.ceil(L);B!==O&&B>0&&E.playCountdownTick(),L>0?p.gameScreen.showCountdown(L):(p.gameScreen.hideCountdown(),Ge())}}h.update(T),c.update(T),l.render(c.camera)});function He(){t.incrementRuns(),f.reset(),b.clear(),S.reset(),i.reset(),m.reset(),R=0,P=!1,L=0,A=0,N=0,o.transition(g.STAGE_START),se()}async function se(){const T=m.currentPhase,I=m.currentStage;P=!1,L=0,p.gameScreen.hideCountdown(),y.startStage(T,I);try{u.physicsWorld.initialized?u.endStage():(ie(!0),await u.init(),ie(!1))}catch(U){console.error("Field init failed:",U),ie(!1);return}u.startStage(T,I),m.startCurrentStage(),M.enable()}function Oe(){u.endStage(),o.transition(g.SHOP),p.shopScreen.show(f.money,b.getAll(),f.getOwnedActiveItems())}function Be(){o.transition(g.SKILL_SELECT);const T=w.pickChoices(d.SKILL_CHOICES,S.getOwnedSkills(),Date.now());p.skillSelectScreen.show(T)}function Ge(){if(R>0){R--,L=0,p.gameScreen.hideCountdown(),M.enable(),P=!1;return}u.endStage();const T=s.calculate(i.snapshot,t);t.updateBest(T.phase,T.stage),o.transition(g.GAME_OVER),o.transition(g.RESULT),p.resultScreen.show(T)}const Y=document.createElement("div");Y.style.cssText=`
    position: absolute; inset: 0; display: none;
    align-items: center; justify-content: center;
    background: rgba(10,10,30,0.8); color: #ffd700;
    font-size: 1.2rem; letter-spacing: 0.2em;
  `,Y.textContent="LOADING...",n.appendChild(Y);function ie(T){Y.style.display=T?"flex":"none"}x.on("skill:selected",()=>{R=Math.max(R,S.gameOverShields)}),e.start(),o.transition(g.TITLE),p.titleScreen.show(),console.log("YukiMedal initialized")}As().catch(console.error);
