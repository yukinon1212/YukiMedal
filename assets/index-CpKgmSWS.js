var rs=Object.defineProperty;var ls=(d,e,s)=>e in d?rs(d,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):d[e]=s;var r=(d,e,s)=>ls(d,typeof e!="symbol"?e+"":e,s);import{M as k,O as cs,B as Ve,F as Et,S as Me,U as Qe,V as ne,W as Ye,H as qe,N as ds,C as hs,a as Y,b as se,A as ps,c as Ge,R as ms,d as us,e as fs,L as gs,f as ys,g as xs,h as jt,i as bs,j as vs,k as Zt,l as A,m as O,n as ws,P as Ee,o as Ss,p as Ts,q as Es,r as Ms,s as Cs,t as Xt,u as Is,D as Xe,v as Mt,w as $e,x as Ke,y as Je,G as Ct,z as _s,E as ie,I as As,J as ye,T as Ie,K as Rs,Q as Ps,X as Kt,Y as ks,Z as It,_ as Ls,$ as Ds,a0 as Le,a1 as gt,a2 as Hs,a3 as et,a4 as tt}from"./three-CzJWjZO5.js";import{O as ze}from"./rapier-DpxwuBBO.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))i(t);new MutationObserver(t=>{for(const a of t)if(a.type==="childList")for(const n of a.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function s(t){const a={};return t.integrity&&(a.integrity=t.integrity),t.referrerPolicy&&(a.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?a.credentials="include":t.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(t){if(t.ep)return;t.ep=!0;const a=s(t);fetch(t.href,a)}})();var E=(d=>(d.INIT="INIT",d.TITLE="TITLE",d.STAGE_START="STAGE_START",d.PLAYING="PLAYING",d.STAGE_CLEAR="STAGE_CLEAR",d.SKIP_PROMPT="SKIP_PROMPT",d.GAME_OVER="GAME_OVER",d.SHOP="SHOP",d.SKILL_SELECT="SKILL_SELECT",d.RESULT="RESULT",d))(E||{});class Gs{constructor(){r(this,"listeners",new Map)}on(e,s){this.listeners.has(e)||this.listeners.set(e,new Set);const i=this.listeners.get(e);return i.add(s),()=>i.delete(s)}once(e,s){const i=this.on(e,t=>{s(t),i()})}emit(e,s){const i=this.listeners.get(e);if(i)for(const t of i)t(s)}off(e,s){var i;(i=this.listeners.get(e))==null||i.delete(s)}clear(){this.listeners.clear()}}const P=new Gs,Bs=[{from:E.INIT,to:E.TITLE},{from:E.TITLE,to:E.STAGE_START},{from:E.STAGE_START,to:E.PLAYING},{from:E.PLAYING,to:E.STAGE_CLEAR},{from:E.PLAYING,to:E.GAME_OVER},{from:E.STAGE_CLEAR,to:E.STAGE_START},{from:E.STAGE_CLEAR,to:E.SKIP_PROMPT},{from:E.STAGE_CLEAR,to:E.SHOP},{from:E.SKIP_PROMPT,to:E.SHOP},{from:E.SKIP_PROMPT,to:E.STAGE_START},{from:E.SHOP,to:E.SKILL_SELECT},{from:E.SKILL_SELECT,to:E.STAGE_START},{from:E.GAME_OVER,to:E.RESULT},{from:E.RESULT,to:E.TITLE}];class Os{constructor(){r(this,"current",E.INIT)}get state(){return this.current}canTransition(e){return Bs.some(s=>(Array.isArray(s.from)?s.from:[s.from]).includes(this.current)&&s.to===e)}transition(e){if(!this.canTransition(e))throw new Error(`Invalid state transition: ${this.current} → ${e}`);const s=this.current;this.current=e,P.emit("state:changed",{from:s,to:e})}is(e){return this.current===e}isAny(...e){return e.includes(this.current)}}class Ns{constructor(){r(this,"updateFns",[]);r(this,"rafId",null);r(this,"lastTime",0);r(this,"maxDelta",1/20)}addUpdateFn(e){this.updateFns.push(e)}removeUpdateFn(e){const s=this.updateFns.indexOf(e);s!==-1&&this.updateFns.splice(s,1)}start(){if(this.rafId!==null)return;this.lastTime=performance.now();const e=s=>{this.rafId=requestAnimationFrame(e);const i=(s-this.lastTime)/1e3;this.lastTime=s;const t=Math.min(i,this.maxDelta);for(const a of this.updateFns)a(t)};this.rafId=requestAnimationFrame(e)}stop(){this.rafId!==null&&(cancelAnimationFrame(this.rafId),this.rafId=null)}get isRunning(){return this.rafId!==null}}const _t="yukimedal_save",$s="yukimedal_best",st={bestPhase:0,bestStage:0,totalRuns:0,lastPlayedAt:0};class zs{constructor(){r(this,"data");this.data=this.load()}load(){try{const e=localStorage.getItem(_t);return e?{...st,...JSON.parse(e)}:{...st}}catch{return{...st}}}save(){try{localStorage.setItem(_t,JSON.stringify(this.data))}catch{}}updateBest(e,s){const i=e*3+s,t=this.data.bestPhase*3+this.data.bestStage;i>t&&(this.data.bestPhase=e,this.data.bestStage=s,localStorage.setItem($s,JSON.stringify({phase:e,stage:s}))),this.data.lastPlayedAt=Date.now(),this.save()}incrementRuns(){this.data.totalRuns++,this.save()}get bestPhase(){return this.data.bestPhase}get bestStage(){return this.data.bestStage}get totalRuns(){return this.data.totalRuns}}const Jt={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}_e.BlurDirectionX=new ne(1,0);_e.BlurDirectionY=new ne(0,1);const Zs={name:"OutputShader",uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
  ...
  `,document.head.appendChild(d)}class Hi{constructor(e){r(this,"el");r(this,"titleEl");r(this,"onStartCallbacks",[]);r(this,"onSettingsCallbacks",[]);r(this,"hideTimer",null);Di(),this.el=document.createElement("div"),this.el.style.cssText=`
      ...
      overflow: hidden;
    `;const s=document.createElement("div");s.style.cssText="position:absolute;inset:0;pointer-events:none;overflow:hidden;";for(let f=0;f<22;f++){const c=document.createElement("div"),p=14+Math.random()*32,y=Math.random()*100,x=Math.random()*100,v=Math.random()*10,_=10+Math.random()*10,H=.07+Math.random()*.13;c.style.cssText=`
        position: absolute;
        ...
        top: ${x}%;
        opacity: ${H};
        animation: titleCoinFloat ${_}s ease-in-out infinite;
        animation-delay: -${v}s;
  ...
  `,document.head.appendChild(d)}class zi{constructor(e){r(this,"el");r(this,"medalCounter");r(this,"quotaBar");r(this,"phaseIndicator");r(this,"throwHint");r(this,"inventoryPanel");r(this,"activeItemPanel");r(this,"countdownEl");r(this,"feverBannerEl");r(this,"comboEl");r(this,"edgeGlowEl");r(this,"onUseActiveCallbacks",[]);r(this,"hideTimer",null);r(this,"jackpotHudEl");r(this,"jackpotBarEl");r(this,"comboHideTimer",null);r(this,"aimIndicatorEl");r(this,"stageCountEl");this.el=document.createElement("div"),this.el.style.cssText=`
    ...
    `,t.textContent="▸ ITEMS",this.inventoryPanel.appendChild(t);for(const a of e){const n=Ae(a.definitionId);if(!n)continue;const o=String(n.rarity),l=s[o]??"#9999aa",m=i[o]??"◇",u=document.createElement("div");u.style.cssText=`
  ...
  `,document.head.appendChild(d)}class Wi{constructor(e){r(this,"el");r(this,"onContinueCallbacks",[]);r(this,"onSkipCallbacks",[]);r(this,"continueBtn");r(this,"shopBtn");r(this,"hideTimer",null);r(this,"countUpTimer",null);Fi(),this.el=document.createElement("div"),this.el.style.cssText=`
      position: absolute;
      inset: 0;
      display: none;
      flex-direction: column;
  ...
  `,document.head.appendChild(d)}class Vi{constructor(e){r(this,"el");r(this,"onRetryCallbacks",[]);r(this,"onTitleCallbacks",[]);r(this,"hideTimer",null);Ui(),this.el=document.createElement("div"),this.el.style.cssText=`
      position: absolute;
      inset: 0;
      display: none;
      flex-direction: column;
...
`;class Ki{constructor(e){r(this,"el");r(this,"moneyEl");r(this,"inventoryEl");r(this,"onBuyMedalsCallbacks",[]);r(this,"onSellCallbacks",[]);r(this,"onContinueCallbacks",[]);r(this,"onBuyActiveCallbacks",[]);r(this,"hideTimer",null);this.el=document.createElement("div"),this.el.style.cssText=`
    ...
    `;const m=new Map(i.map(h=>[h.id,h.count]));for(const h of vt){const f=e>=h.price,c=m.get(h.id)??0,p=document.createElement("div");p.style.cssText=`
      ...
      `,y.textContent=h.name;const x=document.createElement("div");x.style.cssText="color: var(--t-text-dim); font-size: clamp(0.75rem, 1.4vw, 0.85rem); flex: 1;",x.textContent=h.description;const v=document.createElement("div");v.style.cssText="display: flex; justify-content: space-between; align-items: center; margin-top: 6px;";const _=document.createElement("div");_.style.cssText="color: #88cc88; font-size: clamp(0.75rem, 1.4vw, 0.85rem);",_.textContent=`×${c}`;const H=document.createElement("button");H.style.cssText=`
        padding: 5px 12px;
        ...
        letter-spacing: 0.05em;
      `,H.textContent=`${h.price} G`,f&&(H.addEventListener("mouseenter",()=>{H.style.background=`${h.color}44`}),H.addEventListener("mouseleave",()=>{H.style.background=`${h.color}22`}),p.addEventListener("mouseenter",()=>{p.style.transform="translateY(-3px)",p.style.boxShadow=`0 8px 32px rgba(0,0,0,0.5), 0 0 14px ${h.color}44`}),p.addEventListener("mouseleave",()=>{p.style.transform="",p.style.boxShadow=""}),H.addEventListener("click",()=>this.onBuyActiveCallbacks.forEach(T=>T(h.id)))),v.appendChild(_),v.appendChild(H),p.appendChild(y),p.appendChild(x),p.appendChild(v),l.appendChild(p)}o.appendChild(l),this.inventoryEl.appendChild(o);const u=document.createElement("div");if(u.appendChild(this.sectionHeader("🎁 YOUR ITEMS  —  tap to sell","var(--t-text-dim)")),s.length===0){const h=document.createElement("p");h.style.cssText="color: var(--t-text-dim); opacity: 0.45; font-size: clamp(0.9rem, 1.8vw, 1rem);",h.textContent="No items collected yet.",u.appendChild(h)}else{const h=document.createElement("div");h.style.cssText=`
        display: grid;
        grid-template-columns: repeat(auto-fill, minmax(150px, 1fr));
        gap: 12px;
      `;for(const f of s){const c=Ae(f.definitionId);if(!c)continue;const p=document.createElement("div"),x={Common:"#aaaaaa",Uncommon:"#44cc77",Rare:"#4488ff",Epic:"#aa44ff",Legendary:"#ffaa00"}[c.rarity]??"#aaaaaa";p.style.cssText=`
          padding: 12px 14px;
          ${ct}
          background: rgba(0,0,0,0.5);
  ...
  `,document.head.appendChild(d)}class sa{constructor(e){r(this,"el");r(this,"onVolumeChangeCallbacks",[]);r(this,"onThemeChangeCallbacks",[]);r(this,"onCloseCallbacks",[]);r(this,"hideTimer",null);r(this,"themeBtns",new Map);ta(),this.el=document.createElement("div"),this.el.style.cssText=`
    ...
    `;const i=document.createElement("h2");i.style.cssText="font-size: 1.6rem; color: var(--t-primary); margin-bottom: 32px; letter-spacing: 0.2em; text-align: center;",i.textContent="SETTINGS",s.appendChild(i);const t=document.createElement("div");t.style.cssText="margin-bottom: 32px;";const a=document.createElement("div");a.style.cssText="font-size: 0.75rem; color: var(--t-text-dim); letter-spacing: 0.15em; margin-bottom: 16px; text-transform: uppercase;",a.textContent="VOLUME",t.appendChild(a);const n=[{label:"Master",type:"master",value:e.masterVolume},{label:"BGM",type:"bgm",value:e.bgmVolume},{label:"SFX",type:"sfx",value:e.sfxVolume}];for(const p of n){const y=document.createElement("div");y.style.cssText="display: flex; align-items: center; gap: 12px; margin-bottom: 14px;";const x=document.createElement("div");x.style.cssText="font-size: 0.85rem; color: var(--t-text-bright); width: 52px; flex-shrink: 0;",x.textContent=p.label;const v=document.createElement("input");v.type="range",v.min="0",v.max="1",v.step="0.05",v.value=String(p.value),v.className="settings-slider",v.style.cssText="flex: 1;";const _=document.createElement("div");_.style.cssText="font-size: 0.8rem; color: var(--t-primary); width: 36px; text-align: right; flex-shrink: 0;",_.textContent=`${Math.round(p.value*100)}%`,v.addEventListener("input",()=>{const H=parseFloat(v.value);_.textContent=`${Math.round(H*100)}%`,this.onVolumeChangeCallbacks.forEach(T=>T(p.type,H))}),y.appendChild(x),y.appendChild(v),y.appendChild(_),t.appendChild(y)}s.appendChild(t);const o=document.createElement("hr");o.style.cssText="border: none; border-top: 1px solid var(--t-border-faint); margin-bottom: 24px;",s.appendChild(o);const l=document.createElement("div");l.style.cssText="margin-bottom: 32px;";const m=document.createElement("div");m.style.cssText="font-size: 0.75rem; color: var(--t-text-dim); letter-spacing: 0.15em; margin-bottom: 16px; text-transform: uppercase;",m.textContent="THEME",l.appendChild(m);const u=document.createElement("div");u.style.cssText="display: flex; gap: 10px; flex-wrap: wrap;";const h=["royal","cyber","steampunk"];for(const p of h){const y=p===e.theme,x=document.createElement("button");x.style.cssText=`
      ...
      `,x.textContent=is[p].displayName,x.addEventListener("click",()=>{this.selectTheme(p),this.onThemeChangeCallbacks.forEach(v=>v(p))}),this.themeBtns.set(p,x),u.appendChild(x)}l.appendChild(u),s.appendChild(l);const f=document.createElement("hr");f.style.cssText="border: none; border-top: 1px solid var(--t-border-faint); margin-bottom: 24px;",s.appendChild(f);const c=document.createElement("button");c.style.cssText=`
      width: 100%;
      padding: 12px;
      background: transparent;
...
}`,this._currentName=e,this._currentTheme=s,this._callbacks.forEach(t=>t(s))}onChange(e){this._callbacks.push(e)}};r(ge,"_instance",null);let ft=ge;const de=class de{constructor(){r(this,"comboCount",0);r(this,"lastCollectMs",0);r(this,"feverEndMs",0);r(this,"_wasInFever",!1)}onMedalCollected(e){const s=Date.now();s-this.lastCollectMs<de.COMBO_WINDOW_MS?this.comboCount+=e:this.comboCount=e,this.lastCollectMs=s,P.emit("combo:updated",{count:this.comboCount}),this.comboCount>=de.COMBO_TO_FEVER&&!this.isFever&&this._triggerFever()}update(){const e=this.isFever;this._wasInFever&&!e&&(this._wasInFever=!1,this.comboCount=0,P.emit("fever:ended",void 0)),this._wasInFever=e}get isFever(){return Date.now()<this.feverEndMs}get feverRemainingMs(){return Math.max(0,this.feverEndMs-Date.now())}get comboCountValue(){return this.comboCount}reset(){this.comboCount=0,this.lastCollectMs=0,this.feverEndMs=0,this._wasInFever=!1}_triggerFever(){this.feverEndMs=Date.now()+de.FEVER_DURATION_MS,this.comboCount=0,this._wasInFever=!0,P.emit("fever:started",void 0)}};r(de,"COMBO_WINDOW_MS",5e3),r(de,"COMBO_TO_FEVER",6),r(de,"FEVER_DURATION_MS",1e4),r(de,"FEVER_SPEED_MULT",1.6);let je=de;const Ue=new gt(.05,4,4),ca=new ie(.06,.06,.02,8),da=new Hs(.06,0),ha=new gt(.028,4,4);class pa{constructor(e){r(this,"particles",[]);r(this,"flashRings",[]);r(this,"scene");this.scene=e}spawnFlashRing(e,s,i,t){const a=new et(.1,.38,20),n=new Ge({color:t,transparent:!0,opacity:.9,side:tt}),o=new k(a,n);o.position.set(e,s,i),o.rotation.x=-Math.PI/2,this.scene.add(o),this.flashRings.push({mesh:o,life:0,maxLife:.25});const l=new et(.05,.22,16),m=new Ge({color:t,transparent:!0,opacity:.65,side:tt}),u=new k(l,m);u.position.set(e,s+.01,i),u.rotation.x=-Math.PI/2,this.scene.add(u),this.flashRings.push({mesh:u,life:-.06,maxLife:.35})}spawnMedalCollect(e,s,i){this.spawnFlashRing(e,s,i,16766720);const t=14;for(let a=0;a<t;a++){const n=a<5,o=n?ca:Ue,l=new O({color:n?16763904:16766720,emissive:new Y(n?14522624:16766720),emissiveIntensity:n?.6:1,metalness:n?.9:.3,roughness:n?.2:.5,transparent:!0}),m=new k(o,l);m.position.set(e,s,i);const u=a/t*Math.PI*2,h=1.5+Math.random()*3.5,f=new se(Math.cos(u)*h*.55,2.5+Math.random()*3.5,Math.sin(u)*h*.55);this.scene.add(m),this.particles.push({mesh:m,velocity:f,life:0,maxLife:.7+Math.random()*.5})}}spawnItemCollect(e,s,i,t){this.spawnFlashRing(e,s,i,t),this.spawnFlashRing(e,s+.1,i,t);const a=new Y(t),n=24;for(let o=0;o<n;o++){const m=o%3===0?da:Ue,u=new O({color:t,emissive:a,emissiveIntensity:1,metalness:.1,roughness:.4,transparent:!0}),h=new k(m,u);h.position.set(e,s,i);const f=o/n*Math.PI*2+Math.random()*.4,c=2.5+Math.random()*3,p=new se(Math.cos(f)*c,3.5+Math.random()*2.5,Math.sin(f)*c);this.scene.add(h),this.particles.push({mesh:h,velocity:p,life:0,maxLife:1.2+Math.random()*.5})}}spawnThrow(e,s,i){for(let a=0;a<9;a++){const n=new O({color:16766720,emissive:new Y(16766720),emissiveIntensity:1,metalness:.5,roughness:.3,transparent:!0}),o=new k(Ue,n);o.position.set(e,s,i);const l=a/9*Math.PI*2,m=1.2+Math.random()*1.6,u=new se(Math.cos(l)*m*.4,2.5+Math.random()*2,Math.sin(l)*m*.2);this.scene.add(o),this.particles.push({mesh:o,velocity:u,life:0,maxLife:.35+Math.random()*.2})}}spawnCoinGlints(e,s,i,t=3){const a=[16774314,16769152,16766720,16777215,16771248];for(let n=0;n<t;n++){const o=a[Math.floor(Math.random()*a.length)],l=new O({color:o,emissive:new Y(o),emissiveIntensity:2.5,transparent:!0,opacity:.9}),m=new k(ha,l),u=(Math.random()-.5)*1.2,h=(Math.random()-.5)*1.2;m.position.set(e+u,s+Math.random()*.1,i+h);const f=Math.random()*Math.PI*2,c=.4+Math.random()*.6,p=new se(Math.cos(f)*c*.3,.8+Math.random()*1.2,Math.sin(f)*c*.3);this.scene.add(m),this.particles.push({mesh:m,velocity:p,life:0,maxLife:.35+Math.random()*.25})}}spawnJackpot(e,s,i){this.spawnFlashRing(e,s,i,16766720);const t=new et(.3,.8,32),a=new Ge({color:16777215,transparent:!0,opacity:.85,side:tt}),n=new k(t,a);n.position.set(e,s,i),n.rotation.x=-Math.PI/2,this.scene.add(n),this.flashRings.push({mesh:n,life:0,maxLife:.4});const o=30;for(let l=0;l<o;l++){const m=l/o*360,u=new Y(`hsl(${m}, 100%, 60%)`),h=l%4===0,f=new O({color:u,emissive:u,emissiveIntensity:1,metalness:h?.8:.2,roughness:.3,transparent:!0}),c=new k(Ue,f);c.position.set(e,s,i);const p=l/o*Math.PI*2+Math.random()*.3,y=3.5+Math.random()*4.5,x=new se(Math.cos(p)*y,4+Math.random()*5,Math.sin(p)*y);this.scene.add(c),this.particles.push({mesh:c,velocity:x,life:0,maxLife:1.6+Math.random()*.6})}}update(e){const i=[];for(const a of this.particles){a.life+=e;const n=a.life/a.maxLife;a.velocity.y+=-9.8*e,a.mesh.position.addScaledVector(a.velocity,e),a.mesh.rotation.x+=e*5,a.mesh.rotation.y+=e*4,a.mesh.rotation.z+=e*3;const o=Math.max(0,1-n*.65);a.mesh.scale.setScalar(o),a.mesh.material.opacity=Math.pow(1-n,1.6),n>=1&&i.push(a)}for(const a of i)this.scene.remove(a.mesh),a.mesh.material.dispose(),this.particles.splice(this.particles.indexOf(a),1);const t=[];for(const a of this.flashRings){if(a.life+=e,a.life<0)continue;const n=a.life/a.maxLife,l=1+(1-Math.pow(1-n,2.2))*3.2;a.mesh.scale.set(l,l,l);const m=a.mesh.material.opacity>.7?.9:.65;a.mesh.material.opacity=m*Math.pow(1-n,.7),n>=1&&t.push(a)}for(const a of t)this.scene.remove(a.mesh),a.mesh.geometry.dispose(),a.mesh.material.dispose(),this.flashRings.splice(this.flashRings.indexOf(a),1)}clear(){for(const e of this.particles)this.scene.remove(e.mesh),e.mesh.material.dispose();this.particles=[];for(const e of this.flashRings)this.scene.remove(e.mesh),e.mesh.geometry.dispose(),e.mesh.material.dispose();this.flashRings=[]}}class ma{constructor(){r(this,"counter",0);r(this,"jackpotCount",0)}onQuotaAdded(e){this.counter+=e,P.emit("jackpot:progress",{current:this.counter,target:g.JACKPOT_THRESHOLD}),this.counter>=g.JACKPOT_THRESHOLD&&(this.counter-=g.JACKPOT_THRESHOLD,this.jackpotCount++,P.emit("jackpot:triggered",{count:this.jackpotCount}))}reset(){this.counter=0,this.jackpotCount=0}get progress(){return Math.min(1,this.counter/g.JACKPOT_THRESHOLD)}get current(){return this.counter}get target(){return g.JACKPOT_THRESHOLD}}const dt=1280,ht=720;function as(){const d=document.getElementById("ui-root");if(!d)return;const e=window.innerWidth<window.innerHeight,s=e?window.innerHeight:window.innerWidth,i=e?window.innerWidth:window.innerHeight,t=s/dt,a=i/ht,n=Math.min(t,a),o=Math.round((s-dt*n)/2),l=Math.round((i-ht*n)/2);d.style.width=`${dt}px`,d.style.height=`${ht}px`,d.style.transform=`translate(${o}px, ${l}px) scale(${n})`,d.style.transformOrigin="top left",d.style.inset="unset",d.style.top="0",d.style.left="0"}as();window.addEventListener("resize",as);screen.orientation&&"lock"in screen.orientation&&screen.orientation.lock("landscape").catch(()=>{});async function ua(){const d=ut.getInstance(),e=ft.getInstance();e.applyTheme(d.theme);const s=new Os,i=new Ns,t=new zs,a=new Ai,n=new Ri;let o=0;const l=document.getElementById("app"),m=document.getElementById("ui-root"),u=new Js(l),h=new ei,f=new ti(u),c=new si(u.scene);u.setCamera(h.camera);const p=e.currentTheme;u.applySceneTheme(p.scene),f.applyTheme(p.lights),c.applyTheme(p.scene);const y=new Mi,x=new Ci(s),v=new _i,_=new Pi,H=new ki,T=new Li,S=new Ei(u,y,v,p.scene);S.setMedalQuotaMultiplierFn(()=>_.quotaPerMedalMultiplier);const b=new na(m),N=new la(u.renderer.domElement);b.titleScreen.applyTheme(d.theme);const G=new je,R=new pa(u.scene),C=new ma,M=new mt;M.setMasterVolume(d.masterVolume),M.setBgmVolume(d.bgmVolume),M.setSfxVolume(d.sfxVolume),e.onChange(w=>{u.applySceneTheme(w.scene),f.applyTheme(w.lights),c.applyTheme(w.scene),b.titleScreen.applyTheme(w.name),S.physicsWorld.initialized&&S.rebuildFieldMesh(w.scene)}),b.titleScreen.onSettings(()=>{b.settingsScreen.show(d.snapshot)}),b.settingsScreen.onClose(()=>{b.settingsScreen.hide()}),b.settingsScreen.onVolumeChange((w,D)=>{w==="master"?(d.setMasterVolume(D),M.setMasterVolume(D)):w==="bgm"?(d.setBgmVolume(D),M.setBgmVolume(D)):(d.setSfxVolume(D),M.setSfxVolume(D))}),b.settingsScreen.onThemeChange(w=>{d.setTheme(w),e.applyTheme(w)});let z=0,F=!1,$=0,W=0,j=0;b.titleScreen.onStart(()=>{s.is(E.TITLE)&&Be()}),b.stageResultScreen.onContinue(()=>{b.stageResultScreen.hide(),x.advanceStage(),be()}),b.stageResultScreen.onSkip(()=>{b.stageResultScreen.hide(),x.advancePhase(),Ze()}),b.shopScreen.onBuyMedals(w=>{const D=w*g.MEDAL_BUY_PRICE;T.buyMedals(w)?b.shopScreen.show(T.money,v.getAll(),T.getOwnedActiveItems()):console.log(`Not enough shop money (need ${D} G, have ${T.money} G)`)}),b.shopScreen.onSell(w=>{const D=T.sellItem(w,v);a.addShopMoney(D),b.shopScreen.show(T.money,v.getAll(),T.getOwnedActiveItems())}),b.shopScreen.onBuyActive(w=>{T.buyActiveItem(w)&&b.shopScreen.show(T.money,v.getAll(),T.getOwnedActiveItems())}),b.shopScreen.onContinue(()=>{b.shopScreen.hide(),Oe()}),b.skillSelectScreen.onSelect(w=>{_.addSkill(w,x.currentPhase),T.setSellMultiplier(_.itemSellMultiplier),b.skillSelectScreen.hide(),s.transition(E.STAGE_START),be()}),b.resultScreen.onRetry(()=>{b.resultScreen.hide(),s.transition(E.TITLE),b.titleScreen.show()}),b.resultScreen.onTitle(()=>{b.resultScreen.hide(),s.transition(E.TITLE),b.titleScreen.show()}),b.gameScreen.onUseActive(w=>{if(!s.is(E.PLAYING)||!T.useActiveItem(w))return;const D=Nt(w);if(!D)return;const V=Date.now()+D.durationMs;if(w==="side_guard")j=V,S.addSideGuardWalls(),S.fieldMesh.addSideGuardMeshes(S.fieldMesh.group);else if(w==="medal_fever")W=V;else if(w==="medal_shower"){for(let Z=0;Z<20;Z++)setTimeout(()=>{if(!s.is(E.PLAYING))return;const J=(Math.random()*2-1)*(g.FIELD_WIDTH/2-.5),re=(Math.random()-.5)*(g.FIELD_DEPTH/2);S.medalSpawner.spawn(J,5,re,S.physicsWorld,S.physicsSync,S.collisionHandler,u)},Z*150);h.shake(.12,.3)}else w==="earthquake"&&(S.shakeAllMedals(4),h.shake(.4,.5),b.gameScreen.showFloatingText("🌋 地震！","var(--t-secondary)"))}),N.onAim(w=>{s.is(E.PLAYING)?b.gameScreen.showAim(w):b.gameScreen.hideAim()}),N.onThrow((w,D)=>{if(!s.is(E.PLAYING))return;const V=w*(g.FIELD_WIDTH/2+.5),Z=_.medalThrowCount;let J=0;for(let re=0;re<Z&&T.spendMedal();re++){const we=(re-Math.floor(Z/2))*.6;S.throwMedal(V+we,D),J++}J>0&&(P.emit("medal:thrown",{count:J}),R.spawnThrow(V,2,g.FIELD_DEPTH/2-.5))}),P.on("quota:reached",()=>{s.is(E.PLAYING)&&(N.disable(),setTimeout(()=>{if(!s.is(E.PLAYING))return;const w=_.onClearBonusMedals;w>0&&T.addMedals(w);const D=Math.max(0,Math.floor((y.currentValue/y.targetValue-1)*100)),V=15+Math.min(30,D);T.addMoney(V),x.clearCurrentStage(),b.chanceScreen.show(Z=>{Z.medals>0&&(T.addMedals(Z.medals),b.gameScreen.showFloatingText(`+${Z.medals}`,"var(--t-primary)"));const J=x.isLastStageOfPhase;b.stageResultScreen.show(x.currentPhase,x.currentStage,J,y.currentValue,y.targetValue)})},500))}),P.on("medal:collected",({count:w,x:D,y:V,z:Z})=>{if(s.is(E.PLAYING)){const J=(D/g.FIELD_WIDTH*2+1)/2*72+14;b.gameScreen.showFloatingText(`+${w}`,w>=2?"var(--t-secondary)":"var(--t-primary)",J),T.addMedals(w),G.onMedalCollected(w),C.onQuotaAdded(w),R.spawnMedalCollect(D,Math.max(V,0),Z),o+=w*150+Math.floor(Math.random()*50),oe.refreshJackpot(o),S.fieldMesh.triggerCollectionFlash()}}),P.on("item:collected",({x:w,y:D,z:V})=>{s.is(E.PLAYING)&&R.spawnItemCollect(w,Math.max(D,0),V,59647)}),P.on("jackpot:progress",({current:w,target:D})=>{s.is(E.PLAYING)&&b.gameScreen.updateJackpot(w,D)}),P.on("jackpot:triggered",()=>{if(!s.is(E.PLAYING))return;T.addMedals(g.JACKPOT_MEDAL_REWARD),b.gameScreen.showFloatingText(`JACKPOT! +${g.JACKPOT_MEDAL_REWARD}`,"var(--t-primary)"),M.playJackpotFanfare(),h.shake(.35,.6),R.spawnJackpot(0,2,-2),b.gameScreen.resetJackpot(g.JACKPOT_THRESHOLD)}),P.on("fever:started",()=>{S.pusher.speedMultiplier=je.FEVER_SPEED_MULT;const D=1.5*(W>Date.now()?2:1)*_.quotaPerMedalMultiplier;b.gameScreen.showFever(1e4,D),M.playFeverStart(),f.setFeverMode(!0),M.startBGM(!0),h.shake(.2,.4);for(let V=0;V<12;V++)setTimeout(()=>{if(!s.is(E.PLAYING))return;const Z=(Math.random()*2-1)*(g.FIELD_WIDTH/2-.5),J=(Math.random()*2-1)*(g.FIELD_DEPTH/4);S.medalSpawner.spawn(Z,4.5,J,S.physicsWorld,S.physicsSync,S.collisionHandler,u)},V*250)}),P.on("fever:ended",()=>{S.pusher.speedMultiplier=1,b.gameScreen.hideFever(),b.gameScreen.hideCombo(),M.playFeverEnd(),f.setFeverMode(!1),M.startBGM(!1)}),P.on("combo:updated",({count:w})=>{s.is(E.PLAYING)&&w>=2&&(b.gameScreen.showCombo(w),M.playCombo(w))}),P.on("medal:thrown",()=>{M.playThrow(),b.gameScreen.flashAim()}),P.on("medal:collected",()=>M.playMedalCollected()),P.on("quota:reached",()=>M.playQuotaReached()),P.on("stage:cleared",()=>M.playStageCleared()),P.on("game:over",()=>M.playGameOver()),P.on("skill:selected",()=>M.playSkillSelected()),P.on("medal:collected",()=>h.shake(.04,.08)),P.on("quota:reached",()=>h.shake(.15,.3)),P.on("stage:cleared",()=>h.shake(.28,.5)),P.on("game:over",()=>h.shake(.5,.8)),P.on("state:changed",({to:w})=>{w===E.PLAYING?M.startBGM(!1):M.stopBGM(),h.setTitleMode(w===E.TITLE)});let te=0,xe=0;i.addUpdateFn(w=>{if(te+=w,s.is(E.PLAYING)){const D=Date.now();j>0&&D>j&&(j=0,S.removeSideGuardWalls(),S.fieldMesh.removeSideGuardMeshes(S.fieldMesh.group)),W>0&&D>W&&(W=0);const V=W>Date.now()?2:1,Z=G.isFever?1.5:1,J=V*Z;S.setMedalQuotaMultiplierFn(()=>_.quotaPerMedalMultiplier*J),S.update(w),xe+=w;const re=G.isFever?.25:.55;if(xe>=re&&S.medalSpawner.count>0){xe=0;const ae=(Math.random()-.5)*5,le=-2+(Math.random()-.5)*4,Se=G.isFever?5:2;R.spawnCoinGlints(ae,.5,le,Se)}const we=T.getOwnedActiveItems().map(ae=>{const le=Nt(ae.id),Se=ae.id==="side_guard"?Math.max(0,j-Date.now()):ae.id==="medal_fever"?Math.max(0,W-Date.now()):0;return{...ae,name:le.name,color:le.color,remainingMs:Se}});if(b.updateGameHUD(T.currentMedals,y.currentValue,y.targetValue,x.currentPhase,x.currentStage,v.getAll(),we),!F&&T.currentMedals<=0&&!y.isReached&&(F=!0,$=10,N.disable(),b.gameScreen.quotaBar.setDanger(!0)),F&&T.currentMedals>0&&(F=!1,$=0,b.gameScreen.hideCountdown(),b.gameScreen.quotaBar.setDanger(!1),N.enable()),F&&$>0){const ae=Math.ceil($);$-=w;const le=Math.ceil($);le!==ae&&le>0&&M.playCountdownTick(),$>0?b.gameScreen.showCountdown($):(b.gameScreen.hideCountdown(),Pe())}}G.update(),R.update(w),c.update(w),f.update(te),h.update(w),u.render(h.camera)});function Be(){t.incrementRuns(),T.reset(),v.clear(),_.reset(),a.reset(),x.reset(),z=0,F=!1,$=0,W=0,j=0,G.reset(),C.reset(),S.pusher.speedMultiplier=1,o=0,oe.refreshJackpot(0),s.transition(E.STAGE_START),be()}async function be(){const w=x.currentPhase,D=x.currentStage;F=!1,$=0,b.gameScreen.hideCountdown(),b.gameScreen.quotaBar.setDanger(!1),G.reset(),C.reset(),S.pusher.speedMultiplier=1,b.gameScreen.hideFever(),b.gameScreen.hideCombo(),b.gameScreen.resetJackpot(g.JACKPOT_THRESHOLD),y.startStage(w,D);try{S.physicsWorld.initialized?D===1?S.endStage():S.endStageKeepMedals():(ve(!0),await S.init(),ve(!1))}catch(V){console.error("Field init failed:",V),ve(!1);return}D===1?S.startStage(w,D):S.startStageKeepMedals(w,D),x.startCurrentStage(),S.pusher.paused=!0,b.gameScreen.showStageCountdown(w,D,()=>{S.pusher.paused=!1,s.is(E.PLAYING)&&N.enable()})}function Ze(){S.endStage(),s.transition(E.SHOP),b.shopScreen.show(T.money,v.getAll(),T.getOwnedActiveItems())}function Oe(){s.transition(E.SKILL_SELECT);const w=H.pickChoices(g.SKILL_CHOICES,_.getOwnedSkills(),Date.now());b.skillSelectScreen.show(w)}function Pe(){if(z>0){z--,$=0,b.gameScreen.hideCountdown(),N.enable(),F=!1;return}S.endStage();const w=n.calculate(a.snapshot,t);t.updateBest(w.phase,w.stage),s.transition(E.GAME_OVER),s.transition(E.RESULT),b.resultScreen.show(w)}const me=document.createElement("div");me.style.cssText=`
    position: absolute; inset: 0; display: none;
    align-items: center; justify-content: center;
    background: var(--t-bg-overlay-dark); color: var(--t-primary);
    font-size: 1.2rem; letter-spacing: 0.2em;
  `,me.textContent="LOADING...",m.appendChild(me);function ve(w){me.style.display=w?"flex":"none"}P.on("skill:selected",()=>{z=Math.max(z,_.gameOverShields)}),i.start(),h.setTitleMode(!0),s.transition(E.TITLE),b.titleScreen.show(),console.log("YukiMedal initialized")}ua().catch(console.error);
